import { c as P, l as _, e as B } from "./WorkbenchMonacoEditor-CE3ZUqbM.js";
import { f as Q, g as G, C as J, H as Y, b as y, d as X, F as Z, S as $, e as K } from "./lspLanguageFeatures-Drxrblqs.js";
import { a as Ae, D as Oe, h as Ie, R as Ne, c as Le, i as Ee, j as De, t as Ue, k as Be } from "./lspLanguageFeatures-Drxrblqs.js";
const x = 120 * 1e3;
class C {
  constructor(i) {
  ...
  _getClient() {
    return this._lastUsedTime = Date.now(), this._client || (this._worker = P({
      ...
      createWorker: () => new Worker(new URL(
        /* @vite-ignore */
        "/assets/json.worker-DQOG4ivs.js",
        import.meta.url
      ), { type: "module" }),
...
//# sourceMappingURL=jsonMode-B5uOp29h.js.map
