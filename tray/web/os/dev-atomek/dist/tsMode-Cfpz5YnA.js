import { c as M, e as w, U as F, a as P, M as v, l as f, t as K, R as O } from "./WorkbenchMonacoEditor-DeMocMpz.js";
class E {
  constructor(e, t) {
  ...
  _getClient() {
    return this._client || (this._client = (async () => (this._worker = M({
      ...
      createWorker: () => new Worker(new URL(
        /* @vite-ignore */
        "" + new URL("assets/ts.worker-8H1ltW3J.js", import.meta.url).href,
        import.meta.url
      ), { type: "module" }),
      label: this._modeId,
      keepIdleModels: !0,
...
class $ extends y {
  async provideDocumentSymbols(e, t) {
    ...
    const p = (r, u) => ({
      ...
      tags: [],
      children: r.childItems?.map((g) => p(g, r.text)),
      containerName: u
    });
...
function R(c, e) {
  ...
  function p() {
    ...
    X(t), n.completionItems && t.push(
      ...
      f.registerHoverProvider(e, new V(i))
      ...
      f.registerCodeActionProvider(e, new G(i))
    ), n.inlayHints && t.push(
      f.registerInlayHintsProvider(e, new q(i))
    ), n.diagnostics && t.push(new W(l, c, e, i));
  }
  return p(), i;
}
function X(c) {
...
//# sourceMappingURL=tsMode-Cfpz5YnA.js.map
