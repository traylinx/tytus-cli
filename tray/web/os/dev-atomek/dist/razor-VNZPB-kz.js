import { l as t } from "./WorkbenchMonacoEditor-DeMocMpz.js";
const e = [
  "area",
  "base",
  "br",
  ...
  onEnterRules: [
    {
      ...
      afterText: /^<\/(\w[\w\d]*)\s*>$/i,
      action: {
        indentAction: t.IndentAction.IndentOutdent
      }
    },
    {
      beforeText: new RegExp(
      ...
      action: { indentAction: t.IndentAction.Indent }
    }
  ]
}, m = {
  defaultToken: "",
...
//# sourceMappingURL=razor-VNZPB-kz.js.map
