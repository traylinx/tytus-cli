...
import { jsx as a, jsxs as u, Fragment as Ve } from "react/jsx-runtime";
import { forwardRef as Da, createElement as jn, useState as X, useRef as Xe, useCallback as z, useEffect as se, lazy as bs, useMemo as fe, Suspense as vs } from "react";
 ...
 */
const gs = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), ws = (e) => e.replace(
  /^([A-Z])|[\s-_]+(\w)/g,
  (t, n, r) => r ? r.toUpperCase() : n.toLowerCase()
), va = (e) => {
  const t = ws(e);
  return t.charAt(0).toUpperCase() + t.slice(1);
}, Fa = (...e) => e.filter((t, n, r) => !!t && t.trim() !== "" && r.indexOf(t) === n).join(" ").trim(), ks = (e) => {
  for (const t in e)
...
const xs = Da(
  ({
    ...
    "svg",
    {
      ...
      className: Fa("lucide", s),
      ...!i && !ks(l) && { "aria-hidden": "true" },
      ...l
    },
    [
      ...o.map(([p, b]) => jn(p, b)),
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const Ls = [["path", { d: "M20 6 9 17l-5-5", key: "1gmf2c" }]], As = ie("check", Ls);
/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const Os = [["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]], St = ie("chevron-down", Os);
/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const si = /* @__PURE__ */ new Set([".git", "node_modules", "dist", "build", ".next", ".turbo", "coverage", ".cache"]);
function ii() {
  const e = Bn();
  return !!(e?.showOpenFilePicker && e.showDirectoryPicker);
}
async function oi() {
  const e = Bn()?.showOpenFilePicker;
  if (!e) return _a(!1);
  const t = await e({ multiple: !0 }), n = await Promise.all(t.map((r) => Gn(r, r.name, "local-file")));
  return Mt(n.filter(Boolean));
}
async function ci() {
  const e = Bn()?.showDirectoryPicker;
  if (!e)
    return { name: "Browser fallback folder", files: await _a(!0) };
  const t = await e({ mode: "readwrite" }), n = [];
  return await Qn(t, t.name, n, 0, 320), { name: t.name, handle: t, files: Mt(n) };
}
async function li(e) {
  const t = await Promise.all(e.map((n) => Gn(n, n.name, "local-file")));
  return Mt(t.filter(Boolean));
}
async function wa(e) {
  const t = [];
  return await Qn(e, e.name, t, 0, 320), { name: e.name, handle: e, files: Mt(t) };
}
async function xn(e, t = "readwrite") {
  try {
...
async function Qn(e, t, n, r, s) {
  if (!(n.length >= s || r > 8))
    for await (const i of e.values()) {
      if (n.length >= s) break;
      if (i.kind === "directory") {
        if (si.has(i.name)) continue;
        await Qn(i, `${t}/${i.name}`, n, r + 1, s);
        continue;
      }
      const o = i, l = await Gn(o, `${t}/${o.name}`, "local-folder");
      l && n.push(l);
    }
}
function _a(e) {
  return new Promise((t) => {
    ...
    n.type = "file", n.multiple = !0, n.style.display = "none", e && n.setAttribute("webkitdirectory", ""), n.onchange = async () => {
      const r = Array.from(n.files ?? []), s = await Promise.all(r.map(async (i) => {
...
`).map(
    ...
    const i = r.split("|").filter(Boolean).map((l) => `<th style="padding:8px 12px;background:var(--bg-titlebar);font-weight:600;font-size:13px;border:1px solid var(--border-default)">${l.trim()}</th>`).join(""), o = s.trim().split(`
...
const Je = {
  ...
  available: !0
}, ui = "atomek:selected-chat-target", dn = {
  openclaw: "OpenClaw",
  hermes: "Hermes"
}, Ut = /https?:\/\/(?:10(?:\.\d{1,3}){3}|192\.168(?:\.\d{1,3}){2}|172\.(?:1[6-9]|2\d|3[01])(?:\.\d{1,3}){2})(?::\d+)?\S*/gi, Bt = /\b(?:10(?:\.\d{1,3}){3}|192\.168(?:\.\d{1,3}){2}|172\.(?:1[6-9]|2\d|3[01])(?:\.\d{1,3}){2})\b/g, Gt = /\b(?:MiniMax(?:-M[\w.-]+)?|Moonshot|Kimi|DeepSeek|Qwen|Alibaba|Xiaomi|Nous|OpenRouter|Strato|Scalesys|ail-compound|switchAILocal|OpenAI-compatible|vLLM|llama\.cpp)\b/gi, Qt = /\b(?:route[_-]?id|pod[_-]?id|droplet[_-]?id|provider[_-]?id|publicUrl|gatewayUrl|privateUrl)\b\s*[:=]\s*[^\s,;]+/gi, $t = /\b(?:pod-agent|ail-route|strato-eu|wannolot|scalesys)[._:-][a-z0-9._:-]{4,}\b/gi, _t = /https?:\/\/[^\s)]*(?:tytus\.traylinx\.com|strato|scalesys|wannolot|droplet|gateway|route|\.internal|\.local|digitalocean|do\.com|hetzner)[^\s)]*/gi, en = /\b(?:fe80|fc00|fd[0-9a-f]{2}):[0-9a-f:]+(?:%[a-z0-9]+)?\b/gi;
function $n(e) {
  return e.replace(Ut, "private gateway").replace(_t, "private gateway").replace(en, "private gateway").replace(Bt, "private gateway").replace(Qt, "agent runtime").replace($t, "your Tytus pod").replace(Gt, "agent runtime").replace(/\s{3,}/g, "  ");
}
function ka(e) {
  const t = e.toLowerCase();
  return /\b(503|502|504|warm|warming|boot|starting|not ready|temporarily unavailable)\b/.test(t) ? { message: "Agent is warming up. Try again in a moment.", retryable: !0 } : /\b(timeout|timed out|aborted)\b/.test(t) ? { message: "Connection timed out. The agent may still be working. Try again.", retryable: !0 } : /\b(offline|stopped|unreachable|not found|404)\b/.test(t) ? { message: "Agent is offline. Restart the pod or pick another agent.", retryable: !0 } : { message: $n(e).trim() || "Agent chat failed. Try again or pick another agent.", retryable: !1 };
}
function nr(e) {
  return `${ui}:${e}`;
}
function hi(e) {
  try {
    return localStorage.getItem(nr(e))?.trim() || Je.id;
  } catch {
    return Je.id;
  }
}
function Pa(e, t) {
  try {
    localStorage.setItem(nr(e), t || Je.id);
  } catch {
  }
}
function gt(e, ...t) {
...
function pi(e) {
  return e.kind !== "pod-agent" ? null : ar([
    e.label,
    e.id,
...
function vi(e) {
  const t = e.trim();
  return t.length < 2 || t.length > 44 ? !1 : Ut.test(t) || _t.test(t) || en.test(t) || Bt.test(t) || Qt.test(t) || $t.test(t) || Gt.test(t) ? (Ut.lastIndex = 0, _t.lastIndex = 0, en.lastIndex = 0, Bt.lastIndex = 0, Qt.lastIndex = 0, $t.lastIndex = 0, Gt.lastIndex = 0, !1) : (Ut.lastIndex = 0, _t.lastIndex = 0, en.lastIndex = 0, Bt.lastIndex = 0, Qt.lastIndex = 0, $t.lastIndex = 0, Gt.lastIndex = 0, /^[\p{L}\p{N}][\p{L}\p{N} ._()'&+-]*$/u.test(t));
}
function yi(e, t) {
  const n = gt(e.metadata, "displayName", "display_name", "customName", "custom_name", "podDisplayName", "pod_display_name", "name");
  if (n) {
    const r = $n(n).replace(/\bNemoClaw\b/gi, "OpenClaw").replace(/\s+/g, " ").trim();
    if (vi(r)) return r;
  }
  return dn[t];
}
...
function wi(e) {
  const t = e.filter((i) => i.kind === "pod-agent"), n = t.reduce((i, o) => (i[o.agentFamily] = (i[o.agentFamily] ?? 0) + 1, i), { openclaw: 0, hermes: 0 }), r = {}, s = { openclaw: 0, hermes: 0 };
  return e.map((i) => {
    if (i.kind !== "pod-agent") return i;
    const o = i.label, l = dn[i.agentFamily];
    s[i.agentFamily] += 1;
    const f = o.toLowerCase();
    r[f] = (r[f] ?? 0) + 1;
    const p = t.filter((P) => P.label.toLowerCase() === f).length > 1, b = o === l && n[i.agentFamily] > 1;
    if (!p && !b) return i;
    const v = b ? s[i.agentFamily] : r[f];
    return { ...i, label: `${o} ${v}` };
  });
}
function ki(e) {
  const t = e.daemon?.state, n = t?.included ?? [], r = t?.agents ?? [], s = new Map(r.map((o) => [o.id, o])), i = n.flatMap((o) => {
    const l = o.id ?? "", p = { ...(o.agentId ? s.get(o.agentId) : void 0)?.meta ?? {}, ...o.meta ?? {} }, b = ar([l, o.kind, gt(p, "displayName", "display_name", "agentFamily", "agentType", "brand")].join(" "));
    return !l || !b ? [] : [{
      id: `pod-agent.${l}`,
      kind: "pod-agent",
      label: dn[b],
  ...
  return rr({ generatedAt: (/* @__PURE__ */ new Date()).toISOString(), resources: i });
}
async function Pi(e, t) {
  ...
  const r = rr(n), s = r.length > 0 ? [] : ki(e), i = /* @__PURE__ */ new Map();
  for (const o of [Je, ...r, ...s]) i.set(o.id, o);
  return [...i.values()];
}
const _n = "atomek", Re = "atomek:default", xi = 3e3, ea = "tytus.atomek.threadTitleOverrides", sr = "tytus.atomek.selectedThreadId", xa = {
  available: !1,
  source: "none",
...
}, Ni = (e, t = xi) => e.length <= t ? e : `${e.slice(0, t)}

[...clipped ${e.length - t} chars...]`, Tn = (e, t) => {
  const n = e.split(`
`).map((r) => r.replace(/^#+\s*/, "").trim()).find(Boolean);
  return n ? n.length > 80 ? `${n.slice(0, 77)}...` : n : t;
}, Ti = (e) => ["briefing", "action-list", "quiz", "plan", "storyboard", "report", "local-draft", "markdown", "memory"].includes(e) ? e : "report", Na = (e) => ({
  id: e.id,
  title: e.title,
  kind: Ti(e.kind),
  body: e.body,
...
`)
  ...
  try {
    const n = ta();
    n[e] = t, localStorage.setItem(ea, JSON.stringify(n));
  } catch {
  }
}, Xi = (e) => {
  try {
    const t = ta();
    delete t[e], localStorage.setItem(ea, JSON.stringify(t));
  } catch {
  }
}, za = (e) => {
  const t = ta();
  ...
  try {
    return localStorage.getItem(sr)?.trim() || null;
  } catch {
    return null;
  }
}, rt = (e) => {
  try {
    localStorage.setItem(sr, e);
  } catch {
  }
}, sn = (e) => `${Re}:agent-session:${e}`, on = (e) => `${Re}:agent-transcript:${e}`, na = (e) => `${Re}:${_n}:agent-session:${e}`, cn = (e) => `${Re}:${_n}:agent-transcript:${e}`, ir = 100, Ai = (e, t) => {
  try {
    const n = localStorage.getItem(na(e))?.trim();
    if (n) return n;
    const r = localStorage.getItem(sn(e))?.trim();
    return r || t && t !== e && localStorage.getItem(sn(t))?.trim() || null;
  } catch {
    return null;
  }
}, Oi = (e, t) => {
  try {
    localStorage.setItem(na(e), t);
  } catch {
  }
}, Rt = (e, t) => {
  try {
    const n = localStorage.getItem(cn(e)), r = n ? JSON.parse(n) : [], s = /* @__PURE__ */ new Map();
    for (const i of [...r, ...t]) s.set(i.id, i);
    localStorage.setItem(cn(e), JSON.stringify([...s.values()].slice(-ir)));
  } catch {
  }
}, tn = (e) => {
  if (!e) return [];
  ...
  try {
    const n = tn(localStorage.getItem(cn(e)));
    if (n.length > 0) return n;
    const r = tn(localStorage.getItem(on(e)));
    return r.length > 0 || !t || t === e ? r : tn(localStorage.getItem(on(t)));
  } catch {
    return [];
  }
};
function Si() {
  const e = `${Re}:${_n}:agent-transcript:`, t = [];
  try {
    for (let n = 0; n < localStorage.length; n += 1) {
      const r = localStorage.key(n);
      if (!r || !r.startsWith(e)) continue;
      const s = tn(localStorage.getItem(r));
      if (s.length === 0) continue;
      const i = s[s.length - 1], o = s.find((l) => l.role === "user");
      t.push({
        targetId: r.slice(e.length),
        lastActivityAt: typeof i?.createdAt == "number" ? i.createdAt : Date.now(),
        messageCount: s.length,
        preview: (o?.body ?? i?.body ?? "").trim().slice(0, 80)
      });
    }
  } catch {
  }
...
const or = (e, t) => {
  try {
    localStorage.removeItem(cn(e)), localStorage.removeItem(na(e)), localStorage.removeItem(on(e)), localStorage.removeItem(sn(e)), t && t !== e && (localStorage.removeItem(on(t)), localStorage.removeItem(sn(t)));
  } catch {
  }
}, ji = (e) => {
  const t = e.daemon;
...
function Vi({ host: e, requestContext: t, chatSettings: n, selectedTarget: r = Je, setStatus: s }) {
  const i = e.ai, [o, l] = X(null), [f, p] = X([]), [b, v] = X([]), [P, H] = X([]), [C, V] = X([]), [Z, I] = X(xa), [oe, pe] = X(!1), S = Xe(!0), B = Xe(null), J = z(async () => {
    if (!i) {
      I(xa);
      return;
    }
    ...
    if (i)
      try {
        const A = await i.listArtifacts({ threadId: T });
        if (!S.current) return;
        H(A.map(Na));
      } catch (A) {
        s(`AI artifacts unavailable: ${A instanceof Error ? A.message : String(A)}`);
      }
  }, [i, s]), U = z(async (T) => {
    if (i)
      try {
        const A = await i.listMessages(T);
        if (!S.current) return;
        const D = f.find((L) => L.id === T) ?? null;
        D && l(D), rt(T), v(A.map(ht).filter(Boolean)), V([]), await g(T);
      } catch (A) {
        s(`Load chat failed: ${A instanceof Error ? A.message : String(A)}`);
      }
  }, [i, g, s, f]), q = z(async () => {
    if (i)
      try {
        const T = za(await i.listThreads({ workspaceKey: Re, status: "active" })), A = Li(), D = T.find((ae) => ae.id === A) ?? T[0] ?? await i.createThread({ workspaceKey: Re, title: "Atomek chat" });
        if (!S.current) return;
        p(T[0] ? T : [D]), l(D), rt(D.id);
        const L = await i.listMessages(D.id);
        if (!S.current) return;
        v(L.map(ht).filter(Boolean)), await g(D.id);
      } catch (T) {
        s(`AI chat unavailable: ${T instanceof Error ? T.message : String(T)}`);
      }
  }, [i, g, s]);
  se(() => (S.current = !0, J(), q(), () => {
    S.current = !1;
  }), [q, J]);
  const ce = r.kind === "pod-agent" ? r.podId : null;
  se(() => {
    if (r.kind === "pod-agent") {
      v(Ci(r.id, r.podId)), V([]);
      return;
    ...
    return (async () => {
      try {
        const A = await i.listMessages(o.id);
        !T && S.current && v(A.map(ht).filter(Boolean));
      } catch {
      }
    })(), () => {
      T = !0;
  ...
  const ne = z(async () => {
    if (!i) return null;
    if (o) return o;
    const T = await i.createThread({ workspaceKey: Re, title: "Atomek chat" });
    return S.current && (l(T), rt(T.id), p((A) => [T, ...A.filter((D) => D.id !== T.id)])), T;
  }, [i, o]), Te = z(async () => {
    if (r.kind === "pod-agent") {
      or(r.id, r.podId), v([]), V([]), s(`Cleared ${r.label} chat`);
      return;
    }
    if (!i) return;
    const T = await i.createThread({ workspaceKey: Re, title: "Atomek chat" });
    l(T), rt(T.id), p((A) => [T, ...A.filter((D) => D.id !== T.id)]), v([]), H([]), V([]), s("New AI chat created");
  }, [i, r, s]), Le = z(async (T, A) => {
    if (!i) return;
    const D = A.trim();
    if (D)
      try {
        const L = i.updateThread, ae = f.find((be) => be.id === T) ?? o, ue = typeof L == "function" ? await L({ threadId: T, title: D }) : { ...ae ?? await ne(), id: T, title: D, updatedAt: Date.now() };
        typeof L != "function" && Ta(T, D), p((be) => be.map((ye) => ye.id === ue.id ? ue : ye)), l((be) => be?.id === ue.id ? ue : be), s(typeof L == "function" ? `Renamed chat: ${ue.title}` : `Renamed chat locally: ${ue.title}`);
      } catch (L) {
        s(`Rename chat failed: ${L instanceof Error ? L.message : String(L)}`);
      }
  }, [i, ne, s, o, f]), Ae = z(async (T) => {
    if (i)
      try {
        await i.deleteThread(T), Xi(T);
        const A = f.filter((D) => D.id !== T);
        if (p(A), o?.id === T) {
          const D = A[0] ?? await i.createThread({ workspaceKey: Re, title: "Atomek chat" });
          l(D), rt(D.id), p((ae) => ae.some((ue) => ue.id === D.id) ? ae : [D, ...ae]);
          const L = await i.listMessages(D.id);
          v(L.map(ht).filter(Boolean)), await g(D.id);
        }
        s("Deleted AI chat");
      } catch (A) {
        s(`Delete chat failed: ${A instanceof Error ? A.message : String(A)}`);
      }
  }, [i, g, s, o?.id, f]), m = z(async (T) => {
    if (!i) return null;
    try {
      const A = await ne();
      if (!A) return null;
      rt(A.id);
      const D = await i.createArtifact({
        threadId: A.id,
        messageId: T.messageId ?? null,
        title: T.title?.trim() || Tn(T.body, "Atomek artifact"),
        kind: T.kind ?? "markdown",
        body: T.body
      }), L = Na(D);
      return H((ae) => [L, ...ae.filter((ue) => ue.id !== L.id)]), s(`Saved AI artifact: ${L.title}`), L;
    } catch (A) {
      return s(`Save artifact failed: ${A instanceof Error ? A.message : String(A)}`), null;
    }
  }, [i, ne, s]), F = z(async (T) => {
    if (i)
      try {
        await i.deleteArtifact(T), H((A) => A.filter((D) => D.id !== T)), s("Deleted AI artifact");
      } catch (A) {
        s(`Delete artifact failed: ${A instanceof Error ? A.message : String(A)}`);
      }
  }, [i, s]), te = z(async (T) => {
    if (!i) return null;
    try {
      const A = await i.writeMemory({
        title: T.title?.trim() || Tn(T.body, "Atomek memory"),
        body: T.body,
        metadata: {
          source: "atomek",
          messageId: T.messageId ?? null
      ...
      return V((D) => [A, ...D.filter((L) => L.id !== A.id)].slice(0, 5)), s(`Remembered: ${A.title}`), A;
    } catch (A) {
      return s(`Remember failed: ${A instanceof Error ? A.message : String(A)}`), null;
    }
  }, [i, s]), le = z(async (T) => {
    if (!i) return [];
    const A = await i.searchMemory({ query: T, limit: 5 });
    return S.current && V(A), A;
  }, [i]), w = z(async (T, A = {}) => {
    const D = T.trim();
    if (!D) return null;
    const L = r;
    if (L.kind === "atomek-ai" && !i) return null;
    pe(!0);
    let ae = null;
    const ue = new AbortController();
    B.current = ue;
    try {
      const be = A.requestContext ?? t;
      if (L.kind === "pod-agent") {
        const re = ji(e), Y = Date.now(), de = {
          id: `agent-user-${Y}`,
          role: "user",
          body: D,
          status: "complete",
          createdAt: Y
        }, he = `agent-assistant-${Y}`, ke = {
          id: he,
          role: "assistant",
          body: "",
          status: "streaming",
        ...
        if (v((d) => [...d, de, ke]), Rt(L.id, [de, ke]), !L.available) {
          const d = ka(L.description), k = { ...ke, body: d.message, status: "error", error: d.message };
          return v((x) => x.map((O) => O.id === he ? k : O)), Rt(L.id, [k]), s(d.message), k;
        }
        if (!re) {
          const d = "Agent chat bridge unavailable in this Tytus host build. Update TytusOS host API/runtime to enable OpenClaw and Hermes chat.", k = { ...ke, body: d, status: "error", error: d };
          return v((x) => x.map((O) => O.id === he ? k : O)), Rt(L.id, [k]), s("Agent chat bridge unavailable"), k;
        }
        let De = "";
        const Ke = (d, k) => (v((x) => x.map((O) => O.id === he ? d : O)), Rt(L.id, [de, d]), s(k), d);
        try {
          for await (const d of re.chatAgent({
            podId: L.podId,
            routeId: L.routeId ?? null,
            sessionId: Ai(L.id, L.podId),
            message: Wi(D, be),
            mode: "operator",
            target: "agent",
            ...
            if (d.type === "profile") {
              const k = d.profile === "local" ? "Local Cortex" : "Cloud Cortex";
              v(
                (x) => x.map(
                  (O) => O.id === he ? { ...O, gatewayLabel: k } : O
                )
              );
            }
            if (d.type === "session" && Oi(L.id, d.sessionId), d.type === "token" && (De = $n(`${De}${d.text}`), v((k) => k.map((x) => x.id === he ? { ...x, body: De, status: "streaming" } : x))), d.type === "error") {
              const k = ka(d.message), x = { ...ke, body: k.message, status: "error", error: k.message };
              return Ke(x, k.message);
            }
            if (d.type === "done")
              return ae = { ...ke, body: De || "Agent finished without visible output.", status: "complete" }, Ke(ae, `${L.label} answered`);
          }
        } catch (d) {
          if (ue.signal.aborted || d instanceof DOMException && d.name === "AbortError")
            return ae = { ...ke, body: De || "Stopped by user.", status: "complete" }, Ke(ae, `${L.label} response stopped`);
          throw d;
        }
        return ue.signal.aborted ? (ae = { ...ke, body: De || "Stopped by user.", status: "complete" }, Ke(ae, `${L.label} response stopped`)) : ae || (ae = { ...ke, body: De || "Agent finished without visible output.", status: "complete" }, Ke(ae, `${L.label} answered`));
      }
      const ye = await ne();
      if (!ye || !i) return null;
      rt(ye.id);
      const He = (ye.title ?? "").trim();
      if ((!He || He === "Atomek chat") && D.trim()) {
        const re = Tn(D, "Atomek chat");
        re && re !== He && (async () => {
          try {
            const Y = i.updateThread, de = typeof Y == "function" ? await Y({ threadId: ye.id, title: re }) : { ...ye, title: re, updatedAt: Date.now() };
            if (typeof Y != "function" && Ta(ye.id, re), !S.current) return;
            l((he) => he?.id === de.id ? de : he), p((he) => he.map((ke) => ke.id === de.id ? de : ke));
          } catch {
          }
        })();
      }
      const qe = await le(D).catch(() => []), tt = zi(qe), Pe = tt ? [...be, tt] : [...be];
      let ge = null;
      for await (const re of i.sendMessage({
        threadId: ye.id,
        body: D,
        ...
        if (re.type === "message_created") {
          const Y = ht(re.message);
          if (!Y) continue;
          Y.role === "assistant" && (ge = Y.id), v((de) => [...de.filter((he) => he.id !== Y.id), Y]);
        }
        if (re.type === "token" && (ge = re.messageId, v((Y) => Y.some((de) => de.id === re.messageId) ? Y.map(
          (de) => de.id === re.messageId ? { ...de, body: re.body, status: "streaming", sourceLabel: "Atomek" } : de
        ) : [...Y, {
          id: re.messageId,
          role: "assistant",
          body: re.body,
          ...
          sourceLabel: "Atomek",
          createdAt: Date.now()
        }])), re.type === "message_updated" || re.type === "done") {
          const Y = ht(re.message);
          if (!Y) continue;
          Y.role === "assistant" && (ae = Y), v((de) => de.map((he) => he.id === Y.id ? Y : he)), Y.gatewayLabel && s(`AI answered via ${Y.gatewayLabel}`);
        }
        if (re.type === "run_failed") {
          const Y = ue.signal.aborted;
          s(Y ? "AI response stopped" : `AI failed: ${re.error}`), ge && v((de) => de.map((he) => he.id !== ge ? he : Y ? { ...he, status: "complete", error: void 0, body: he.body || "Stopped by user." } : { ...he, status: "error", error: re.error, body: re.error }));
        }
      }
      const Ze = za(await i.listThreads({ workspaceKey: Re, status: "active" }).catch(() => []));
      return S.current && Ze.length > 0 && p(Ze), J(), ae;
    } catch (be) {
      return be instanceof DOMException && be.name === "AbortError" ? (s("AI response stopped"), ae) : (s(`AI failed: ${be instanceof Error ? be.message : String(be)}`), null);
    } finally {
      B.current === ue && (B.current = null), pe(!1);
    }
  }, [i, n.gatewayPreference, n.model, ne, e, le, J, t, r, s]), W = z(() => {
    B.current?.abort(), s("Stopping AI response…");
  }, [s]);
  return {
    aiStatus: Z,
    artifacts: P,
...
const Ii = (e) => `tytus-workbench:///${encodeURI(e.path)}`, Di = (e) => {
  let t = 2166136261;
  for (let n = 0; n < e.length; n += 1)
    t ^= e.charCodeAt(n), t = Math.imul(t, 16777619);
  return (t >>> 0).toString(16).padStart(8, "0");
}, Fi = ({ files: e, openEditorIds: t, activeFileId: n, versions: r, activeSelection: s }) => {
  const i = new Set(t), o = e.map((l) => {
    const f = l.id === n;
    return {
      id: l.id,
      uri: Ii(l),
      ...
      language: l.language,
      version: r[l.id] ?? 1,
      contentHash: Di(l.content),
      dirty: l.dirty,
      source: l.source,
      selection: f && s ? s : void 0,
      updatedAt: Date.now(),
      open: i.has(l.id),
      active: f
    };
  ...
  return {
    ...
    activeDocumentId: n,
    openDocumentIds: t.filter((l) => o.some((f) => f.id === l))
  };
}, Ri = "active-file", Ei = (e) => e === "none" ? "No context" : e === "active-selection" ? "Active selection" : e === "active-file" ? "Active file" : e === "open-editors" ? "Open editors" : e === "selected-files" ? "Selected files" : "Indexed project", qi = (e, t = "file") => `${t}:${e.id}`, Yi = (e, t) => [
  "selection",
  e.id,
  t.startLineNumber,
  t.startColumn,
  ...
  let s = [];
  return t.scope === "active-selection" ? r?.selection ? s = [Ji(r, r.selection, !0)] : r && (s = [Et(r, !0, "Active file")]) : t.scope === "active-file" ? r && (s = [Et(r, !0, "Active file")]) : t.scope === "open-editors" ? s = e.openDocumentIds.map((i) => e.byId.get(i)).filter(Boolean).map((i) => Et(i, !0, "Open editor")) : t.scope === "selected-files" && (s = t.selectedFileIds.map((i) => e.byId.get(i)).filter(Boolean).map((i) => Et(i, !1, "Selected file"))), Ki(s).filter((i) => !n.has(i.id));
}, Ki = (e) => {
  const t = /* @__PURE__ */ new Set();
  return e.filter((n) => t.has(n.id) ? !1 : (t.add(n.id), !0));
}, Ui = 4e3, Bi = 8e3, Gi = 4e3, Qi = (e, t) => e.length <= t ? e : `${e.slice(0, t)}

[...clipped ${e.length - t} chars...]`, $i = (e, t, n) => {
  const r = Zi(e, n), s = [], i = new Map(t.map((o) => [o.id, o]));
  for (const o of r) {
    if (!o.fileId) continue;
    const l = i.get(o.fileId), f = e.byId.get(o.fileId);
    if (!l || !f || !o.includeBody) continue;
    const p = [
      `Path: ${l.path}`,
      `Language: ${l.language}`,
      `Version: ${f.version}`,
      `Hash: ${f.contentHash}`,
      `Dirty: ${f.dirty ? "yes" : "no"}`,
      o.range ? `Range: ${Xa(o.range)}` : null
    ].filter(Boolean).join(`
`), b = o.kind === "selection" && o.range ? _i(l.content, o.range) : l.content, v = o.kind === "selection" ? Ui : o.label.startsWith("Open editor") ? Gi : Bi;
    s.push({
...
`)).join(`
`)
  }), { parts: s, attachments: r };
}, _i = (e, t) => {
  const n = e.split(`
`), r = Math.max(1, t.startLineNumber), s = Math.max(r, t.endLineNumber), i = n.slice(r - 1, s);
...
`));
}, Xa = (e) => `${e.startLineNumber}:${e.startColumn}-${e.endLineNumber}:${e.endColumn}`, La = 75e4, eo = 2800, to = 240, no = 80, ao = /* @__PURE__ */ new Set([
  ".git",
  ".hg",
  ".svn",
  ".next",
  ...
  e.map((t) => `${t.id}\0${t.path}\0${t.language}\0${t.dirty ? "1" : "0"}\0${it(t.content)}`).sort().join("")
), Vn = (e, t = {}) => {
  const n = e.size ?? e.content.length;
  return n === 0 || e.content.length === 0 ? "empty" : n > (t.maxFileBytes ?? La) || e.content.length > (t.maxFileBytes ?? La) ? "huge" : !t.includeDirty && e.dirty ? null : uo(e.path) ? "vendor" : ho(e) ? "binary" : null;
}, Aa = (e, t = {}) => {
  const n = Date.now(), r = [], s = [], i = [];
  for (const o of e) {
    const l = o.size ?? o.content.length, f = Vn(o, t);
    if (f) {
      s.push({ fileId: o.id, name: o.name, path: o.path, language: o.language, reason: f, size: l });
      continue;
    }
    const p = it(o.content), b = so(o, p, n, t);
    i.push(...b), r.push({
      fileId: o.id,
      name: o.name,
      path: o.path,
...
}, so = (e, t = it(e.content), n = Date.now(), r = {}) => {
  const s = Math.max(500, r.maxChunkChars ?? eo), i = Math.min(Math.max(0, r.chunkOverlapChars ?? to), Math.floor(s / 2)), o = Math.max(1, r.maxChunksPerFile ?? no), l = co(e.content), f = [];
  let p = 0, b = 0;
  for (; p < e.content.length && f.length < o; ) {
    const v = oo(e.content, p, Math.min(e.content.length, p + s)), P = e.content.slice(p, v).trim();
    if (P.length > 0) {
      const H = lo(l, p, v);
      f.push({
        id: `${e.id}:${t}:${b}:${H.startLineNumber}-${H.endLineNumber}`,
        fileId: e.id,
        path: e.path,
        name: e.name,
        language: e.language,
  ...
  const r = Math.max(t + 1, n - 500), s = e.lastIndexOf(`
`, n);
  if (s >= r) return s + 1;
...
` && t.push(n + 1);
  ...
  const r = Oa(e, t), s = Oa(e, Math.max(t, n - 1));
  return {
    startLineNumber: r + 1,
    startColumn: t - e[r] + 1,
    endLineNumber: s + 1,
  ...
  return 0;
}, uo = (e) => e.split(/[\\/]+/).filter(Boolean).some((t) => ao.has(t)), ho = (e) => {
...
class fo {
  ...
  options;
  constructor(t = [], n = {}) {
    this.options = { ...n }, this.snapshot = Aa(t, this.options);
  }
  getSnapshot() {
  ...
  refresh(t, n = this.options) {
    return this.options = { ...n }, this.snapshot = Aa(t, this.options), this.snapshot;
  }
  update(t, n = this.options) {
    return this.refresh(t, n);
  }
  staleReport(t) {
    return mo(this.snapshot, t, this.options);
  }
  isStale(t) {
    return this.staleReport(t).stale;
  }
}
const ft = (e = [], t = {}) => new fo(e, t), mo = (e, t, n = {}) => {
  const r = new Map(t.map((l) => [l.id, l])), s = e.byFileId, i = [];
  for (const l of e.files) {
    const f = r.get(l.fileId);
    if (!f) {
      i.push({ fileId: l.fileId, path: l.path, status: "deleted", indexedHash: l.hash });
      continue;
    }
    if (Vn(f, n)) {
      i.push({ fileId: l.fileId, path: f.path, status: "skipped-now", indexedHash: l.hash, currentHash: it(f.content) });
      continue;
    }
    const b = it(f.content);
    b !== l.hash ? i.push({ fileId: l.fileId, path: f.path, status: "changed", indexedHash: l.hash, currentHash: b }) : f.dirty !== l.dirty && i.push({ fileId: l.fileId, path: f.path, status: "dirty-state-changed", indexedHash: l.hash, currentHash: b });
  }
  for (const l of t)
    !s.has(l.id) && !Vn(l, n) && i.push({ fileId: l.id, path: l.path, status: "new", currentHash: it(l.content) });
  const o = e.signature !== cr(t);
  return { stale: i.length > 0, signatureChanged: o, files: i };
}, po = 8, bo = 12e3, lr = (e, t, n = {}, r) => {
  const s = go(t);
  if (s.length === 0) return [];
  const i = new Set(r?.files.map((b) => b.fileId) ?? []), o = e.chunks.filter((b) => n.includeDirty !== !1 || !b.dirty).map((b) => wo(b, s)).filter((b) => b.score >= (n.minScore ?? 1)).sort((b, v) => v.score - b.score || b.chunk.path.localeCompare(v.chunk.path) || b.chunk.ordinal - v.chunk.ordinal), l = [], f = /* @__PURE__ */ new Set();
  let p = n.maxChars ?? bo;
  for (const b of o) {
    if (l.length >= (n.limit ?? po) || p <= 0) break;
    const v = `${b.chunk.fileId}:${b.chunk.ordinal}`;
    if (f.has(v)) continue;
    f.add(v);
    const P = b.chunk.text.length > p ? `${b.chunk.text.slice(0, Math.max(0, p - 28))}
[...context clipped...]` : b.chunk.text;
    l.push(vo(b, P, i.has(b.chunk.fileId))), p -= P.length;
  }
  return l;
}, vo = (e, t = e.chunk.text, n = !1) => {
  const { chunk: r, score: s, matchedTerms: i } = e;
  return {
    id: `index-hit:${r.id}`,
    kind: "index-hit",
...
`), go = (e) => Array.from(new Set(
  e.toLowerCase().split(/[^a-z0-9_.$/-]+/i).map((t) => t.trim()).filter((t) => t.length >= 2)
)), wo = (e, t) => {
  const n = e.text.toLowerCase(), r = e.path.toLowerCase(), s = e.name.toLowerCase(), i = e.language.toLowerCase();
  let o = 0;
  const l = [];
  for (const f of t) {
    const p = zn(n, f), b = zn(r, f), v = zn(s, f), P = i === f ? 1 : 0;
    p + b + v + P !== 0 && (l.push(f), o += Math.min(p, 12), o += b * 4, o += v * 6, o += P * 3, (n.includes(`function ${f}`) || n.includes(`const ${f}`) || n.includes(`class ${f}`) || n.includes(`type ${f}`)) && (o += 3));
  }
  ...
  const n = e.toLowerCase(), r = t.map((f) => n.indexOf(f)).filter((f) => f >= 0).sort((f, p) => f - p)[0] ?? 0, s = Math.max(0, r - 120), i = Math.min(e.length, r + 260), o = s > 0 ? "…" : "", l = i < e.length ? "…" : "";
  return `${o}${e.slice(s, i).replace(/\s+/g, " ").trim()}${l}`;
}, Po = (e, t = {}) => {
  const { autoRefresh: n = !1, ...r } = t, s = Xe(e), i = Xe(null);
  i.current || (i.current = ft(e, r));
  const [o, l] = X(() => i.current?.getSnapshot() ?? ft(e, r).getSnapshot());
  s.current = e;
  const f = z((P = s.current) => {
    const H = (i.current ?? ft([], r)).refresh(P, r);
    return l(H), H;
  }, [r.maxFileBytes, r.maxChunkChars, r.chunkOverlapChars, r.maxChunksPerFile, r.includeDirty]), p = z((P = s.current) => {
    const H = (i.current ?? ft([], r)).update(P, r);
    return l(H), H;
  }, [f]);
  se(() => {
    n && f(e);
  }, [n, e, f]);
  const b = (i.current ?? ft([], r)).staleReport(e), v = z((P, H = {}) => {
    const C = i.current ?? ft([], r);
    return lr(C.getSnapshot(), P, H, C.staleReport(s.current));
  }, []);
  return { snapshot: o, staleReport: b, isStale: b.stale, refresh: f, update: p, retrieve: v };
}, xo = "tytus.atomek.semanticVector:v1", dr = "__gateway_default__", ur = (e) => e?.trim() || dr, No = (e) => {
  const t = ur(e);
  return t === dr ? "gateway default" : t;
}, hr = (e, t, n) => [
  xo,
  ...
  if (!fr()) return null;
  try {
    const r = hr(e, t, n), s = window.localStorage.getItem(r);
    if (!s) return null;
  ...
  if (!fr()) return null;
  try {
    const t = hr(e.appId, e.modelAlias, { id: e.chunkId, hash: e.contentHash }), n = { ...e, key: t };
    return window.localStorage.setItem(t, JSON.stringify(n)), n;
  } catch {
    return null;
  }
}, At = 8, Xo = 12e3, Lo = 180, Ao = async (e, t, n, r, s = {}, i, o) => {
  const l = lr(t, n, { ...s, limit: Math.max(s.limit ?? At, 16) }, i), f = e.ai;
  if (typeof f?.embedText != "function")
    return { hits: l.slice(0, s.limit ?? At), mode: "keyword", reason: "Semantic index unavailable — using keyword retrieval.", embeddedChunks: 0 };
  try {
    const p = ur(r.embeddingModel), b = await f.embedText({
      input: n,
    ...
    const P = new Map(l.map((S) => [S.chunkId, S])), H = Wo(n), C = /* @__PURE__ */ new Map();
    t.chunks.filter((S) => s.includeDirty !== !1 || !S.dirty).slice(0, Lo).forEach((S) => C.set(S.id, S)), l.forEach((S) => {
      const B = t.byChunkId.get(S.chunkId);
      B && C.set(B.id, B);
    });
    const V = Array.from(C.values()), Z = [];
    let I = 0;
    for (const S of V) {
      o?.aborted;
      const B = To(e.appId, p, S) ?? await Co(f, e.appId, p, S, r, o);
      if (!B) continue;
      B.updatedAt > Date.now() - 1e3 && (I += 1);
      const J = jo(v, B.vector);
      if (!Number.isFinite(J)) continue;
      const U = P.get(S.id)?.score ?? Vo(S, H), q = Mo(U) * 0.42 + Math.max(0, J) * 0.58;
      Z.push({ chunk: S, keywordScore: U, vectorScore: J, score: q, matchedTerms: H.filter((ce) => S.text.toLowerCase().includes(ce)) });
    }
    if (Z.length === 0) return { hits: l.slice(0, s.limit ?? At), mode: "vector-fallback", reason: "Semantic retrieval produced no vectors — using keyword retrieval.", embeddedChunks: I };
    const oe = new Set(i?.files.map((S) => S.fileId) ?? []), pe = Z.sort((S, B) => B.score - S.score || B.keywordScore - S.keywordScore || S.chunk.path.localeCompare(B.chunk.path) || S.chunk.ordinal - B.chunk.ordinal).slice(0, Math.max(s.limit ?? At, 1)).map((S) => So(S, oe.has(S.chunk.fileId)));
    return {
      hits: Ho(pe, s.maxChars ?? Xo),
      mode: "hybrid",
      reason: `Hybrid retrieval used ${No(r.embeddingModel)} embeddings + keyword ranking.`,
      embeddedChunks: I
    };
  } catch (p) {
    return {
      hits: l.slice(0, s.limit ?? At),
  ...
  return {
    ...
    text: e.chunk.text,
    snippet: Io(e.chunk.text, e.matchedTerms),
    score: e.score,
...
[...context clipped...]` : s.text;
    r.push({ ...s, text: i, charCount: i.length }), n -= i.length;
  }
  return r;
}, mr = (e) => {
  ...
  let r = 0, s = 0, i = 0;
  for (let o = 0; o < n; o += 1)
    r += e[o] * t[o], s += e[o] * e[o], i += t[o] * t[o];
  return s === 0 || i === 0 ? 0 : r / (Math.sqrt(s) * Math.sqrt(i));
}, Mo = (e) => Math.min(1, Math.max(0, e / 24)), Wo = (e) => Array.from(new Set(
  e.toLowerCase().split(/[^a-z0-9_.$/-]+/i).map((t) => t.trim()).filter((t) => t.length >= 2)
)), Vo = (e, t) => {
  const n = `${e.path}
${e.name}
${e.language}
${e.text}`.toLowerCase();
  return t.reduce((r, s) => r + (n.includes(s) ? 1 : 0), 0);
}, Io = (e, t) => {
  const n = e.toLowerCase(), r = t.map((o) => n.indexOf(o)).filter((o) => o >= 0).sort((o, l) => o - l)[0] ?? 0, s = Math.max(0, r - 120), i = Math.min(e.length, r + 260);
  return `${s > 0 ? "…" : ""}${e.slice(s, i).replace(/\s+/g, " ").trim()}${i < e.length ? "…" : ""}`;
}, Do = /```([^\n`]*)\n([\s\S]*?)```/g, Fo = /^@@\s+-(\d+)(?:,\d+)?\s+\+(\d+)(?:,\d+)?\s+@@/;
function aa(e) {
  return Array.from(e.matchAll(Do)).map((t) => pr(t[1] ?? "", Jo(t[2] ?? ""))).filter((t) => t.content.trim().length > 0);
}
function pr(e, t) {
  const n = e.trim().split(/[\s,]+/).filter(Boolean), r = {}, s = [];
  for (const i of n) {
    const o = i.match(/^([a-z0-9_-]+)=(.+)$/i);
    o ? r[o[1].toLowerCase()] = Ko(o[2]) : s.push(i.toLowerCase());
  }
  return { lang: e.trim().toLowerCase(), flags: s, attrs: r, content: t };
}
function Ie(e, t) {
  return (typeof e == "string" ? pr(e, "").flags : e.flags).includes(t.toLowerCase());
}
function br(e) {
  return [...aa(e).filter((r) => Ie(r, "diff") || Ie(r, "patch")).map((r) => r.content), e].filter((r, s, i) => Ro(r) && i.findIndex((o) => o === r) === s);
}
function Ro(e) {
...
`), r = [];
  ...
  }), r.length === 0) return [{ raw: t, ...Xn(t) }];
  const s = Array.from(new Set(r)).sort((o, l) => o - l), i = [];
  for (let o = 0; o < s.length; o += 1) {
    const l = s[o], p = s.find((v) => v > l && n[v].startsWith("diff --git ")) ?? n.length, b = n.slice(l, p).join(`
`);
    /^@@\s+-\d+/m.test(b) && i.push({ raw: b, ...Xn(b) });
  }
  return i.length > 0 ? i : [{ raw: t, ...Xn(t) }];
}
function Xn(e) {
  const t = e.match(/^diff --git\s+(?:"?a\/(.+?)"?|(\S+))\s+(?:"?b\/(.+?)"?|(\S+))/m), n = e.match(/^---\s+(?:"?a\/(.+?)"?|(\S+))/m), r = e.match(/^\+\+\+\s+(?:"?b\/(.+?)"?|(\S+))/m), s = Ge(t?.[1] || t?.[2] || n?.[1] || n?.[2] || "") || null, i = Ge(t?.[3] || t?.[4] || r?.[1] || r?.[2] || "") || null, o = i && i !== "/dev/null" ? i : s;
...
function In(e) {
  return aa(e).filter((t) => qo(t)).map((t) => ({
    content: Zo(t.content),
...
function qo(e) {
  return Ie(e, "atomek-replace") || Ie(e, "atomek-full") || Ie(e, "full-replacement") || Ie(e, "full") || Ie(e, "replace");
}
function Yo(e) {
...
`).slice(0, 5);
  for (const r of n) {
    const s = r.match(/^\s*(?:\/\/|#|<!--)?\s*(?:atomek-)?(?:path|file)\s*:\s*([^\s>]+)\s*(?:-->)?\s*$/i);
    if (s) return Ge(s[1]);
  }
  return null;
}
...
`), s = [];
  ...
  for (let l = 0; l < r.length; l += 1) {
    const f = r[l].match(Fo);
    if (!f) continue;
    o = !0;
    const p = Number(f[1]), b = Math.max(0, p - 1);
    if (b < i) return null;
    for (s.push(...n.slice(i, b)), i = b, l += 1; l < r.length; l += 1) {
      const v = r[l];
      if (v.startsWith("@@ ")) {
        l -= 1;
        break;
      ...
      const P = v[0], H = v.slice(1);
      if (P === " ") {
        if (n[i] !== H) return null;
        s.push(H), i += 1;
        continue;
      }
      if (P === "-") {
...
function Uo(e) {
  const { body: t, files: n, sourceTitle: r, activeFile: s = null, versions: i = {} } = e, o = /* @__PURE__ */ new Map(), l = [];
  for (const b of br(t))
    for (const v of Eo(b)) {
      if (!v.path) {
        if (s) {
          const C = Dn(s.content, v.raw);
          C && C !== s.content && o.set(s.id, qt({
            file: s,
            proposedContent: C,
            sourceTitle: r,
      ...
      const P = Ca(n, v.path);
      if (!P) {
        l.push(`${v.path}: no opened file`);
        continue;
      }
      const H = Dn(P.file.content, v.raw);
      if (!H || H === P.file.content) {
        l.push(`${v.path}: patch did not match or produced no change`);
        continue;
      }
      o.set(P.file.id, qt({
        file: P.file,
  ...
  for (const b of In(t)) {
    const v = b.path ? Ca(n, b.path) : s ? { file: s, normalizedPatchPath: Ge(s.path), confidence: "exact" } : null;
    if (!v) {
      l.push(`${b.path ?? "replacement block"}: no opened file`);
      continue;
    }
    if (b.content === v.file.content) {
      l.push(`${v.file.path}: replacement produced no change`);
      continue;
    }
    o.set(v.file.id, qt({
      file: v.file,
      ...
      versions: i,
      targetPath: b.path ?? v.file.path,
      match: v
    }));
  }
  const f = In(t).some((b) => b.path);
  if (o.size === 0 && s && !f) {
    const b = Bo(t, s);
    b && b.content !== s.content && o.set(s.id, qt({
      file: s,
      proposedContent: b.content,
      sourceTitle: r,
      extractionLabel: b.label,
...
`), s = Math.max(n.length, r.length);
  let i = 0, o = 0, l = 0;
  for (let f = 0; f < s; f += 1)
    n[f] !== r[f] && (n[f] === void 0 ? i += 1 : r[f] === void 0 ? o += 1 : l += 1);
  return { added: i, removed: o, changed: l };
}
function Qo(e) {
  return e.reduce((t, n) => ({
...
const un = (e) => typeof e == "object" && e !== null, ec = (e) => un(e.ai) ? e.ai : null, tc = (e) => {
  if (!un(e)) return null;
  const t = e.id;
  return typeof t == "string" && t.trim() ? t : null;
}, nc = (e) => {
  const t = tc(e);
  return !t || !un(e) ? null : { ...e, id: t };
}, Ye = (e) => typeof e == "string" ? /\bembeddings?\b|text-embedding/i.test(e) : Array.isArray(e) ? e.some(Ye) : un(e) ? Object.values(e).some(Ye) : !1, ac = async (e, t) => {
  const n = ec(e);
  if (typeof n?.listModels != "function") return [];
  const r = await n.listModels(t);
  return Array.isArray(r) ? r.map(nc).filter((s) => !!s) : [];
}, rc = (e) => (e.embedding ?? e.embeddings ?? e.supportsEmbedding ?? e.supportsEmbeddings) === !0 ? !0 : Ye(e.capability) || Ye(e.capabilities) || Ye(e.modality) || Ye(e.modalities) || Ye(e.task) || Ye(e.tasks) || Ye(e.type) || Ye(e.kind), yr = (e) => typeof e == "object" && e !== null, sc = (e) => yr(e.ai) ? e.ai : null, gr = (e) => typeof sc(e)?.embedText == "function", ic = async (e, t) => gr(e) ? (await ac(e, t)).filter(rc) : [], oc = (e) => yr(e.ai) ? gr(e) ? null : "host.ai.embedText is not exposed by this Tytus build." : "host.ai is not available in this Tytus build.", cc = ["typecheck", "test", "lint", "build", "release:check", "verify", "verify:cortex"], lc = [
...
function fc(e) {
  const t = e.results.length > 0 ? e.results.map((r, s) => [
    `Check ${s + 1}: ${r.command}`,
    `Status: ${r.status}`,
    "Output:",
    kc(r.output || "(no output pasted)", "text")
  ].join(`
`)).join(`
...
function pc(e) {
  ...
  for (const r of t) {
    const s = bc(r.content);
    if (!s?.scripts) continue;
    const i = kr(r.path), o = vc(e, i, s);
    if (!o) continue;
    const l = Object.keys(s.scripts).filter((p) => typeof s.scripts?.[p] == "string"), f = yc(l);
    for (const p of f) {
      const b = `${o} run ${p}`;
      n.push({
        id: Pr(`${i}:${b}`),
...
function vc(e, t, n) {
  ...
  for (const [r, s] of lc)
    if (e.some((i) => wc(i.path) === r && kr(i.path) === t)) return s;
  return null;
}
function yc(e) {
  const t = cc.filter((r) => e.includes(r)), n = e.filter((r) => !t.includes(r)).filter((r) => /(^|:)(check|typecheck|test|lint|verify|build)(:|$)/i.test(r)).sort((r, s) => r.localeCompare(s));
  return [...t, ...n];
}
function gc(e) {
  const t = /* @__PURE__ */ new Set();
...
function zc({ className: e }) {
  return /* @__PURE__ */ a("img", { src: Tc, alt: "ATOMEK", className: e, draggable: !1 });
}
const Xc = `# Tytus Resource Fabric
...
], Hc = "tytus-atomek-handles", wt = "handles", jc = 1, Nr = () => new Promise((e, t) => {
  const n = indexedDB.open(Hc, jc);
  n.onupgradeneeded = () => {
    const r = n.result;
    r.objectStoreNames.contains(wt) || r.createObjectStore(wt);
...
async function Sa(e, t) {
  ...
  await new Promise((r, s) => {
    ...
    i.objectStore(wt).put(t, e), i.oncomplete = () => r(), i.onerror = () => s(i.error ?? new Error("Failed to persist file handle"));
  }), n.close();
}
async function Ln(e) {
  const t = await Nr(), n = await new Promise((r, s) => {
    const o = t.transaction(wt, "readonly").objectStore(wt).get(e);
    o.onsuccess = () => r(o.result ?? null), o.onerror = () => s(o.error ?? new Error("Failed to read file handle"));
  });
  return t.close(), n;
}
const Mc = bs(() => import("./WorkbenchMonacoEditor-CE3ZUqbM.js").then((e) => e.W).then((e) => ({ default: e.WorkbenchMonacoEditor }))), Wc = {
  id: "welcome",
  name: "Agent Team",
  path: "Agent Team",
  language: "text",
  ...
  dirty: !1,
  source: "sample"
}, Tr = "tytus.workspace.recent", zr = "tytus.workspace.layout", Xr = "tytus.atomek.session.v2", Lr = "tytus.atomek.chatAiSettings", An = "atomek:default", Ar = "tytus.atomek.currentMission", Fn = "tytus.atomek.currentMissionChanged", Ha = "0.4.28", nn = {
...
function On(e) {
  const t = Math.max(e || 1400, 760), n = Math.max(0, t - Vc), r = n < 1180, s = r ? 200 : 240, i = r ? 280 : 300, o = r ? 360 : 420, l = Math.max(s, Math.min(r ? 340 : 420, Math.floor(n * 0.28))), f = Math.min(300, l), p = Math.floor(n * (r ? 0.5 : 0.62)), b = n - f - o, v = Math.max(i, Math.min(r ? 1e3 : 1400, p, b));
  return { primaryMin: s, primaryMax: l, secondaryMin: i, secondaryMax: v };
}
function Ic(e) {
  const t = [], n = /```([^\n`]*)\n?([\s\S]*?)```/g;
  let r = 0, s = 0, i;
  for (; (i = n.exec(e)) !== null; ) {
    if (i.index > r) {
      const l = e.slice(r, i.index);
      l.trim() && t.push({ type: "markdown", body: l, key: `md-${s}` });
    }
    t.push({
      type: "code",
...
async function Rn(e, t, n) {
  ...
  const s = await r.call(e, t, { create: !0 });
...
function Rc(e) {
  const t = e?.resources ?? [], n = (l) => l.status === "ready" || l.status === "available", r = t.filter((l) => l.kind === "pod-agent" && Pt(l) === "openclaw"), s = t.filter((l) => l.kind === "pod-agent" && Pt(l) === "hermes"), i = t.filter((l) => l.kind === "local-cli" && n(l)), o = t.filter((l) => l.kind === "shared-folder" && n(l));
  return [
...
function Ec(e) {
  const t = e?.resources ?? [], n = (r) => t.some((s) => s.kind === r && (s.status === "ready" || s.status === "available"));
  return [
...
function Be(e, t, n) {
  return st(e, (r) => {
    ...
    return n.some((i) => {
      ...
      if (o.length <= 4) {
        const l = o.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        return new RegExp(`(^|[^a-z0-9])${l}([^a-z0-9]|$)`).test(s);
      }
      return s.includes(o);
    });
  });
...
function xt(e, t = "repo-repair") {
  const n = Ht.find((q) => q.id === t) ?? Ht[0], r = e?.resources ?? [], s = st(r, (q) => q.kind === "pod-agent" && Pt(q) === "openclaw"), i = st(r, (q) => q.kind === "pod-agent" && Pt(q) === "hermes"), o = st(r, (q) => q.kind === "ail-route"), l = st(r, (q) => q.kind === "shared-folder"), f = Be(r, "local-cli", ["claude"]), p = Be(r, "local-cli", ["opencode", "open code"]), b = Be(r, "local-cli", ["codex"]), v = Be(r, "local-cli", ["pi"]), P = Be(r, "local-cli", ["kimi"]), H = st(r, (q) => q.kind === "local-cli"), C = Be(r, "app-skill", ["juli3ta", "music", "song"]), V = Be(r, "app-skill", ["blender", "3d"]), Z = Be(r, "app-skill", ["remotion", "video", "render"]), I = st(r, (q) => q.kind === "app-skill"), oe = t === "pod-local" ? s ?? i ?? o ?? f ?? H : t === "creative-production" ? i ?? o ?? f ?? H : t === "research-watch" ? s ?? o ?? i ?? f ?? H : f ?? p ?? o ?? H, pe = t === "creative-production" ? C ?? V ?? Z ?? I ?? p ?? f ?? H : p ?? f ?? b ?? H, S = t === "pod-local" ? b ?? v ?? P ?? s ?? f ?? H : t === "research-watch" ? v ?? P ?? b ?? s ?? H : b ?? v ?? s ?? P ?? H, B = t === "creative-production" ? C ?? V ?? Z ?? I : t === "research-watch" ? Be(r, "app-skill", ["browser", "channel", "telegram"]) ?? I : I, J = [
    Ot("planner", "Planner", "Break goal into tasks, risks, and required context.", oe, "No planner agent ready"),
    Ot("implementer", "Implementer", "Execute local/app work and return transcript or patch proposal.", pe, "No local/app implementer ready"),
    Ot("reviewer", "Reviewer", "Independent critique before approval or handoff.", S, "No reviewer agent ready"),
    Ot("team-desk", "Team Desk", "Shared mission folder for transcripts, outputs, proposals, and handoff.", l, "Mission folder only until shared folder is bound")
  ];
  (t === "creative-production" || B) && J.push(Ot("app-tool", "App Tool", "Drive installed local app skill through mission context.", B, "No configured app skill"));
  const g = J.filter((q) => q.status === "ready" || q.status === "available" || q.status === "degraded").length, U = g >= J.length - 1 ? "ready" : g >= 2 ? "partial" : "needs-setup";
  return { ...n, readiness: U, assignments: J };
}
function ot(e, t, n) {
  if (n && Ht.some((s) => s.id === n)) return n;
  const r = e.toLowerCase();
  return /(music|song|audio|video|render|blender|remotion|juli3ta|creative)/.test(r) ? "creative-production" : /(research|watch|monitor|news|summar|scan)/.test(r) ? "research-watch" : (t?.resources ?? []).some((s) => s.kind === "pod-agent" && Cr(s)) ? "pod-local" : "repo-repair";
}
function Yc(e) {
  return Ht.map((t) => xt(e, t.id));
}
function Zt(e) {
...
function Ct(e) {
  ...
  try {
    localStorage.setItem(Ar, JSON.stringify(t)), window.dispatchEvent(new CustomEvent(Fn, { detail: t }));
  } catch {
  }
}
function Zc() {
  try {
    ...
    return !t.missionId || !t.title ? null : {
      ...
      teamPresetId: Ht.some((n) => n.id === t.teamPresetId) ? t.teamPresetId : void 0
    };
  } catch {
    return null;
  }
...
function jt(e, t, n) {
  const r = e.trim() || "Coordinate a Tytus mission.", s = xt(t, ot(r, t, n)), i = (v) => s.assignments.find((P) => P.role === v), o = i("planner"), l = i("implementer"), f = i("reviewer"), p = i("team-desk"), b = i("app-tool");
  return [
    {
      id: "task-scope",
      ...
      resourceHint: o ? Zt(o) : "Planner agent",
      role: "planner",
    ...
    },
    {
      ...
      resourceHint: l ? Zt(l) : "Local/app implementer",
      role: "implementer",
    ...
    } : null,
    {
      ...
      resourceHint: f ? `${Zt(f)} · ${p?.resourceLabel ?? "mission folder"}` : "Reviewer + mission folder",
      role: "reviewer",
      assignedResourceLabel: f?.resourceLabel ?? "Reviewer agent",
      status: "waiting",
...
function jr(e, t, n, r) {
  const s = ot(n || e.goal, t, r ?? e.teamPresetId), i = xt(t, s), o = jt(n || e.goal, t, s);
  return JSON.stringify({
    ...
    storage: {
      ...
      teamDesk: i.assignments.find((l) => l.role === "team-desk")?.resourceLabel ?? "mission folder",
      paths: {
        runs: "runs/",
        outputs: "outputs/",
        proposals: "proposals/",
    ...
    tasks: o.map((l, f) => ({
      ...
      status: f === 0 ? "ready" : "waiting",
      selectedResourceHint: l.resourceHint,
      dependsOn: f === 0 ? [] : [o[f - 1].id],
...
function Uc({ host: e }) {
  const t = Xe(null), [n, r] = X(0), s = fe(() => jl(), []), i = fe(() => Al(), []), o = fe(() => Ll(Xl(), i.recent), [i.recent]), [l, f] = X(i.activity ?? "computer"), [p, b] = X(s.primaryVisible), [v, P] = X(s.primaryWidth), [H, C] = X(i.secondaryTab ?? "chat"), [V, Z] = X(s.secondaryVisible), [I, oe] = X(s.secondaryWidth), [pe, S] = X(!!i.bottomPanelVisible), [B, J] = X(i.bottomPanelTab ?? "problems"), [g, U] = X(s.markdownPreviewVisible), [q, ce] = X(!!i.welcomeClosed), [ne, Te] = X(i.folder ? { name: i.folder.name, files: [] } : null), [Le, Ae] = X(i.folder?.handleKey ?? null), [m, F] = X(() => Ol(i.files)), [te, le] = X(() => (i.openEditorIds ?? []).filter((c) => (i.files ?? []).some((h) => h.id === c))), [w, W] = X(() => i.activeFileId && (i.files ?? []).some((c) => c.id === i.activeFileId) ? i.activeFileId : null), [T, A] = X(i.query ?? ""), [D, L] = X({ lineNumber: 1, column: 1 }), [ae, ue] = X(null), [be, ye] = X({}), [He, je] = X(Ri), [qe, tt] = X([]), [Pe, ge] = X([]), [Ze, re] = X(null), [Y, de] = X(i.chatInput ?? ""), [he, ke] = X(!1), [De, Ke] = X(""), [d, k] = X([]), [x, O] = X(null), [j, K] = X(null), [ee, Q] = X(!1), [xe, Ue] = X(() => Ml()), [$, R] = X([Je]), [me, Oe] = X(() => hi(An)), [Ne, Ce] = X(null), [Fe, ct] = X(null), [lt, Nt] = X(""), [Qe, hn] = X(""), [Wt, Vt] = X(""), [It, ia] = X("failed"), [Er, oa] = X(null), [qr, M] = X("Ready"), [Tt, Yr] = X(() => o), Me = te.map((c) => m.find((h) => h.id === c)).filter(Boolean), E = w ? m.find((c) => c.id === w) ?? null : null, ca = fe(() => Fi({ files: m, openEditorIds: te, activeFileId: w, versions: be, activeSelection: ae }), [w, ae, be, m, te]), la = fe(() => ({
    scope: He,
    removedAttachmentIds: qe,
    selectedFileIds: []
  }), [He, qe]), zt = fe(() => $i(ca, m, la), [la, ca, m]), $e = Po(m, { autoRefresh: !0, includeDirty: !0 }), da = fe(() => Pe.map((c) => ({
    id: c.id,
    kind: "index-hit",
    label: c.label,
    path: c.path,
    ...
    snippet: c.snippet
  })), [Pe]), Jr = fe(() => [...zt.attachments, ...da], [zt.attachments, da]), ua = fe(() => $.find((c) => c.id === me) ?? Je, [$, me]), _ = Vi({ host: e, requestContext: zt.parts, chatSettings: xe, selectedTarget: ua, setStatus: M }), nt = fe(
    () => [..._.artifacts, ...d].sort((c, h) => h.createdAt - c.createdAt),
    [_.artifacts, d]
  ), Dt = ee && !E, fn = !E && !Dt && !q, ze = fe(() => m.filter((c) => c.dirty), [m]), Zr = fe(() => {
    const c = T.trim().toLowerCase();
    return c ? m.filter((h) => h.path.toLowerCase().includes(c)) : m;
  }, [m, T]);
  se(() => {
    ye((c) => {
      const h = {};
      for (const y of m) h[y.id] = c[y.id] ?? 1;
      return h;
    });
  }, [m]), se(() => {
    tt([]), ge([]);
    ...
    const h = async () => {
      const N = await Pi(e);
      c && (R(N), Oe((G) => {
        const ve = N.some((at) => at.id === G) ? G : Je.id;
        return ve !== G && Pa(An, ve), ve;
      }));
    };
    h();
  ...
  const Kr = z((c) => {
    const h = $.find((y) => y.id === c) ?? Je;
    Oe(h.id), Pa(An, h.id), M(`Chat target: ${h.label}`);
  }, [$, M]), Ur = z((c) => {
    if (c.kind === "index-hit") {
      ge((h) => h.filter((y) => y.id !== c.id)), M(`Removed project context: ${c.label}`);
      return;
    }
    tt((h) => h.includes(c.id) ? h : [...h, c.id]), M(`Removed chat context: ${c.label}`);
  }, []), Ft = z(() => {
    Q(!0), W(null), ce(!0), M("Atomek settings opened");
  }, []), ha = z(() => {
    Q(!1), W((c) => c ?? te.at(-1) ?? null), te.length === 0 && ce(!1), M("Atomek settings closed");
  }, [te]), dt = z((c) => {
    ye((h) => ({ ...h, [c]: (h[c] ?? 1) + 1 }));
  }, []), Br = z((c) => {
    c.preventDefault(), c.currentTarget.setPointerCapture?.(c.pointerId);
    const h = On(n), y = c.clientX, N = I, G = (at) => {
      const Pn = N + (y - at.clientX);
      oe(Jt(Pn, h.secondaryMin, h.secondaryMax));
    }, ve = () => {
      window.removeEventListener("pointermove", G), window.removeEventListener("pointerup", ve);
    };
    window.addEventListener("pointermove", G), window.addEventListener("pointerup", ve);
  }, [I, n]), Gr = z((c) => {
    c.preventDefault(), c.currentTarget.setPointerCapture?.(c.pointerId);
    const h = On(n), y = c.clientX, N = v, G = (at) => {
      const Pn = N + (at.clientX - y);
      P(Jt(Pn, h.primaryMin, h.primaryMax));
    }, ve = () => {
      window.removeEventListener("pointermove", G), window.removeEventListener("pointerup", ve);
    };
    window.addEventListener("pointermove", G), window.addEventListener("pointerup", ve);
    ...
    Yr((h) => {
      const y = [c, ...h.filter((N) => N.path !== c.path)].slice(0, 10);
      return localStorage.setItem(Tr, JSON.stringify(y)), y;
    });
  }, []), we = z((c, h) => {
    le((y) => y.includes(c.id) ? y : [...y, c.id]), W(c.id), ce(!1), oa(h ?? null), L({ lineNumber: h ?? 1, column: 1 });
  }, []), Qr = z((c) => {
    const h = {
      id: `atomek-doc:${c.id}`,
      name: c.fileName,
    ...
    F((y) => Kt(y, [h])), we(h), C("chat"), Z(!0), U(!0), M(`Opened Atomek guide: ${c.title}`);
  }, [we]), $r = z((c) => {
    if (!c.fileId) return;
    const h = m.find((y) => y.id === c.fileId);
    h && (we(h, c.range?.startLineNumber ?? 1), M(`Revealed context: ${c.label}`));
  }, [m, we]), Xt = z(async () => {
    if (Cn(ze, "open new files"))
      try {
        const c = await oi();
        if (c.length === 0) return;
        F((h) => Kt(h, c)), await Promise.all(c.map(async (h) => {
          const y = h.handle ? `file:${h.path}` : void 0;
          h.handle && y && await Sa(y, h.handle), _e({ name: h.name, path: h.path, kind: "file", handleKey: y, at: Date.now() });
        })), we(c[0]), M(`Opened ${c.length} local file${c.length === 1 ? "" : "s"}`);
      } catch (c) {
        c.name !== "AbortError" && M(`Open file failed: ${c.message}`);
      }
  }, [ze, we, _e]), mn = z(async () => {
    if (Cn(ze, "open another folder"))
      try {
        const c = await ci(), h = c.handle ? `folder:${c.name}:${Date.now()}` : null;
        c.handle && h && await Sa(h, c.handle), Ae(h), Te(c), F(c.files), le([]), W(null), ce(!1), _e({ name: c.name, path: c.name, kind: "folder", handleKey: h ?? void 0, at: Date.now() }), M(`${c.handle ? "Opened local folder" : "Opened browser fallback folder"} ${c.name} (${c.files.length} text files indexed)`);
      } catch (c) {
    ...
    if (!w) return;
    let h = !1;
    F((y) => y.map((N) => N.id !== w || N.content === c ? N : (h = !0, { ...N, content: c, dirty: !0 }))), h && dt(w);
  }, [w, dt]), pn = z(async () => {
    if (E)
      try {
        const c = await Nn(E);
        F((h) => h.map((y) => y.id === c.id ? c : y)), M(`Saved ${c.name}`);
      } catch (c) {
        M(`Save failed: ${c.message}`);
      }
  }, [E]), es = z(async (c) => {
    const h = m.find((N) => N.id === c);
    if (!h) return null;
    const y = await Nn(h);
    return F((N) => N.map((G) => G.id === y.id ? y : G)), y;
  }, [m]), fa = z(async () => {
    const c = m.filter((h) => h.dirty);
    if (c.length === 0) {
      M("No dirty files to save");
      return;
    }
    try {
      const h = await Promise.all(c.map((N) => Nn(N))), y = new Map(h.map((N) => [N.id, N]));
      F((N) => N.map((G) => y.get(G.id) ?? G)), Ce(null), M(`Saved ${h.length} dirty file${h.length === 1 ? "" : "s"}`);
    } catch (h) {
      M(`Save all failed: ${h.message}`);
    }
  }, [m]), bn = z((c) => {
    const h = m.find((y) => y.id === c);
    if (h?.dirty && !window.confirm(`${h.name} has unsaved changes. Close without saving?`)) {
      M(`Close canceled — ${h.name} has unsaved changes`);
      return;
    }
    le((y) => {
      const N = y.filter((G) => G !== c);
      return w === c && (W(N.at(-1) ?? null), ue(null)), N;
    });
  }, [w, m]), ts = z(() => {
    Cn(ze, "close all editors") && (le([]), W(null), oa(null), ce(!1), M("Closed all editors"));
  }, [ze]), vn = z(() => {
    const c = m.filter((y) => y.name.startsWith("Untitled")).length + 1, h = {
...
`,
    ...
    return ge(N), N.length === 0 ? (M($e.snapshot.chunks.length === 0 ? "Project index is empty — open a folder with readable files first" : "Project index found no matching context for this prompt"), h) : (y.mode !== "hybrid" && y.reason ? M(y.reason) : M(`${N.length} project context hit${N.length === 1 ? "" : "s"} · ${y.reason ?? "hybrid retrieval"}`), [
      ...h,
      ...Oo(N)
    ]);
  }, [zt.parts, He, xe, e, $e]), yn = z(() => {
    if (!E && Me.length === 0) {
      M("Open a file before asking Atomek to synthesize an AI artifact");
      return;
    }
    const h = [
      `Create a polished Markdown artifact from ${E?.path ?? `${Me.length} open editors`}.`,
    ...
    Z(!0), C("chat"), M("Asking Atomek to synthesize an AI artifact…"), (async () => {
      const y = await et(h), N = await _.askAgent(h, { requestContext: y });
      !N || N.status === "error" || _.createArtifact({
        messageId: N.id,
        title: `AI synthesis — ${E?.name ?? "open workspace"}`,
        kind: "markdown",
        body: N.body
      }).then(() => {
        Z(!0), C("outputs"), S(!0), J("output");
      });
    })();
  }, [E, _, et, Me.length]), gn = z(async (c) => {
    if (c.kind === "folder") {
      const y = m.filter((N) => N.path === c.path || N.path.startsWith(`${c.path}/`));
      if (ne?.name === c.name || y.length > 0) {
        y.length > 0 && (Te((N) => N?.name === c.name ? N : { name: c.name, files: y }), F((N) => Kt(N, y))), f("explorer"), b(!0), W(null), ce(!1), _e({ ...c, at: Date.now() }), M(`Opened recent folder ${c.name}`);
        return;
      }
    }
    const h = m.find((y) => y.path === c.path || y.name === c.name);
    if (h) {
      we(h), M(`Opened recent ${h.name}`);
      return;
    }
    if (!c.handleKey) {
      M("Recent item has no stored browser permission. Use Open File or Open Folder once, then Atomek can restore it.");
      return;
    }
    try {
      if (c.kind === "folder") {
        const G = await Ln(c.handleKey);
        if (!G || !await xn(G, "readwrite")) {
          M("Browser permission expired for this folder. Click Open Folder and pick it once to refresh the recent handle.");
          return;
        }
        const ve = await wa(G);
        Ae(c.handleKey), Te(ve), F(ve.files), le([]), W(null), ce(!1), _e({ ...c, at: Date.now() }), M(`Reopened ${ve.name} (${ve.files.length} text files indexed)`);
        return;
      }
      const y = await Ln(c.handleKey);
      if (!y || !await xn(y, "readwrite")) {
        M("Browser permission expired for this file. Click Open File and pick it once to refresh the recent handle.");
        return;
      }
      const N = await li([y]);
      if (!N[0]) {
        M(`Recent file is not readable text: ${c.name}`);
        return;
      }
      F((G) => Kt(G, N)), we(N[0]), _e({ ...c, at: Date.now() }), M(`Reopened ${N[0].name}`);
    } catch (y) {
      M(`Open recent failed: ${y instanceof Error ? y.message : String(y)}`);
    }
  }, [m, ne?.name, we, _e]), We = z((c) => {
    Z(!0), C("chat"), de(""), (async () => {
      const h = await et(c);
      await _.askAgent(c, { requestContext: h });
    })();
  }, [_, et]), ma = z(async (c) => {
    if (!e.skills?.get) {
    ...
    try {
      const h = await e.skills.get(c.id), y = h.body.length > 4500 ? `${h.body.slice(0, 4500)}

[Skill pack clipped by Atomek. Ask for the full pack if needed.]` : h.body, N = [
...
`);
      de((G) => [G.trim(), N].filter(Boolean).join(`

`)), Z(!0), C("chat"), M(`Attached skill ${h.title} to chat input`);
    } catch (h) {
      M(`Failed to attach skill: ${h instanceof Error ? h.message : String(h)}`);
    }
  }, [e.skills]), ns = z((c) => {
    const h = _.messages.findIndex((N) => N.id === c.id), y = _.messages.slice(0, h < 0 ? void 0 : h).reverse().find((N) => N.role === "user");
    if (!y?.body.trim()) {
      M("No previous user prompt to regenerate from");
      return;
    }
    (async () => {
      const N = await et(y.body);
      await _.askAgent(y.body, { requestContext: N });
    })();
  }, [_, et]), as = z((c) => {
    _.createArtifact({
      messageId: c.id,
...
`).find(Boolean)?.replace(/^#+\s*/, "").slice(0, 80) || "Atomek memory",
    ...
    _.createArtifact({
      title: E.path,
      kind: E.language === "markdown" ? "markdown" : "report",
      body: E.content
    }).then(() => {
      Z(!0), C("outputs"), S(!0), J("output");
    });
  }, [E, _]), wn = z((c) => {
    const h = Hn(m, Sn(c.title || c.kind)), y = {
    ...
    F((N) => [...N, y]), we(y), M(`Opened ${c.title} as editable file`);
  }, [m, we]), kn = z(() => {
...
`), G = {
    ...
    k((ve) => [G, ...ve]), S(!0), J("output"), M(`Captured manual check: ${h}`);
  }, []), ut = z((c, h) => {
    const y = Uo({
      body: h,
      files: m,
      ...
      edits: y.edits.map(Tl),
      skipped: y.skipped
    };
    return y.edits.length > 1 ? (K(N), O(null), M(`Previewing AI workspace patch for ${y.edits.length} files`), !0) : y.edits.length === 1 ? (O(N.edits[0]), K(null), M(`Previewing AI patch for ${N.edits[0].fileName}`), !0) : (M(y.skipped.length > 0 ? `No applicable edit found. ${y.skipped.slice(0, 2).join(" · ")}` : "No fenced replacement block or applicable unified diff found. Ask Atomek for an edit again."), !1);
  }, [E, be, m]), pa = z((c, h) => {
    const y = {
    ...
    k((N) => [y, ...N]), Z(!0), C("outputs"), S(!0), J("output"), M(`Saved local job output: ${c}`), (h.includes("```diff") || h.includes("--- a/")) && ut(c, h);
  }, [ut]), is = z(() => {
    const c = Y.trim();
    if (!c) return;
    de("");
    const h = hl(c);
    (async () => {
      const y = await et(c), N = await _.askAgent(c, { requestContext: y });
      if (!h || !N || N.status === "error") return;
      ut(N.body.split(`
`).find(Boolean)?.replace(/^#+\s*/, "").slice(0, 80) || "Atomek edit", N.body) || M("Edit request answered without a patch. Use Generate patch / Edit to request an applicable diff.");
    })();
  }, [_, et, Y, ut]), os = z(() => {
    Ze && (re(null), We(fl(Ze)));
  }, [We, Ze]), Lt = z((c) => {
    ...
    Vt(y), Nt(""), hn(""), ia("failed"), S(!0), J("terminal"), M(h.commands.length > 0 ? `Manual check ready: copy ${h.commands[0].command}` : "Manual check ready: enter a check command to copy");
  }, [m]), cs = z((c) => {
    c.trim() && (kt(c), Vt(c), M(`Manual check command copied: ${c}`));
  }, []), ls = z(() => {
    ct((c) => {
      if (!c) return c;
      const h = uc(c, lt), y = h.commands.at(-1)?.command ?? "";
      return y && Vt(y), h;
    }), Nt("");
  }, [lt]), ds = z(() => {
    if (!Fe || !Wt.trim()) {
    ...
    const c = Wt.trim();
    ct((h) => h && hc(h, c, It, Qe)), hn(""), M(`Captured manual check result: ${c} (${It})`);
  }, [Qe, Wt, Fe, It]), us = z(() => {
    Fe && We(fc(Fe));
  }, [We, Fe]), hs = z(() => {
    if (!x) return;
    const c = m.find((h) => h.id === x.fileId);
    if (!c) {
      M(`Cannot apply edit — ${x.fileName} is no longer open`), O(null);
      return;
    }
    c.content !== x.originalContent && !window.confirm(`${x.fileName} changed after the preview was created. Apply the AI edit anyway?`) || (F((h) => h.map((y) => y.id === x.fileId ? { ...y, content: x.proposedContent, dirty: !0 } : y)), dt(x.fileId), Ce(`AI edit applied to ${c.name}. Save All to persist it to disk.`), O(null), Lt(`AI edit applied to ${c.name}`), M(`Applied AI edit to ${c.name} — unsaved; manual check ready`));
  }, [dt, m, x, Lt]), fs = z(() => {
    if (!x) return;
    const c = Hn(m, `${Sn(x.fileName)}-ai-edit`), h = {
      id: `pending-edit-${x.fileId}-${Date.now()}`,
      name: c,
      path: c,
      language: E?.language ?? "markdown",
      content: x.proposedContent,
      dirty: !0,
      source: "generated"
    };
    F((y) => [...y, h]), we(h), O(null), M(`Opened proposed edit as ${c}`);
  }, [E?.language, m, we, x]), ms = z(() => {
    if (!j) return;
    const c = new Map(j.edits.map((y) => [y.fileId, y]));
    m.some((y) => {
      const N = c.get(y.id);
      return N && y.content !== N.originalContent;
    }) && !window.confirm("One or more files changed after the workspace patch preview was created. Apply anyway?") || (F((y) => y.map((N) => {
      const G = c.get(N.id);
      return G ? { ...N, content: G.proposedContent, dirty: !0 } : N;
    })), c.forEach((y, N) => dt(N)), Ce(`AI workspace patch applied to ${c.size} file${c.size === 1 ? "" : "s"}. Save All to persist changes.`), K(null), Lt(`AI workspace patch applied to ${c.size} file${c.size === 1 ? "" : "s"}`), M(`Applied AI workspace patch to ${c.size} file${c.size === 1 ? "" : "s"} — unsaved; manual check ready`));
  }, [dt, m, j, Lt]), ps = z(() => {
    if (!j) return;
    const c = [...m], h = j.edits.map((y) => {
      const N = Hn(c, `${Sn(y.fileName)}-ai-edit`), G = m.find((at) => at.id === y.fileId), ve = {
        id: `workspace-patch-${y.fileId}-${Date.now()}-${N}`,
        name: N,
        path: N,
    ...
    F((y) => [...y, ...h]), h[0] && we(h[0]), K(null), M(`Opened ${h.length} proposed edit file${h.length === 1 ? "" : "s"}`);
  }, [m, we, j]), ba = z((c) => {
    if (c === "explain") {
      We("Explain the active file. Focus on purpose, structure, risks, and next useful edits.");
      return;
    }
    if (c === "improve") {
      We("Review the active file and propose the smallest concrete improvements. Include exact snippets if useful.");
      return;
    }
    if (c === "plan") {
      We("Create an implementation plan from the open editor context. Be specific, ordered, and call out blockers.");
      return;
    }
    if (c === "edit") {
      We("Edit the active file or open workspace files. Prefer one git-style unified diff in a fenced diff block, with paths matching opened files. If editing one file, a complete fenced replacement is also OK. Do not use provider-specific tools or model assumptions.");
      return;
    }
    We("Draft a concrete Markdown artifact from the open editor context. Make it ready to save as an output.");
  }, [We]);
  return se(() => {
    const c = (h) => {
      (h.metaKey || h.ctrlKey) && (h.key.toLowerCase() === "o" && (h.preventDefault(), Xt()), h.key.toLowerCase() === "s" && (h.preventDefault(), pn()), h.key.toLowerCase() === "w" && (h.preventDefault(), w && bn(w)), h.key.toLowerCase() === "b" && (h.preventDefault(), b((N) => !N)), h.shiftKey && h.key.toLowerCase() === "f" && (h.preventDefault(), f("search"), b(!0)), (h.key.toLowerCase() === "k" || h.key.toLowerCase() === "p") && (h.preventDefault(), ke(!0)));
    };
    return window.addEventListener("keydown", c), () => window.removeEventListener("keydown", c);
  }, [w, bn, Xt, pn]), se(() => {
    const c = (h) => {
      ze.length !== 0 && (h.preventDefault(), h.returnValue = "");
    };
    ...
    const c = t.current;
    if (!c) return;
    const h = () => r(Math.round(c.getBoundingClientRect().width));
    h();
    ...
    if (!n) return;
    const c = On(n);
    P((h) => Jt(h, c.primaryMin, c.primaryMax)), oe((h) => Jt(h, c.secondaryMin, c.secondaryMax));
  }, [n]), se(() => {
    const c = { primaryVisible: p, primaryWidth: v, secondaryVisible: V, secondaryWidth: I, markdownPreviewVisible: g };
    localStorage.setItem(zr, JSON.stringify(c));
  }, [g, p, v, V, I]), se(() => {
    if (!i.folder?.handleKey) return;
    let c = !1;
    return (async () => {
      try {
        const h = await Ln(i.folder?.handleKey ?? "");
        if (!h || !await xn(h, "readwrite") || c) return;
        const y = await wa(h);
        if (c) return;
        Ae(i.folder?.handleKey ?? null), Te(y), F((N) => Hl(N, y.files)), le((N) => N.filter((G) => y.files.some((ve) => ve.id === G) || m.some((ve) => ve.id === G))), M(`Restored ${y.name} (${y.files.length} text files indexed)`);
      } catch (h) {
        c || M(`Workspace restore failed: ${h instanceof Error ? h.message : String(h)}`);
      }
    })(), () => {
      c = !0;
    };
    ...
    Sl({
      activity: l,
      folder: ne ? { name: ne.name, handleKey: Le } : null,
      files: Cl(m),
      openEditorIds: te,
      activeFileId: w,
      query: T,
      ...
      welcomeClosed: q,
      secondaryTab: H,
      bottomPanelVisible: pe,
      bottomPanelTab: B,
      recent: Tt
    });
  }, [l, w, B, pe, Y, Le, m, ne, te, T, Tt, H, q]), se(() => {
    localStorage.setItem(Lr, JSON.stringify(xe));
  }, [xe]), /* @__PURE__ */ u(
    "div",
    {
      ref: t,
      className: `workbench-workbench ${p ? "" : "no-primary"} ${V ? "" : "no-secondary"} ${pe ? "has-bottom-panel" : ""}`,
      "data-app": "workbench-vscode-base",
      style: { "--workbench-primary-width": `${v}px`, "--workbench-secondary-width": `${I}px` },
      children: [
        /* @__PURE__ */ a(
          Bc,
          {
        ...
        p && /* @__PURE__ */ u("div", { className: "workbench-primary-region", children: [
          /* @__PURE__ */ a(
            Gc,
            {
              ...
              setStatus: M,
              hasFsAccess: ii(),
              attachSkillToChat: ma,
              saveLocalJobOutput: pa,
              activeFile: E
            }
          ),
          /* @__PURE__ */ a("div", { className: "workbench-primary-resizer", onPointerDown: Gr, title: "Resize Explorer" })
        ] }),
        /* @__PURE__ */ u("main", { className: "workbench-editor-area", children: [
          /* @__PURE__ */ a("button", { className: "workbench-command-center", onClick: () => ke(!0), children: "Workspace" }),
          /* @__PURE__ */ u("section", { className: "workbench-editor-stack", children: [
            /* @__PURE__ */ a(
              el,
              {
                ...
                closeSettings: ha,
                secondaryVisible: V,
                toggleSecondary: () => Z((c) => !c),
                canPreview: E?.language === "markdown",
                previewVisible: g,
                togglePreview: () => U((c) => !c)
              }
            ),
            /* @__PURE__ */ a(_c, { file: E, folder: ne, showWelcome: fn }),
            Ne && ze.length > 0 ? /* @__PURE__ */ u("div", { className: "workbench-ai-dirty-banner", children: [
              /* @__PURE__ */ a("span", { children: Ne }),
              /* @__PURE__ */ a("button", { onClick: () => {
                fa();
              }, children: "Save all" }),
              /* @__PURE__ */ a("button", { onClick: () => Ce(null), title: "Dismiss", children: /* @__PURE__ */ a(Ee, { size: 13 }) })
            ] }) : null,
            /* @__PURE__ */ a("div", { className: "workbench-editor-content", children: E ? /* @__PURE__ */ u("div", { className: E.language === "markdown" && g ? "workbench-editor-split" : "workbench-editor-single", children: [
              /* @__PURE__ */ a("div", { className: "workbench-editor-pane", children: /* @__PURE__ */ a(vs, { fallback: /* @__PURE__ */ a("div", { className: "workbench-empty-pane", children: "Loading editor…" }), children: /* @__PURE__ */ a(
                Mc,
                {
                  file: E,
                  revealLine: Er,
              ...
              E.language === "markdown" && g && /* @__PURE__ */ a(ol, { content: E.content })
            ] }) : Dt ? /* @__PURE__ */ a(
              pl,
              {
                host: e,
            ...
            ) : fn ? /* @__PURE__ */ a(al, { host: e, openFile: Xt, openFolder: mn, newFile: vn, recent: Tt, reopenRecent: gn, setStatus: M, openControlTower: () => {
              f("computer"), b(!0);
            }, openChat: () => {
              C("chat"), Z(!0);
            }, openEmbeddedDoc: Qr }) : /* @__PURE__ */ u("div", { className: "workbench-no-editor", children: [
              /* @__PURE__ */ a(ln, { size: 34 }),
              /* @__PURE__ */ a("p", { children: "No editor open" }),
              /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => ce(!1), children: "Show Agent Team" })
            ] }) }),
            pe && /* @__PURE__ */ a(
              ll,
              {
                ...
                runAiSynthesis: yn,
                captureManualCheck: kn,
                openOutputAsFile: wn,
                manualCheckSession: Fe,
                manualCheckCommandInput: lt,
                setManualCheckCommandInput: Nt,
                manualCheckOutputInput: Qe,
                setManualCheckOutputInput: hn,
                manualCheckSelectedCommand: Wt,
                setManualCheckSelectedCommand: Vt,
                manualCheckStatus: It,
                setManualCheckStatus: ia,
                copyManualCheckCommand: cs,
                addManualCheckCommand: ls,
                recordManualCheckResult: ds,
                askAgentFromManualChecks: us,
                onClose: () => S(!1)
              }
            )
          ] })
        ...
        V && /* @__PURE__ */ a(
          dl,
          {
            ...
            chatInput: Y,
            setChatInput: de,
            chatMessages: _.messages,
            chatThread: _.thread,
            chatThreads: _.threads,
            askAgent: is,
            stopChat: _.stopChat,
            regenerateMessage: ns,
            newChat: () => {
              _.newChat();
            },
            selectThread: (c) => {
            ...
            saveMessageAsArtifact: as,
            rememberMessage: rs,
            previewEditFromMessage: (c) => ut(c.body.split(`
`).find(Boolean)?.replace(/^#+\s*/, "").slice(0, 80) || "Atomek answer", c.body),
            runQuickPrompt: ba,
            pendingPatchPrompt: Ze,
            generatePatchPrompt: os,
            workspaceFileCount: m.length,
            aiStatus: _.aiStatus,
            chatSettings: xe,
            chatTargets: $,
            selectedChatTarget: ua,
            selectChatTarget: Kr,
            openSettings: Ft,
            busy: _.busy,
            memoryHitCount: _.memoryHits.length,
            outputs: nt,
            runAiSynthesis: yn,
            captureManualCheck: kn,
            openOutputAsFile: wn,
            previewEditFromOutput: (c) => ut(c.title, c.body),
            canPreviewEdit: m.length > 0,
            clearOutputs: () => k([]),
            deleteArtifact: (c) => {
              _.deleteArtifact(c);
            },
            ...
            contextScope: He,
            setContextScope: je,
            contextAttachments: Jr,
            removeContextAttachment: Ur,
            revealContextAttachment: $r,
        ...
        he && /* @__PURE__ */ a(
          il,
          {
            ...
            activeFile: E,
            commands: [
              { label: "File: New File", detail: "Create an untitled Markdown file", run: vn },
              ...
              ...Tt.map((c) => ({ label: `File: Open Recent — ${c.name}`, detail: c.path, run: () => {
                gn(c);
              } })),
              { label: "File: Save All", detail: `${ze.length} dirty file${ze.length === 1 ? "" : "s"}`, run: () => {
                fa();
              }, disabled: ze.length === 0 },
              { label: "File: Close All Editors", detail: `${Me.length} open editor${Me.length === 1 ? "" : "s"}`, run: ts, disabled: Me.length === 0 },
              ...
              { label: "Help: Show Agent Team", detail: "Open the Atomek Resource Fabric landing page", run: () => {
                W(null), ce(!1), f("computer"), b(!0);
              } },
              { label: "View: Toggle Primary Side Bar", detail: p ? "Hide Explorer side bar" : "Show Explorer side bar", run: () => b((c) => !c) },
              { label: "View: Toggle Chat Panel", detail: V ? "Hide right AI side bar" : "Show right AI side bar", run: () => Z((c) => !c) },
              { label: "View: Toggle Bottom Panel", detail: pe ? "Hide Problems/Output/Terminal panel" : "Show Problems/Output/Terminal panel", run: () => S((c) => !c) },
              { label: "Atomek: Open Settings", detail: "Open settings as an editor tab", run: Ft },
              ...
              { label: "View: Toggle Markdown Preview", detail: E?.language === "markdown" ? "Show or hide Markdown preview split" : "Available for Markdown files", run: () => U((c) => !c), disabled: E?.language !== "markdown" },
              { label: "Atomek: Create AI Synthesis", detail: E || Me.length > 0 ? "Ask AIL to produce a saved Markdown artifact" : "Open a file first", run: yn, disabled: !E && Me.length === 0 },
              { label: "AI: Explain Active File", detail: E ? `Ask Cortex to explain ${E.path}` : "Open a file first", run: () => We("Explain the active file. Focus on purpose, structure, risks, and next useful edits."), disabled: !E },
              { label: "AI: Improve Active File", detail: E ? `Ask Cortex for concrete edits to ${E.path}` : "Open a file first", run: () => We("Review the active file and propose the smallest concrete improvements. Include exact snippets if useful."), disabled: !E },
              { label: "AI: Draft Editable Replacement", detail: E ? `Ask Cortex for a full-file replacement for ${E.path}` : "Open a file first", run: () => ba("edit"), disabled: !E },
              { label: "AI: Plan Workspace Work", detail: Me.length > 0 ? "Use open editors as bounded context" : "Open files first", run: () => We("Create an implementation plan from the open editor context. Be specific and sequence the work."), disabled: Me.length === 0 },
              { label: "AI: Save Active File as Artifact", detail: E ? "Persist active file in host.ai artifacts" : "Open a file first", run: ss, disabled: !E },
              { label: "AI: Capture Manual Check Output", detail: "Paste check output as an auditable local artifact; no shell execution", run: kn },
              { label: "AI: Open Latest Artifact as File", detail: nt[0] ? `Create editable file from ${nt[0].title}` : "No outputs yet", run: () => nt[0] && wn(nt[0]), disabled: nt.length === 0 }
            ],
            openWorkbenchFile: we,
            onClose: () => ke(!1)
          }
        ...
        /* @__PURE__ */ a(Nl, { status: qr, file: E ?? Wc, cursor: D, fileCount: m.length, dirtyCount: ze.length })
      ]
    }
  );
}
function Bc({ active: e, setActive: t, togglePrimary: n, openSettings: r, settingsActive: s }) {
  return /* @__PURE__ */ u("aside", { className: "workbench-activity-bar", "aria-label": "Activity Bar", children: [
    /* @__PURE__ */ a("button", { className: "workbench-activity-brand", title: "Toggle side bar", "aria-label": "Toggle side bar", onClick: n, children: /* @__PURE__ */ a(xr, { size: 30, variant: "cream" }) }),
    /* @__PURE__ */ a(pt, { icon: /* @__PURE__ */ a(Ya, { size: 25 }), label: "Explorer", active: e === "explorer", onClick: () => t("explorer") }),
    /* @__PURE__ */ a(pt, { icon: /* @__PURE__ */ a(Ka, { size: 25 }), label: "Search", active: e === "search", onClick: () => t("search") }),
    /* @__PURE__ */ a(pt, { icon: /* @__PURE__ */ a(Za, { size: 25 }), label: "Source Control", active: e === "source-control", onClick: () => t("source-control") }),
    /* @__PURE__ */ a(pt, { icon: /* @__PURE__ */ a(Ra, { size: 25 }), label: "Run and Debug", active: e === "run", onClick: () => t("run") }),
    /* @__PURE__ */ a(pt, { icon: /* @__PURE__ */ a(Yn, { size: 25 }), label: "Agent Team", active: e === "computer", onClick: () => t("computer") }),
    /* @__PURE__ */ a("div", { className: "workbench-activity-spacer" }),
    /* @__PURE__ */ a(pt, { icon: /* @__PURE__ */ a(_s, { size: 23 }), label: "Settings", active: s, onClick: r })
  ] });
}
function pt({ icon: e, label: t, active: n, onClick: r }) {
  return /* @__PURE__ */ a("button", { className: `workbench-activity-button ${n ? "active" : ""}`, title: t, "aria-label": t, onClick: r, children: e });
}
function Gc(e) {
  return e.activity === "search" ? /* @__PURE__ */ a(rl, { files: e.files, query: e.query, setQuery: e.setQuery, openWorkbenchFile: e.openWorkbenchFile, activeFileId: e.activeFileId }) : e.activity === "source-control" ? /* @__PURE__ */ a(Ia, { title: "SOURCE CONTROL", body: "No source control provider registered. Git belongs here, not as a fake demo." }) : e.activity === "run" ? /* @__PURE__ */ a(Ia, { title: "RUN AND DEBUG", body: "Run configurations, terminals, and recipe execution will plug into this surface later." }) : e.activity === "computer" ? /* @__PURE__ */ a(Fr, { host: e.host, setStatus: e.setStatus, attachSkillToChat: e.attachSkillToChat, saveLocalJobOutput: e.saveLocalJobOutput, activeFile: e.activeFile, openEditors: e.openEditors }) : /* @__PURE__ */ a(Qc, { ...e });
}
function Qc(e) {
  const t = !e.folder, n = fe(() => $c(e.files, e.folder?.name), [e.files, e.folder?.name]), [r, s] = X(() => /* @__PURE__ */ new Set());
  se(() => {
    const o = Mr(n);
    s((l) => {
      const f = new Set(l);
      return o.forEach((p) => f.add(p)), f;
    });
  }, [n]);
  const i = z((o) => {
    s((l) => {
  ...
  return /* @__PURE__ */ u("aside", { className: "workbench-sidebar", children: [
    ...
    /* @__PURE__ */ u("div", { className: "workbench-sidebar-scroll", children: [
      t ? /* @__PURE__ */ u(Ve, { children: [
        ...
        /* @__PURE__ */ a("button", { className: "workbench-button-blue", onClick: () => e.recent[0] ? void e.reopenRecent(e.recent[0]) : e.setStatus("No recent local workspace yet."), children: "Open Recent" }),
        ...
        /* @__PURE__ */ a("input", { className: "workbench-input", value: e.query, onChange: (o) => e.setQuery(o.target.value), placeholder: "Search files" }),
        /* @__PURE__ */ u("div", { className: "workbench-section-title", children: [
          /* @__PURE__ */ a(St, { size: 12 }),
          " Open Editors"
        ] }),
        e.openEditors.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No open editors" }) : e.openEditors.map((o) => /* @__PURE__ */ a(sa, { file: o, active: o.id === e.activeFileId, onOpen: () => e.openWorkbenchFile(o), label: o.name, detail: o.path }, o.id)),
        /* @__PURE__ */ u("div", { className: "workbench-section-title", children: [
          /* @__PURE__ */ a(St, { size: 12 }),
          " ",
          e.folder?.name ?? "Workspace"
        ] }),
        n.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No readable text files found." }) : Wr(n, e.activeFileId, e.openWorkbenchFile, r, i)
      ] }),
      /* @__PURE__ */ a("div", { className: "workbench-section-title", children: "Recent" }),
      e.recent.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No recent folders yet." }) : e.recent.map((o) => /* @__PURE__ */ u("button", { className: "workbench-tree-row", onClick: () => {
        e.reopenRecent(o);
      }, title: o.path, children: [
        o.kind === "file" ? /* @__PURE__ */ a(Zn, { size: 14 }) : /* @__PURE__ */ a(Ja, { size: 14 }),
        /* @__PURE__ */ a("span", { className: "workbench-row-name", children: o.name })
      ] }, `${o.path}-${o.at}`))
    ] })
  ] });
}
function sa({ file: e, active: t, onOpen: n, basePath: r, depth: s = 0, label: i, detail: o }) {
  const l = r && e.path.startsWith(`${r}/`) ? e.path.slice(r.length + 1) : e.path, f = s || Math.max(0, l.split("/").length - 1);
  return /* @__PURE__ */ u("button", { className: `workbench-file-row ${t ? "active" : ""}`, style: { "--workbench-depth": f }, onClick: n, title: e.path, children: [
    /* @__PURE__ */ a(Zn, { size: 14 }),
    /* @__PURE__ */ u("span", { className: "workbench-row-text", children: [
      /* @__PURE__ */ a("span", { className: "workbench-row-name", children: i ?? l }),
...
function $c(e, t) {
  const n = [], r = /* @__PURE__ */ new Map(), s = (o, l, f = n) => {
    const p = r.get(o);
    if (p) return p;
    const b = { name: l, path: o, children: [] };
    return r.set(o, b), f.push(b), b;
  };
  e.forEach((o) => {
    const l = t && o.path.startsWith(`${t}/`) ? o.path.slice(t.length + 1) : o.path, f = l.split("/").filter(Boolean);
    let p = n, b = "";
    f.slice(0, -1).forEach((v) => {
      b = b ? `${b}/${v}` : v, p = s(b, v, p).children;
    }), p.push({ name: f.at(-1) ?? o.name, path: l, file: o, children: [] });
  });
  const i = (o) => o.sort((l, f) => +!!l.file - +!!f.file || l.name.localeCompare(f.name)).map((l) => ({ ...l, children: i(l.children) }));
  return i(n);
}
function Mr(e) {
  return e.flatMap((t) => t.file ? [] : [t.path, ...Mr(t.children)]);
}
function Wr(e, t, n, r, s, i = 0) {
  return e.map((o) => {
    if (o.file)
      return /* @__PURE__ */ a(sa, { file: o.file, active: o.file.id === t, onOpen: () => n(o.file), depth: i, label: o.name }, o.file.id);
    const l = r.has(o.path);
    return /* @__PURE__ */ u("div", { children: [
      /* @__PURE__ */ u("button", { className: "workbench-folder-row", style: { "--workbench-depth": i }, onClick: () => s(o.path), title: l ? `Collapse ${o.name}` : `Expand ${o.name}`, children: [
        l ? /* @__PURE__ */ a(St, { size: 12 }) : /* @__PURE__ */ a(St, { className: "workbench-chevron-collapsed", size: 12 }),
        l ? /* @__PURE__ */ a(Un, { size: 14 }) : /* @__PURE__ */ a(Ja, { size: 14 }),
        /* @__PURE__ */ a("span", { className: "workbench-row-name", children: o.name }),
        /* @__PURE__ */ a("span", { className: "workbench-row-meta", children: o.children.length })
      ] }),
      l ? Wr(o.children, t, n, r, s, i + 1) : null
    ] }, o.path);
  });
}
function _c({ file: e, folder: t, showWelcome: n }) {
  const r = n ? ["Agent Team"] : e?.path.split("/").filter(Boolean) ?? [], s = t && r[0] === t.name ? r.slice(1) : r;
  return /* @__PURE__ */ a("div", { className: "workbench-breadcrumb", children: s.length === 0 ? /* @__PURE__ */ a("span", { children: "Workspace" }) : s.map((i, o) => /* @__PURE__ */ u("span", { className: "workbench-breadcrumb-part", children: [
    o > 0 && /* @__PURE__ */ a("span", { className: "workbench-breadcrumb-sep", children: "›" }),
    i
  ] }, `${i}-${o}`)) });
}
function el(e) {
  return /* @__PURE__ */ u("div", { className: "workbench-tabs", children: [
    e.showWelcome && /* @__PURE__ */ u("button", { className: "workbench-tab active", children: [
      /* @__PURE__ */ a(ln, { size: 15 }),
      /* @__PURE__ */ a("span", { className: "workbench-tab-name", children: "Agent Team" }),
      /* @__PURE__ */ a("span", { className: "workbench-tab-close", role: "button", tabIndex: 0, onClick: (t) => {
        t.stopPropagation(), e.closeWelcome();
      }, children: /* @__PURE__ */ a(Ee, { size: 13 }) })
    ] }),
    ...
    e.canPreview && /* @__PURE__ */ a("button", { className: `workbench-editor-action ${e.previewVisible ? "active" : ""}`, title: "Toggle Markdown Preview", onClick: e.togglePreview, children: /* @__PURE__ */ a(Jn, { size: 16 }) }),
    /* @__PURE__ */ a("button", { className: `workbench-editor-action ${e.secondaryVisible ? "active" : ""}`, title: "Toggle Chat", onClick: e.toggleSecondary, children: /* @__PURE__ */ a(Ks, { size: 16 }) })
  ] });
}
function tl(e) {
  const t = e?.resources ?? [], n = (s) => t.filter((i) => i.kind === s).length, r = t.filter((s) => s.status === "ready" || s.status === "available").length;
  return [
...
function nl(e) {
  ...
  return [...e?.resources ?? []].sort((n, r) => (t[n.kind] ?? 9) - (t[r.kind] ?? 9) || Se(n).localeCompare(Se(r))).slice(0, 8);
}
function al({
  host: e,
  openFile: t,
  ...
  const [b, v] = X("Coordinate a Tytus mission across pods, local agents, shared folders, and app skills."), [P, H] = X(null), [C, V] = X([]), [Z, I] = X(!1), [oe, pe] = X(null), [S, B] = X(null), [J, g] = X("pod-local"), U = z(async () => {
    I(!0), B(null);
    try {
      const [w, W] = await Promise.all([
        e.resources?.list?.() ?? Promise.resolve(null),
        e.missions?.list?.().catch(() => []) ?? Promise.resolve([])
      ]);
      H(w ?? null), V(W), w && o(`Agent team loaded · ${w.resources.length} resources · ${w.warnings.length} warnings`);
    } catch (w) {
      const W = w instanceof Error ? w.message : String(w);
      B(W), o(`Agent team resource load failed: ${W}`);
    } finally {
      I(!1);
    }
  }, [e.missions, e.resources, o]), q = z((w, W) => {
    try {
      e.windows.openOrFocus(w), o(`Opened ${W}`);
    } catch (T) {
      o(`Open ${W} failed: ${T instanceof Error ? T.message : String(T)}`);
    }
  }, [e.windows, o]);
  se(() => {
    U();
  ...
  const ce = z(async () => {
    ...
    const w = b.trim() || "Coordinate a Tytus mission.", W = ot(w, P, J);
    I(!0);
    try {
      const T = await e.missions.create({
        ...
        goal: T.goal,
        rootPath: T.rootPath,
        name: T.rootPath.split("/").pop() || T.missionId,
        source: "tray",
        teamPresetId: W
      }, D = {
        ...
        data: { resourceCount: P?.resources.length ?? 0 }
      };
      await e.missions.write({
        rootPath: T.rootPath,
        files: [
          { path: "MISSION.md", content: an(A, P, null, [], w, W) },
          { path: "MISSION.json", content: jr(A, P, w, W) },
          { path: "RESOURCES.md", content: rn(P) },
          { path: "TASKS.md", content: Sr(jt(w, P, W)) },
          { path: "HANDOFF.md", content: Hr(A) },
...
` },
          { path: "AUDIT.jsonl", content: `${JSON.stringify(D)}
` },
...
`) }
      ...
      }), pe(T), Ct(A), o(`Mission created: ${T.rootPath}`), l();
    } catch (T) {
      o(`Mission create failed: ${T instanceof Error ? T.message : String(T)}`);
    } finally {
      I(!1);
    }
  }, [b, P, e.missions, l, o, J]), ne = tl(P), Te = Rc(P), Le = Ec(P), Ae = nl(P), m = P?.warnings ?? [], F = Yc(P), te = xt(P, ot(b, P, J)), le = jt(b, P, te.id);
  return /* @__PURE__ */ u("div", { className: "workbench-welcome workbench-control-home", children: [
    /* @__PURE__ */ u("section", { className: "workbench-control-hero-main", children: [
      /* @__PURE__ */ u("div", { className: "workbench-brand-lockup", "aria-label": "Atomek", children: [
        /* @__PURE__ */ a(xr, { size: 74, variant: "acid" }),
        /* @__PURE__ */ u("div", { children: [
          /* @__PURE__ */ a(zc, { className: "workbench-brand-wordmark" }),
      ...
      /* @__PURE__ */ u("div", { className: "workbench-control-goal-row", children: [
        /* @__PURE__ */ a("textarea", { value: b, onChange: (w) => v(w.target.value), rows: 3, "aria-label": "Mission goal" }),
        /* @__PURE__ */ u("div", { className: "workbench-control-hero-actions", children: [
          ...
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: l, children: "Open team board" }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: f, children: "Open chat" })
        ] })
      ] }),
      /* @__PURE__ */ a("div", { className: "workbench-team-preset-strip", "aria-label": "Team presets", children: F.map((w) => /* @__PURE__ */ u(
        "button",
        {
          className: `workbench-team-preset-card ${w.id === te.id ? "active" : ""} ${w.readiness}`,
          onClick: () => g(w.id),
          children: [
            /* @__PURE__ */ u("div", { children: [
              /* @__PURE__ */ a("strong", { children: w.label }),
              /* @__PURE__ */ a("span", { children: w.readiness })
            ] }),
            /* @__PURE__ */ a("p", { children: w.summary }),
            /* @__PURE__ */ a("small", { children: w.assignments.map((W) => W.resourceLabel).slice(0, 3).join(" · ") })
          ]
        },
        w.id
      )) }),
      oe ? /* @__PURE__ */ u("div", { className: "workbench-control-success", children: [
        "Mission ready: ",
        /* @__PURE__ */ a("code", { children: oe.rootPath })
      ] }) : null,
      S ? /* @__PURE__ */ a("div", { className: "workbench-inline-error", children: S }) : null
    ] }),
    /* @__PURE__ */ u("section", { className: "workbench-control-grid", children: [
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        ...
        /* @__PURE__ */ a("div", { className: "workbench-control-metrics", children: ne.map((w) => /* @__PURE__ */ u("div", { className: "workbench-control-metric", children: [
          /* @__PURE__ */ a("strong", { children: w.value }),
          /* @__PURE__ */ a("span", { children: w.label }),
          /* @__PURE__ */ a("em", { children: w.detail })
        ] }, w.label)) })
      ] }),
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        /* @__PURE__ */ u("header", { children: [
        ...
        /* @__PURE__ */ a("div", { className: "workbench-agent-brand-grid", children: Te.map((w) => /* @__PURE__ */ u("div", { className: `workbench-agent-brand-card ${w.status.replace(/\s+/g, "-")}`, children: [
          /* @__PURE__ */ u("div", { children: [
            /* @__PURE__ */ a("strong", { children: w.label }),
            /* @__PURE__ */ a("span", { children: w.status })
          ] }),
          /* @__PURE__ */ a("b", { children: w.value }),
          /* @__PURE__ */ a("p", { children: w.detail })
        ] }, w.label)) })
      ] }),
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        /* @__PURE__ */ u("header", { children: [
        ...
        /* @__PURE__ */ a("div", { className: "workbench-doc-grid", children: Sc.map((w) => /* @__PURE__ */ u("button", { className: "workbench-doc-card", onClick: () => p(w), title: w.summary, children: [
          /* @__PURE__ */ a("strong", { children: w.title }),
          /* @__PURE__ */ a("p", { children: w.summary }),
          /* @__PURE__ */ a("small", { children: w.tags.join(" · ") })
        ] }, w.id)) })
      ] }),
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        /* @__PURE__ */ u("header", { children: [
        ...
        /* @__PURE__ */ a("div", { className: "workbench-fabric-flow", children: Le.map((w, W) => /* @__PURE__ */ u("div", { className: `workbench-fabric-node ${w.status.replace(/\s+/g, "-")}`, children: [
          /* @__PURE__ */ a("span", { children: W + 1 }),
          /* @__PURE__ */ a("strong", { children: w.label }),
          /* @__PURE__ */ a("em", { children: w.status }),
          /* @__PURE__ */ a("p", { children: w.detail })
        ] }, w.label)) }),
        /* @__PURE__ */ u("div", { className: "workbench-fabric-actions", children: [
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => q(Yt.sharedFiles, "Shared Files"), children: "Open shared files" }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => q(Yt.podInspector, "Pod Inspector"), children: "Open pods" }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => q(Yt.channels, "Channels"), children: "Open channels" }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => q(Yt.settings, "Agent Settings"), children: "Open agent settings" })
        ] })
      ] }),
      ...
      /* @__PURE__ */ u("article", { className: "workbench-control-card", children: [
        /* @__PURE__ */ u("header", { children: [
          ...
          /* @__PURE__ */ a("span", { children: C.length ? `${C.length} missions` : "none yet" })
        ] }),
        C.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "Create a mission once; it stays in Tytus Home/Missions and can be resumed here." }) : null,
        C.slice(0, 4).map((w) => /* @__PURE__ */ u("button", { className: "workbench-control-preset", onClick: () => {
          Ct(w), l();
        }, title: w.rootPath, children: [
          w.title,
      ...
      /* @__PURE__ */ u("article", { className: "workbench-control-card", children: [
        ...
        /* @__PURE__ */ u("button", { className: "workbench-start-link", onClick: t, children: [
          /* @__PURE__ */ a(Ya, { size: 18 }),
          "Open file"
        ] }),
        /* @__PURE__ */ u("button", { className: "workbench-start-link", onClick: r, children: [
          /* @__PURE__ */ a(Kn, { size: 18 }),
          "New mission note"
        ] }),
        s.length ? /* @__PURE__ */ u("div", { className: "workbench-control-recent", children: [
          /* @__PURE__ */ a("span", { children: "Recent" }),
          s.slice(0, 3).map((w) => /* @__PURE__ */ a("button", { onClick: () => {
            i(w);
          }, children: w.name }, `${w.path}-${w.at}`))
        ] }) : null
      ] }),
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        /* @__PURE__ */ u("header", { children: [
          /* @__PURE__ */ a("strong", { children: "Resource graph" }),
          /* @__PURE__ */ a("span", { children: P ? `${P.resources.length} discovered` : "not loaded" })
        ] }),
        /* @__PURE__ */ u("div", { className: "workbench-control-resource-list", children: [
          Ae.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No resource graph yet. Start Tytus tray beta30 or newer, then refresh." }) : null,
          Ae.map((w) => /* @__PURE__ */ u("div", { className: "workbench-control-resource", children: [
            /* @__PURE__ */ u("div", { children: [
              /* @__PURE__ */ a("strong", { children: Se(w) }),
              /* @__PURE__ */ a("span", { children: ra(w) })
            ] }),
            /* @__PURE__ */ a("span", { className: `workbench-computer-pill ${w.status}`, children: w.status })
          ] }, w.id))
        ] }),
        m.length ? /* @__PURE__ */ a("div", { className: "workbench-resource-warnings", children: m.slice(0, 2).map((w) => /* @__PURE__ */ u("span", { children: [
          w.code,
          ": ",
          w.message
        ] }, `${w.code}-${w.resourceId ?? w.message}`)) }) : null
      ] }),
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        /* @__PURE__ */ a("header", { children: /* @__PURE__ */ a("strong", { children: "Recommended task graph" }) }),
        /* @__PURE__ */ a("div", { className: "workbench-task-graph home", children: le.map((w, W) => /* @__PURE__ */ u("button", { className: `workbench-task-card ${w.status}`, onClick: () => v(w.prompt), children: [
          /* @__PURE__ */ a("span", { children: W + 1 }),
          /* @__PURE__ */ a("strong", { children: w.title }),
          /* @__PURE__ */ a("em", { children: w.resourceHint }),
          /* @__PURE__ */ a("small", { children: w.assignedResourceLabel })
        ] }, w.id)) })
      ] }),
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
...
function rl({ files: e, query: t, setQuery: n, openWorkbenchFile: r, activeFileId: s }) {
  const i = fe(() => sl(e, t), [e, t]), o = fe(() => {
    const l = /* @__PURE__ */ new Map();
    return i.forEach((f) => l.set(f.file.id, [...l.get(f.file.id) ?? [], f])), Array.from(l.values()).slice(0, 50);
  }, [i]);
  return /* @__PURE__ */ u("aside", { className: "workbench-sidebar", children: [
    /* @__PURE__ */ a("div", { className: "workbench-sidebar-title", children: "SEARCH" }),
    /* @__PURE__ */ u("div", { className: "workbench-sidebar-scroll", children: [
      /* @__PURE__ */ a("input", { className: "workbench-input", value: t, onChange: (l) => n(l.target.value), placeholder: "Search files and text", autoFocus: !0 }),
      /* @__PURE__ */ u("div", { className: "workbench-section-title", children: [
        /* @__PURE__ */ a(ln, { size: 12 }),
        " Results"
      ] }),
      t.trim() ? o.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No matches." }) : o.map((l) => {
        const f = l[0].file;
        return /* @__PURE__ */ u("div", { className: "workbench-search-group", children: [
          /* @__PURE__ */ a(sa, { file: f, active: f.id === s, onOpen: () => r(f) }),
          l.slice(0, 5).map((p) => /* @__PURE__ */ u("button", { className: "workbench-search-hit", onClick: () => r(f, p.lineNumber), title: p.line, children: [
            /* @__PURE__ */ a("span", { className: "workbench-search-line", children: p.lineNumber }),
            /* @__PURE__ */ a("span", { children: p.line })
          ] }, `${f.id}-${p.lineNumber}-${p.line}`)),
          l.length > 5 && /* @__PURE__ */ u("div", { className: "workbench-search-more", children: [
            "+",
            l.length - 5,
            " more matches"
          ] })
...
function sl(e, t) {
  ...
  const r = [];
  return e.forEach((s) => {
    s.path.toLowerCase().includes(n) && r.push({ file: s, lineNumber: 1, line: s.path }), s.content.split(`
`).some((i, o) => i.toLowerCase().includes(n) ? (r.push({ file: s, lineNumber: o + 1, line: i.trim() || "(blank line)" }), r.length >= 200) : !1);
  }), r.slice(0, 200);
}
function il(e) {
  ...
  })), r = [...e.commands, ...n].filter((s) => !t || s.label.toLowerCase().includes(t) || s.detail.toLowerCase().includes(t)).slice(0, 12);
  return se(() => {
    const s = (i) => {
    ...
    /* @__PURE__ */ a(
      "input",
      {
        ...
        onKeyDown: (s) => {
          s.key === "Enter" && r[0] && !r[0].disabled && (r[0].run(), e.onClose());
        }
      }
    ),
    /* @__PURE__ */ a("div", { className: "workbench-command-list", children: r.map((s) => /* @__PURE__ */ u(
      "button",
      {
        disabled: s.disabled,
        ...
        children: [
          ...
          /* @__PURE__ */ a("small", { children: s.detail })
        ]
      },
      `${s.label}-${s.detail}`
    )) })
...
function cl(e) {
  const t = e.session ? mc(e.session) : "pending";
  return /* @__PURE__ */ u("div", { className: "workbench-manual-check-panel", children: [
    ...
    e.session ? /* @__PURE__ */ u(Ve, { children: [
...
function ll(e) {
  return /* @__PURE__ */ u("section", { className: "workbench-bottom-panel", "aria-label": "Panel", children: [
    /* @__PURE__ */ u("div", { className: "workbench-bottom-tabs", children: [
      ...
      /* @__PURE__ */ a("span", {}),
      /* @__PURE__ */ a("button", { title: "Close Panel", onClick: e.onClose, children: /* @__PURE__ */ a(Ee, { size: 14 }) })
    ] }),
    /* @__PURE__ */ u("div", { className: "workbench-bottom-body", children: [
      ...
      e.tab === "output" && /* @__PURE__ */ a(Dr, { outputs: e.outputs, clearOutputs: e.clearOutputs, deleteArtifact: e.deleteArtifact, runAiSynthesis: e.runAiSynthesis, captureManualCheck: e.captureManualCheck, openOutputAsFile: e.openOutputAsFile, compact: !0 })
    ] })
  ] });
}
function dl(e) {
  const [t, n] = X(!1), [r, s] = X(""), [i, o] = X([]), l = Xe(null), f = Xe(null), p = Xe(null), [b, v] = X({ top: 0, right: 0 }), P = fe(
    () => e.chatThreads.map((g) => ({
      kind: "atomek-thread",
      id: `thread:${g.id}`,
      title: g.title,
      lastActivityAt: g.lastMessageAt ?? g.updatedAt ?? 0,
      thread: g
    })),
    [e.chatThreads]
  ), H = fe(() => i.map((g) => {
    const U = e.chatTargets.find((q) => q.id === g.targetId);
    return U ? {
      kind: "pod-agent",
      id: `agent:${g.targetId}`,
      title: U.label,
      subtitle: g.preview || U.description || `${g.messageCount} messages`,
      lastActivityAt: g.lastActivityAt,
      targetId: g.targetId
    } : null;
  }).filter((g) => g !== null), [i, e.chatTargets]), C = fe(() => [...P, ...H].sort((g, U) => U.lastActivityAt - g.lastActivityAt), [P, H]), V = fe(() => e.selectedChatTarget.kind === "atomek-ai" && e.chatThread ? C.find((g) => g.kind === "atomek-thread" && g.thread.id === e.chatThread?.id) ?? null : e.selectedChatTarget.kind !== "atomek-ai" ? C.find((g) => g.kind === "pod-agent" && g.targetId === e.selectedChatTarget.id) ?? null : null, [C, e.selectedChatTarget, e.chatThread]), Z = z((g, U) => U ? `${g.title} ${g.kind === "pod-agent" ? g.subtitle : ""}`.toLowerCase().includes(U) : !0, []), I = r.trim().toLowerCase(), oe = V ? Z(V, I) : !1, pe = fe(() => C.filter((g) => g.id !== V?.id).filter((g) => Z(g, I)), [C, V, I, Z]), S = z(() => {
    o(Si());
  }, []), B = z((g) => {
    n(!1), g.kind === "atomek-thread" ? (e.selectedChatTarget.kind !== "atomek-ai" && e.selectChatTarget(Je.id), e.selectThread(g.thread.id)) : e.selectChatTarget(g.targetId), e.tab !== "chat" && e.setTab("chat");
  }, [e]), J = z((g) => {
    window.confirm(`Delete conversation "${g.title}"?`) && (g.kind === "atomek-thread" ? e.deleteThread(g.thread.id) : (Hi(g.targetId), S()));
  }, [e, S]);
  return se(() => {
    if (!t) {
      s("");
    ...
    const g = () => {
      ...
      v({
        top: ne.bottom + 6,
        right: Math.max(8, window.innerWidth - ne.right)
      });
    };
    g(), window.setTimeout(() => p.current?.focus(), 0);
    const U = (ce) => {
      const ne = ce.target;
      ne && (f.current?.contains(ne) || l.current?.contains(ne) || n(!1));
    }, q = (ce) => {
      ce.key === "Escape" && n(!1);
    };
    return window.addEventListener("resize", g), window.addEventListener("scroll", g, !0), window.addEventListener("mousedown", U), window.addEventListener("keydown", q), () => {
      window.removeEventListener("resize", g), window.removeEventListener("scroll", g, !0), window.removeEventListener("mousedown", U), window.removeEventListener("keydown", q);
    };
  }, [t]), /* @__PURE__ */ u("aside", { className: "workbench-secondary", children: [
    ...
    /* @__PURE__ */ u("div", { className: "workbench-secondary-tabs", children: [
      ...
      /* @__PURE__ */ u("div", { className: "workbench-secondary-actions", children: [
        /* @__PURE__ */ a("button", { title: "New Chat", onClick: e.newChat, children: /* @__PURE__ */ a(Wn, { size: 15 }) }),
        /* @__PURE__ */ a(
          "button",
          {
            ref: l,
            ...
            children: /* @__PURE__ */ a(Ea, { size: 15 })
          }
        ),
        /* @__PURE__ */ a("button", { title: "Chat Settings", onClick: e.openSettings, children: /* @__PURE__ */ a(qa, { size: 16 }) }),
        /* @__PURE__ */ a("button", { title: "Close Chat", onClick: e.onClose, children: /* @__PURE__ */ a(Ee, { size: 15 }) })
      ] })
    ] }),
    t && typeof document < "u" ? ys(
      /* @__PURE__ */ u(
        "div",
        {
          ref: f,
          ...
          children: [
            ...
            /* @__PURE__ */ u("div", { className: "workbench-history-portal-list", children: [
              V && oe ? /* @__PURE__ */ u(Ve, { children: [
                /* @__PURE__ */ a("div", { className: "workbench-history-portal-group", children: "Current" }),
                /* @__PURE__ */ u(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ u("span", { className: "workbench-history-portal-title", children: [
                        V.kind === "pod-agent" ? /* @__PURE__ */ a("span", { className: "workbench-history-portal-badge", children: "Agent" }) : null,
                        V.title
                      ] }),
                      /* @__PURE__ */ a("small", { children: qn(V.lastActivityAt) }),
                      /* @__PURE__ */ a(
                        "button",
                        {
                          className: "workbench-history-portal-delete",
                          onClick: (g) => {
                            g.stopPropagation(), J(V);
                          },
                          title: "Delete conversation",
                          "aria-label": "Delete conversation",
                          children: /* @__PURE__ */ a(ga, { size: 13 })
                        }
                      )
                    ]
                  }
              ...
              pe.length > 0 ? /* @__PURE__ */ u(Ve, { children: [
                /* @__PURE__ */ a("div", { className: "workbench-history-portal-group", children: "Recent" }),
                pe.map((g) => /* @__PURE__ */ u(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ u("span", { className: "workbench-history-portal-title", children: [
                        g.kind === "pod-agent" ? /* @__PURE__ */ a("span", { className: "workbench-history-portal-badge", children: "Agent" }) : null,
                        g.title
                      ] }),
                      /* @__PURE__ */ a("small", { children: qn(g.lastActivityAt) }),
                      /* @__PURE__ */ a(
                        "button",
                        {
                          className: "workbench-history-portal-delete",
                          onClick: (U) => {
                            U.stopPropagation(), J(g);
                          },
                          title: "Delete conversation",
                          "aria-label": "Delete conversation",
                          children: /* @__PURE__ */ a(ga, { size: 13 })
              ...
              !oe && pe.length === 0 ? /* @__PURE__ */ a("div", { className: "workbench-history-portal-empty", children: r.trim() ? "No matches" : "No conversations yet — start chatting with any agent." }) : null
            ] }),
    ...
    e.tab === "chat" ? /* @__PURE__ */ a(ul, { ...e }) : e.tab === "agents" ? /* @__PURE__ */ a(
      Fr,
      {
        host: e.host,
    ...
    ) : /* @__PURE__ */ a(Dr, { outputs: e.outputs, clearOutputs: e.clearOutputs, deleteArtifact: e.deleteArtifact, runAiSynthesis: e.runAiSynthesis, captureManualCheck: e.captureManualCheck, openOutputAsFile: e.openOutputAsFile, previewEditFromOutput: e.previewEditFromOutput, canPreviewEdit: e.canPreviewEdit })
  ] });
}
function Vr({ body: e }) {
  const t = fe(() => Ic(e), [e]), [n, r] = X(null), s = z((i, o) => {
    (async () => await kt(o) && (r(i), window.setTimeout(() => r((f) => f === i ? null : f), 1200)))();
  }, []);
  return /* @__PURE__ */ a("div", { className: "workbench-rich-body", children: t.map((i) => {
      ...
      return /* @__PURE__ */ u("div", { className: "workbench-rich-code", children: [
        /* @__PURE__ */ u("div", { className: "workbench-rich-code-head", children: [
          ...
          /* @__PURE__ */ u("button", { onClick: () => s(i.key, i.body), title: "Copy code block", children: [
            o ? /* @__PURE__ */ a(As, { size: 12 }) : /* @__PURE__ */ a(Mn, { size: 12 }),
            o ? "Copied" : "Copy"
          ] })
        ] }),
    ...
    return /* @__PURE__ */ a(
      "div",
      {
        ...
        dangerouslySetInnerHTML: { __html: tr(i.body) }
      },
      i.key
    );
  }) });
...
function ul(e) {
  const t = e.selectedChatTarget.available, n = e.selectedChatTarget.kind === "atomek-ai", r = e.chatInput.trim().length > 0 && !e.busy && t, s = Xe(null), [i, o] = X(!0), [l, f] = X(!1), p = Xe(null), b = Xe(null), v = Xe(null), P = Xe(null), [H, C] = X(!1), [V, Z] = X(0), I = typeof window < "u" && !!(window.SpeechRecognition || window.webkitSpeechRecognition), oe = z(() => {
    const m = v.current;
    try {
      m?.stop?.();
    } catch {
    }
    v.current = null, P.current !== null && (window.clearInterval(P.current), P.current = null), C(!1), Z(0);
  }, []), pe = z(() => {
    if (!I || H) return;
    const m = window.SpeechRecognition || window.webkitSpeechRecognition;
    if (!m) return;
    const F = new m();
    F.lang = navigator.language || "en-US", F.interimResults = !1, F.continuous = !1, F.onresult = (te) => {
      let le = "";
      for (let w = te.resultIndex; w < te.results.length; w += 1) {
        const W = te.results[w];
        W.isFinal && (le += W[0].transcript);
      }
      if (le) {
        const w = e.chatInput.trim().length > 0 ? `${e.chatInput} ${le}` : le;
        e.setChatInput(w);
      }
    }, F.onerror = () => {
      oe();
    ...
    try {
      F.start(), C(!0), Z(0), P.current = window.setInterval(() => Z((te) => te + 1), 1e3);
    } catch {
      oe();
    }
  }, [I, H, e, oe]);
  ...
  const S = (m) => {
    const F = Math.floor(m / 60), te = m % 60;
    return `${F.toString().padStart(1, "0")}:${te.toString().padStart(2, "0")}`;
  }, B = () => p.current?.removeAttribute("open"), J = () => b.current?.removeAttribute("open"), g = (m) => {
    e.setContextScope(m), m === "indexed-project" && e.refreshProjectIndex(), B();
  }, U = (m) => {
    e.selectChatTarget(m), J();
  }, q = fe(() => e.chatMessages.map((m) => `${m.id}:${m.status ?? ""}:${m.body.length}`).join("|"), [e.chatMessages]);
  se(() => {
    const m = s.current;
    m && (i ? (m.scrollTop = m.scrollHeight, f(!1)) : f(!0));
  }, [i, q]);
  const ce = z(() => {
    const m = s.current;
    if (!m) return;
    const te = m.scrollHeight - m.scrollTop - m.clientHeight < 48;
    o(te), te && f(!1);
  }, []), ne = z(() => {
    const m = s.current;
    m && (m.scrollTop = m.scrollHeight, o(!0), f(!1));
  }, []), Te = z((m) => {
    kt(m.body);
  }, []), Le = Xe(null), Ae = () => Le.current?.removeAttribute("open");
  return /* @__PURE__ */ u("div", { className: "workbench-chat-wrap", children: [
    /* @__PURE__ */ u("div", { className: "workbench-chat-threadbar", children: [
      /* @__PURE__ */ a("span", { className: "workbench-chat-thread-title", title: e.chatThread?.title ?? e.selectedChatTarget.label, children: n ? e.chatThread?.title ?? "Atomek chat" : `${e.selectedChatTarget.label} session` }),
      /* @__PURE__ */ u("span", { className: "workbench-chat-thread-actions", children: [
        /* @__PURE__ */ a(
          "button",
          {
            ...
            disabled: e.busy,
            title: n ? "New conversation" : "Clear conversation",
            "aria-label": "New conversation",
            children: /* @__PURE__ */ a(Wn, { size: 15 })
          }
        ),
        n && e.chatThreads.length > 0 ? /* @__PURE__ */ u("details", { ref: Le, className: "workbench-chat-iconmenu", children: [
          /* @__PURE__ */ a("summary", { className: "workbench-chat-iconbtn", title: "Chat history", "aria-label": "Chat history", children: /* @__PURE__ */ a(Ea, { size: 15 }) }),
          /* @__PURE__ */ u("div", { className: "workbench-chat-history-pop", role: "menu", children: [
            /* @__PURE__ */ u("div", { className: "workbench-chat-history-header", children: [
              "Chats (",
              e.chatThreads.length,
              ")"
            ] }),
            e.chatThreads.map((m) => /* @__PURE__ */ u(
              "button",
              {
                className: m.id === e.chatThread?.id ? "active" : "",
                onClick: () => {
                  e.selectThread(m.id), Ae();
                },
                title: m.title,
                children: [
                  /* @__PURE__ */ a("span", { className: "workbench-chat-history-title", children: m.title }),
                  /* @__PURE__ */ a("small", { children: qn(m.lastMessageAt ?? m.updatedAt) })
                ]
              },
              m.id
            ))
        ...
        n ? /* @__PURE__ */ u("details", { className: "workbench-chat-iconmenu", children: [
          /* @__PURE__ */ a("summary", { className: "workbench-chat-iconbtn", title: "Chat actions", "aria-label": "Chat actions", children: /* @__PURE__ */ a(qa, { size: 15 }) }),
          /* @__PURE__ */ u("div", { className: "workbench-chat-threadmenu-pop", children: [
            /* @__PURE__ */ a(
              "button",
              {
                onClick: (m) => {
                  if (m.currentTarget.closest("details")?.removeAttribute("open"), !e.chatThread) return;
                  const F = window.prompt("Rename chat", e.chatThread.title);
                  F !== null && e.renameThread(e.chatThread.id, F);
                },
            ...
            /* @__PURE__ */ a(
              "button",
              {
                className: "danger",
                onClick: (m) => {
                  m.currentTarget.closest("details")?.removeAttribute("open"), e.chatThread && window.confirm(`Delete chat "${e.chatThread.title}"?`) && e.deleteThread(e.chatThread.id);
                },
                disabled: !e.chatThread || e.busy,
                children: "Delete"
              }
    ...
    /* @__PURE__ */ u("div", { ref: s, className: "workbench-chat-transcript", onScroll: ce, children: [
      e.chatMessages.length === 0 ? /* @__PURE__ */ a("div", { className: "workbench-chat-empty", children: /* @__PURE__ */ u("div", { children: [
        /* @__PURE__ */ a(qs, { size: 48 }),
        /* @__PURE__ */ u("h3", { children: [
          "Build with ",
          e.selectedChatTarget.label
        ] }),
        /* @__PURE__ */ a("p", { children: e.selectedChatTarget.kind === "atomek-ai" ? "Ask about open files, request a plan, or draft an artifact." : "Chat with the selected pod agent from this same Atomek panel." }),
        ...
        /* @__PURE__ */ a("strong", { children: m.role === "user" ? "You" : m.sourceLabel ?? "Atomek" }),
        m.status === "streaming" ? /* @__PURE__ */ a("em", { children: " streaming" }) : null,
        m.status === "error" ? /* @__PURE__ */ a("em", { children: " error" }) : null,
        /* @__PURE__ */ a("br", {}),
        /* @__PURE__ */ a(Vr, { body: m.body }),
        m.gatewayLabel ? /* @__PURE__ */ u(Ve, { children: [
          /* @__PURE__ */ a("br", {}),
          /* @__PURE__ */ a("small", { children: m.gatewayLabel })
        ] }) : null,
        m.role === "assistant" && m.status !== "streaming" && m.status !== "error" ? /* @__PURE__ */ u("div", { className: "workbench-chat-message-actions", children: [
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action", onClick: () => Te(m), title: "Copy answer", "aria-label": "Copy answer", children: /* @__PURE__ */ a(Mn, { size: 14 }) }),
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action", onClick: () => e.saveMessageAsArtifact(m), title: "Save as output artifact", "aria-label": "Save as output artifact", children: /* @__PURE__ */ a(Kn, { size: 14 }) }),
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action", onClick: () => e.rememberMessage(m), title: "Store in Atomek memory", "aria-label": "Remember", children: /* @__PURE__ */ a(Za, { size: 14 }) }),
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action", onClick: () => e.previewEditFromMessage(m), disabled: e.workspaceFileCount === 0, title: "Preview an editable patch", "aria-label": "Preview patch", children: /* @__PURE__ */ a(Jn, { size: 14 }) }),
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action regen", onClick: () => e.regenerateMessage(m), disabled: e.busy, title: "Regenerate answer", "aria-label": "Regenerate", children: /* @__PURE__ */ a(yt, { size: 14 }) })
        ] }) : null,
        m.role === "assistant" && m.status === "error" ? /* @__PURE__ */ u("div", { className: "workbench-chat-message-actions", children: [
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action", onClick: () => Te(m), title: "Copy error", "aria-label": "Copy error", children: /* @__PURE__ */ a(Mn, { size: 14 }) }),
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action regen", onClick: () => e.regenerateMessage(m), disabled: e.busy, title: "Retry", "aria-label": "Retry", children: /* @__PURE__ */ a(yt, { size: 14 }) })
        ] }) : null
      ] }, m.id)),
      l ? /* @__PURE__ */ a("button", { className: "workbench-chat-jump", onClick: ne, children: "Jump to latest" }) : null
    ] }),
    /* @__PURE__ */ u("div", { className: "workbench-chat-composer", children: [
      /* @__PURE__ */ u("div", { className: "workbench-chat-tip", children: [
        /* @__PURE__ */ a("span", { children: "Target" }),
        ...
        /* @__PURE__ */ a("strong", { children: Ei(e.contextScope) }),
        /* @__PURE__ */ a("em", { children: e.selectedChatTarget.kind === "atomek-ai" ? Ma(e.chatSettings, e.aiStatus.label, e.memoryHitCount) : e.selectedChatTarget.description })
      ] }),
      /* @__PURE__ */ u("div", { className: "workbench-chat-box", children: [
        /* @__PURE__ */ u("div", { className: "workbench-chat-attachments", children: [
          ...
          e.contextScope === "indexed-project" ? /* @__PURE__ */ u(Ve, { children: [
          ...
          e.contextAttachments.length === 0 ? /* @__PURE__ */ u("span", { className: "workbench-chat-chip muted", children: [
            /* @__PURE__ */ a(ya, { size: 13 }),
            " No file context"
          ] }) : e.contextAttachments.map((m) => {
            const F = typeof m.score == "number" ? m.score.toFixed(2) : null, te = typeof m.vectorScore == "number" ? m.vectorScore.toFixed(2) : null, le = typeof m.keywordScore == "number" ? m.keywordScore.toFixed(1) : null, w = [
              m.path,
            ...
            return /* @__PURE__ */ u("span", { className: "workbench-chat-chip", title: w, children: [
              /* @__PURE__ */ a("button", { className: "workbench-chat-chip-open", onClick: () => e.revealContextAttachment(m), disabled: !m.fileId, title: "Reveal context", children: /* @__PURE__ */ a(ya, { size: 13 }) }),
              m.label,
              F ? /* @__PURE__ */ a("small", { children: F }) : null,
              m.snippet ? /* @__PURE__ */ u("small", { children: [
                m.snippet.slice(0, 60),
                m.snippet.length > 60 ? "…" : ""
              ] }) : null,
              m.dirty ? /* @__PURE__ */ a("small", { children: "dirty" }) : null,
              m.removable ? /* @__PURE__ */ a("button", { className: "workbench-chat-chip-remove", onClick: () => e.removeContextAttachment(m), title: "Remove context", children: /* @__PURE__ */ a(Ee, { size: 11 }) }) : null
            ] }, m.id);
          }),
        ...
        /* @__PURE__ */ u("div", { className: "workbench-chat-toolbar atomek-input", children: [
          /* @__PURE__ */ u("details", { ref: p, className: "workbench-chat-attach", children: [
            /* @__PURE__ */ a("summary", { title: "Add context", "aria-label": "Add context", children: /* @__PURE__ */ a(Wn, { size: 16 }) }),
            /* @__PURE__ */ u("div", { className: "workbench-chat-attach-menu", role: "menu", children: [
              /* @__PURE__ */ a("button", { onClick: () => g("active-file"), disabled: !e.activeFile, title: "Use active file as context", children: "Active file" }),
              /* @__PURE__ */ a("button", { onClick: () => g("active-selection"), disabled: !e.activeFile, title: "Use current selection", children: "Selection" }),
              /* @__PURE__ */ a("button", { onClick: () => g("open-editors"), title: "All open editors", children: "Open editors" }),
              /* @__PURE__ */ a("button", { onClick: () => g("indexed-project"), title: "Project-wide retrieval (semantic + keyword)", children: "Indexed project" }),
              /* @__PURE__ */ a("button", { onClick: () => g("none"), title: "No file context", children: "No context" })
            ] })
          ] }),
          H ? /* @__PURE__ */ u("div", { className: "workbench-chat-recording", children: [
            /* @__PURE__ */ a("button", { className: "workbench-chat-recording-cancel", onClick: oe, title: "Cancel recording", "aria-label": "Cancel recording", children: /* @__PURE__ */ a(Ee, { size: 14 }) }),
            /* @__PURE__ */ a("span", { className: "workbench-chat-recording-wave", "aria-hidden": "true", children: Array.from({ length: 14 }).map((m, F) => /* @__PURE__ */ a("span", { style: { animationDelay: `${F * 0.05}s` } }, F)) }),
            /* @__PURE__ */ a("span", { className: "workbench-chat-recording-dot", "aria-hidden": "true" }),
            /* @__PURE__ */ a("span", { className: "workbench-chat-recording-time", children: S(V) })
          ] }) : /* @__PURE__ */ a("span", { className: "workbench-chat-route-summary", children: e.selectedChatTarget.kind === "atomek-ai" ? Ma(e.chatSettings, e.aiStatus.label, e.memoryHitCount) : e.selectedChatTarget.description }),
          /* @__PURE__ */ u("div", { className: "workbench-chat-toolbar-right", children: [
            H ? null : /* @__PURE__ */ a(
              "button",
              {
                ...
                onClick: pe,
                disabled: !I || e.busy,
                title: I ? "Voice input" : "Voice input not supported in this browser",
                "aria-label": "Voice input",
                children: /* @__PURE__ */ a(Js, { size: 16 })
              }
            ),
            /* @__PURE__ */ u("details", { ref: b, className: "workbench-chat-target", children: [
              /* @__PURE__ */ u("summary", { title: "Choose chat target", "aria-label": "Choose chat target", children: [
                /* @__PURE__ */ a("span", { className: "workbench-chat-target-label", children: e.selectedChatTarget.label }),
                /* @__PURE__ */ a(St, { size: 14 })
              ] }),
              /* @__PURE__ */ a("div", { className: "workbench-chat-target-menu", role: "menu", children: e.chatTargets.map((m) => /* @__PURE__ */ u(
                "button",
                {
                  onClick: () => U(m.id),
                  disabled: !m.available,
                  className: m.id === e.selectedChatTarget.id ? "active" : "",
                  title: m.description,
                  children: [
                    /* @__PURE__ */ a("span", { className: "workbench-chat-target-row-label", children: m.label }),
                    m.kind === "pod-agent" && m.status !== "running" ? /* @__PURE__ */ a("small", { children: m.status }) : null
                  ]
                },
                m.id
              )) })
            ] }),
            e.busy ? /* @__PURE__ */ a("button", { className: "workbench-chat-send stop", onClick: e.stopChat, title: "Stop", "aria-label": "Stop", children: /* @__PURE__ */ a(Ba, { size: 14 }) }) : /* @__PURE__ */ a("button", { className: `workbench-chat-send ${r ? "ready" : ""}`, onClick: e.askAgent, title: "Send", disabled: !r, "aria-label": "Send message", children: /* @__PURE__ */ a(Ts, { size: 18 }) })
          ] })
        ] })
      ] })
    ] })
...
function Ma(e, t, n) {
  e.model;
  const s = [e.gatewayPreference === "auto" ? t : Ir(e.gatewayPreference)];
...
function ml({ host: e, appName: t, currentVersion: n }) {
  const r = e.apps, [s, i] = X(null), [o, l] = X(!1), [f, p] = X(null), b = z(async () => {
    if (!r?.checkUpdate) {
    ...
    l(!0), p(null);
    try {
      const C = await r.checkUpdate();
      i(C), C.error && p(C.error);
    } catch (C) {
      p(C instanceof Error ? C.message : String(C));
    } finally {
      l(!1);
    }
  }, [r]);
  ...
  const v = z(async () => {
    ...
    l(!0), p(null);
    try {
      const C = await r.updateSelf();
      i(C), p(C.error ?? `${t} updated. Close and reopen the app to load the new bundle.`);
    } catch (C) {
      p(C instanceof Error ? C.message : String(C));
    } finally {
      l(!1);
    }
  }, [r, t]), P = s?.latestVersion ?? n, H = !!s?.updateAvailable;
  return /* @__PURE__ */ u("div", { className: "workbench-settings-section", children: [
    ...
    /* @__PURE__ */ u("div", { style: { display: "flex", gap: 8, flexWrap: "wrap" }, children: [
      ...
      H ? /* @__PURE__ */ a("button", { className: "workbench-button-primary", onClick: () => void v(), disabled: o, children: o ? "Updating…" : `Update ${t}` }) : null
    ] }),
    /* @__PURE__ */ a("div", { className: "workbench-settings-note", children: f ?? (s ? H ? "Update available." : "You are running the latest available version." : "Checking latest version…") })
  ] });
}
function pl(e) {
  const [t, n] = X([]), [r, s] = X("Loading gateway models…"), [i, o] = X([]), [l, f] = X("Checking embedding capability…");
  se(() => {
    ...
    return (async () => {
      ...
      try {
        const C = await e.host.ai.listModels({
          gatewayPreference: e.chatSettings.gatewayPreference,
          signal: P.signal
        });
        if (P.signal.aborted) return;
        n(C.map((V) => ({ id: V.id, gatewayLabel: V.gatewayLabel }))), s(C.length > 0 ? `${C.length} models discovered from AIL.` : "No models discovered. You can still enter any AIL alias manually.");
      } catch (C) {
        if (P.signal.aborted) return;
        n([]), s(`Model discovery failed: ${C instanceof Error ? C.message : String(C)}`);
      }
    })(), () => P.abort();
  }, [e.chatSettings.gatewayPreference, e.host.ai]), se(() => {
    const P = new AbortController();
    return (async () => {
      const C = oc(e.host);
      if (C) {
      ...
      f("Loading embedding-capable models from AIL…");
      try {
        const V = await ic(e.host, {
          gatewayPreference: e.chatSettings.gatewayPreference,
          signal: P.signal
        });
        if (P.signal.aborted) return;
        o(V.map((Z) => ({ id: Z.id, gatewayLabel: Z.gatewayLabel ?? Z.source ?? "AIL" }))), f(V.length > 0 ? `${V.length} embedding models discovered from AIL metadata.` : "AIL embedding API is present, but no embedding-capable model metadata was returned.");
      } catch (V) {
        if (P.signal.aborted) return;
        o([]), f(`Embedding model discovery failed: ${V instanceof Error ? V.message : String(V)}`);
      }
    })(), () => P.abort();
  }, [e.chatSettings.gatewayPreference, e.host]);
  const p = (P) => {
    e.onChange({ ...e.chatSettings, gatewayPreference: P });
  }, b = (P) => {
    e.onChange({ ...e.chatSettings, model: P });
  }, v = (P) => {
    e.onChange({ ...e.chatSettings, embeddingModel: P });
  };
  return /* @__PURE__ */ a("div", { className: "workbench-settings-tab", children: /* @__PURE__ */ u("section", { className: "workbench-settings-page", "aria-label": "Atomek Settings", children: [
    /* @__PURE__ */ u("header", { className: "workbench-settings-header", children: [
      ...
      /* @__PURE__ */ a("button", { onClick: e.onClose, title: "Close", children: /* @__PURE__ */ a(Ee, { size: 15 }) })
    ] }),
    /* @__PURE__ */ u("div", { className: "workbench-settings-body", children: [
      /* @__PURE__ */ a(ml, { host: e.host, appName: "Atomek", currentVersion: Ha }),
      /* @__PURE__ */ u("div", { className: "workbench-settings-section", children: [
        ...
        /* @__PURE__ */ u("label", { className: "workbench-settings-label", children: [
          ...
          /* @__PURE__ */ a("datalist", { id: "atomek-chat-models", children: t.map((P) => /* @__PURE__ */ a("option", { value: P.id, children: P.gatewayLabel }, `${P.gatewayLabel}:${P.id}`)) })
        ] }),
        /* @__PURE__ */ u("div", { className: "workbench-settings-note", children: [
          "Current request: ",
          Ir(e.chatSettings.gatewayPreference),
      ...
      /* @__PURE__ */ u("div", { className: "workbench-settings-section", children: [
        ...
        /* @__PURE__ */ u("label", { className: "workbench-settings-label", children: [
          ...
          /* @__PURE__ */ a("datalist", { id: "atomek-embedding-models", children: i.map((P) => /* @__PURE__ */ a("option", { value: P.id, children: P.gatewayLabel }, `${P.gatewayLabel}:${P.id}`)) })
        ] }),
    ...
    /* @__PURE__ */ u("footer", { className: "workbench-settings-footer", children: [
      /* @__PURE__ */ a("button", { onClick: () => e.onChange(nn), children: "Reset" }),
      /* @__PURE__ */ a("button", { onClick: e.onClose, children: "Close tab" })
    ] })
  ] }) });
}
function Dr({ outputs: e, clearOutputs: t, deleteArtifact: n, runAiSynthesis: r, captureManualCheck: s, openOutputAsFile: i, previewEditFromOutput: o, canPreviewEdit: l = !1, compact: f = !1 }) {
  return /* @__PURE__ */ u("div", { className: `workbench-panel-list ${f ? "compact" : ""}`, children: [
    ...
    e.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No outputs yet. Save an AI answer as an artifact or create an AI synthesis." }) : e.map((p) => /* @__PURE__ */ u("div", { className: "workbench-output-card", children: [
      /* @__PURE__ */ u("div", { className: "workbench-output-head", children: [
        ...
        /* @__PURE__ */ a("button", { onClick: () => void kt(p.body), children: "Copy" }),
        /* @__PURE__ */ a("button", { onClick: () => i(p), children: "Open as file" }),
        o ? /* @__PURE__ */ a(
          "button",
          {
            className: Wa(p.body) ? "workbench-output-edit-cta" : void 0,
            onClick: () => o(p),
            disabled: !l,
            children: Wa(p.body) ? "Preview/apply edit" : "Preview edit"
          }
        ) : null,
        p.source === "ai" ? /* @__PURE__ */ a("button", { onClick: () => n(p.id), children: "Delete" }) : null
      ] }),
      /* @__PURE__ */ a(Vr, { body: p.body })
    ] }, p.id))
  ] });
}
function bl({ edit: e, onApply: t, onOpenAsFile: n, onClose: r }) {
  return /* @__PURE__ */ a("div", { className: "workbench-edit-review-overlay", role: "dialog", "aria-label": "Review AI edit", children: /* @__PURE__ */ u("section", { className: "workbench-edit-review", children: [
    /* @__PURE__ */ u("header", { className: "workbench-edit-review-head", children: [
      ...
      /* @__PURE__ */ a("button", { title: "Close", onClick: r, children: /* @__PURE__ */ a(Ee, { size: 16 }) })
    ] }),
...
function vl({ patch: e, onApply: t, onOpenAsFiles: n, onClose: r }) {
  ...
  return /* @__PURE__ */ a("div", { className: "workbench-edit-review-overlay", role: "dialog", "aria-label": "Review AI workspace patch", children: /* @__PURE__ */ u("section", { className: "workbench-edit-review workspace", children: [
    ...
    /* @__PURE__ */ u("div", { className: "workbench-workspace-patch-list", children: [
      e.edits.map((i) => /* @__PURE__ */ u("article", { className: "workbench-workspace-patch-card", children: [
        ...
        /* @__PURE__ */ a("pre", { children: zl(i.proposedContent) })
      ] }, i.fileId)),
...
function gl(e, t) {
  ...
  if (e)
    n.push("", `Active file: ${e.path}`, `Language: ${e.language}`, `Dirty: ${e.dirty ? "yes" : "no"}`, "", "Active file content:", "```" + e.language, yl(e.content), "```");
  else if (t.length > 0) {
...
function Pl(e) {
  const n = e.data?.find((r) => typeof r.id == "string" && r.id.trim());
  return typeof n?.id == "string" ? n.id : null;
}
function xl(e) {
  const n = e.choices?.[0], r = n?.message?.content ?? n?.text ?? n?.delta?.content;
  return typeof r == "string" ? r : Array.isArray(r) ? r.map((s) => typeof s == "string" ? s : s && typeof s == "object" && "text" in s && typeof s.text == "string" ? s.text : "").join("") : JSON.stringify(e, null, 2);
}
function Fr({
  host: e,
  setStatus: t,
  ...
  const [l, f] = X([]), [p, b] = X([]), [v, P] = X(null), [H, C] = X(!1), [V, Z] = X(null), [I, oe] = X("Review the active Atomek context. Return concise findings. If you propose edits, output a unified diff or fenced replacement blocks so Atomek can preview before applying."), [pe, S] = X(null), [B, J] = X([]), [g, U] = X(() => Zc()), [q, ce] = X([]), [ne, Te] = X([]), [Le, Ae] = X([]), m = Xe([]), [F, te] = X("task-execute"), [le, w] = X("mission"), W = B.find((d) => d.status === "running" || d.status === "canceling") ?? B[0] ?? null, T = o === "dock", A = fe(() => xt(v, ot(I || g?.goal || "", v, g?.teamPresetId)), [I, g?.goal, g?.teamPresetId, v]), D = fe(() => jt(I || g?.goal || "", v, A.id), [I, g?.goal, A.id, v]), L = D.find((d) => d.id === F) ?? D[1] ?? D[0] ?? null, ae = i.filter((d) => d.dirty).length, ue = s ? `${s.path} · ${s.language} · ${s.content.length.toLocaleString()} chars${s.dirty ? " · dirty" : ""}` : i.length > 0 ? `${i.length} open editor${i.length === 1 ? "" : "s"}${ae ? ` · ${ae} dirty` : ""}` : "No active file — jobs run with only your typed prompt.", be = fe(() => [
    {
  ...
  const ye = z(async (d = g) => {
    if (!d?.rootPath || !e.missions?.listRuns)
      return Ae([]), [];
    try {
      const k = await e.missions.listRuns(d.rootPath);
      return Ae(k), m.current = k, k;
    } catch (k) {
      return t(`Mission run history failed: ${k instanceof Error ? k.message : String(k)}`), [];
    }
  }, [e.missions, g, t]), He = z(async (d, k) => {
    if (!d) return;
    const x = [...k].sort((j, K) => ja(K).localeCompare(ja(j))).slice(0, 100), O = x.map((j) => JSON.stringify(j)).join(`
`) + (x.length ? `
` : "");
    d.rootPath && e.missions?.write ? await e.missions.write({ rootPath: d.rootPath, files: [{ path: "RUNS.jsonl", content: O }] }) : d.handle && await Rn(d.handle, "RUNS.jsonl", O), Ae(x), m.current = x;
  }, [e.missions]), je = z(async (d, k = g) => {
    if (!k) return;
    const x = [
      d,
      ...m.current.filter((O) => O.id !== d.id)
    ];
    await He(k, x);
  }, [g, He]), qe = z(async () => {
    if (!e.local?.listTools && !e.skills?.list && !e.resources?.list) {
      f([]), b([]), P(null), Z("This Tytus host build does not expose local tools, resource graph, or skill registry yet.");
      return;
    }
    C(!0), Z(null);
    try {
      const [d, k, x, O] = await Promise.all([
        e.local?.listTools?.().catch((j) => (t(`Local tool discovery failed: ${j instanceof Error ? j.message : String(j)}`), [])) ?? Promise.resolve([]),
        e.skills?.list?.().catch((j) => (t(`Skill registry discovery failed: ${j instanceof Error ? j.message : String(j)}`), [])) ?? Promise.resolve([]),
        e.resources?.list?.().catch((j) => (t(`Resource graph discovery failed: ${j instanceof Error ? j.message : String(j)}`), null)) ?? Promise.resolve(null),
        e.missions?.list?.().catch((j) => (t(`Mission list failed: ${j instanceof Error ? j.message : String(j)}`), [])) ?? Promise.resolve([])
      ]);
      f(d), b(k), P(x), ce(O), g?.rootPath && ye(g), t(`Agent team loaded · ${d.length} tools · ${k.length} skills · ${O.length} missions${x ? ` · ${x.resources.length} resources` : ""}`);
    } catch (d) {
      Z(d instanceof Error ? d.message : String(d));
    } finally {
      C(!1);
    }
  }, [e.local, e.missions, e.resources, e.skills, ye, g, t]);
  se(() => {
    qe();
  }, [qe]), se(() => {
    const d = (k) => {
      const x = k.detail;
      x?.missionId && (U(x), ye(x)), qe();
    };
    return window.addEventListener(Fn, d), () => window.removeEventListener(Fn, d);
  }, [qe, ye]);
  const tt = z((d) => {
    const k = Kc(d);
    U(k), Ct(k), ye(k), Te([{
      ts: (/* @__PURE__ */ new Date()).toISOString(),
      kind: "mission.resume",
      message: `Mission resumed from Atomek agent team: ${k.rootPath ?? k.name}`,
      data: { runCount: d.runCount ?? 0, taskCount: d.taskCount ?? 0 }
    }]), oe(d.goal || `Continue mission ${d.title}. Review MISSION.md, TASKS.md, RESOURCES.md, and runs/ before acting.`), t(`Resumed mission: ${d.rootPath}`);
  }, [ye, t]), Pe = z(async (d, k, x = []) => {
    const O = [
      ...ne,
      ...x,
      { ts: (/* @__PURE__ */ new Date()).toISOString(), kind: "mission.pack.write", message: "Mission context pack written from Atomek" }
    ], j = ot(k || d.goal, v, d.teamPresetId), K = jt(k || d.goal, v, j), ee = [
      { path: "MISSION.md", content: an(d, v, s, i, k, j) },
      { path: "MISSION.json", content: jr(d, v, k, j) },
      { path: "RESOURCES.md", content: rn(v) },
      { path: "TASKS.md", content: Sr(K) },
      { path: "HANDOFF.md", content: Hr(d) },
      { path: "INBOX.md", content: `# Mission inbox
...
Approved handoffs, final artifacts, and user-ready summaries go here.
` },
      { path: "AUDIT.jsonl", content: O.map((Q) => JSON.stringify(Q)).join(`
`) + `
` },
      { path: "RUNS.jsonl", content: m.current.map((Q) => JSON.stringify(Q)).join(`
`) + (m.current.length ? `
` : "") },
      { path: "runs/README.md", content: `# Mission runs
...
` }
    ...
    if (d.rootPath && e.missions?.write)
      await e.missions.write({ rootPath: d.rootPath, files: ee });
    else if (d.handle) {
      await bt(d.handle, "runs"), await bt(d.handle, "outputs"), await bt(d.handle, "proposals"), await bt(d.handle, "approvals");
      for (const Q of ee) await Fc(d.handle, Q.path, Q.content);
    } else
      throw new Error("Mission has neither tray rootPath nor browser folder handle");
    Te(O), Ct(d);
  }, [s, e.missions, ne, i, v]), ge = z(async (d, k = {}) => {
    if (g)
      return await Pe(g, d), g;
    const x = `Atomek mission ${(/* @__PURE__ */ new Date()).toLocaleString()}`, O = d.trim() || "Coordinate Tytus resources for the current Atomek task.";
    let j = null;
    if (e.missions?.create) {
      const ee = await e.missions.create({ title: x, goal: O });
      j = {
        missionId: ee.missionId,
        title: ee.title,
        goal: ee.goal,
        rootPath: ee.rootPath,
        name: ee.rootPath.split("/").pop() || ee.missionId,
        source: "tray"
      };
    } else if (k.allowBrowserPicker) {
      const ee = await Dc();
      if (!ee)
      ...
      j = {
        handle: ee,
        name: ee.name,
        missionId: `mission-${Date.now()}-${Jc(ee.name)}`,
        title: x,
        goal: O,
        source: "browser"
      };
    ...
    if (!j) return null;
    const K = { ts: (/* @__PURE__ */ new Date()).toISOString(), kind: "mission.folder.ready", message: `Mission folder ready: ${j.rootPath ?? j.name}` };
    return U(j), Ct(j), Te([K]), await Pe(j, O, [K]), t(`Mission pack ready in ${j.rootPath ?? j.name}`), j;
  }, [e.missions, g, t, Pe]), Ze = z(async (d) => {
    if (!e.local?.openTerminal) {
      t("Terminal bridge unavailable in this host build");
      return;
    }
    try {
      const k = I.trim() || `Open ${d.label} from Atomek with current context.`, x = d.kind === "ai-cli" ? await ge(k) : g;
      await e.local.openTerminal({
        toolId: d.id,
        command: d.command,
        cwd: x?.rootPath ?? Va(s),
        prompt: x ? `Atomek mission pack ready at ${x.rootPath ?? x.name}. Read MISSION.md and RESOURCES.md. ${ue}` : `Opened from Atomek. ${ue}`
      }), t(d.kind === "ai-cli" ? `Started ${d.label} in a fresh Tytus Terminal with mission context.` : "Opened Tytus Terminal");
    } catch (k) {
      t(`Terminal launch failed: ${k instanceof Error ? k.message : String(k)}`);
    }
  }, [s, ue, ge, e.local, I, g, t]), re = z(async () => {
    try {
      await ge(I.trim(), { allowBrowserPicker: !0 }) || t("Mission folder setup skipped.");
    } catch (d) {
      t(`Mission folder setup failed: ${d instanceof Error ? d.message : String(d)}`);
    }
  }, [ge, I, t]), Y = z(async (d, k, x, O = g, j) => {
    if (!O) return;
    const K = (/* @__PURE__ */ new Date()).toISOString().replace(/[:.]/g, "-"), ee = j ?? `runs/${K}-${d.id}.md`, Q = ee.split("/").pop() || `${K}-${d.id}.md`;
    if (O.rootPath && e.missions?.write)
      await e.missions.write({ rootPath: O.rootPath, files: [{ path: ee, content: k }] });
    else if (O.handle) {
      const xe = await bt(O.handle, "runs");
      await Rn(xe, Q, k);
    }
    await Pe(O, I, [{
      ts: (/* @__PURE__ */ new Date()).toISOString(),
      kind: "local-cli.run.complete",
      message: `${d.label} exited ${x}; transcript saved to ${ee}`,
      data: { toolId: d.id, exitCode: x, transcript: ee }
    }]);
  }, [e.missions, I, g, Pe]), de = z(async (d) => {
    ...
    let x = null;
    try {
      x = await ge(k), x && await Pe(x, k, [{
        ts: (/* @__PURE__ */ new Date()).toISOString(),
        kind: "local-cli.run.start",
        message: `${d.label} background review started`,
        data: { toolId: d.id, taskId: L?.id ?? "manual", taskTitle: L?.title ?? "Manual run" }
      }]);
    } catch (K) {
      t(`Mission pack failed before local job start: ${K instanceof Error ? K.message : String(K)}`);
      return;
    }
    S(d.id);
    const O = `local-run-${Date.now()}-${d.id}`, j = mt();
    J((K) => [{
      id: O,
      toolId: d.id,
      label: d.label,
      ...
      startedAt: Date.now(),
      taskId: L?.id ?? "manual",
      taskTitle: L?.title ?? "Manual run",
      lines: [`[Atomek] Starting ${d.label} local job for ${L?.title ?? "manual run"}…`]
    }, ...K].slice(0, 6));
    try {
      const K = await e.local.runJob({
        toolId: d.id,
        prompt: x ? [
          "Tytus mission context pack is active.",
          `Mission: ${x.title}`,
          `Goal: ${x.goal}`,
          x.rootPath ? `Mission folder: ${x.rootPath}` : `Mission folder: ${x.name}`,
...
`)
      }), ee = K.transcriptPath ?? (x?.rootPath ? `runs/${(/* @__PURE__ */ new Date()).toISOString().replace(/[:.]/g, "-")}-${d.id}.md` : void 0), Q = [
        `[Atomek] Started ${d.label} local job ${K.id}`,
        L ? `[Atomek] Task: ${L.title} (${L.id})` : "[Atomek] Task: manual",
        x?.rootPath ? `[Atomek] Mission: ${x.rootPath}` : ""
      ].filter(Boolean), xe = {
        id: O,
        jobId: K.id,
        toolId: d.id,
        ...
        taskTitle: L?.title ?? "Manual run",
        transcriptPath: ee,
        summary: `Started ${d.label} for ${L?.title ?? "manual run"}`
      };
      je(xe, x).catch(($) => {
        t(`Mission run index failed: ${$ instanceof Error ? $.message : String($)}`);
      }), J(($) => $.map((R) => R.id === O ? { ...R, jobId: K.id, transcriptPath: ee } : R));
      const Ue = ($) => {
        J((R) => R.map((me) => me.id === O ? $(me) : me));
      };
      e.local.streamJob(K.id, {
        onLog: ($) => {
          Q.push($), Ue((R) => ({ ...R, lines: Q.slice(-500) }));
        },
        onDone: ($) => {
          $ && (Q.push($), Ue((R) => ({ ...R, lines: Q.slice(-500) })));
        },
        onFail: ($) => {
          Q.push(`[FAIL] ${$}`), Ue((R) => ({
            ...
            t(`Mission run index failed: ${R instanceof Error ? R.message : String(R)}`);
          }), r(`${d.label} local job failed`, Q.join(`
`)), Y(d, Q.join(`
`), -1, x, ee).catch((R) => {
            t(`Mission transcript save failed: ${R instanceof Error ? R.message : String(R)}`);
          }), S(null);
        },
        onExit: ($) => {
          const R = [
...
`);
          Ue((me) => ({
            ...
            finishedAt: mt(),
            exitCode: $,
            summary: `${d.label} exited ${$}`
          }, x).catch((me) => {
            t(`Mission run index failed: ${me instanceof Error ? me.message : String(me)}`);
          }), r(`${d.label} local job`, R), Y(d, R, $, x, ee).catch((me) => {
            t(`Mission transcript save failed: ${me instanceof Error ? me.message : String(me)}`);
          }), S(null);
        },
        onError: () => t(`Local job stream issue for ${d.label}`)
      }), t(`Started ${d.label} mission run${L ? ` · ${L.title}` : ""}`);
    } catch (K) {
      S(null), J((ee) => ee.map((Q) => Q.id === O ? {
        ...Q,
        status: "failed",
        finishedAt: Date.now(),
        lines: [...Q.lines, `[Atomek] Failed to start: ${K instanceof Error ? K.message : String(K)}`]
      } : Q)), t(`Local job failed to start: ${K instanceof Error ? K.message : String(K)}`);
    }
  }, [s, ge, e.local, I, i, v, r, Y, L, t, je, Pe]), he = z(async (d) => {
    const k = En(d);
    if (!k) {
      t(`Cannot dispatch ${Se(d)}: missing pod id`);
      return;
    }
    const x = I.trim();
    if (!x) {
    ...
    let O = null;
    const j = Se(d), K = `pod-run-${Date.now()}-${k}`, ee = mt(), Q = `runs/${(/* @__PURE__ */ new Date()).toISOString().replace(/[:.]/g, "-")}-${d.id.replace(/[^a-z0-9_.-]/gi, "-")}.md`;
    try {
      O = await ge(x), O && await Pe(O, x, [{
        ts: (/* @__PURE__ */ new Date()).toISOString(),
        kind: "pod-agent.run.start",
        message: `${j} mission task started`,
        data: { resourceId: d.id, podId: k, taskId: L?.id ?? "manual", taskTitle: L?.title ?? "Manual pod run" }
      }]);
    } catch (R) {
      t(`Mission pack failed before pod task: ${R instanceof Error ? R.message : String(R)}`);
      return;
    }
    const xe = {
      id: K,
      ...
      startedAt: ee,
      taskId: L?.id ?? "manual",
      taskTitle: L?.title ?? "Manual pod run",
      transcriptPath: Q,
      summary: `Started ${j} for ${L?.title ?? "manual pod run"}`
    };
    J((R) => [{
      id: K,
      toolId: d.id,
      ...
      taskTitle: L?.title ?? "Manual pod run",
      transcriptPath: Q,
      lines: [`[Atomek] Dispatching ${j} via Tytus host bridge…`, `[Atomek] Pod: ${k}`, `[Atomek] Task: ${L?.title ?? "manual pod run"}`]
    }, ...R].slice(0, 6)), await je(xe, O).catch((R) => {
      t(`Mission run index failed: ${R instanceof Error ? R.message : String(R)}`);
    });
    const Ue = [], $ = (R) => {
      Ue.push(R), J((me) => me.map((Oe) => Oe.id === K ? { ...Oe, lines: [...Oe.lines, R].slice(-500) } : Oe));
    };
    try {
      const R = await e.daemon.callPodEndpoint(k, "/v1/models", { method: "GET" });
      if (!R.ok)
        throw new Error(`/v1/models ${R.status}: ${await R.text()}`);
      const me = await R.json(), Oe = Pl(me);
      if (!Oe)
        throw new Error("pod /v1/models returned no model id");
      $(`[Atomek] Selected pod model from live metadata: ${Oe}`);
      const Ne = await e.daemon.callPodEndpoint(k, "/v1/chat/completions", {
        method: "POST",
...
`)
            },
            {
              role: "user",
              content: [
                O ? `Mission folder: ${O.rootPath ?? O.name}` : "Mission folder: not available",
                O ? `Mission: ${O.title}` : "",
                O ? `Goal: ${O.goal}` : "",
                L ? `Task: ${L.title} (${L.id})` : "Task: manual",
                "",
                "Mission context:",
                O ? an(O, v, s, i, x) : "",
                v ? rn(v) : "",
...
`)
      ...
      if (!Ne.ok)
        throw new Error(`/v1/chat/completions ${Ne.status}: ${Ce}`);
      let Fe = Ce;
      try {
        Fe = JSON.parse(Ce);
      } catch {
      }
      const ct = typeof Fe == "string" ? Fe : xl(Fe);
      $(ct);
      const lt = [
        `# Pod job — ${j}`,
        "",
        ...
        `- Pod: ${k}`,
        `- Captured: ${(/* @__PURE__ */ new Date()).toISOString()}`,
        `- Task: ${L?.title ?? "Manual pod run"}`,
        "",
        ct,
        ""
      ].join(`
`);
      J((Nt) => Nt.map((Qe) => Qe.id === K ? { ...Qe, status: "complete", finishedAt: Date.now(), lines: [...Qe.lines, "[Atomek] Pod task complete."].slice(-500) } : Qe)), await je({ ...xe, status: "complete", finishedAt: mt(), summary: `${j} completed`, transcriptPath: Q }, O), r(`${j} pod job`, lt), await Y({ id: d.id, label: j, kind: "pod-agent", status: d.status }, lt, 0, O, Q), t(`${j} completed mission task`);
    } catch (R) {
      const me = R instanceof Error ? R.message : String(R);
      $(`[FAIL] ${me}`), J((Ne) => Ne.map((Ce) => Ce.id === K ? { ...Ce, status: "failed", finishedAt: Date.now(), lines: Ce.lines.slice(-500) } : Ce)), await je({ ...xe, status: "failed", finishedAt: mt(), exitCode: -1, summary: me, transcriptPath: Q }, O).catch((Ne) => {
        t(`Mission run index failed: ${Ne instanceof Error ? Ne.message : String(Ne)}`);
      });
      const Oe = [`# Pod job failed — ${j}`, "", `- Pod: ${k}`, `- Error: ${me}`, "", "```text", Ue.join(`
`), "```", ""].join(`
`);
      r(`${j} pod job failed`, Oe), await Y({ id: d.id, label: j, kind: "pod-agent", status: d.status }, Oe, -1, O, Q).catch((Ne) => {
        t(`Pod transcript save failed: ${Ne instanceof Error ? Ne.message : String(Ne)}`);
      }), t(`Pod task failed: ${me}`);
    }
  }, [s, ge, e.daemon, I, i, v, r, Y, L, t, je, Pe]), ke = z(async (d) => {
    if (!d.jobId || !e.local?.cancelJob) {
      t("Local job cancel bridge unavailable in this host build");
      return;
    }
    J((k) => k.map((x) => x.id === d.id ? { ...x, status: "canceling", lines: [...x.lines, "[Atomek] Cancel requested…"] } : x)), je({
      id: d.id,
      jobId: d.jobId,
      toolId: d.toolId,
      label: d.label,
      ...
      t(`Mission run index failed: ${k instanceof Error ? k.message : String(k)}`);
    });
    try {
      await e.local.cancelJob(d.jobId), t(`Cancel requested for ${d.label}`);
    } catch (k) {
      J((x) => x.map((O) => O.id === d.id ? { ...O, status: "running", lines: [...O.lines, `[Atomek] Cancel failed: ${k instanceof Error ? k.message : String(k)}`] } : O)), t(`Local job cancel failed: ${k instanceof Error ? k.message : String(k)}`);
    }
  }, [e.local, t, je]), De = z(async (d) => {
    const k = [
      `Use Tytus resource "${Se(d)}" (${d.kind}) for the next mission step.`,
...
`);
    oe(k), g && await Pe(g, k, [{
      ...
      message: `Selected resource ${Se(d)}`,
      data: { resourceId: d.id, kind: d.kind, status: d.status }
    }]), t(`Selected ${Se(d)} for mission`);
  }, [g, t, Pe]), Ke = z((d) => {
    const k = d.setupAction, x = k?.commandPreview ? `${k.label}: ${k.commandPreview}` : k?.deepLink ? `${k.label}: ${k.deepLink}` : k?.label ?? `${Se(d)} needs setup`;
    t(x), kt(k?.commandPreview ?? k?.deepLink ?? x);
  }, [t]);
  return /* @__PURE__ */ u("aside", { className: T ? "workbench-agent-dock" : "workbench-sidebar", children: [
    T ? null : /* @__PURE__ */ a("div", { className: "workbench-sidebar-title", children: "AGENT TEAM" }),
    /* @__PURE__ */ u("div", { className: T ? "workbench-agent-dock-scroll" : "workbench-sidebar-scroll", children: [
      /* @__PURE__ */ u("div", { className: "workbench-computer-hero", children: [
        /* @__PURE__ */ a(Yn, { size: 18 }),
        /* @__PURE__ */ u("div", { children: [
          /* @__PURE__ */ a("strong", { children: T ? "Mission Runs" : "OpenClaw + Hermes Team Board" }),
      ...
      /* @__PURE__ */ u("button", { className: "workbench-button-subtle workbench-computer-refresh", onClick: () => {
        ...
        /* @__PURE__ */ a(yt, { size: 14 }),
        " ",
        H ? "Refreshing…" : "Refresh capabilities"
      ] }),
      V && /* @__PURE__ */ a("div", { className: "workbench-inline-error", children: V }),
      /* @__PURE__ */ u("div", { className: "workbench-team-switcher", role: "tablist", "aria-label": "Atomek agent team views", children: [
        /* @__PURE__ */ a("button", { className: le === "mission" ? "active" : "", onClick: () => w("mission"), children: "Mission" }),
        /* @__PURE__ */ a("button", { className: le === "runs" ? "active" : "", onClick: () => w("runs"), children: "Runs" }),
        /* @__PURE__ */ a("button", { className: le === "setup" ? "active" : "", onClick: () => w("setup"), children: "Setup" })
      ] }),
      le === "mission" ? /* @__PURE__ */ u(Ve, { children: [
        ...
        /* @__PURE__ */ u("div", { className: "workbench-computer-context-card mission", children: [
          /* @__PURE__ */ a("strong", { children: g ? g.title : "No mission folder selected" }),
          /* @__PURE__ */ a("span", { children: g ? `${g.rootPath ?? g.name} · ${g.source} · ${ne.length} audit events · transcripts saved under runs/` : "Atomek creates this automatically before launching local agents. It is the shared folder agents read/write transcripts from." }),
        ...
        /* @__PURE__ */ u("div", { className: "workbench-team-assignment-list", children: [
          /* @__PURE__ */ u("div", { className: `workbench-team-assignment-summary ${A.readiness}`, children: [
            /* @__PURE__ */ a("strong", { children: A.label }),
            /* @__PURE__ */ u("span", { children: [
              A.readiness,
              " · ",
              A.bestFor
          ...
          A.assignments.map((d) => /* @__PURE__ */ u("div", { className: "workbench-team-assignment-row", children: [
            /* @__PURE__ */ u("div", { children: [
        ...
        /* @__PURE__ */ u("div", { className: "workbench-computer-actions", children: [
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle workbench-agent-primary-action", onClick: () => {
            re();
          }, children: g ? "Refresh mission pack" : "Start mission pack" }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => g && void Pe(g, I), disabled: !g, children: "Rewrite context files" })
        ] }),
        q.length ? /* @__PURE__ */ u(Ve, { children: [
          /* @__PURE__ */ a("div", { className: "workbench-section-title", children: "RESUME MISSION" }),
          /* @__PURE__ */ a("div", { className: "workbench-mission-list", children: q.slice(0, T ? 3 : 5).map((d) => /* @__PURE__ */ u(
            "button",
            {
              className: `workbench-mission-row ${g?.missionId === d.missionId ? "active" : ""}`,
              onClick: () => tt(d),
              title: d.rootPath,
              children: [
        ...
        /* @__PURE__ */ a("div", { className: "workbench-computer-presets", children: be.map((d) => /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => oe(d.prompt), children: d.label }, d.label)) }),
        /* @__PURE__ */ a(
          "textarea",
          {
        ...
        /* @__PURE__ */ a("div", { className: "workbench-task-graph", children: D.map((d, k) => /* @__PURE__ */ u(
          "button",
          {
            className: `workbench-task-card ${d.status} ${L?.id === d.id ? "active" : ""}`,
            onClick: () => {
              te(d.id), oe(d.prompt);
            },
            title: "Load this task prompt",
            children: [
              /* @__PURE__ */ a("span", { children: k + 1 }),
              /* @__PURE__ */ a("strong", { children: d.title }),
      ...
      le === "runs" ? /* @__PURE__ */ u(Ve, { children: [
        W ? /* @__PURE__ */ u("div", { className: "workbench-agent-run", children: [
          /* @__PURE__ */ u("header", { children: [
            /* @__PURE__ */ u("div", { children: [
              ...
              W.transcriptPath ? /* @__PURE__ */ a("span", { children: W.transcriptPath }) : null
            ] }),
            /* @__PURE__ */ u("div", { className: "workbench-agent-run-actions", children: [
              /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => r(`${W.label} local job`, W.lines.join(`
`)), disabled: W.lines.length === 0, children: "Save output" }),
              W.jobId && (W.status === "running" || W.status === "canceling") ? /* @__PURE__ */ u("button", { className: "workbench-button-subtle danger", onClick: () => {
                ...
                /* @__PURE__ */ a(Ba, { size: 12 }),
                " ",
                W.status === "canceling" ? "Canceling…" : "Cancel"
              ] }) : null
            ] })
          ] }),
          /* @__PURE__ */ a("pre", { className: "workbench-computer-job-log", children: W.lines.join(`
`) || "[waiting for output]" })
        ] }) : null,
        Le.length ? /* @__PURE__ */ u(Ve, { children: [
          /* @__PURE__ */ a("div", { className: "workbench-section-title", children: "RUN HISTORY" }),
          /* @__PURE__ */ a("div", { className: "workbench-run-history", children: Le.slice(0, T ? 4 : 8).map((d) => /* @__PURE__ */ u("div", { className: "workbench-run-history-row", children: [
            /* @__PURE__ */ u("div", { children: [
            ...
            /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => void kt(d.transcriptPath ?? d.id), title: "Copy transcript path or run id", children: "Copy path" })
          ] }, d.id)) })
        ] }) : null
      ] }) : null,
      le === "setup" ? /* @__PURE__ */ u(Ve, { children: [
        ...
        /* @__PURE__ */ u("div", { className: "workbench-computer-list compact", children: [
          !v && !H ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No resource graph reported yet. Older Tytus host builds need `/api/resources`." }) : null,
          v?.resources.slice(0, T ? 8 : 5).map((d) => /* @__PURE__ */ u("div", { className: "workbench-resource-row", children: [
            /* @__PURE__ */ u("div", { children: [
              /* @__PURE__ */ a("strong", { children: Se(d) }),
              /* @__PURE__ */ a("span", { children: ra(d) })
            ] }),
            /* @__PURE__ */ u("div", { className: "workbench-resource-row-actions", children: [
              ...
              d.kind === "pod-agent" && En(d) ? /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => {
                he(d);
              }, children: "Ask pod" }) : null,
              d.status === "needs-setup" || d.setupAction ? /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => Ke(d), children: "Setup" }) : null
            ] })
          ] }, d.id))
        ] }),
        ...
        /* @__PURE__ */ u("div", { className: "workbench-computer-list", children: [
          l.length === 0 && !H ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No local tools reported yet." }) : null,
          l.map((d) => /* @__PURE__ */ u("div", { className: "workbench-computer-card", children: [
            ...
            /* @__PURE__ */ u("div", { className: "workbench-computer-actions", children: [
              /* @__PURE__ */ a("button", { className: "workbench-button-subtle workbench-agent-primary-action", onClick: () => {
                Ze(d);
              }, disabled: d.status !== "available", title: "Launch this tool in a fresh Tytus Terminal with mission context and execute it immediately.", children: wl(d) }),
              d.kind === "ai-cli" ? /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => {
                de(d);
              }, disabled: d.status !== "available" || pe !== null, title: "Run this local agent as a background read-only review inside Atomek and stream output here. It cannot write files directly.", children: kl(d, pe) }) : null
            ] })
          ] }, d.id))
        ] }),
        /* @__PURE__ */ a("div", { className: "workbench-section-title", children: "AGENTIC APP SKILLS" }),
        /* @__PURE__ */ u("div", { className: "workbench-computer-list", children: [
          p.length === 0 && !H ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No skills reported yet." }) : null,
          p.map((d) => /* @__PURE__ */ u("div", { className: "workbench-computer-card", children: [
            ...
            d.triggers?.length ? /* @__PURE__ */ a("div", { className: "workbench-computer-triggers", children: d.triggers.slice(0, 4).map((k) => /* @__PURE__ */ a("span", { children: k }, k)) }) : null,
            /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => {
              n(d);
...
function Nl({ status: e, file: t, cursor: n, fileCount: r, dirtyCount: s }) {
  return /* @__PURE__ */ u("footer", { className: "workbench-statusbar", children: [
    ...
    /* @__PURE__ */ a("span", { children: Qa(t.language) })
  ] });
}
function Cn(e, t) {
...
function Ll(...e) {
  ...
  for (const n of e.flatMap(Rr)) {
    const r = `${n.kind ?? "file"}:${n.handleKey ?? n.path}`, s = t.get(r);
    (!s || n.at >= s.at) && t.set(r, n);
  }
...
function Cl(e) {
  ...
  return e.slice(0, 160).map((r) => {
    const i = t + r.content.length <= n ? r.content : "";
    return t += i.length, {
      id: r.id,
      name: r.name,
      path: r.path,
...
function Hl(e, t) {
  ...
  return t.map((r) => {
    const s = n.get(r.id);
    return s && s.dirty ? { ...r, content: s.content, dirty: !0 } : r;
  });
}
function jl() {
  const e = {
...
function Ml() {
  try {
    ...
    const t = JSON.parse(e);
    return {
      gatewayPreference: t.gatewayPreference === "remote" || t.gatewayPreference === "local" || t.gatewayPreference === "auto" ? t.gatewayPreference : nn.gatewayPreference,
...
function Wl({ host: e }) {
  return /* @__PURE__ */ a(Uc, { host: e });
}
function Fl(e) {
  return function() {
    return /* @__PURE__ */ a(Wl, { host: e.host });
  };
}
export {
  Fl as default
