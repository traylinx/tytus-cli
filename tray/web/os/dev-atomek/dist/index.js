 ...
 */
const As = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), Ls = (e) => e.replace(
  /^([A-Z])|[\s-_]+(\w)/g,
  (t, n, r) => r ? r.toUpperCase() : n.toLowerCase()
), La = (e) => {
  const t = Ls(e);
  return t.charAt(0).toUpperCase() + t.slice(1);
}, Qa = (...e) => e.filter((t, n, r) => !!t && t.trim() !== "" && r.indexOf(t) === n).join(" ").trim(), Xs = (e) => {
  for (const t in e)
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const Vs = [["path", { d: "M20 6 9 17l-5-5", key: "1gmf2c" }]], Is = ye("check", Vs);
/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const Fs = [["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]], Xt = ye("chevron-down", Fs);
/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const pi = /* @__PURE__ */ new Set([".git", "node_modules", "dist", "build", ".next", ".turbo", "coverage", ".cache"]);
function bi() {
  const e = ca();
  return !!(e?.showOpenFilePicker && e.showDirectoryPicker);
}
async function vi() {
  const e = ca()?.showOpenFilePicker;
  if (!e) return ir(!1);
  const t = await e({ multiple: !0 }), n = await Promise.all(t.map((r) => la(r, r.name, "local-file")));
  return Jt(n.filter(Boolean));
}
async function yi() {
  const e = ca()?.showDirectoryPicker;
  if (!e)
    return { name: "Browser fallback folder", files: await ir(!0) };
  const t = await e({ mode: "readwrite" }), n = [];
  return await da(t, t.name, n, 0, 320), { name: t.name, handle: t, files: Jt(n) };
}
async function gi(e) {
  const t = await Promise.all(e.map((n) => la(n, n.name, "local-file")));
  return Jt(t.filter(Boolean));
}
async function Oa(e) {
  const t = [];
  return await da(e, e.name, t, 0, 320), { name: e.name, handle: e, files: Jt(t) };
}
async function Sn(e, t = "readwrite") {
  try {
...
async function da(e, t, n, r, i) {
  if (!(n.length >= i || r > 8))
    for await (const s of e.values()) {
      if (n.length >= i) break;
      if (s.kind === "directory") {
        if (pi.has(s.name)) continue;
        await da(s, `${t}/${s.name}`, n, r + 1, i);
        continue;
      }
      const o = s, l = await la(o, `${t}/${o.name}`, "local-folder");
      l && n.push(l);
    }
}
function ir(e) {
...
`).map(
    ...
    const s = r.split("|").filter(Boolean).map((l) => `<th style="padding:8px 12px;background:var(--bg-titlebar);font-weight:600;font-size:13px;border:1px solid var(--border-default)">${l.trim()}</th>`).join(""), o = i.trim().split(`
`).map((l) => `<tr>${l.split("|").filter(Boolean).map(
      (p, b) => `<td style="padding:8px 12px;border:1px solid var(--border-default);font-size:13px;background:${b % 2 === 0 ? "transparent" : "var(--bg-hover)"};color:var(--text-primary)">${p.trim()}</td>`
    ).join("")}</tr>`).join("");
...
function Pi(e) {
  return ft(e, "routeId") || ft(e, "route_id") || null;
}
function Ot(e) {
  const t = [
    ft(e, "agentFamily"),
    ft(e, "agentType"),
    ft(e, "internalAgentType"),
    ft(e, "brand"),
    e.label
  ].join(" ").toLowerCase();
...
function Ni(e) {
  const t = e?.resources ?? [], n = (l) => l.status === "ready" || l.status === "available", r = t.filter((l) => l.kind === "pod-agent" && Ot(l) === "openclaw"), i = t.filter((l) => l.kind === "pod-agent" && Ot(l) === "hermes"), s = t.filter((l) => l.kind === "local-cli" && n(l)), o = t.filter((l) => l.kind === "shared-folder" && n(l));
  return [
...
function ct(e, t, n) {
  return gt(e, (r) => {
    ...
    return n.some((s) => {
      ...
      if (o.length <= 4) {
        const l = o.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        return new RegExp(`(^|[^a-z0-9])${l}([^a-z0-9]|$)`).test(i);
      }
      return i.includes(o);
    });
  });
...
function Rt(e, t, n, r, i) {
  return {
    ...
    resourceLabel: r ? Fe(r) : i,
    status: r?.status ?? "needs-setup",
    trustTier: r?.trustTier ?? "not-available",
    sandbox: r?.sandbox ?? "none"
  };
}
function Mt(e, t = "repo-repair") {
  const n = Yt.find((x) => x.id === t) ?? Yt[0], r = e?.resources ?? [], i = gt(r, (x) => x.kind === "pod-agent" && Ot(x) === "openclaw"), s = gt(r, (x) => x.kind === "pod-agent" && Ot(x) === "hermes"), o = gt(r, (x) => x.kind === "ail-route"), l = gt(r, (x) => x.kind === "shared-folder"), m = ct(r, "local-cli", ["claude"]), p = ct(r, "local-cli", ["opencode", "open code"]), b = ct(r, "local-cli", ["codex"]), y = ct(r, "local-cli", ["pi"]), N = ct(r, "local-cli", ["kimi"]), z = gt(r, (x) => x.kind === "local-cli"), V = ct(r, "app-skill", ["juli3ta", "music", "song"]), R = ct(r, "app-skill", ["blender", "3d"]), Y = ct(r, "app-skill", ["remotion", "video", "render"]), B = gt(r, (x) => x.kind === "app-skill"), we = t === "pod-local" ? i ?? s ?? o ?? m ?? z : t === "creative-production" ? s ?? o ?? m ?? z : t === "research-watch" ? i ?? o ?? s ?? m ?? z : m ?? p ?? o ?? z, G = t === "creative-production" ? V ?? R ?? Y ?? B ?? p ?? m ?? z : p ?? m ?? b ?? z, M = t === "pod-local" ? b ?? y ?? N ?? i ?? m ?? z : t === "research-watch" ? y ?? N ?? b ?? i ?? z : b ?? y ?? i ?? N ?? z, I = t === "creative-production" ? V ?? R ?? Y ?? B : t === "research-watch" ? ct(r, "app-skill", ["browser", "channel", "telegram"]) ?? B : B, he = [
    Rt("planner", "Planner", "Break goal into tasks, risks, and required context.", we, "No planner agent ready"),
    Rt("implementer", "Implementer", "Execute local/app work and return transcript or patch proposal.", G, "No local/app implementer ready"),
    Rt("reviewer", "Reviewer", "Independent critique before approval or handoff.", M, "No reviewer agent ready"),
    Rt("team-desk", "Team Desk", "Shared mission folder for transcripts, outputs, proposals, and handoff.", l, "Mission folder only until shared folder is bound")
  ];
  (t === "creative-production" || I) && he.push(Rt("app-tool", "App Tool", "Drive installed local app skill through mission context.", I, "No configured app skill"));
  const se = he.filter((x) => x.status === "ready" || x.status === "available" || x.status === "degraded").length, T = se >= he.length - 1 ? "ready" : se >= 2 ? "partial" : "needs-setup";
  return { ...n, readiness: T, assignments: he };
}
function kt(e, t, n) {
  if (n && Yt.some((i) => i.id === n)) return n;
  const r = e.toLowerCase();
  return /(music|song|audio|video|render|blender|remotion|juli3ta|creative)/.test(r) ? "creative-production" : /(research|watch|monitor|news|summar|scan)/.test(r) ? "research-watch" : (t?.resources ?? []).some((i) => i.kind === "pod-agent" && dr(i)) ? "pod-local" : "repo-repair";
}
function Ai(e) {
  return Yt.map((t) => Mt(e, t.id));
}
function Ut(e) {
  return `${e.label}: ${e.resourceLabel} (${e.status})`;
}
function bn(e, t, n) {
  const r = e.trim() || "Coordinate a Tytus mission.", i = Mt(t, kt(r, t, n)), s = (y) => i.assignments.find((N) => N.role === y), o = s("planner"), l = s("implementer"), m = s("reviewer"), p = s("team-desk"), b = s("app-tool");
  return [
    {
      id: "task-scope",
      ...
      resourceHint: o ? Ut(o) : "Planner agent",
      role: "planner",
    ...
    },
    {
      ...
      resourceHint: l ? Ut(l) : "Local/app implementer",
      role: "implementer",
      assignedResourceLabel: l?.resourceLabel ?? "Local/app implementer",
      status: "waiting",
    ...
    b ? {
      ...
      resourceHint: Ut(b),
      role: "app-tool",
      assignedResourceLabel: b.resourceLabel,
      status: b.status === "ready" || b.status === "available" ? "waiting" : "needs-approval",
    ...
    } : null,
    {
      ...
      resourceHint: m ? `${Ut(m)} · ${p?.resourceLabel ?? "mission folder"}` : "Reviewer + mission folder",
      role: "reviewer",
...
function Kn(e, t, n, r, i, s) {
  const o = Mt(t, kt(i || e.goal, t, s ?? e.teamPresetId));
  return [
    `# ${e.title}`,
    "",
    `- Mission ID: \`${e.missionId}\``,
    ...
    `- Summary: ${o.summary}`,
    "",
    ...o.assignments.map((l) => `- ${l.label}: ${l.resourceLabel} — ${l.purpose} [${l.status}, ${l.trustTier}, ${l.sandbox}]`),
    "",
    ...
    "## Resource graph",
    "",
    t ? `- ${lr(t.resources)}` : "- not loaded",
    ...t?.warnings?.length ? t.warnings.map((l) => `- Warning: ${l.code} — ${l.message}`) : [],
    "",
    "## Rules",
    "",
...
function Ci(e, t, n, r) {
  const i = kt(n || e.goal, t, r ?? e.teamPresetId), s = Mt(t, i), o = bn(n || e.goal, t, i);
  return JSON.stringify({
    ...
    storage: {
      ...
      teamDesk: s.assignments.find((l) => l.role === "team-desk")?.resourceLabel ?? "mission folder",
      paths: {
        runs: "runs/",
        outputs: "outputs/",
        proposals: "proposals/",
    ...
    resources: (t?.resources ?? []).filter((l) => l.status === "ready").map((l) => ({
      resourceId: l.id,
      pinnedLabel: Fe(l),
      pinnedKind: l.kind,
      pinnedCapabilities: l.capabilities,
      visibility: {
    ...
    tasks: o.map((l, m) => ({
      ...
      prompt: l.prompt,
      role: l.role,
      assignedResourceLabel: l.assignedResourceLabel,
      status: m === 0 ? "ready" : "waiting",
      selectedResourceHint: l.resourceHint,
      dependsOn: m === 0 ? [] : [o[m - 1].id],
      expectedOutputs: l.expectedOutputs,
      approvalGateIds: ["file-write-preview"]
    }))
  }, null, 2);
}
const ur = ["MISSION.md", "TASKS.md", "RESOURCES.md", "HANDOFF.md"];
function hr(e, t, n, r, i, s, o = []) {
  const l = bn(i || e.goal, t, s);
  return [
    { path: "MISSION.md", content: Kn(e, t, n, r, i, s), primary: !0, editable: !0 },
    { path: "MISSION.json", content: Ci(e, t, i, s), editable: !0 },
    { path: "RESOURCES.md", content: Bn(t), primary: !0, editable: !0 },
    { path: "TASKS.md", content: Li(l), primary: !0, editable: !0 },
    { path: "HANDOFF.md", content: Xi(e), primary: !0, editable: !0 },
...
`, editable: !0 },
    { path: "AUDIT.jsonl", content: o.join(""), editable: !1 },
    { path: "RUNS.jsonl", content: "", editable: !1 },
...
function Oi(e, t) {
  return `mission:${e.missionId}:${ua(t)}`;
}
function Si(e, t) {
  const n = t.path.split("/").pop() || t.path;
  return {
    id: Oi(e, t.path),
    name: n,
    path: `${e.title}/${t.path}`,
...
function Hi(e, t) {
  return t.map((n) => Si(e, n));
}
function ji(e) {
  const t = new Map(e.map((n) => [n.path, n]));
  return ur.flatMap((n) => {
    const r = t.get(n);
    return r ? [r] : [];
  });
}
const mr = "tytus.atomek.currentMission", Un = "tytus.atomek.currentMissionChanged";
function Mi(e, t) {
  const n = e.trim().replace(/\s+/g, " ").slice(0, 80);
  return n || t.trim().replace(/\s+/g, " ").slice(0, 80) || "Untitled mission";
}
function Wi(e) {
...
function qt(e) {
  ...
  try {
    localStorage.setItem(mr, JSON.stringify(t)), window.dispatchEvent(new CustomEvent(Un, { detail: t }));
  } catch {
  }
}
function Vi() {
  try {
    ...
    return !t.missionId || !t.title ? null : {
      ...
      teamPresetId: Yt.some((n) => n.id === t.teamPresetId) ? t.teamPresetId : void 0
    };
  } catch {
    return null;
  }
...
const st = {
  ...
  available: !0
}, Fi = "atomek:selected-chat-target", vn = {
  openclaw: "OpenClaw",
  hermes: "Hermes"
}, nn = /https?:\/\/(?:10(?:\.\d{1,3}){3}|192\.168(?:\.\d{1,3}){2}|172\.(?:1[6-9]|2\d|3[01])(?:\.\d{1,3}){2})(?::\d+)?\S*/gi, an = /\b(?:10(?:\.\d{1,3}){3}|192\.168(?:\.\d{1,3}){2}|172\.(?:1[6-9]|2\d|3[01])(?:\.\d{1,3}){2})\b/g, rn = /\b(?:MiniMax(?:-M[\w.-]+)?|Moonshot|Kimi|DeepSeek|Qwen|Alibaba|Xiaomi|Nous|OpenRouter|Strato|Scalesys|ail-compound|switchAILocal|OpenAI-compatible|vLLM|llama\.cpp)\b/gi, sn = /\b(?:route[_-]?id|pod[_-]?id|droplet[_-]?id|provider[_-]?id|publicUrl|gatewayUrl|privateUrl)\b\s*[:=]\s*[^\s,;]+/gi, on = /\b(?:pod-agent|ail-route|strato-eu|wannolot|scalesys)[._:-][a-z0-9._:-]{4,}\b/gi, cn = /https?:\/\/[^\s)]*(?:tytus\.traylinx\.com|strato|scalesys|wannolot|droplet|gateway|route|\.internal|\.local|digitalocean|do\.com|hetzner)[^\s)]*/gi, ln = /\b(?:fe80|fc00|fd[0-9a-f]{2}):[0-9a-f:]+(?:%[a-z0-9]+)?\b/gi;
function yn(e) {
  return e.replace(nn, "private gateway").replace(cn, "private gateway").replace(ln, "private gateway").replace(an, "private gateway").replace(sn, "agent runtime").replace(on, "your Tytus pod").replace(rn, "agent runtime").replace(/\s{3,}/g, "  ");
}
function Gn(e) {
  const t = e.toLowerCase();
  return /\b(503|502|504|warm|warming|boot|starting|not ready|temporarily unavailable)\b/.test(t) ? { message: "Agent is warming up. Try again in a moment.", retryable: !0 } : /\b(timeout|timed out|aborted)\b/.test(t) ? { message: "Connection timed out. The agent may still be working. Try again.", retryable: !0 } : /\b(offline|stopped|unreachable|not found|404)\b/.test(t) ? { message: "Agent is offline. Restart the pod or pick another agent.", retryable: !0 } : { message: yn(e).trim() || "Agent chat failed. Try again or pick another agent.", retryable: !1 };
}
function fr(e) {
  return `${Fi}:${e}`;
}
function Ri(e) {
  try {
    return localStorage.getItem(fr(e))?.trim() || st.id;
  } catch {
    return st.id;
  }
}
function Ha(e, t) {
  try {
    localStorage.setItem(fr(e), t || st.id);
  } catch {
  }
}
function St(e, ...t) {
...
function qi(e) {
  return e.kind !== "pod-agent" ? null : pr([
    e.label,
    e.id,
    St(e.metadata, "displayName", "display_name", "name", "podName", "pod_name"),
    St(e.metadata, "agentFamily", "agent_family", "agentType", "agent_type", "internalAgentType", "brand")
  ].join(" "));
}
function Yi(e) {
...
function Ji(e) {
  const t = e.trim();
  return t.length < 2 || t.length > 44 ? !1 : nn.test(t) || cn.test(t) || ln.test(t) || an.test(t) || sn.test(t) || on.test(t) || rn.test(t) ? (nn.lastIndex = 0, cn.lastIndex = 0, ln.lastIndex = 0, an.lastIndex = 0, sn.lastIndex = 0, on.lastIndex = 0, rn.lastIndex = 0, !1) : (nn.lastIndex = 0, cn.lastIndex = 0, ln.lastIndex = 0, an.lastIndex = 0, sn.lastIndex = 0, on.lastIndex = 0, rn.lastIndex = 0, /^[\p{L}\p{N}][\p{L}\p{N} ._()'&+-]*$/u.test(t));
}
function Zi(e, t) {
  const n = St(e.metadata, "displayName", "display_name", "customName", "custom_name", "podDisplayName", "pod_display_name", "name");
  if (n) {
    const r = yn(n).replace(/\bNemoClaw\b/gi, "OpenClaw").replace(/\s+/g, " ").trim();
    if (Ji(r)) return r;
  }
  return vn[t];
}
...
function Bi(e) {
  ...
  return e.map((s) => {
    ...
    const o = s.label, l = vn[s.agentFamily];
    i[s.agentFamily] += 1;
    const m = o.toLowerCase();
    r[m] = (r[m] ?? 0) + 1;
    const p = t.filter((N) => N.label.toLowerCase() === m).length > 1, b = o === l && n[s.agentFamily] > 1;
    if (!p && !b) return s;
    const y = b ? i[s.agentFamily] : r[m];
    return { ...s, label: `${o} ${y}` };
  });
}
function Ui(e) {
  const t = e.daemon?.state, n = t?.included ?? [], r = t?.agents ?? [], i = new Map(r.map((o) => [o.id, o])), s = n.flatMap((o) => {
    const l = o.id ?? "", p = { ...(o.agentId ? i.get(o.agentId) : void 0)?.meta ?? {}, ...o.meta ?? {} }, b = pr([l, o.kind, St(p, "displayName", "display_name", "agentFamily", "agentType", "brand")].join(" "));
    return !l || !b ? [] : [{
      id: `pod-agent.${l}`,
      kind: "pod-agent",
      label: vn[b],
  ...
  return br({ generatedAt: (/* @__PURE__ */ new Date()).toISOString(), resources: s });
}
async function Gi(e, t) {
  ...
  const r = br(n), i = r.length > 0 ? [] : Ui(e), s = /* @__PURE__ */ new Map();
  for (const o of [st, ...r, ...i]) s.set(o.id, o);
  return [...s.values()];
}
const ma = "atomek", nt = "atomek:default", Qi = 3e3, fa = "tytus.atomek.threadTitleOverrides", vr = "tytus.atomek.selectedThreadId", ja = {
  available: !1,
  source: "none",
  label: "Tytus AI unavailable",
  reason: "host.ai is not available in this Tytus build."
}, zt = (e) => e.role !== "user" && e.role !== "assistant" ? null : {
  id: e.id,
  role: e.role,
  body: e.body,
  status: e.status,
...
}, $i = (e, t = Qi) => e.length <= t ? e : `${e.slice(0, t)}

[...clipped ${e.length - t} chars...]`, Hn = (e, t) => {
  const n = e.split(`
`).map((r) => r.replace(/^#+\s*/, "").trim()).find(Boolean);
  return n ? n.length > 80 ? `${n.slice(0, 77)}...` : n : t;
}, _i = (e) => ["briefing", "action-list", "quiz", "plan", "storyboard", "report", "local-draft", "markdown", "memory"].includes(e) ? e : "report", Ma = (e) => ({
  id: e.id,
  title: e.title,
  kind: _i(e.kind),
  body: e.body,
...
`)
  ...
  try {
    const n = pa();
    n[e] = t, localStorage.setItem(fa, JSON.stringify(n));
  } catch {
  }
}, to = (e) => {
  try {
    const t = pa();
    delete t[e], localStorage.setItem(fa, JSON.stringify(t));
  } catch {
  }
}, Va = (e) => {
  const t = pa();
  ...
  try {
    return localStorage.getItem(vr)?.trim() || null;
  } catch {
    return null;
  }
}, yt = (e) => {
...
}, hn = (e) => `${nt}:agent-session:${e}`, mn = (e) => `${nt}:agent-transcript:${e}`, ba = (e) => `${nt}:${ma}:agent-session:${e}`, fn = (e) => `${nt}:${ma}:agent-transcript:${e}`, yr = 100, ao = (e, t) => {
  try {
    const n = localStorage.getItem(ba(e))?.trim();
    if (n) return n;
    const r = localStorage.getItem(hn(e))?.trim();
    return r || t && t !== e && localStorage.getItem(hn(t))?.trim() || null;
  } catch {
    return null;
  }
}, ro = (e, t) => {
  ...
  try {
    const n = localStorage.getItem(fn(e)), r = n ? JSON.parse(n) : [], i = /* @__PURE__ */ new Map();
    for (const s of [...r, ...t]) i.set(s.id, s);
    localStorage.setItem(fn(e), JSON.stringify([...i.values()].slice(-yr)));
  } catch {
  }
}, dn = (e) => {
  if (!e) return [];
  ...
  try {
    const n = dn(localStorage.getItem(fn(e)));
    if (n.length > 0) return n;
    const r = dn(localStorage.getItem(mn(e)));
    return r.length > 0 || !t || t === e ? r : dn(localStorage.getItem(mn(t)));
  } catch {
    return [];
  }
};
function io() {
  const e = `${nt}:${ma}:agent-transcript:`, t = [];
  try {
    for (let n = 0; n < localStorage.length; n += 1) {
      const r = localStorage.key(n);
      if (!r || !r.startsWith(e)) continue;
      const i = dn(localStorage.getItem(r));
      if (i.length === 0) continue;
      const s = i[i.length - 1], o = i.find((l) => l.role === "user");
      t.push({
...
const gr = (e, t) => {
  try {
    localStorage.removeItem(fn(e)), localStorage.removeItem(ba(e)), localStorage.removeItem(mn(e)), localStorage.removeItem(hn(e)), t && t !== e && (localStorage.removeItem(mn(t)), localStorage.removeItem(hn(t)));
  } catch {
  }
}, co = (e) => {
  const t = e.daemon;
...
function ho({ host: e, requestContext: t, chatSettings: n, selectedTarget: r = st, setStatus: i }) {
  const s = e.ai, [o, l] = P(null), [m, p] = P([]), [b, y] = P([]), [N, z] = P([]), [V, R] = P([]), [Y, B] = P(ja), [we, G] = P(!1), M = Re(!0), I = Re(null), he = w(async () => {
    if (!s) {
      B(ja);
      return;
    }
    ...
    if (s)
      try {
        const O = await s.listArtifacts({ threadId: L });
        if (!M.current) return;
        z(O.map(Ma));
      } catch (O) {
        i(`AI artifacts unavailable: ${O instanceof Error ? O.message : String(O)}`);
      }
  }, [s, i]), T = w(async (L) => {
    if (s)
      try {
        const O = await s.listMessages(L);
        if (!M.current) return;
        const q = m.find((S) => S.id === L) ?? null;
        q && l(q), yt(L), y(O.map(zt).filter(Boolean)), R([]), await se(L);
      } catch (O) {
        i(`Load chat failed: ${O instanceof Error ? O.message : String(O)}`);
      }
  }, [s, se, i, m]), x = w(async () => {
    if (s)
      try {
        const L = Va(await s.listThreads({ workspaceKey: nt, status: "active" })), O = no(), q = L.find(($) => $.id === O) ?? L[0] ?? await s.createThread({ workspaceKey: nt, title: "Atomek chat" });
        if (!M.current) return;
        p(L[0] ? L : [q]), l(q), yt(q.id);
        const S = await s.listMessages(q.id);
        if (!M.current) return;
        y(S.map(zt).filter(Boolean)), await se(q.id);
      } catch (L) {
        i(`AI chat unavailable: ${L instanceof Error ? L.message : String(L)}`);
      }
  }, [s, se, i]);
  pe(() => (M.current = !0, he(), x(), () => {
    M.current = !1;
  }), [x, he]);
  const Te = r.kind === "pod-agent" ? r.podId : null;
  pe(() => {
    if (r.kind === "pod-agent") {
      y(so(r.id, r.podId)), R([]);
      return;
    ...
    return (async () => {
      try {
        const O = await s.listMessages(o.id);
        !L && M.current && y(O.map(zt).filter(Boolean));
      } catch {
      }
    })(), () => {
      L = !0;
  ...
  const ne = w(async () => {
    if (!s) return null;
    if (o) return o;
    const L = await s.createThread({ workspaceKey: nt, title: "Atomek chat" });
    return M.current && (l(L), yt(L.id), p((O) => [L, ...O.filter((q) => q.id !== L.id)])), L;
  }, [s, o]), ze = w(async () => {
    if (r.kind === "pod-agent") {
      gr(r.id, r.podId), y([]), R([]), i(`Cleared ${r.label} chat`);
      return;
    }
    if (!s) return;
    const L = await s.createThread({ workspaceKey: nt, title: "Atomek chat" });
    l(L), yt(L.id), p((O) => [L, ...O.filter((q) => q.id !== L.id)]), y([]), z([]), R([]), i("New AI chat created");
  }, [s, r, i]), Me = w(async (L, O) => {
    if (!s) return;
    const q = O.trim();
    if (q)
      try {
        const S = s.updateThread, $ = m.find((ge) => ge.id === L) ?? o, ce = typeof S == "function" ? await S({ threadId: L, title: q }) : { ...$ ?? await ne(), id: L, title: q, updatedAt: Date.now() };
        typeof S != "function" && Wa(L, q), p((ge) => ge.map((be) => be.id === ce.id ? ce : be)), l((ge) => ge?.id === ce.id ? ce : ge), i(typeof S == "function" ? `Renamed chat: ${ce.title}` : `Renamed chat locally: ${ce.title}`);
      } catch (S) {
        i(`Rename chat failed: ${S instanceof Error ? S.message : String(S)}`);
      }
  }, [s, ne, i, o, m]), De = w(async (L) => {
    if (s)
      try {
        await s.deleteThread(L), to(L);
        const O = m.filter((q) => q.id !== L);
        if (p(O), o?.id === L) {
          const q = O[0] ?? await s.createThread({ workspaceKey: nt, title: "Atomek chat" });
          l(q), yt(q.id), p(($) => $.some((ce) => ce.id === q.id) ? $ : [q, ...$]);
          const S = await s.listMessages(q.id);
          y(S.map(zt).filter(Boolean)), await se(q.id);
        }
        i("Deleted AI chat");
      } catch (O) {
        i(`Delete chat failed: ${O instanceof Error ? O.message : String(O)}`);
      }
  }, [s, se, i, o?.id, m]), We = w(async (L) => {
    if (!s) return null;
    try {
      const O = await ne();
      if (!O) return null;
      yt(O.id);
      const q = await s.createArtifact({
        threadId: O.id,
        messageId: L.messageId ?? null,
        title: L.title?.trim() || Hn(L.body, "Atomek artifact"),
        kind: L.kind ?? "markdown",
        body: L.body
      }), S = Ma(q);
      return z(($) => [S, ...$.filter((ce) => ce.id !== S.id)]), i(`Saved AI artifact: ${S.title}`), S;
    } catch (O) {
      return i(`Save artifact failed: ${O instanceof Error ? O.message : String(O)}`), null;
    }
  }, [s, ne, i]), f = w(async (L) => {
    if (s)
      try {
        await s.deleteArtifact(L), z((O) => O.filter((q) => q.id !== L)), i("Deleted AI artifact");
      } catch (O) {
        i(`Delete artifact failed: ${O instanceof Error ? O.message : String(O)}`);
      }
  }, [s, i]), D = w(async (L) => {
    if (!s) return null;
    try {
      const O = await s.writeMemory({
        title: L.title?.trim() || Hn(L.body, "Atomek memory"),
        body: L.body,
        metadata: {
          source: "atomek",
          messageId: L.messageId ?? null
      ...
      return R((q) => [O, ...q.filter((S) => S.id !== O.id)].slice(0, 5)), i(`Remembered: ${O.title}`), O;
    } catch (O) {
      return i(`Remember failed: ${O instanceof Error ? O.message : String(O)}`), null;
    }
  }, [s, i]), Q = w(async (L) => {
    if (!s) return [];
    const O = await s.searchMemory({ query: L, limit: 5 });
    return M.current && R(O), O;
  }, [s]), ke = w(async (L, O = {}) => {
    const q = L.trim();
    if (!q) return null;
    const S = r;
    if (S.kind === "atomek-ai" && !s) return null;
    G(!0);
    let $ = null;
    const ce = new AbortController();
    I.current = ce;
    try {
      const ge = O.requestContext ?? t;
      if (S.kind === "pod-agent") {
        const _ = co(e), ae = Date.now(), re = {
          id: `agent-user-${ae}`,
          role: "user",
          body: q,
          status: "complete",
          createdAt: ae
        }, me = `agent-assistant-${ae}`, Pe = {
          id: me,
          role: "assistant",
          body: "",
          status: "streaming",
        ...
        if (y((Z) => [...Z, re, Pe]), Gt(S.id, [re, Pe]), !S.available) {
          const Z = Gn(S.description), ve = { ...Pe, body: Z.message, status: "error", error: Z.message };
          return y((Ae) => Ae.map((le) => le.id === me ? ve : le)), Gt(S.id, [ve]), i(Z.message), ve;
        }
        if (!_) {
          const Z = "Agent chat bridge unavailable in this Tytus host build. Update TytusOS host API/runtime to enable OpenClaw and Hermes chat.", ve = { ...Pe, body: Z, status: "error", error: Z };
          return y((Ae) => Ae.map((le) => le.id === me ? ve : le)), Gt(S.id, [ve]), i("Agent chat bridge unavailable"), ve;
        }
        let He = "";
        const it = (Z, ve) => (y((Ae) => Ae.map((le) => le.id === me ? Z : le)), Gt(S.id, [re, Z]), i(ve), Z);
        try {
          for await (const Z of _.chatAgent({
            podId: S.podId,
            routeId: S.routeId ?? null,
            sessionId: ao(S.id, S.podId),
            message: uo(q, ge),
            mode: "operator",
            target: "agent",
            ...
            if (Z.type === "profile") {
              const ve = Z.profile === "local" ? "Local Cortex" : "Cloud Cortex";
              y(
                (Ae) => Ae.map(
                  (le) => le.id === me ? { ...le, gatewayLabel: ve } : le
                )
              );
            }
            if (Z.type === "session" && ro(S.id, Z.sessionId), Z.type === "token" && (He = yn(`${He}${Z.text}`), y((ve) => ve.map((Ae) => Ae.id === me ? { ...Ae, body: He, status: "streaming" } : Ae))), Z.type === "error") {
              const ve = Gn(Z.message), Ae = { ...Pe, body: ve.message, status: "error", error: ve.message };
              return it(Ae, ve.message);
            }
            if (Z.type === "done")
              return $ = { ...Pe, body: He || "Agent finished without visible output.", status: "complete" }, it($, `${S.label} answered`);
          }
        } catch (Z) {
          if (ce.signal.aborted || Z instanceof DOMException && Z.name === "AbortError")
            return $ = { ...Pe, body: He || "Stopped by user.", status: "complete" }, it($, `${S.label} response stopped`);
          throw Z;
        }
        return ce.signal.aborted ? ($ = { ...Pe, body: He || "Stopped by user.", status: "complete" }, it($, `${S.label} response stopped`)) : $ || ($ = { ...Pe, body: He || "Agent finished without visible output.", status: "complete" }, it($, `${S.label} answered`));
      }
      const be = await ne();
      if (!be || !s) return null;
      yt(be.id);
      const g = (be.title ?? "").trim();
      if ((!g || g === "Atomek chat") && q.trim()) {
        const _ = Hn(q, "Atomek chat");
        _ && _ !== g && (async () => {
          try {
            const ae = s.updateThread, re = typeof ae == "function" ? await ae({ threadId: be.id, title: _ }) : { ...be, title: _, updatedAt: Date.now() };
            if (typeof ae != "function" && Wa(be.id, _), !M.current) return;
            l((me) => me?.id === re.id ? re : me), p((me) => me.map((Pe) => Pe.id === re.id ? re : Pe));
          } catch {
          }
        })();
      }
      const Xe = await Q(q).catch(() => []), E = eo(Xe), Ue = E ? [...ge, E] : [...ge];
      let et = null;
      for await (const _ of s.sendMessage({
        threadId: be.id,
        body: q,
        ...
        if (_.type === "message_created") {
          const ae = zt(_.message);
          if (!ae) continue;
          ae.role === "assistant" && (et = ae.id), y((re) => [...re.filter((me) => me.id !== ae.id), ae]);
        }
        if (_.type === "token" && (et = _.messageId, y((ae) => ae.some((re) => re.id === _.messageId) ? ae.map(
          (re) => re.id === _.messageId ? { ...re, body: _.body, status: "streaming", sourceLabel: "Atomek" } : re
        ) : [...ae, {
          id: _.messageId,
          role: "assistant",
          body: _.body,
          ...
          sourceLabel: "Atomek",
          createdAt: Date.now()
        }])), _.type === "message_updated" || _.type === "done") {
          const ae = zt(_.message);
          if (!ae) continue;
          ae.role === "assistant" && ($ = ae), y((re) => re.map((me) => me.id === ae.id ? ae : me)), ae.gatewayLabel && i(`AI answered via ${ae.gatewayLabel}`);
        }
        if (_.type === "run_failed") {
          const ae = ce.signal.aborted;
          i(ae ? "AI response stopped" : `AI failed: ${_.error}`), et && y((re) => re.map((me) => me.id !== et ? me : ae ? { ...me, status: "complete", error: void 0, body: me.body || "Stopped by user." } : { ...me, status: "error", error: _.error, body: _.error }));
        }
      }
      const Ee = Va(await s.listThreads({ workspaceKey: nt, status: "active" }).catch(() => []));
      return M.current && Ee.length > 0 && p(Ee), he(), $;
    } catch (ge) {
      return ge instanceof DOMException && ge.name === "AbortError" ? (i("AI response stopped"), $) : (i(`AI failed: ${ge instanceof Error ? ge.message : String(ge)}`), null);
    } finally {
      I.current === ce && (I.current = null), G(!1);
    }
  }, [s, n.gatewayPreference, n.model, ne, e, Q, he, t, r, i]), ie = w(() => {
    I.current?.abort(), i("Stopping AI response…");
  }, [i]);
  return {
    aiStatus: Y,
    artifacts: N,
...
const mo = (e) => `tytus-workbench:///${encodeURI(e.path)}`, fo = (e) => {
  let t = 2166136261;
  for (let n = 0; n < e.length; n += 1)
    t ^= e.charCodeAt(n), t = Math.imul(t, 16777619);
  return (t >>> 0).toString(16).padStart(8, "0");
}, po = ({ files: e, openEditorIds: t, activeFileId: n, versions: r, activeSelection: i }) => {
  const s = new Set(t), o = e.map((l) => {
    const m = l.id === n;
    return {
      id: l.id,
      uri: mo(l),
  ...
  return {
    documents: o,
    byId: new Map(o.map((l) => [l.id, l])),
    activeDocumentId: n,
    openDocumentIds: t.filter((l) => o.some((m) => m.id === l))
  };
}, bo = "active-file", vo = (e) => e === "none" ? "No context" : e === "active-selection" ? "Active selection" : e === "active-file" ? "Active file" : e === "open-editors" ? "Open editors" : e === "selected-files" ? "Selected files" : "Indexed project", yo = (e, t = "file") => `${t}:${e.id}`, go = (e, t) => [
  "selection",
  e.id,
  t.startLineNumber,
  t.startColumn,
  ...
  let i = [];
  return t.scope === "active-selection" ? r?.selection ? i = [wo(r, r.selection, !0)] : r && (i = [Qt(r, !0, "Active file")]) : t.scope === "active-file" ? r && (i = [Qt(r, !0, "Active file")]) : t.scope === "open-editors" ? i = e.openDocumentIds.map((s) => e.byId.get(s)).filter(Boolean).map((s) => Qt(s, !0, "Open editor")) : t.scope === "selected-files" && (i = t.selectedFileIds.map((s) => e.byId.get(s)).filter(Boolean).map((s) => Qt(s, !1, "Selected file"))), xo(i).filter((s) => !n.has(s.id));
}, xo = (e) => {
  const t = /* @__PURE__ */ new Set();
  return e.filter((n) => t.has(n.id) ? !1 : (t.add(n.id), !0));
}, Po = 4e3, No = 8e3, To = 4e3, zo = (e, t) => e.length <= t ? e : `${e.slice(0, t)}

[...clipped ${e.length - t} chars...]`, Ao = (e, t, n) => {
  const r = ko(e, n), i = [], s = new Map(t.map((o) => [o.id, o]));
  for (const o of r) {
    if (!o.fileId) continue;
    const l = s.get(o.fileId), m = e.byId.get(o.fileId);
    if (!l || !m || !o.includeBody) continue;
    const p = [
      `Path: ${l.path}`,
      `Language: ${l.language}`,
      `Version: ${m.version}`,
      ...
      o.range ? `Range: ${Ia(o.range)}` : null
    ].filter(Boolean).join(`
`), b = o.kind === "selection" && o.range ? Lo(l.content, o.range) : l.content, y = o.kind === "selection" ? Po : o.label.startsWith("Open editor") ? To : No;
    i.push({
      kind: o.kind === "selection" ? "selection" : "file",
      title: o.kind === "selection" ? `Active selection: ${l.path}` : o.label,
      text: `${p}
...
`));
}, Ia = (e) => `${e.startLineNumber}:${e.startColumn}-${e.endLineNumber}:${e.endColumn}`, Fa = 75e4, Xo = 2800, Co = 240, Oo = 80, So = /* @__PURE__ */ new Set([
  ".git",
  ".hg",
  ".svn",
  ".next",
  ...
  e.map((t) => `${t.id}\0${t.path}\0${t.language}\0${t.dirty ? "1" : "0"}\0${wt(t.content)}`).sort().join("")
), Qn = (e, t = {}) => {
  const n = e.size ?? e.content.length;
  return n === 0 || e.content.length === 0 ? "empty" : n > (t.maxFileBytes ?? Fa) || e.content.length > (t.maxFileBytes ?? Fa) ? "huge" : !t.includeDirty && e.dirty ? null : Fo(e.path) ? "vendor" : Ro(e) ? "binary" : null;
}, Ra = (e, t = {}) => {
  const n = Date.now(), r = [], i = [], s = [];
  for (const o of e) {
    const l = o.size ?? o.content.length, m = Qn(o, t);
    if (m) {
      i.push({ fileId: o.id, name: o.name, path: o.path, language: o.language, reason: m, size: l });
      continue;
    }
    const p = wt(o.content), b = jo(o, p, n, t);
    s.push(...b), r.push({
      fileId: o.id,
      name: o.name,
      path: o.path,
...
}, jo = (e, t = wt(e.content), n = Date.now(), r = {}) => {
  const i = Math.max(500, r.maxChunkChars ?? Xo), s = Math.min(Math.max(0, r.chunkOverlapChars ?? Co), Math.floor(i / 2)), o = Math.max(1, r.maxChunksPerFile ?? Oo), l = Vo(e.content), m = [];
  let p = 0, b = 0;
  for (; p < e.content.length && m.length < o; ) {
    const y = Wo(e.content, p, Math.min(e.content.length, p + i)), N = e.content.slice(p, y).trim();
    if (N.length > 0) {
      const z = Io(l, p, y);
      m.push({
        id: `${e.id}:${t}:${b}:${z.startLineNumber}-${z.endLineNumber}`,
        fileId: e.id,
        path: e.path,
        name: e.name,
        language: e.language,
...
` && t.push(n + 1);
  ...
  const r = Da(e, t), i = Da(e, Math.max(t, n - 1));
  return {
    startLineNumber: r + 1,
    startColumn: t - e[r] + 1,
    endLineNumber: i + 1,
  ...
  return 0;
}, Fo = (e) => e.split(/[\\/]+/).filter(Boolean).some((t) => So.has(t)), Ro = (e) => {
...
class Do {
  ...
  options;
  constructor(t = [], n = {}) {
    this.options = { ...n }, this.snapshot = Ra(t, this.options);
  }
  getSnapshot() {
  ...
  refresh(t, n = this.options) {
    return this.options = { ...n }, this.snapshot = Ra(t, this.options), this.snapshot;
  }
  update(t, n = this.options) {
    return this.refresh(t, n);
  }
  staleReport(t) {
    return Eo(this.snapshot, t, this.options);
  }
  isStale(t) {
    return this.staleReport(t).stale;
  }
}
const At = (e = [], t = {}) => new Do(e, t), Eo = (e, t, n = {}) => {
  const r = new Map(t.map((l) => [l.id, l])), i = e.byFileId, s = [];
  for (const l of e.files) {
    const m = r.get(l.fileId);
    if (!m) {
      s.push({ fileId: l.fileId, path: l.path, status: "deleted", indexedHash: l.hash });
      continue;
    }
    if (Qn(m, n)) {
      s.push({ fileId: l.fileId, path: m.path, status: "skipped-now", indexedHash: l.hash, currentHash: wt(m.content) });
      continue;
    }
    const b = wt(m.content);
    b !== l.hash ? s.push({ fileId: l.fileId, path: m.path, status: "changed", indexedHash: l.hash, currentHash: b }) : m.dirty !== l.dirty && s.push({ fileId: l.fileId, path: m.path, status: "dirty-state-changed", indexedHash: l.hash, currentHash: b });
  }
  for (const l of t)
    !i.has(l.id) && !Qn(l, n) && s.push({ fileId: l.id, path: l.path, status: "new", currentHash: wt(l.content) });
  const o = e.signature !== wr(t);
  return { stale: s.length > 0, signatureChanged: o, files: s };
}, qo = 8, Yo = 12e3, kr = (e, t, n = {}, r) => {
  const i = Ko(t);
  if (i.length === 0) return [];
  const s = new Set(r?.files.map((b) => b.fileId) ?? []), o = e.chunks.filter((b) => n.includeDirty !== !1 || !b.dirty).map((b) => Bo(b, i)).filter((b) => b.score >= (n.minScore ?? 1)).sort((b, y) => y.score - b.score || b.chunk.path.localeCompare(y.chunk.path) || b.chunk.ordinal - y.chunk.ordinal), l = [], m = /* @__PURE__ */ new Set();
  let p = n.maxChars ?? Yo;
  for (const b of o) {
    if (l.length >= (n.limit ?? qo) || p <= 0) break;
    const y = `${b.chunk.fileId}:${b.chunk.ordinal}`;
    if (m.has(y)) continue;
    m.add(y);
    const N = b.chunk.text.length > p ? `${b.chunk.text.slice(0, Math.max(0, p - 28))}
[...context clipped...]` : b.chunk.text;
    l.push(Jo(b, N, s.has(b.chunk.fileId))), p -= N.length;
  }
  return l;
}, Jo = (e, t = e.chunk.text, n = !1) => {
...
`), Ko = (e) => Array.from(new Set(
  ...
  const l = [];
  for (const m of t) {
    const p = jn(n, m), b = jn(r, m), y = jn(i, m), N = s === m ? 1 : 0;
    p + b + y + N !== 0 && (l.push(m), o += Math.min(p, 12), o += b * 4, o += y * 6, o += N * 3, (n.includes(`function ${m}`) || n.includes(`const ${m}`) || n.includes(`class ${m}`) || n.includes(`type ${m}`)) && (o += 3));
  }
  return o += Math.max(0, 2 - e.ordinal * 0.05), { chunk: e, score: o, matchedTerms: l };
}, jn = (e, t) => {
  ...
  const n = e.toLowerCase(), r = t.map((m) => n.indexOf(m)).filter((m) => m >= 0).sort((m, p) => m - p)[0] ?? 0, i = Math.max(0, r - 120), s = Math.min(e.length, r + 260), o = i > 0 ? "…" : "", l = s < e.length ? "…" : "";
  return `${o}${e.slice(i, s).replace(/\s+/g, " ").trim()}${l}`;
}, Go = (e, t = {}) => {
  const { autoRefresh: n = !1, ...r } = t, i = Re(e), s = Re(null);
  s.current || (s.current = At(e, r));
  const [o, l] = P(() => s.current?.getSnapshot() ?? At(e, r).getSnapshot());
  i.current = e;
  const m = w((N = i.current) => {
    const z = (s.current ?? At([], r)).refresh(N, r);
    return l(z), z;
  }, [r.maxFileBytes, r.maxChunkChars, r.chunkOverlapChars, r.maxChunksPerFile, r.includeDirty]), p = w((N = i.current) => {
    const z = (s.current ?? At([], r)).update(N, r);
    return l(z), z;
  }, [m]);
  pe(() => {
    n && m(e);
  }, [n, e, m]);
  const b = (s.current ?? At([], r)).staleReport(e), y = w((N, z = {}) => {
    const V = s.current ?? At([], r);
    return kr(V.getSnapshot(), N, z, V.staleReport(i.current));
  }, []);
  return { snapshot: o, staleReport: b, isStale: b.stale, refresh: m, update: p, retrieve: y };
}, Qo = "tytus.atomek.semanticVector:v1", xr = "__gateway_default__", Pr = (e) => e?.trim() || xr, $o = (e) => {
  const t = Pr(e);
  return t === xr ? "gateway default" : t;
}, Nr = (e, t, n) => [
  Qo,
  ...
  if (!Tr()) return null;
  try {
    const r = Nr(e, t, n), i = window.localStorage.getItem(r);
    if (!i) return null;
  ...
  if (!Tr()) return null;
  try {
    const t = Nr(e.appId, e.modelAlias, { id: e.chunkId, hash: e.contentHash }), n = { ...e, key: t };
    return window.localStorage.setItem(t, JSON.stringify(n)), n;
  } catch {
    return null;
  }
}, Dt = 8, tc = 12e3, nc = 180, ac = async (e, t, n, r, i = {}, s, o) => {
  const l = kr(t, n, { ...i, limit: Math.max(i.limit ?? Dt, 16) }, s), m = e.ai;
  if (typeof m?.embedText != "function")
    return { hits: l.slice(0, i.limit ?? Dt), mode: "keyword", reason: "Semantic index unavailable — using keyword retrieval.", embeddedChunks: 0 };
  try {
    const p = Pr(r.embeddingModel), b = await m.embedText({
      input: n,
      gatewayPreference: r.gatewayPreference,
      model: r.embeddingModel.trim() || void 0,
      signal: o
    }), y = zr(b.embedding);
    if (!y) throw new Error("host.ai.embedText returned no embedding vector");
    const N = new Map(l.map((M) => [M.chunkId, M])), z = dc(n), V = /* @__PURE__ */ new Map();
    t.chunks.filter((M) => i.includeDirty !== !1 || !M.dirty).slice(0, nc).forEach((M) => V.set(M.id, M)), l.forEach((M) => {
      const I = t.byChunkId.get(M.chunkId);
      I && V.set(I.id, I);
    });
    const R = Array.from(V.values()), Y = [];
    let B = 0;
    for (const M of R) {
      o?.aborted;
      const I = _o(e.appId, p, M) ?? await sc(m, e.appId, p, M, r, o);
      if (!I) continue;
      I.updatedAt > Date.now() - 1e3 && (B += 1);
      const he = cc(y, I.vector);
      if (!Number.isFinite(he)) continue;
      const T = N.get(M.id)?.score ?? uc(M, z), x = lc(T) * 0.42 + Math.max(0, he) * 0.58;
      Y.push({ chunk: M, keywordScore: T, vectorScore: he, score: x, matchedTerms: z.filter((Te) => M.text.toLowerCase().includes(Te)) });
    }
    if (Y.length === 0) return { hits: l.slice(0, i.limit ?? Dt), mode: "vector-fallback", reason: "Semantic retrieval produced no vectors — using keyword retrieval.", embeddedChunks: B };
    const we = new Set(s?.files.map((M) => M.fileId) ?? []), G = Y.sort((M, I) => I.score - M.score || I.keywordScore - M.keywordScore || M.chunk.path.localeCompare(I.chunk.path) || M.chunk.ordinal - I.chunk.ordinal).slice(0, Math.max(i.limit ?? Dt, 1)).map((M) => ic(M, we.has(M.chunk.fileId)));
    return {
      hits: oc(G, i.maxChars ?? tc),
      mode: "hybrid",
      reason: `Hybrid retrieval used ${$o(r.embeddingModel)} embeddings + keyword ranking.`,
      embeddedChunks: B
    };
  } catch (p) {
    return {
      hits: l.slice(0, i.limit ?? Dt),
      mode: "vector-fallback",
      reason: `Semantic retrieval failed (${p instanceof Error ? p.message : String(p)}) — using keyword retrieval.`,
      embeddedChunks: 0
    };
  }
}, rc = (e) => e.map((t) => ({
  ...
  return {
    ...
    text: e.chunk.text,
    snippet: hc(e.chunk.text, e.matchedTerms),
    score: e.score,
...
}, lc = (e) => Math.min(1, Math.max(0, e / 24)), dc = (e) => Array.from(new Set(
  e.toLowerCase().split(/[^a-z0-9_.$/-]+/i).map((t) => t.trim()).filter((t) => t.length >= 2)
)), uc = (e, t) => {
  const n = `${e.path}
${e.name}
...
${e.text}`.toLowerCase();
  ...
  const n = e.toLowerCase(), r = t.map((o) => n.indexOf(o)).filter((o) => o >= 0).sort((o, l) => o - l)[0] ?? 0, i = Math.max(0, r - 120), s = Math.min(e.length, r + 260);
  return `${i > 0 ? "…" : ""}${e.slice(i, s).replace(/\s+/g, " ").trim()}${s < e.length ? "…" : ""}`;
}, mc = /```([^\n`]*)\n([\s\S]*?)```/g, fc = /^@@\s+-(\d+)(?:,\d+)?\s+\+(\d+)(?:,\d+)?\s+@@/;
function va(e) {
  return Array.from(e.matchAll(mc)).map((t) => Ar(t[1] ?? "", gc(t[2] ?? ""))).filter((t) => t.content.trim().length > 0);
}
function Ar(e, t) {
  const n = e.trim().split(/[\s,]+/).filter(Boolean), r = {}, i = [];
  for (const s of n) {
    const o = s.match(/^([a-z0-9_-]+)=(.+)$/i);
    o ? r[o[1].toLowerCase()] = kc(o[2]) : i.push(s.toLowerCase());
  }
  return { lang: e.trim().toLowerCase(), flags: i, attrs: r, content: t };
}
function $e(e, t) {
  return (typeof e == "string" ? Ar(e, "").flags : e.flags).includes(t.toLowerCase());
}
function Lr(e) {
  return [...va(e).filter((r) => $e(r, "diff") || $e(r, "patch")).map((r) => r.content), e].filter((r, i, s) => pc(r) && s.findIndex((o) => o === r) === i);
}
function pc(e) {
...
`), r = [];
  if (n.forEach((o, l) => {
    (o.startsWith("diff --git ") || o.startsWith("--- ")) && r.push(l);
  }), r.length === 0) return [{ raw: t, ...Mn(t) }];
  const i = Array.from(new Set(r)).sort((o, l) => o - l), s = [];
  for (let o = 0; o < i.length; o += 1) {
    const l = i[o], p = i.find((y) => y > l && n[y].startsWith("diff --git ")) ?? n.length, b = n.slice(l, p).join(`
`);
    /^@@\s+-\d+/m.test(b) && s.push({ raw: b, ...Mn(b) });
  }
  return s.length > 0 ? s : [{ raw: t, ...Mn(t) }];
}
function Mn(e) {
  const t = e.match(/^diff --git\s+(?:"?a\/(.+?)"?|(\S+))\s+(?:"?b\/(.+?)"?|(\S+))/m), n = e.match(/^---\s+(?:"?a\/(.+?)"?|(\S+))/m), r = e.match(/^\+\+\+\s+(?:"?b\/(.+?)"?|(\S+))/m), i = lt(t?.[1] || t?.[2] || n?.[1] || n?.[2] || "") || null, s = lt(t?.[3] || t?.[4] || r?.[1] || r?.[2] || "") || null, o = s && s !== "/dev/null" ? s : i;
...
function $n(e) {
  return va(e).filter((t) => vc(t)).map((t) => ({
    content: wc(t.content),
...
function vc(e) {
  return $e(e, "atomek-replace") || $e(e, "atomek-full") || $e(e, "full-replacement") || $e(e, "full") || $e(e, "replace");
}
function yc(e) {
...
`), i = [];
  ...
  for (let l = 0; l < r.length; l += 1) {
    const m = r[l].match(fc);
    if (!m) continue;
    o = !0;
    const p = Number(m[1]), b = Math.max(0, p - 1);
    if (b < s) return null;
    for (i.push(...n.slice(s, b)), s = b, l += 1; l < r.length; l += 1) {
      const y = r[l];
      if (y.startsWith("@@ ")) {
        l -= 1;
        break;
      }
      if (y.startsWith("diff --git ") || y.startsWith("--- ") || y.startsWith("+++ ") || y.startsWith("\\ No newline at end of file")) continue;
      const N = y[0], z = y.slice(1);
      if (N === " ") {
        if (n[s] !== z) return null;
        i.push(z), s += 1;
        continue;
      }
      if (N === "-") {
...
function xc(e) {
  const { body: t, files: n, sourceTitle: r, activeFile: i = null, versions: s = {} } = e, o = /* @__PURE__ */ new Map(), l = [];
  for (const b of Lr(t))
    for (const y of bc(b)) {
      if (!y.path) {
        if (i) {
          const V = _n(i.content, y.raw);
          V && V !== i.content && o.set(i.id, $t({
            file: i,
            proposedContent: V,
            sourceTitle: r,
      ...
      const N = Ea(n, y.path);
      if (!N) {
        l.push(`${y.path}: no opened file`);
        continue;
      }
      const z = _n(N.file.content, y.raw);
      if (!z || z === N.file.content) {
        l.push(`${y.path}: patch did not match or produced no change`);
        continue;
      }
      o.set(N.file.id, $t({
        file: N.file,
        proposedContent: z,
        sourceTitle: r,
        extractionLabel: `workspace diff (${y.path})`,
        versions: s,
        targetPath: y.path,
        match: N
      }));
  ...
  for (const b of $n(t)) {
    const y = b.path ? Ea(n, b.path) : i ? { file: i, normalizedPatchPath: lt(i.path), confidence: "exact" } : null;
    if (!y) {
      l.push(`${b.path ?? "replacement block"}: no opened file`);
      continue;
    }
    if (b.content === y.file.content) {
      l.push(`${y.file.path}: replacement produced no change`);
      continue;
    }
    o.set(y.file.id, $t({
      file: y.file,
      ...
      versions: s,
      targetPath: b.path ?? y.file.path,
      match: y
    }));
  }
  const m = $n(t).some((b) => b.path);
  if (o.size === 0 && i && !m) {
    const b = Pc(t, i);
    b && b.content !== i.content && o.set(i.id, $t({
      file: i,
      proposedContent: b.content,
      sourceTitle: r,
      extractionLabel: b.label,
  ...
  return {
    ...
    stats: Tc(p.map((b) => b.stats)),
    kind: p.length === 0 ? "empty" : p.length === 1 ? "single-file" : "multi-file"
  };
}
function Pc(e, t) {
  for (const m of Lr(e)) {
    const p = _n(t.content, m);
    if (p) return { content: p, label: "unified diff patch" };
  }
  const n = va(e);
  if (n.length === 0) return null;
  const r = Ac(t), i = $n(e)[0];
  if (i) return { content: i.content, label: i.label };
  const s = n.find((m) => r.some((p) => $e(m, p)) && !$e(m, "diff") && !$e(m, "patch"));
  if (s) return { content: s.content, label: `matched ${s.lang || t.language} block` };
  const l = n.filter((m) => !$e(m, "diff") && !$e(m, "patch")).sort((m, p) => p.content.length - m.content.length)[0];
  return l ? { content: l.content, label: `largest fenced block (${l.lang || "plain"})` } : null;
}
function Ea(e, t) {
  const n = lt(t), r = n.split("/").at(-1) ?? n, i = e.find((l) => lt(l.path) === n);
  if (i) return { file: i, normalizedPatchPath: n, confidence: "exact" };
  const s = e.find((l) => lt(l.path).endsWith(`/${n}`));
  if (s) return { file: s, normalizedPatchPath: n, confidence: "suffix" };
  const o = e.find((l) => l.name === r || lt(l.path).endsWith(`/${r}`));
...
`), i = Math.max(n.length, r.length);
  let s = 0, o = 0, l = 0;
  for (let m = 0; m < i; m += 1)
    n[m] !== r[m] && (n[m] === void 0 ? s += 1 : r[m] === void 0 ? o += 1 : l += 1);
  return { added: s, removed: o, changed: l };
}
function Tc(e) {
  return e.reduce((t, n) => ({
...
function $t(e) {
  ...
  return {
    ...
    stats: Nc(e.file.content, e.proposedContent),
    base: {
...
const gn = (e) => typeof e == "object" && e !== null, Lc = (e) => gn(e.ai) ? e.ai : null, Xc = (e) => {
  if (!gn(e)) return null;
  const t = e.id;
  return typeof t == "string" && t.trim() ? t : null;
}, Cc = (e) => {
  const t = Xc(e);
  return !t || !gn(e) ? null : { ...e, id: t };
}, rt = (e) => typeof e == "string" ? /\bembeddings?\b|text-embedding/i.test(e) : Array.isArray(e) ? e.some(rt) : gn(e) ? Object.values(e).some(rt) : !1, Oc = async (e, t) => {
  const n = Lc(e);
  if (typeof n?.listModels != "function") return [];
  const r = await n.listModels(t);
  return Array.isArray(r) ? r.map(Cc).filter((i) => !!i) : [];
}, Sc = (e) => (e.embedding ?? e.embeddings ?? e.supportsEmbedding ?? e.supportsEmbeddings) === !0 ? !0 : rt(e.capability) || rt(e.capabilities) || rt(e.modality) || rt(e.modalities) || rt(e.task) || rt(e.tasks) || rt(e.type) || rt(e.kind), Cr = (e) => typeof e == "object" && e !== null, Hc = (e) => Cr(e.ai) ? e.ai : null, Or = (e) => typeof Hc(e)?.embedText == "function", jc = async (e, t) => Or(e) ? (await Oc(e, t)).filter(Sc) : [], Mc = (e) => Cr(e.ai) ? Or(e) ? null : "host.ai.embedText is not exposed by this Tytus build." : "host.ai is not available in this Tytus build.", Wc = ["typecheck", "test", "lint", "build", "release:check", "verify", "verify:cortex"], Vc = [
...
function Dc(e) {
  const t = e.results.length > 0 ? e.results.map((r, i) => [
    ...
    `Status: ${r.status}`,
    "Output:",
    Uc(r.output || "(no output pasted)", "text")
  ].join(`
`)).join(`
...
function qc(e) {
  ...
  for (const r of t) {
    const i = Yc(r.content);
    if (!i?.scripts) continue;
    const s = Hr(r.path), o = Jc(e, s, i);
    if (!o) continue;
    const l = Object.keys(i.scripts).filter((p) => typeof i.scripts?.[p] == "string"), m = Zc(l);
    for (const p of m) {
      const b = `${o} run ${p}`;
      n.push({
        id: jr(`${s}:${b}`),
...
function Jc(e, t, n) {
  ...
  for (const [r, i] of Vc)
    if (e.some((s) => Bc(s.path) === r && Hr(s.path) === t)) return i;
  return null;
}
function Zc(e) {
  const t = Wc.filter((r) => e.includes(r)), n = e.filter((r) => !t.includes(r)).filter((r) => /(^|:)(check|typecheck|test|lint|verify|build)(:|$)/i.test(r)).sort((r, i) => r.localeCompare(i));
  return [...t, ...n];
}
function Kc(e) {
  const t = /* @__PURE__ */ new Set();
...
function el({ className: e }) {
  return /* @__PURE__ */ a("img", { src: _c, alt: "ATOMEK", className: e, draggable: !1 });
}
const Wr = {
...
}, qa = { en: Wr, es: tl }, Ya = (e) => (e || "en").toLowerCase().split("-")[0] || "en", nl = (e, t) => t ? e.replace(/\{(\w+)\}/g, (n, r) => String(t[r] ?? `{${r}}`)) : e, Vr = xs({ locale: "en", t: (e) => Wr[e] ?? e });
function al({ host: e, children: t }) {
  const [n, r] = P(() => Ya(e.i18n?.locale));
  pe(() => e.i18n?.onLocaleChange((s) => r(Ya(s))), [e]);
  const i = ue(() => ({
    locale: n,
    t: (s, o) => {
      const l = e.i18n?.t(s, o);
      return l && l !== s ? l : nl(qa[n]?.[s] ?? qa.en[s] ?? s, o);
    }
  }), [e, n]);
  return /* @__PURE__ */ a(Vr.Provider, { value: i, children: t });
}
function _e() {
  return Ps(Vr).t;
}
const rl = `# Tytus Resource Fabric
...
], dl = "tytus-atomek-handles", Ht = "handles", ul = 1, Ir = () => new Promise((e, t) => {
  const n = indexedDB.open(dl, ul);
  n.onupgradeneeded = () => {
    const r = n.result;
...
async function Ja(e, t) {
  ...
  await new Promise((r, i) => {
    const s = n.transaction(Ht, "readwrite");
    s.objectStore(Ht).put(t, e), s.oncomplete = () => r(), s.onerror = () => i(s.error ?? new Error("Failed to persist file handle"));
  }), n.close();
}
async function Wn(e) {
  const t = await Ir(), n = await new Promise((r, i) => {
    const o = t.transaction(Ht, "readonly").objectStore(Ht).get(e);
    o.onsuccess = () => r(o.result ?? null), o.onerror = () => i(o.error ?? new Error("Failed to read file handle"));
  });
  return t.close(), n;
}
const hl = Ns(() => import("./WorkbenchMonacoEditor-DeMocMpz.js").then((e) => e.W).then((e) => ({ default: e.WorkbenchMonacoEditor }))), ml = {
  id: "welcome",
  name: "Agent Team",
  path: "Agent Team",
  language: "text",
  ...
  dirty: !1,
  source: "sample"
}, Fr = "tytus.workspace.recent", Rr = "tytus.workspace.layout", Dr = "tytus.atomek.session.v2", Er = "tytus.atomek.chatAiSettings", Vn = "atomek:default", Za = "0.4.35", un = {
...
function vl(e) {
  ...
  if (t.length === 0 || e.startsWith("/") || e.includes("\\") || t.some((n) => n === "." || n === ".."))
    throw new Error(`Unsafe mission file path: ${e}`);
}
function In(e) {
  const t = Math.max(e || 1400, 760), n = Math.max(0, t - fl), r = n < 1180, i = r ? 200 : 240, s = r ? 280 : 300, o = r ? 360 : 420, l = Math.max(i, Math.min(r ? 340 : 420, Math.floor(n * 0.28))), m = Math.min(300, l), p = Math.floor(n * (r ? 0.5 : 0.62)), b = n - m - o, y = Math.max(s, Math.min(r ? 1e3 : 1400, p, b));
  return { primaryMin: i, primaryMax: l, secondaryMin: s, secondaryMax: y };
}
function yl(e) {
  const t = [], n = /```([^\n`]*)\n?([\s\S]*?)```/g;
  let r = 0, i = 0, s;
...
function gl({ host: e }) {
  const t = _e(), n = Re(null), [r, i] = P(0), s = ue(() => ad(), []), o = ue(() => $l(), []), l = ue(() => Ql(Gl(), o.recent), [o.recent]), [m, p] = P(() => pl(o.activity) || "explorer"), [b, y] = P(s.primaryVisible), [N, z] = P(s.primaryWidth), [V, R] = P(o.secondaryTab ?? "chat"), [Y, B] = P(s.secondaryVisible), [we, G] = P(s.secondaryWidth), [M, I] = P(!!o.bottomPanelVisible), [he, se] = P(() => bl(o.bottomPanelTab)), [T, x] = P(s.markdownPreviewVisible), [Te, ne] = P(!!o.welcomeClosed), [ze, Me] = P(o.folder ? { name: o.folder.name, files: [] } : null), [De, We] = P(o.folder?.handleKey ?? null), [f, D] = P(() => _l(o.files)), [Q, ke] = P(() => (o.openEditorIds ?? []).filter((c) => (o.files ?? []).some((h) => h.id === c))), [ie, L] = P(() => o.activeFileId && (o.files ?? []).some((c) => c.id === o.activeFileId) ? o.activeFileId : null), [O, q] = P(o.query ?? ""), [S, $] = P({ lineNumber: 1, column: 1 }), [ce, ge] = P(null), [be, g] = P({}), [X, Xe] = P(bo), [E, Ue] = P([]), [et, Ee] = P([]), [_, ae] = P(null), [re, me] = P(o.chatInput ?? ""), [Pe, He] = P(!1), [it, Z] = P(""), [ve, Ae] = P([]), [le, Je] = P(null), [Ge, ot] = P(null), [Zt, pt] = P(!1), [tt, wn] = P(() => rd()), [d, A] = P([st]), [H, C] = P(() => Ri(Vn)), [F, ee] = P(null), [W, Le] = P(null), [xe, de] = P(""), [qe, fe] = P(""), [te, U] = P(""), [Ce, Ze] = P("failed"), [Ye, Oe] = P(null), [dt, j] = P("Ready"), [Wt, Gr] = P(() => l), Ke = Q.map((c) => f.find((h) => h.id === c)).filter(Boolean), J = ie ? f.find((c) => c.id === ie) ?? null : null, ga = ue(() => po({ files: f, openEditorIds: Q, activeFileId: ie, versions: be, activeSelection: ce }), [ie, ce, be, f, Q]), wa = ue(() => ({
    scope: X,
    removedAttachmentIds: E,
    selectedFileIds: []
  }), [X, E]), Vt = ue(() => Ao(ga, f, wa), [wa, ga, f]), ut = Go(f, { autoRefresh: !0, includeDirty: !0 }), ka = ue(() => et.map((c) => ({
    id: c.id,
    kind: "index-hit",
    label: c.label,
    path: c.path,
    ...
    snippet: c.snippet
  })), [et]), Qr = ue(() => [...Vt.attachments, ...ka], [Vt.attachments, ka]), xa = ue(() => d.find((c) => c.id === H) ?? st, [d, H]), oe = ho({ host: e, requestContext: Vt.parts, chatSettings: tt, selectedTarget: xa, setStatus: j }), bt = ue(
    () => [...oe.artifacts, ...ve].sort((c, h) => h.createdAt - c.createdAt),
    [oe.artifacts, ve]
  ), Kt = Zt && !J, kn = !J && !Kt && !Te, Ve = ue(() => f.filter((c) => c.dirty), [f]), $r = ue(() => {
    const c = O.trim().toLowerCase();
    return c ? f.filter((h) => h.path.toLowerCase().includes(c)) : f;
  }, [f, O]);
  pe(() => {
    g((c) => {
      const h = {};
      for (const v of f) h[v.id] = c[v.id] ?? 1;
      return h;
    });
  }, [f]), pe(() => {
    Ue([]), Ee([]);
    ...
    const h = async () => {
      const k = await Gi(e);
      c && (A(k), C((K) => {
        const Ne = k.some((je) => je.id === K) ? K : st.id;
        return Ne !== K && Ha(Vn, Ne), Ne;
      }));
    };
    h();
    const v = e.daemon.onStateChange(() => {
      h();
    });
    return () => {
      c = !1, v?.();
  ...
  const _r = w((c) => {
    const h = d.find((v) => v.id === c) ?? st;
    C(h.id), Ha(Vn, h.id), j(`Chat target: ${h.label}`);
  }, [d, j]), es = w((c) => {
    if (c.kind === "index-hit") {
      Ee((h) => h.filter((v) => v.id !== c.id)), j(`Removed project context: ${c.label}`);
      return;
    }
    Ue((h) => h.includes(c.id) ? h : [...h, c.id]), j(`Removed chat context: ${c.label}`);
  }, []), Bt = w(() => {
    pt(!0), L(null), ne(!0), j("Atomek settings opened");
  }, []), Pa = w(() => {
    pt(!1), L((c) => c ?? Q.at(-1) ?? null), Q.length === 0 && ne(!1), j("Atomek settings closed");
  }, [Q]), xt = w((c) => {
    g((h) => ({ ...h, [c]: (h[c] ?? 1) + 1 }));
  }, []), ts = w((c) => {
    c.preventDefault(), c.currentTarget.setPointerCapture?.(c.pointerId);
    const h = In(r), v = c.clientX, k = we, K = (je) => {
      const vt = k + (v - je.clientX);
      G(en(vt, h.secondaryMin, h.secondaryMax));
    }, Ne = () => {
      window.removeEventListener("pointermove", K), window.removeEventListener("pointerup", Ne);
    };
    window.addEventListener("pointermove", K), window.addEventListener("pointerup", Ne);
  }, [we, r]), ns = w((c) => {
    c.preventDefault(), c.currentTarget.setPointerCapture?.(c.pointerId);
    const h = In(r), v = c.clientX, k = N, K = (je) => {
      const vt = k + (je.clientX - v);
      z(en(vt, h.primaryMin, h.primaryMax));
    }, Ne = () => {
      window.removeEventListener("pointermove", K), window.removeEventListener("pointerup", Ne);
    };
    window.addEventListener("pointermove", K), window.addEventListener("pointerup", Ne);
    ...
    Gr((h) => {
      const v = [c, ...h.filter((k) => k.path !== c.path)].slice(0, 10);
      return localStorage.setItem(Fr, JSON.stringify(v)), v;
    });
  }, []), Se = w((c, h) => {
    ke((v) => v.includes(c.id) ? v : [...v, c.id]), L(c.id), ne(!1), Oe(h ?? null), $({ lineNumber: h ?? 1, column: 1 });
  }, []), xn = w((c, h, v = {}) => {
    const k = v.primaryOnly === !1 ? h : ji(h), K = Hi(c, k);
    if (K.length === 0) return;
    const Ne = new Set(
      f.filter((Ie) => Ie.source === "mission" && Ie.dirty && Ie.mission?.missionId === c.missionId).map((Ie) => Ie.mission?.relPath).filter(Boolean)
    ), je = K.filter((Ie) => !Ne.has(Ie.mission?.relPath ?? "")), vt = K.length - je.length;
    if (je.length > 0 && (D((Ie) => Et(Ie, je)), v.openTabs !== !1 && (ke((Ie) => Array.from(/* @__PURE__ */ new Set([...Ie, ...je.map((On) => On.id)]))), v.activate !== !1))) {
      const Ie = je.find((On) => On.mission?.relPath === v.activatePath) ?? je[0];
      L(Ie.id), ne(!1), x(!0), Oe(null), $({ lineNumber: 1, column: 1 });
    }
    if (!v.quiet) {
      const Ie = v.openTabs === !1 ? "Updated" : "Opened";
      j(`${je.length ? `${Ie} ${je.length} mission file${je.length === 1 ? "" : "s"}` : "Mission files already open"}${vt ? ` · skipped ${vt} dirty tab${vt === 1 ? "" : "s"}` : ""}`);
    }
  }, [f]), as = w((c) => {
    const h = {
      id: `atomek-doc:${c.id}`,
      name: c.fileName,
      path: `Atomek Docs/${c.fileName}`,
      language: "markdown",
      content: c.body,
      dirty: !1,
      source: "sample"
    };
    D((v) => Et(v, [h])), Se(h), R("chat"), B(!0), x(!0), j(`Opened Atomek guide: ${c.title}`);
  }, [Se]), rs = w((c) => {
    if (!c.fileId) return;
    const h = f.find((v) => v.id === c.fileId);
    h && (Se(h, c.range?.startLineNumber ?? 1), j(`Revealed context: ${c.label}`));
  }, [f, Se]), It = w(async () => {
    if (Fn(Ve, "open new files"))
      try {
        const c = await vi();
        if (c.length === 0) return;
        D((h) => Et(h, c)), await Promise.all(c.map(async (h) => {
          const v = h.handle ? `file:${h.path}` : void 0;
          h.handle && v && await Ja(v, h.handle), ht({ name: h.name, path: h.path, kind: "file", handleKey: v, at: Date.now() });
        })), Se(c[0]), j(`Opened ${c.length} local file${c.length === 1 ? "" : "s"}`);
      } catch (c) {
        c.name !== "AbortError" && j(`Open file failed: ${c.message}`);
      }
  }, [Ve, Se, ht]), Pn = w(async () => {
    if (Fn(Ve, "open another folder"))
      try {
        const c = await yi(), h = c.handle ? `folder:${c.name}:${Date.now()}` : null;
        c.handle && h && await Ja(h, c.handle), We(h), Me(c), D(c.files), ke([]), L(null), ne(!1), ht({ name: c.name, path: c.name, kind: "folder", handleKey: h ?? void 0, at: Date.now() }), j(`${c.handle ? "Opened local folder" : "Opened browser fallback folder"} ${c.name} (${c.files.length} text files indexed)`);
      } catch (c) {
        c.name !== "AbortError" && j(`Open folder failed: ${c.message}`);
      }
  }, [Ve, ht]), ss = w((c) => {
    if (!ie) return;
    let h = !1;
    D((v) => v.map((k) => k.id !== ie || k.content === c ? k : (h = !0, { ...k, content: c, dirty: !0 }))), h && xt(ie);
  }, [ie, xt]), Pt = w(async (c) => {
    if (c.source !== "mission") return wi(c);
    const h = c.mission?.relPath, v = c.mission?.rootPath;
    if (!h)
      throw new Error("Mission file save requires mission metadata. Recreate or refresh the mission pack.");
    if (vl(h), v && e.missions?.write)
      return await e.missions.write({ rootPath: v, files: [{ path: h, content: c.content }] }), { ...c, dirty: !1 };
    if (c.mission?.handle)
      return await cr(c.mission.handle, h, c.content), { ...c, dirty: !1 };
    throw new Error("Mission file save requires a tray mission path. Recreate or refresh the mission pack.");
  }, [e.missions]), Nn = w(async () => {
    if (J)
      try {
        const c = await Pt(J);
        D((h) => h.map((v) => v.id === c.id ? c : v)), j(`Saved ${c.name}`);
      } catch (c) {
        j(`Save failed: ${c.message}`);
      }
  }, [J, Pt]), is = w(async (c) => {
    const h = f.find((k) => k.id === c);
    if (!h) return null;
    const v = await Pt(h);
    return D((k) => k.map((K) => K.id === v.id ? v : K)), v;
  }, [f, Pt]), Na = w(async () => {
    const c = f.filter((h) => h.dirty);
    if (c.length === 0) {
      j("No dirty files to save");
      return;
    }
    try {
      const h = await Promise.all(c.map((k) => Pt(k))), v = new Map(h.map((k) => [k.id, k]));
      D((k) => k.map((K) => v.get(K.id) ?? K)), ee(null), j(`Saved ${h.length} dirty file${h.length === 1 ? "" : "s"}`);
    } catch (h) {
      j(`Save all failed: ${h.message}`);
    }
  }, [f, Pt]), Tn = w((c) => {
    const h = f.find((v) => v.id === c);
    if (h?.dirty && !window.confirm(`${h.name} has unsaved changes. Close without saving?`)) {
      j(`Close canceled — ${h.name} has unsaved changes`);
      return;
    }
    ke((v) => {
      const k = v.filter((K) => K !== c);
      return ie === c && (L(k.at(-1) ?? null), ge(null)), k;
    });
  }, [ie, f]), os = w(() => {
    Fn(Ve, "close all editors") && (ke([]), L(null), Oe(null), ne(!1), j("Closed all editors"));
  }, [Ve]), zn = w(() => {
    const c = f.filter((v) => v.name.startsWith("Untitled")).length + 1, h = {
...
`,
    ...
    return Ee(k), k.length === 0 ? (j(ut.snapshot.chunks.length === 0 ? "Project index is empty — open a folder with readable files first" : "Project index found no matching context for this prompt"), h) : (v.mode !== "hybrid" && v.reason ? j(v.reason) : j(`${k.length} project context hit${k.length === 1 ? "" : "s"} · ${v.reason ?? "hybrid retrieval"}`), [
      ...h,
      ...rc(k)
    ]);
  }, [Vt.parts, X, tt, e, ut]), An = w(() => {
    if (!J && Ke.length === 0) {
      j("Open a file before asking Atomek to synthesize an AI artifact");
      return;
    }
    const h = [
      `Create a polished Markdown artifact from ${J?.path ?? `${Ke.length} open editors`}.`,
    ...
    B(!0), R("chat"), j("Asking Atomek to synthesize an AI artifact…"), (async () => {
      const v = await mt(h), k = await oe.askAgent(h, { requestContext: v });
      !k || k.status === "error" || oe.createArtifact({
        messageId: k.id,
        title: `AI synthesis — ${J?.name ?? "open workspace"}`,
        kind: "markdown",
        body: k.body
      }).then(() => {
        B(!0), R("outputs"), I(!0), se("output");
      });
    })();
  }, [J, oe, mt, Ke.length]), Ln = w(async (c) => {
    if (c.kind === "folder") {
      const v = f.filter((k) => k.path === c.path || k.path.startsWith(`${c.path}/`));
      if (ze?.name === c.name || v.length > 0) {
        v.length > 0 && (Me((k) => k?.name === c.name ? k : { name: c.name, files: v }), D((k) => Et(k, v))), p("explorer"), y(!0), L(null), ne(!1), ht({ ...c, at: Date.now() }), j(`Opened recent folder ${c.name}`);
        return;
      }
    }
    const h = f.find((v) => v.path === c.path || v.name === c.name);
    if (h) {
      Se(h), j(`Opened recent ${h.name}`);
      return;
    }
    if (!c.handleKey) {
    ...
    try {
      if (c.kind === "folder") {
        const K = await Wn(c.handleKey);
        if (!K || !await Sn(K, "readwrite")) {
          j("Browser permission expired for this folder. Click Open Folder and pick it once to refresh the recent handle.");
          return;
        }
        const Ne = await Oa(K);
        We(c.handleKey), Me(Ne), D(Ne.files), ke([]), L(null), ne(!1), ht({ ...c, at: Date.now() }), j(`Reopened ${Ne.name} (${Ne.files.length} text files indexed)`);
        return;
      }
      const v = await Wn(c.handleKey);
      if (!v || !await Sn(v, "readwrite")) {
        j("Browser permission expired for this file. Click Open File and pick it once to refresh the recent handle.");
        return;
      }
      const k = await gi([v]);
      if (!k[0]) {
        j(`Recent file is not readable text: ${c.name}`);
        return;
      }
      D((K) => Et(K, k)), Se(k[0]), ht({ ...c, at: Date.now() }), j(`Reopened ${k[0].name}`);
    } catch (v) {
      j(`Open recent failed: ${v instanceof Error ? v.message : String(v)}`);
    }
  }, [f, ze?.name, Se, ht]), Be = w((c) => {
    B(!0), R("chat"), me(""), (async () => {
      const h = await mt(c);
      await oe.askAgent(c, { requestContext: h });
    })();
  }, [oe, mt]), Ta = w(async (c) => {
    if (!e.skills?.get) {
    ...
    try {
      const h = await e.skills.get(c.id), v = h.body.length > 4500 ? `${h.body.slice(0, 4500)}

[Skill pack clipped by Atomek. Ask for the full pack if needed.]` : h.body, k = [
...
`);
      me((K) => [K.trim(), k].filter(Boolean).join(`

`)), B(!0), R("chat"), j(`Attached skill ${h.title} to chat input`);
    } catch (h) {
      j(`Failed to attach skill: ${h instanceof Error ? h.message : String(h)}`);
    }
  }, [e.skills]), cs = w((c) => {
    const h = oe.messages.findIndex((k) => k.id === c.id), v = oe.messages.slice(0, h < 0 ? void 0 : h).reverse().find((k) => k.role === "user");
    if (!v?.body.trim()) {
      j("No previous user prompt to regenerate from");
      return;
    }
    (async () => {
      const k = await mt(v.body);
      await oe.askAgent(v.body, { requestContext: k });
    })();
  }, [oe, mt]), ls = w((c) => {
    oe.createArtifact({
      messageId: c.id,
...
`).find(Boolean)?.replace(/^#+\s*/, "").slice(0, 80) || "Atomek memory",
    ...
    oe.createArtifact({
      title: J.path,
      kind: J.language === "markdown" ? "markdown" : "report",
      body: J.content
    }).then(() => {
      B(!0), R("outputs"), I(!0), se("output");
    });
  }, [J, oe]), Xn = w((c) => {
    const h = Dn(f, Rn(c.title || c.kind)), v = {
    ...
    D((k) => [...k, v]), Se(v), j(`Opened ${c.title} as editable file`);
  }, [f, Se]), Cn = w(() => {
    ...
    const v = window.prompt("Paste check output/result");
    if (v === null) return;
    const k = [
      "# Manual check result",
      "",
...
`), K = {
    ...
    Ae((Ne) => [K, ...Ne]), I(!0), se("output"), j(`Captured manual check: ${h}`);
  }, []), Nt = w((c, h) => {
    const v = xc({
      body: h,
      files: f,
      ...
      edits: v.edits.map(Bl),
      skipped: v.skipped
    };
    return v.edits.length > 1 ? (ot(k), Je(null), j(`Previewing AI workspace patch for ${v.edits.length} files`), !0) : v.edits.length === 1 ? (Je(k.edits[0]), ot(null), j(`Previewing AI patch for ${k.edits[0].fileName}`), !0) : (j(v.skipped.length > 0 ? `No applicable edit found. ${v.skipped.slice(0, 2).join(" · ")}` : "No fenced replacement block or applicable unified diff found. Ask Atomek for an edit again."), !1);
  }, [J, be, f]), za = w((c, h) => {
    const v = {
    ...
    Ae((k) => [v, ...k]), B(!0), R("outputs"), I(!0), se("output"), j(`Saved local job output: ${c}`), (h.includes("```diff") || h.includes("--- a/")) && Nt(c, h);
  }, [Nt]), hs = w(() => {
    const c = re.trim();
    if (!c) return;
    me("");
    const h = Vl(c);
    (async () => {
      const v = await mt(c), k = await oe.askAgent(c, { requestContext: v });
      if (!h || !k || k.status === "error") return;
      Nt(k.body.split(`
`).find(Boolean)?.replace(/^#+\s*/, "").slice(0, 80) || "Atomek edit", k.body) || j("Edit request answered without a patch. Use Generate patch / Edit to request an applicable diff.");
    })();
  }, [oe, mt, re, Nt]), ms = w(() => {
    _ && (ae(null), Be(Il(_)));
  }, [Be, _]), Ft = w((c) => {
    const h = Ic(f, c);
    Le(h);
    const v = h.commands[0]?.command ?? "";
    U(v), de(""), fe(""), Ze("failed"), I(!0), se("terminal"), j(h.commands.length > 0 ? `Manual check ready: copy ${h.commands[0].command}` : "Manual check ready: enter a check command to copy");
  }, [f]), fs = w((c) => {
    c.trim() && (jt(c), U(c), j(`Manual check command copied: ${c}`));
  }, []), ps = w(() => {
    Le((c) => {
      if (!c) return c;
      const h = Fc(c, xe), v = h.commands.at(-1)?.command ?? "";
      return v && U(v), h;
    }), de("");
  }, [xe]), bs = w(() => {
    if (!W || !te.trim()) {
    ...
    const c = te.trim();
    Le((h) => h && Rc(h, c, Ce, qe)), fe(""), j(`Captured manual check result: ${c} (${Ce})`);
  }, [qe, te, W, Ce]), vs = w(() => {
    W && Be(Dc(W));
  }, [Be, W]), ys = w(() => {
    if (!le) return;
    const c = f.find((h) => h.id === le.fileId);
    if (!c) {
      j(`Cannot apply edit — ${le.fileName} is no longer open`), Je(null);
      return;
    }
    c.content !== le.originalContent && !window.confirm(`${le.fileName} changed after the preview was created. Apply the AI edit anyway?`) || (D((h) => h.map((v) => v.id === le.fileId ? { ...v, content: le.proposedContent, dirty: !0 } : v)), xt(le.fileId), ee(`AI edit applied to ${c.name}. Save All to persist it to disk.`), Je(null), Ft(`AI edit applied to ${c.name}`), j(`Applied AI edit to ${c.name} — unsaved; manual check ready`));
  }, [xt, f, le, Ft]), gs = w(() => {
    if (!le) return;
    const c = Dn(f, `${Rn(le.fileName)}-ai-edit`), h = {
      id: `pending-edit-${le.fileId}-${Date.now()}`,
      name: c,
      path: c,
      language: J?.language ?? "markdown",
      content: le.proposedContent,
      dirty: !0,
      source: "generated"
    };
    D((v) => [...v, h]), Se(h), Je(null), j(`Opened proposed edit as ${c}`);
  }, [J?.language, f, Se, le]), ws = w(() => {
    if (!Ge) return;
    const c = new Map(Ge.edits.map((v) => [v.fileId, v]));
    f.some((v) => {
      const k = c.get(v.id);
      return k && v.content !== k.originalContent;
    }) && !window.confirm("One or more files changed after the workspace patch preview was created. Apply anyway?") || (D((v) => v.map((k) => {
      const K = c.get(k.id);
      return K ? { ...k, content: K.proposedContent, dirty: !0 } : k;
    })), c.forEach((v, k) => xt(k)), ee(`AI workspace patch applied to ${c.size} file${c.size === 1 ? "" : "s"}. Save All to persist changes.`), ot(null), Ft(`AI workspace patch applied to ${c.size} file${c.size === 1 ? "" : "s"}`), j(`Applied AI workspace patch to ${c.size} file${c.size === 1 ? "" : "s"} — unsaved; manual check ready`));
  }, [xt, f, Ge, Ft]), ks = w(() => {
    if (!Ge) return;
    const c = [...f], h = Ge.edits.map((v) => {
      const k = Dn(c, `${Rn(v.fileName)}-ai-edit`), K = f.find((je) => je.id === v.fileId), Ne = {
        id: `workspace-patch-${v.fileId}-${Date.now()}-${k}`,
        name: k,
        path: k,
        language: K?.language ?? "markdown",
        content: v.proposedContent,
        dirty: !0,
        source: "generated"
      };
      return c.push(Ne), Ne;
    });
    D((v) => [...v, ...h]), h[0] && Se(h[0]), ot(null), j(`Opened ${h.length} proposed edit file${h.length === 1 ? "" : "s"}`);
  }, [f, Se, Ge]), Aa = w((c) => {
    if (c === "explain") {
      Be("Explain the active file. Focus on purpose, structure, risks, and next useful edits.");
      return;
    }
    if (c === "improve") {
      Be("Review the active file and propose the smallest concrete improvements. Include exact snippets if useful.");
      return;
    }
    if (c === "plan") {
      Be("Create an implementation plan from the open editor context. Be specific, ordered, and call out blockers.");
      return;
    }
    if (c === "edit") {
      Be("Edit the active file or open workspace files. Prefer one git-style unified diff in a fenced diff block, with paths matching opened files. If editing one file, a complete fenced replacement is also OK. Do not use provider-specific tools or model assumptions.");
      return;
    }
    Be("Draft a concrete Markdown artifact from the open editor context. Make it ready to save as an output.");
  }, [Be]);
  return pe(() => {
    const c = (h) => {
      (h.metaKey || h.ctrlKey) && (h.key.toLowerCase() === "o" && (h.preventDefault(), It()), h.key.toLowerCase() === "s" && (h.preventDefault(), Nn()), h.key.toLowerCase() === "w" && (h.preventDefault(), ie && Tn(ie)), h.key.toLowerCase() === "b" && (h.preventDefault(), y((k) => !k)), h.shiftKey && h.key.toLowerCase() === "f" && (h.preventDefault(), p("search"), y(!0)), (h.key.toLowerCase() === "k" || h.key.toLowerCase() === "p") && (h.preventDefault(), He(!0)));
    };
    return window.addEventListener("keydown", c), () => window.removeEventListener("keydown", c);
  }, [ie, Tn, It, Nn]), pe(() => {
    const c = (h) => {
      Ve.length !== 0 && (h.preventDefault(), h.returnValue = "");
    };
    ...
    const c = n.current;
    if (!c) return;
    const h = () => i(Math.round(c.getBoundingClientRect().width));
    h();
    ...
    if (!r) return;
    const c = In(r);
    z((h) => en(h, c.primaryMin, c.primaryMax)), G((h) => en(h, c.secondaryMin, c.secondaryMax));
  }, [r]), pe(() => {
    const c = { primaryVisible: b, primaryWidth: N, secondaryVisible: Y, secondaryWidth: we, markdownPreviewVisible: T };
    localStorage.setItem(Rr, JSON.stringify(c));
  }, [T, b, N, Y, we]), pe(() => {
    if (!o.folder?.handleKey) return;
    let c = !1;
    return (async () => {
      try {
        const h = await Wn(o.folder?.handleKey ?? "");
        if (!h || !await Sn(h, "readwrite") || c) return;
        const v = await Oa(h);
        if (c) return;
        We(o.folder?.handleKey ?? null), Me(v), D((k) => nd(k, v.files)), ke((k) => k.filter((K) => v.files.some((Ne) => Ne.id === K) || f.some((Ne) => Ne.id === K))), j(`Restored ${v.name} (${v.files.length} text files indexed)`);
      } catch (h) {
        c || j(`Workspace restore failed: ${h instanceof Error ? h.message : String(h)}`);
      }
    })(), () => {
      c = !0;
    };
    ...
    td({
      activity: m,
      folder: ze ? { name: ze.name, handleKey: De } : null,
      files: ed(f),
      openEditorIds: Q,
      activeFileId: ie,
      query: O,
      ...
      welcomeClosed: Te,
      secondaryTab: V,
      bottomPanelVisible: M,
      bottomPanelTab: he,
      recent: Wt
    });
  }, [m, ie, he, M, re, De, f, ze, Q, O, Wt, V, Te]), pe(() => {
    localStorage.setItem(Er, JSON.stringify(tt));
  }, [tt]), /* @__PURE__ */ u(
    "div",
    {
      ref: n,
      className: `workbench-workbench ${b ? "" : "no-primary"} ${Y ? "" : "no-secondary"} ${M ? "has-bottom-panel" : ""}`,
      "data-app": "workbench-vscode-base",
      style: { "--workbench-primary-width": `${N}px`, "--workbench-secondary-width": `${we}px` },
      children: [
        /* @__PURE__ */ a(
          wl,
          {
        ...
        b && /* @__PURE__ */ u("div", { className: "workbench-primary-region", children: [
          /* @__PURE__ */ a(
            kl,
            {
              host: e,
              ...
              openFile: It,
              openFolder: Pn,
              openWorkbenchFile: Se,
              newFile: zn,
              recent: Wt,
              reopenRecent: Ln,
              setStatus: j,
              hasFsAccess: bi(),
              attachSkillToChat: Ta,
              saveLocalJobOutput: za,
              activeFile: J,
              openMissionFiles: xn
            }
          ),
          /* @__PURE__ */ a("div", { className: "workbench-primary-resizer", onPointerDown: ns, title: t("shell.resizeExplorer") })
        ] }),
        /* @__PURE__ */ u("main", { className: "workbench-editor-area", children: [
          /* @__PURE__ */ a("button", { className: "workbench-command-center", onClick: () => He(!0), children: t("app.workspace") }),
          /* @__PURE__ */ u("section", { className: "workbench-editor-stack", children: [
            /* @__PURE__ */ a(
              Tl,
              {
                ...
                closeSettings: Pa,
                secondaryVisible: Y,
                toggleSecondary: () => B((c) => !c),
                canPreview: J?.language === "markdown",
                previewVisible: T,
                togglePreview: () => x((c) => !c)
              }
            ),
            /* @__PURE__ */ a(Nl, { file: J, folder: ze, showWelcome: kn }),
            F && Ve.length > 0 ? /* @__PURE__ */ u("div", { className: "workbench-ai-dirty-banner", children: [
              /* @__PURE__ */ a("span", { children: F }),
              /* @__PURE__ */ a("button", { onClick: () => {
                Na();
              }, children: t("shell.saveAll") }),
              /* @__PURE__ */ a("button", { onClick: () => ee(null), title: t("shell.dismiss"), children: /* @__PURE__ */ a(at, { size: 13 }) })
            ] }) : null,
            /* @__PURE__ */ a("div", { className: "workbench-editor-content", children: J ? /* @__PURE__ */ u("div", { className: J.language === "markdown" && T ? "workbench-editor-split" : "workbench-editor-single", children: [
              /* @__PURE__ */ a("div", { className: "workbench-editor-pane", children: /* @__PURE__ */ a(Ts, { fallback: /* @__PURE__ */ a("div", { className: "workbench-empty-pane", children: t("shell.loadingEditor") }), children: /* @__PURE__ */ a(
                hl,
                {
                  file: J,
                  revealLine: Ye,
              ...
              J.language === "markdown" && T && /* @__PURE__ */ a(Sl, { content: J.content })
            ] }) : Kt ? /* @__PURE__ */ a(
              Rl,
              {
                host: e,
            ...
            ) : kn ? /* @__PURE__ */ a(Ll, { host: e, openFile: It, openFolder: Pn, newFile: zn, recent: Wt, reopenRecent: Ln, setStatus: j, openControlTower: () => {
              p("computer"), y(!0);
            }, openChat: () => {
              R("chat"), B(!0);
            }, openEmbeddedDoc: as, openMissionFiles: xn }) : /* @__PURE__ */ u("div", { className: "workbench-no-editor", children: [
              /* @__PURE__ */ a(pn, { size: 34 }),
              /* @__PURE__ */ a("p", { children: t("shell.noEditor") }),
              /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => ne(!1), children: t("shell.showAgentTeam") })
            ] }) }),
            M && /* @__PURE__ */ a(
              jl,
              {
                ...
                runAiSynthesis: An,
                captureManualCheck: Cn,
                openOutputAsFile: Xn,
                manualCheckSession: W,
                manualCheckCommandInput: xe,
                setManualCheckCommandInput: de,
                manualCheckOutputInput: qe,
                setManualCheckOutputInput: fe,
                manualCheckSelectedCommand: te,
                setManualCheckSelectedCommand: U,
                manualCheckStatus: Ce,
                setManualCheckStatus: Ze,
                copyManualCheckCommand: fs,
                addManualCheckCommand: ps,
                recordManualCheckResult: bs,
                askAgentFromManualChecks: vs,
                onClose: () => I(!1)
              }
            )
          ] })
        ...
        Y && /* @__PURE__ */ a(
          Ml,
          {
            ...
            chatInput: re,
            setChatInput: me,
            chatMessages: oe.messages,
            chatThread: oe.thread,
            chatThreads: oe.threads,
            askAgent: hs,
            stopChat: oe.stopChat,
            regenerateMessage: cs,
            newChat: () => {
              oe.newChat();
            },
            selectThread: (c) => {
            ...
            saveMessageAsArtifact: ls,
            rememberMessage: ds,
            previewEditFromMessage: (c) => Nt(c.body.split(`
`).find(Boolean)?.replace(/^#+\s*/, "").slice(0, 80) || "Atomek answer", c.body),
            runQuickPrompt: Aa,
            pendingPatchPrompt: _,
            generatePatchPrompt: ms,
            workspaceFileCount: f.length,
            aiStatus: oe.aiStatus,
            chatSettings: tt,
            chatTargets: d,
            selectedChatTarget: xa,
            selectChatTarget: _r,
            openSettings: Bt,
            busy: oe.busy,
            memoryHitCount: oe.memoryHits.length,
            outputs: bt,
            runAiSynthesis: An,
            captureManualCheck: Cn,
            openOutputAsFile: Xn,
            previewEditFromOutput: (c) => Nt(c.title, c.body),
            ...
            contextScope: X,
            setContextScope: Xe,
            contextAttachments: Qr,
            removeContextAttachment: es,
            revealContextAttachment: rs,
            projectIndexSummary: `${ut.snapshot.files.length} files · ${ut.snapshot.chunks.length} chunks`,
            projectIndexStale: ut.isStale,
            refreshProjectIndex: () => {
              const c = ut.refresh(f);
              j(`Project index refreshed: ${c.files.length} files · ${c.chunks.length} chunks`);
            },
            onResizeStart: ts,
            onClose: () => B(!1)
          }
        ...
        Pe && /* @__PURE__ */ a(
          Ol,
          {
            ...
            activeFile: J,
            commands: [
              { label: "File: New File", detail: "Create an untitled Markdown file", run: zn },
              ...
              ...Wt.map((c) => ({ label: `File: Open Recent — ${c.name}`, detail: c.path, run: () => {
                Ln(c);
              } })),
              { label: "File: Save All", detail: `${Ve.length} dirty file${Ve.length === 1 ? "" : "s"}`, run: () => {
                Na();
              }, disabled: Ve.length === 0 },
              { label: "File: Close All Editors", detail: `${Ke.length} open editor${Ke.length === 1 ? "" : "s"}`, run: os, disabled: Ke.length === 0 },
              ...
              { label: "Help: Show Agent Team", detail: "Open the Atomek Resource Fabric landing page", run: () => {
                L(null), ne(!1), p("computer"), y(!0);
              } },
              { label: "View: Toggle Primary Side Bar", detail: b ? "Hide Explorer side bar" : "Show Explorer side bar", run: () => y((c) => !c) },
              { label: "View: Toggle Chat Panel", detail: Y ? "Hide right AI side bar" : "Show right AI side bar", run: () => B((c) => !c) },
              { label: "View: Toggle Bottom Panel", detail: M ? "Hide Problems/Output/Terminal panel" : "Show Problems/Output/Terminal panel", run: () => I((c) => !c) },
              { label: "Atomek: Open Settings", detail: "Open settings as an editor tab", run: Bt },
              { label: "Checks: Open Manual Check Panel", detail: "Capture copy/paste check commands without host execution", run: () => Ft("Manual check requested from command palette") },
              { label: "View: Toggle Markdown Preview", detail: J?.language === "markdown" ? "Show or hide Markdown preview split" : "Available for Markdown files", run: () => x((c) => !c), disabled: J?.language !== "markdown" },
              { label: "Atomek: Create AI Synthesis", detail: J || Ke.length > 0 ? "Ask AIL to produce a saved Markdown artifact" : "Open a file first", run: An, disabled: !J && Ke.length === 0 },
              { label: "AI: Explain Active File", detail: J ? `Ask Cortex to explain ${J.path}` : "Open a file first", run: () => Be("Explain the active file. Focus on purpose, structure, risks, and next useful edits."), disabled: !J },
              { label: "AI: Improve Active File", detail: J ? `Ask Cortex for concrete edits to ${J.path}` : "Open a file first", run: () => Be("Review the active file and propose the smallest concrete improvements. Include exact snippets if useful."), disabled: !J },
              { label: "AI: Draft Editable Replacement", detail: J ? `Ask Cortex for a full-file replacement for ${J.path}` : "Open a file first", run: () => Aa("edit"), disabled: !J },
              { label: "AI: Plan Workspace Work", detail: Ke.length > 0 ? "Use open editors as bounded context" : "Open files first", run: () => Be("Create an implementation plan from the open editor context. Be specific and sequence the work."), disabled: Ke.length === 0 },
              { label: "AI: Save Active File as Artifact", detail: J ? "Persist active file in host.ai artifacts" : "Open a file first", run: us, disabled: !J },
              { label: "AI: Capture Manual Check Output", detail: "Paste check output as an auditable local artifact; no shell execution", run: Cn },
              { label: "AI: Open Latest Artifact as File", detail: bt[0] ? `Create editable file from ${bt[0].title}` : "No outputs yet", run: () => bt[0] && Xn(bt[0]), disabled: bt.length === 0 }
            ],
            openWorkbenchFile: Se,
            onClose: () => He(!1)
          }
        ...
        /* @__PURE__ */ a(Kl, { status: dt, file: J ?? ml, cursor: S, fileCount: f.length, dirtyCount: Ve.length })
      ]
    }
  );
}
function wl({ active: e, setActive: t, togglePrimary: n, openSettings: r, settingsActive: i }) {
  const s = _e();
  return /* @__PURE__ */ u("aside", { className: "workbench-activity-bar", "aria-label": s("activity.aria"), children: [
    /* @__PURE__ */ a("button", { className: "workbench-activity-brand", title: s("activity.toggleSidebar"), "aria-label": s("activity.toggleSidebar"), onClick: n, children: /* @__PURE__ */ a(Mr, { size: 30, variant: "cream" }) }),
    /* @__PURE__ */ a(tn, { icon: /* @__PURE__ */ a(sa, { size: 25 }), label: s("activity.explorer"), active: e === "explorer", onClick: () => t("explorer") }),
    /* @__PURE__ */ a(tn, { icon: /* @__PURE__ */ a(tr, { size: 25 }), label: s("activity.search"), active: e === "search", onClick: () => t("search") }),
    /* @__PURE__ */ a(tn, { icon: /* @__PURE__ */ a(ta, { size: 25 }), label: s("app.agentTeam"), active: e === "computer", onClick: () => t("computer") }),
    /* @__PURE__ */ a("div", { className: "workbench-activity-spacer" }),
    /* @__PURE__ */ a(tn, { icon: /* @__PURE__ */ a(li, { size: 23 }), label: s("app.settings"), active: i, onClick: r })
  ] });
}
function tn({ icon: e, label: t, active: n, onClick: r }) {
  return /* @__PURE__ */ a("button", { className: `workbench-activity-button ${n ? "active" : ""}`, title: t, "aria-label": t, onClick: r, children: e });
}
function kl(e) {
  return e.activity === "search" ? /* @__PURE__ */ a(Xl, { files: e.files, query: e.query, setQuery: e.setQuery, openWorkbenchFile: e.openWorkbenchFile, activeFileId: e.activeFileId }) : e.activity === "computer" ? /* @__PURE__ */ a(Br, { host: e.host, setStatus: e.setStatus, attachSkillToChat: e.attachSkillToChat, saveLocalJobOutput: e.saveLocalJobOutput, openMissionFiles: e.openMissionFiles, activeFile: e.activeFile, openEditors: e.openEditors }) : /* @__PURE__ */ a(xl, { ...e });
}
function xl(e) {
  const t = _e(), n = !e.folder, r = ue(() => Pl(e.files, e.folder?.name), [e.files, e.folder?.name]), [i, s] = P(() => /* @__PURE__ */ new Set()), [o, l] = P(!0);
  pe(() => {
    const p = qr(r);
    s((b) => {
      const y = new Set(b);
      return p.forEach((N) => y.add(N)), y;
    });
  }, [r]), pe(() => {
    l(!0);
  }, [e.folder?.name]);
  ...
  return /* @__PURE__ */ u("aside", { className: "workbench-sidebar", children: [
    ...
    /* @__PURE__ */ u("div", { className: "workbench-sidebar-scroll", children: [
      n ? /* @__PURE__ */ u(Qe, { children: [
        ...
        /* @__PURE__ */ a("input", { className: "workbench-input", value: e.query, onChange: (p) => e.setQuery(p.target.value), placeholder: t("explorer.searchFiles") }),
        /* @__PURE__ */ u("div", { className: "workbench-section-title", children: [
          /* @__PURE__ */ a(Xt, { size: 12 }),
          " ",
          t("explorer.openEditors")
        ] }),
        e.openEditors.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: t("explorer.noOpenEditors") }) : e.openEditors.map((p) => /* @__PURE__ */ a(ya, { file: p, active: p.id === e.activeFileId, onOpen: () => e.openWorkbenchFile(p), label: p.name, detail: p.path }, p.id)),
        /* @__PURE__ */ u(
          "button",
          {
            type: "button",
            ...
            onClick: () => l((p) => !p),
            "aria-expanded": o,
            title: t(o ? "explorer.collapseFolder" : "explorer.expandFolder", { name: e.folder?.name ?? t("app.workspace") }),
            children: [
              o ? /* @__PURE__ */ a(Xt, { size: 12 }) : /* @__PURE__ */ a(Xt, { className: "workbench-chevron-collapsed", size: 12 }),
              e.folder?.name ?? t("app.workspace")
            ]
          }
        ),
        o ? r.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: t("explorer.noReadableFiles") }) : Yr(r, e.activeFileId, e.openWorkbenchFile, i, m, t) : null
      ] }),
      /* @__PURE__ */ a("div", { className: "workbench-section-title", children: t("explorer.recent") }),
      e.recent.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: t("explorer.noRecentFolders") }) : e.recent.map((p) => /* @__PURE__ */ u("button", { className: "workbench-tree-row", onClick: () => {
        e.reopenRecent(p);
      }, title: p.path, children: [
        p.kind === "file" ? /* @__PURE__ */ a(aa, { size: 14 }) : /* @__PURE__ */ a(er, { size: 14 }),
        /* @__PURE__ */ a("span", { className: "workbench-row-name", children: p.name })
      ] }, `${p.path}-${p.at}`))
    ] })
  ] });
}
function ya({ file: e, active: t, onOpen: n, basePath: r, depth: i = 0, label: s, detail: o }) {
  const l = r && e.path.startsWith(`${r}/`) ? e.path.slice(r.length + 1) : e.path, m = i || Math.max(0, l.split("/").length - 1);
  return /* @__PURE__ */ u("button", { className: `workbench-file-row ${t ? "active" : ""}`, style: { "--workbench-depth": m }, onClick: n, title: e.path, children: [
    /* @__PURE__ */ a(aa, { size: 14 }),
    /* @__PURE__ */ u("span", { className: "workbench-row-text", children: [
      /* @__PURE__ */ a("span", { className: "workbench-row-name", children: s ?? l }),
...
function Pl(e, t) {
  const n = [], r = /* @__PURE__ */ new Map(), i = (o, l, m = n) => {
    const p = r.get(o);
    if (p) return p;
    const b = { name: l, path: o, children: [] };
    return r.set(o, b), m.push(b), b;
  };
  e.forEach((o) => {
    const l = t && o.path.startsWith(`${t}/`) ? o.path.slice(t.length + 1) : o.path, m = l.split("/").filter(Boolean);
    let p = n, b = "";
    m.slice(0, -1).forEach((y) => {
      b = b ? `${b}/${y}` : y, p = i(b, y, p).children;
    }), p.push({ name: m.at(-1) ?? o.name, path: l, file: o, children: [] });
  });
  const s = (o) => o.sort((l, m) => +!!l.file - +!!m.file || l.name.localeCompare(m.name)).map((l) => ({ ...l, children: s(l.children) }));
  return s(n);
}
function qr(e) {
  return e.flatMap((t) => t.file ? [] : [t.path, ...qr(t.children)]);
}
function Yr(e, t, n, r, i, s, o = 0) {
  return e.map((l) => {
    if (l.file)
      return /* @__PURE__ */ a(ya, { file: l.file, active: l.file.id === t, onOpen: () => n(l.file), depth: o, label: l.name }, l.file.id);
    const m = r.has(l.path);
    return /* @__PURE__ */ u("div", { children: [
      /* @__PURE__ */ u("button", { className: "workbench-folder-row", style: { "--workbench-depth": o }, onClick: () => i(l.path), title: s(m ? "explorer.collapseFolder" : "explorer.expandFolder", { name: l.name }), children: [
        m ? /* @__PURE__ */ a(Xt, { size: 12 }) : /* @__PURE__ */ a(Xt, { className: "workbench-chevron-collapsed", size: 12 }),
        m ? /* @__PURE__ */ a(ia, { size: 14 }) : /* @__PURE__ */ a(er, { size: 14 }),
        /* @__PURE__ */ a("span", { className: "workbench-row-name", children: l.name }),
        /* @__PURE__ */ a("span", { className: "workbench-row-meta", children: l.children.length })
      ] }),
      m ? Yr(l.children, t, n, r, i, s, o + 1) : null
    ] }, l.path);
  });
}
function Nl({ file: e, folder: t, showWelcome: n }) {
  const r = _e(), i = n ? [r("app.agentTeam")] : e?.path.split("/").filter(Boolean) ?? [], s = t && i[0] === t.name ? i.slice(1) : i;
  return /* @__PURE__ */ a("div", { className: "workbench-breadcrumb", children: s.length === 0 ? /* @__PURE__ */ a("span", { children: r("app.workspace") }) : s.map((o, l) => /* @__PURE__ */ u("span", { className: "workbench-breadcrumb-part", children: [
    l > 0 && /* @__PURE__ */ a("span", { className: "workbench-breadcrumb-sep", children: "›" }),
    o
  ] }, `${o}-${l}`)) });
}
function Tl(e) {
  ...
  return /* @__PURE__ */ u("div", { className: "workbench-tabs", children: [
    e.showWelcome && /* @__PURE__ */ u("button", { className: "workbench-tab active", children: [
      ...
      }, children: /* @__PURE__ */ a(at, { size: 13 }) })
    ] }),
    ...
    e.canPreview && /* @__PURE__ */ a("button", { className: `workbench-editor-action ${e.previewVisible ? "active" : ""}`, title: t("tabs.toggleMarkdownPreview"), onClick: e.togglePreview, children: /* @__PURE__ */ a(na, { size: 16 }) }),
    /* @__PURE__ */ a("button", { className: `workbench-editor-action ${e.secondaryVisible ? "active" : ""}`, title: t("tabs.toggleChat"), onClick: e.toggleSecondary, children: /* @__PURE__ */ a(ai, { size: 16 }) })
  ] });
}
function zl(e) {
...
function Al(e) {
  ...
  return [...e?.resources ?? []].sort((n, r) => (t[n.kind] ?? 9) - (t[r.kind] ?? 9) || Fe(n).localeCompare(Fe(r))).slice(0, 8);
}
function Ll({
  host: e,
  openFile: t,
  ...
  const y = _e(), N = ue(() => ({
    "repo-repair": {
      name: y("mission.default.repoRepair.name"),
      goal: y("mission.default.repoRepair.goal")
    },
    "pod-local": {
      name: y("mission.default.podLocal.name"),
      goal: y("mission.default.podLocal.goal")
    },
    "creative-production": {
      name: y("mission.default.creativeProduction.name"),
      goal: y("mission.default.creativeProduction.goal")
    },
    "research-watch": {
      name: y("mission.default.researchWatch.name"),
      goal: y("mission.default.researchWatch.goal")
    }
  }), [y]), [z, V] = P(() => y("mission.default.podLocal.name")), [R, Y] = P(() => y("mission.default.podLocal.goal")), [B, we] = P(!1), [G, M] = P(!1), [I, he] = P(null), [se, T] = P([]), [x, Te] = P(!1), [ne, ze] = P(null), [Me, De] = P(null), [We, f] = P("pod-local"), D = w(async () => {
    Te(!0), De(null);
    try {
      ...
      he(g ?? null), T(X), g && o(`Agent team loaded · ${g.resources.length} resources · ${g.warnings.length} warnings`);
    } catch (g) {
      const X = g instanceof Error ? g.message : String(g);
      De(X), o(`Agent team resource load failed: ${X}`);
    } finally {
      Te(!1);
    }
  }, [e.missions, e.resources, o]), Q = w((g, X) => {
    try {
      e.windows.openOrFocus(g), o(`Opened ${X}`);
    } catch (Xe) {
      o(`Open ${X} failed: ${Xe instanceof Error ? Xe.message : String(Xe)}`);
    }
  }, [e.windows, o]);
  pe(() => {
    D();
  ...
  const ke = w(async () => {
    if (!e.missions?.create || !e.missions?.write) {
      o("Mission API unavailable in this Tytus host build"), l();
      return;
    }
    const g = R.trim() || "Coordinate a Tytus mission.", X = Mi(z, g), Xe = kt(g, I, We);
    Te(!0);
    try {
      const E = await e.missions.create({
        title: X,
        goal: g
      }), Ue = {
        missionId: E.missionId,
        ...
        data: { resourceCount: I?.resources.length ?? 0, missionTitle: X }
      }, Ee = hr(
        Ue,
        I,
        null,
...
`]
      ...
      await e.missions.write({
        rootPath: E.rootPath,
        files: Ee
      }), ze(E), qt(Ue), b(Ue, Ee), o(`Mission created: ${E.rootPath}`), l();
    } catch (E) {
      o(`Mission create failed: ${E instanceof Error ? E.message : String(E)}`);
    } finally {
      Te(!1);
    }
  }, [R, I, e.missions, z, l, b, o, We]), ie = w((g) => {
    f(g);
    const X = N[g];
    B || V(X.name), G || Y(X.goal);
  }, [G, B, N]), L = zl(I), O = Ni(I), q = Ti(I), S = Al(I), $ = I?.warnings ?? [], ce = Ai(I), ge = Mt(I, kt(R, I, We)), be = bn(R, I, ge.id);
  return /* @__PURE__ */ u("div", { className: "workbench-welcome workbench-control-home", children: [
    /* @__PURE__ */ u("section", { className: "workbench-control-hero-main", children: [
      /* @__PURE__ */ u("div", { className: "workbench-brand-lockup", "aria-label": "Atomek", children: [
        /* @__PURE__ */ a(Mr, { size: 74, variant: "acid" }),
        /* @__PURE__ */ u("div", { children: [
          /* @__PURE__ */ a(el, { className: "workbench-brand-wordmark" }),
      ...
      /* @__PURE__ */ u("div", { className: "workbench-control-goal-row", children: [
        /* @__PURE__ */ u("div", { className: "workbench-control-mission-fields", children: [
          /* @__PURE__ */ u("label", { className: "workbench-control-field", children: [
            /* @__PURE__ */ a("span", { children: y("mission.name") }),
            /* @__PURE__ */ a(
              "input",
              {
                value: z,
                onChange: (g) => {
                  we(!0), V(g.target.value);
                },
                maxLength: 80,
                placeholder: y("mission.namePlaceholder")
              }
            )
          ] }),
          /* @__PURE__ */ u("label", { className: "workbench-control-field", children: [
            /* @__PURE__ */ a("span", { children: y("mission.goal") }),
            /* @__PURE__ */ a(
              "textarea",
              {
                value: R,
                onChange: (g) => {
                  M(!0), Y(g.target.value);
                },
                rows: 3,
                "aria-label": y("mission.goal"),
                placeholder: y("mission.goalPlaceholder")
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ u("div", { className: "workbench-control-hero-actions", children: [
          /* @__PURE__ */ a("button", { className: "workbench-button-primary", onClick: () => {
            ke();
          }, disabled: x, children: y("mission.start") }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: l, children: y("mission.openBoard") }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: m, children: y("mission.openChat") })
        ] })
      ] }),
      /* @__PURE__ */ a("div", { className: "workbench-team-preset-strip", "aria-label": "Team presets", children: ce.map((g) => /* @__PURE__ */ u(
        "button",
        {
          className: `workbench-team-preset-card ${g.id === ge.id ? "active" : ""} ${g.readiness}`,
          onClick: () => ie(g.id),
          children: [
            /* @__PURE__ */ u("div", { children: [
              /* @__PURE__ */ a("strong", { children: g.label }),
              /* @__PURE__ */ a("span", { children: g.readiness })
            ] }),
            /* @__PURE__ */ a("p", { children: g.summary }),
            /* @__PURE__ */ a("small", { children: g.assignments.map((X) => X.resourceLabel).slice(0, 3).join(" · ") })
          ]
        },
        g.id
      )) }),
      ne ? /* @__PURE__ */ u("div", { className: "workbench-control-success", children: [
        "Mission ready: ",
        /* @__PURE__ */ a("code", { children: ne.rootPath })
      ] }) : null,
      Me ? /* @__PURE__ */ a("div", { className: "workbench-inline-error", children: Me }) : null
    ] }),
    /* @__PURE__ */ u("section", { className: "workbench-control-grid", children: [
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        /* @__PURE__ */ u("header", { children: [
          ...
          /* @__PURE__ */ u("button", { className: "workbench-button-subtle", onClick: () => {
            ...
            /* @__PURE__ */ a(Ct, { size: 13 }),
            " ",
            x ? "Refreshing…" : "Refresh"
          ] })
        ] }),
        /* @__PURE__ */ a("div", { className: "workbench-control-metrics", children: L.map((g) => /* @__PURE__ */ u("div", { className: "workbench-control-metric", children: [
      ...
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        ...
        /* @__PURE__ */ a("div", { className: "workbench-agent-brand-grid", children: O.map((g) => /* @__PURE__ */ u("div", { className: `workbench-agent-brand-card ${g.status.replace(/\s+/g, "-")}`, children: [
          /* @__PURE__ */ u("div", { children: [
            /* @__PURE__ */ a("strong", { children: g.label }),
            /* @__PURE__ */ a("span", { children: g.status })
          ] }),
          /* @__PURE__ */ a("b", { children: g.value }),
          /* @__PURE__ */ a("p", { children: g.detail })
        ] }, g.label)) })
      ] }),
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        /* @__PURE__ */ u("header", { children: [
        ...
        /* @__PURE__ */ a("div", { className: "workbench-doc-grid", children: ll.map((g) => /* @__PURE__ */ u("button", { className: "workbench-doc-card", onClick: () => p(g), title: g.summary, children: [
          /* @__PURE__ */ a("strong", { children: g.title }),
          /* @__PURE__ */ a("p", { children: g.summary }),
          /* @__PURE__ */ a("small", { children: g.tags.join(" · ") })
        ] }, g.id)) })
      ] }),
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        /* @__PURE__ */ u("header", { children: [
        ...
        /* @__PURE__ */ a("div", { className: "workbench-fabric-flow", children: q.map((g, X) => /* @__PURE__ */ u("div", { className: `workbench-fabric-node ${g.status.replace(/\s+/g, "-")}`, children: [
          /* @__PURE__ */ a("span", { children: X + 1 }),
          /* @__PURE__ */ a("strong", { children: g.label }),
          /* @__PURE__ */ a("em", { children: g.status }),
          /* @__PURE__ */ a("p", { children: g.detail })
        ] }, g.label)) }),
        /* @__PURE__ */ u("div", { className: "workbench-fabric-actions", children: [
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => Q(_t.sharedFiles, "Shared Files"), children: "Open shared files" }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => Q(_t.podInspector, "Pod Inspector"), children: "Open pods" }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => Q(_t.channels, "Channels"), children: "Open channels" }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => Q(_t.settings, "Agent Settings"), children: "Open agent settings" })
        ] })
      ] }),
      /* @__PURE__ */ u("article", { className: "workbench-control-card", children: [
        ...
        /* @__PURE__ */ a("button", { className: "workbench-control-preset", onClick: () => Y("Review this repo with local OpenCode/Claude, then ask Codex or pi for an independent review. Save all transcripts and proposed patches in the mission folder."), children: "Review + patch repo" }),
        /* @__PURE__ */ a("button", { className: "workbench-control-preset", onClick: () => Y("Ask OpenClaw for independent critique, use Hermes when allocated for deep planning/copy, then run local Claude/OpenCode/Codex for implementation. Keep shared context in the mission folder and approval-gate all edits."), children: "OpenClaw/Hermes + local agent" }),
        /* @__PURE__ */ a("button", { className: "workbench-control-preset", onClick: () => Y("Coordinate creative output: script, audio, visuals, render assets, and final handoff through app skills and shared folders."), children: "Creative production" })
      ] }),
      /* @__PURE__ */ u("article", { className: "workbench-control-card", children: [
        /* @__PURE__ */ u("header", { children: [
          /* @__PURE__ */ a("strong", { children: "Resume" }),
          /* @__PURE__ */ a("span", { children: se.length ? `${se.length} missions` : "none yet" })
        ] }),
        se.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "Create a mission once; it stays in Tytus Home/Missions and can be resumed here." }) : null,
        se.slice(0, 4).map((g) => /* @__PURE__ */ u("button", { className: "workbench-control-preset", onClick: () => {
          qt(g), l();
      ...
      /* @__PURE__ */ u("article", { className: "workbench-control-card", children: [
        ...
        /* @__PURE__ */ u("button", { className: "workbench-start-link", onClick: n, children: [
          /* @__PURE__ */ a(ia, { size: 18 }),
          "Open workspace folder"
        ] }),
        /* @__PURE__ */ u("button", { className: "workbench-start-link", onClick: t, children: [
          /* @__PURE__ */ a(sa, { size: 18 }),
          "Open file"
        ] }),
        /* @__PURE__ */ u("button", { className: "workbench-start-link", onClick: r, children: [
          /* @__PURE__ */ a(ra, { size: 18 }),
          "New mission note"
        ] }),
        i.length ? /* @__PURE__ */ u("div", { className: "workbench-control-recent", children: [
          /* @__PURE__ */ a("span", { children: "Recent" }),
          i.slice(0, 3).map((g) => /* @__PURE__ */ a("button", { onClick: () => {
            s(g);
          }, children: g.name }, `${g.path}-${g.at}`))
        ] }) : null
      ] }),
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        /* @__PURE__ */ u("header", { children: [
          /* @__PURE__ */ a("strong", { children: "Resource graph" }),
          /* @__PURE__ */ a("span", { children: I ? `${I.resources.length} discovered` : "not loaded" })
        ] }),
        /* @__PURE__ */ u("div", { className: "workbench-control-resource-list", children: [
          S.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No resource graph yet. Start Tytus tray beta30 or newer, then refresh." }) : null,
          S.map((g) => /* @__PURE__ */ u("div", { className: "workbench-control-resource", children: [
            /* @__PURE__ */ u("div", { children: [
              /* @__PURE__ */ a("strong", { children: Fe(g) }),
              /* @__PURE__ */ a("span", { children: ha(g) })
            ] }),
            /* @__PURE__ */ a("span", { className: `workbench-computer-pill ${g.status}`, children: g.status })
          ] }, g.id))
        ] }),
        $.length ? /* @__PURE__ */ a("div", { className: "workbench-resource-warnings", children: $.slice(0, 2).map((g) => /* @__PURE__ */ u("span", { children: [
          g.code,
          ": ",
          g.message
      ...
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        ...
        /* @__PURE__ */ a("div", { className: "workbench-task-graph home", children: be.map((g, X) => /* @__PURE__ */ u("button", { className: `workbench-task-card ${g.status}`, onClick: () => Y(g.prompt), children: [
          /* @__PURE__ */ a("span", { children: X + 1 }),
          /* @__PURE__ */ a("strong", { children: g.title }),
          /* @__PURE__ */ a("em", { children: g.resourceHint }),
          /* @__PURE__ */ a("small", { children: g.assignedResourceLabel })
        ] }, g.id)) })
      ] }),
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
...
function Xl({ files: e, query: t, setQuery: n, openWorkbenchFile: r, activeFileId: i }) {
  const s = _e(), o = ue(() => Cl(e, t), [e, t]), l = ue(() => {
    const m = /* @__PURE__ */ new Map();
    return o.forEach((p) => m.set(p.file.id, [...m.get(p.file.id) ?? [], p])), Array.from(m.values()).slice(0, 50);
  }, [o]);
  return /* @__PURE__ */ u("aside", { className: "workbench-sidebar", children: [
    ...
    /* @__PURE__ */ u("div", { className: "workbench-sidebar-scroll", children: [
      ...
      /* @__PURE__ */ u("div", { className: "workbench-section-title", children: [
        /* @__PURE__ */ a(pn, { size: 12 }),
        " ",
        s("search.results")
      ] }),
      t.trim() ? l.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: s("search.noMatches") }) : l.map((m) => {
        const p = m[0].file;
        return /* @__PURE__ */ u("div", { className: "workbench-search-group", children: [
          /* @__PURE__ */ a(ya, { file: p, active: p.id === i, onOpen: () => r(p) }),
          m.slice(0, 5).map((b) => /* @__PURE__ */ u("button", { className: "workbench-search-hit", onClick: () => r(p, b.lineNumber), title: b.line, children: [
            /* @__PURE__ */ a("span", { className: "workbench-search-line", children: b.lineNumber }),
            /* @__PURE__ */ a("span", { children: b.line })
          ] }, `${p.id}-${b.lineNumber}-${b.line}`)),
...
function Ol(e) {
  const t = e.query.trim().toLowerCase(), n = e.files.slice(0, 80).map((i) => ({
    label: i.path,
    detail: `Open ${rr(i.language)} file`,
...
function Hl(e) {
  const t = e.session ? Ec(e.session) : "pending";
  return /* @__PURE__ */ u("div", { className: "workbench-manual-check-panel", children: [
    ...
    e.session ? /* @__PURE__ */ u(Qe, { children: [
...
function jl(e) {
  return /* @__PURE__ */ u("section", { className: "workbench-bottom-panel", "aria-label": "Panel", children: [
    /* @__PURE__ */ u("div", { className: "workbench-bottom-tabs", children: [
      ...
      /* @__PURE__ */ a("span", {}),
      /* @__PURE__ */ a("button", { title: "Close Panel", onClick: e.onClose, children: /* @__PURE__ */ a(at, { size: 14 }) })
    ] }),
    /* @__PURE__ */ u("div", { className: "workbench-bottom-body", children: [
      ...
      e.tab === "output" && /* @__PURE__ */ a(Kr, { outputs: e.outputs, clearOutputs: e.clearOutputs, deleteArtifact: e.deleteArtifact, runAiSynthesis: e.runAiSynthesis, captureManualCheck: e.captureManualCheck, openOutputAsFile: e.openOutputAsFile, compact: !0 })
    ] })
  ] });
}
function Ml(e) {
  const t = _e(), [n, r] = P(!1), [i, s] = P(""), [o, l] = P([]), m = Re(null), p = Re(null), b = Re(null), [y, N] = P({ top: 0, right: 0 }), z = ue(
    () => e.chatThreads.map((T) => ({
      kind: "atomek-thread",
      id: `thread:${T.id}`,
      title: T.title,
      lastActivityAt: T.lastMessageAt ?? T.updatedAt ?? 0,
      thread: T
    })),
    [e.chatThreads]
  ), V = ue(() => o.map((T) => {
    const x = e.chatTargets.find((Te) => Te.id === T.targetId);
    return x ? {
      kind: "pod-agent",
      id: `agent:${T.targetId}`,
      title: x.label,
      subtitle: T.preview || x.description || `${T.messageCount} messages`,
      lastActivityAt: T.lastActivityAt,
      targetId: T.targetId
    } : null;
  }).filter((T) => T !== null), [o, e.chatTargets]), R = ue(() => [...z, ...V].sort((T, x) => x.lastActivityAt - T.lastActivityAt), [z, V]), Y = ue(() => e.selectedChatTarget.kind === "atomek-ai" && e.chatThread ? R.find((T) => T.kind === "atomek-thread" && T.thread.id === e.chatThread?.id) ?? null : e.selectedChatTarget.kind !== "atomek-ai" ? R.find((T) => T.kind === "pod-agent" && T.targetId === e.selectedChatTarget.id) ?? null : null, [R, e.selectedChatTarget, e.chatThread]), B = w((T, x) => x ? `${T.title} ${T.kind === "pod-agent" ? T.subtitle : ""}`.toLowerCase().includes(x) : !0, []), we = i.trim().toLowerCase(), G = Y ? B(Y, we) : !1, M = ue(() => R.filter((T) => T.id !== Y?.id).filter((T) => B(T, we)), [R, Y, we, B]), I = w(() => {
    l(io());
  }, []), he = w((T) => {
    r(!1), T.kind === "atomek-thread" ? (e.selectedChatTarget.kind !== "atomek-ai" && e.selectChatTarget(st.id), e.selectThread(T.thread.id)) : e.selectChatTarget(T.targetId), e.tab !== "chat" && e.setTab("chat");
  }, [e]), se = w((T) => {
    window.confirm(`Delete conversation "${T.title}"?`) && (T.kind === "atomek-thread" ? e.deleteThread(T.thread.id) : (oo(T.targetId), I()));
  }, [e, I]);
  return pe(() => {
    if (!n) {
      s("");
    ...
    const T = () => {
      const ne = m.current;
      if (!ne) return;
      const ze = ne.getBoundingClientRect();
      N({
        top: ze.bottom + 6,
        right: Math.max(8, window.innerWidth - ze.right)
      });
    };
    T(), window.setTimeout(() => b.current?.focus(), 0);
    const x = (ne) => {
      const ze = ne.target;
      ze && (p.current?.contains(ze) || m.current?.contains(ze) || r(!1));
    }, Te = (ne) => {
      ne.key === "Escape" && r(!1);
    };
    return window.addEventListener("resize", T), window.addEventListener("scroll", T, !0), window.addEventListener("mousedown", x), window.addEventListener("keydown", Te), () => {
      window.removeEventListener("resize", T), window.removeEventListener("scroll", T, !0), window.removeEventListener("mousedown", x), window.removeEventListener("keydown", Te);
    };
    ...
    /* @__PURE__ */ u("div", { className: "workbench-secondary-tabs", children: [
      ...
      /* @__PURE__ */ u("div", { className: "workbench-secondary-actions", children: [
        /* @__PURE__ */ a("button", { title: t("secondary.newChat"), onClick: e.newChat, children: /* @__PURE__ */ a(Yn, { size: 15 }) }),
        /* @__PURE__ */ a(
          "button",
          {
            ref: m,
            ...
            children: /* @__PURE__ */ a($a, { size: 15 })
          }
        ),
        /* @__PURE__ */ a("button", { title: t("secondary.chatSettings"), onClick: e.openSettings, children: /* @__PURE__ */ a(_a, { size: 16 }) }),
        /* @__PURE__ */ a("button", { title: t("secondary.closeChat"), onClick: e.onClose, children: /* @__PURE__ */ a(at, { size: 15 }) })
      ] })
    ] }),
    n && typeof document < "u" ? zs(
      /* @__PURE__ */ u(
        "div",
        {
          ref: p,
          className: "workbench-history-portal",
          style: { top: y.top, right: y.right },
          role: "menu",
          children: [
            /* @__PURE__ */ u("div", { className: "workbench-history-portal-search", children: [
              /* @__PURE__ */ a(tr, { size: 14 }),
              /* @__PURE__ */ a(
                "input",
                {
                  ref: b,
            ...
            /* @__PURE__ */ u("div", { className: "workbench-history-portal-list", children: [
                  ...
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ u("span", { className: "workbench-history-portal-title", children: [
                        Y.kind === "pod-agent" ? /* @__PURE__ */ a("span", { className: "workbench-history-portal-badge", children: t("history.agent") }) : null,
                        Y.title
                      ] }),
                      /* @__PURE__ */ a("small", { children: ea(Y.lastActivityAt) }),
                      /* @__PURE__ */ a(
                        "button",
                        {
                          className: "workbench-history-portal-delete",
                          onClick: (T) => {
                            T.stopPropagation(), se(Y);
                          },
                          title: t("history.deleteConversation"),
                          "aria-label": t("history.deleteConversation"),
                          children: /* @__PURE__ */ a(Ca, { size: 13 })
                        }
                      )
                    ]
                  }
              ...
              M.length > 0 ? /* @__PURE__ */ u(Qe, { children: [
                ...
                M.map((T) => /* @__PURE__ */ u(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ u("span", { className: "workbench-history-portal-title", children: [
                        T.kind === "pod-agent" ? /* @__PURE__ */ a("span", { className: "workbench-history-portal-badge", children: t("history.agent") }) : null,
                        T.title
                      ] }),
                      /* @__PURE__ */ a("small", { children: ea(T.lastActivityAt) }),
                      /* @__PURE__ */ a(
                        "button",
                        {
                          className: "workbench-history-portal-delete",
                          onClick: (x) => {
                            x.stopPropagation(), se(T);
                          },
                          title: t("history.deleteConversation"),
                          "aria-label": t("history.deleteConversation"),
                          children: /* @__PURE__ */ a(Ca, { size: 13 })
              ...
              !G && M.length === 0 ? /* @__PURE__ */ a("div", { className: "workbench-history-portal-empty", children: i.trim() ? t("history.noMatches") : t("history.empty") }) : null
            ] }),
    ...
    e.tab === "chat" ? /* @__PURE__ */ a(Wl, { ...e }) : e.tab === "agents" ? /* @__PURE__ */ a(
      Br,
      {
        host: e.host,
        ...
        openMissionFiles: e.openMissionFiles,
        activeFile: e.activeFile,
        openEditors: e.openEditors,
        variant: "dock"
      }
    ) : /* @__PURE__ */ a(Kr, { outputs: e.outputs, clearOutputs: e.clearOutputs, deleteArtifact: e.deleteArtifact, runAiSynthesis: e.runAiSynthesis, captureManualCheck: e.captureManualCheck, openOutputAsFile: e.openOutputAsFile, previewEditFromOutput: e.previewEditFromOutput, canPreviewEdit: e.canPreviewEdit })
  ] });
}
function Jr({ body: e }) {
  const t = ue(() => yl(e), [e]), [n, r] = P(null), i = w((s, o) => {
    (async () => await jt(o) && (r(s), window.setTimeout(() => r((m) => m === s ? null : m), 1200)))();
  }, []);
  return /* @__PURE__ */ a("div", { className: "workbench-rich-body", children: t.map((s) => {
      ...
      return /* @__PURE__ */ u("div", { className: "workbench-rich-code", children: [
        /* @__PURE__ */ u("div", { className: "workbench-rich-code-head", children: [
          ...
          /* @__PURE__ */ u("button", { onClick: () => i(s.key, s.body), title: "Copy code block", children: [
            o ? /* @__PURE__ */ a(Is, { size: 12 }) : /* @__PURE__ */ a(qn, { size: 12 }),
            o ? "Copied" : "Copy"
          ] })
        ] }),
    ...
    return /* @__PURE__ */ a(
      "div",
      {
        ...
        dangerouslySetInnerHTML: { __html: or(s.body) }
      },
      s.key
    );
  }) });
...
function Wl(e) {
  const t = _e(), n = e.selectedChatTarget.available, r = e.selectedChatTarget.kind === "atomek-ai", i = e.chatInput.trim().length > 0 && !e.busy && n, s = Re(null), [o, l] = P(!0), [m, p] = P(!1), b = Re(null), y = Re(null), N = Re(null), z = Re(null), [V, R] = P(!1), [Y, B] = P(0), we = typeof window < "u" && !!(window.SpeechRecognition || window.webkitSpeechRecognition), G = w(() => {
    const f = N.current;
    try {
      f?.stop?.();
    } catch {
    }
    N.current = null, z.current !== null && (window.clearInterval(z.current), z.current = null), R(!1), B(0);
  }, []), M = w(() => {
    if (!we || V) return;
    const f = window.SpeechRecognition || window.webkitSpeechRecognition;
    if (!f) return;
    const D = new f();
    D.lang = navigator.language || "en-US", D.interimResults = !1, D.continuous = !1, D.onresult = (Q) => {
      let ke = "";
      for (let ie = Q.resultIndex; ie < Q.results.length; ie += 1) {
        const L = Q.results[ie];
        L.isFinal && (ke += L[0].transcript);
      }
      if (ke) {
        const ie = e.chatInput.trim().length > 0 ? `${e.chatInput} ${ke}` : ke;
        e.setChatInput(ie);
      }
    }, D.onerror = () => {
      G();
    ...
    try {
      D.start(), R(!0), B(0), z.current = window.setInterval(() => B((Q) => Q + 1), 1e3);
    } catch {
      G();
    }
  }, [we, V, e, G]);
  pe(() => () => {
    z.current !== null && window.clearInterval(z.current);
    const f = N.current;
    try {
      f?.stop?.();
    } catch {
  ...
  const I = (f) => {
    const D = Math.floor(f / 60), Q = f % 60;
    return `${D.toString().padStart(1, "0")}:${Q.toString().padStart(2, "0")}`;
  }, he = () => b.current?.removeAttribute("open"), se = () => y.current?.removeAttribute("open"), T = (f) => {
    e.setContextScope(f), f === "indexed-project" && e.refreshProjectIndex(), he();
  }, x = (f) => {
    e.selectChatTarget(f), se();
  }, Te = ue(() => e.chatMessages.map((f) => `${f.id}:${f.status ?? ""}:${f.body.length}`).join("|"), [e.chatMessages]);
  pe(() => {
    const f = s.current;
    f && (o ? (f.scrollTop = f.scrollHeight, p(!1)) : p(!0));
  }, [o, Te]);
  const ne = w(() => {
    const f = s.current;
    if (!f) return;
    const Q = f.scrollHeight - f.scrollTop - f.clientHeight < 48;
    l(Q), Q && p(!1);
  }, []), ze = w(() => {
    const f = s.current;
    f && (f.scrollTop = f.scrollHeight, l(!0), p(!1));
  }, []), Me = w((f) => {
    jt(f.body);
  }, []), De = Re(null), We = () => De.current?.removeAttribute("open");
  return /* @__PURE__ */ u("div", { className: "workbench-chat-wrap", children: [
      ...
      /* @__PURE__ */ u("span", { className: "workbench-chat-thread-actions", children: [
        /* @__PURE__ */ a(
          "button",
          {
            ...
            children: /* @__PURE__ */ a(Yn, { size: 15 })
          }
        ),
        r && e.chatThreads.length > 0 ? /* @__PURE__ */ u("details", { ref: De, className: "workbench-chat-iconmenu", children: [
          /* @__PURE__ */ a("summary", { className: "workbench-chat-iconbtn", title: t("chat.history"), "aria-label": t("chat.history"), children: /* @__PURE__ */ a($a, { size: 15 }) }),
          /* @__PURE__ */ u("div", { className: "workbench-chat-history-pop", role: "menu", children: [
            ...
            e.chatThreads.map((f) => /* @__PURE__ */ u(
              "button",
              {
                ...
                onClick: () => {
                  e.selectThread(f.id), We();
                },
                title: f.title,
                children: [
                  /* @__PURE__ */ a("span", { className: "workbench-chat-history-title", children: f.title }),
                  /* @__PURE__ */ a("small", { children: ea(f.lastMessageAt ?? f.updatedAt) })
                ]
              },
              f.id
            ))
        ...
        r ? /* @__PURE__ */ u("details", { className: "workbench-chat-iconmenu", children: [
          /* @__PURE__ */ a("summary", { className: "workbench-chat-iconbtn", title: t("chat.actions"), "aria-label": t("chat.actions"), children: /* @__PURE__ */ a(_a, { size: 15 }) }),
            ...
            /* @__PURE__ */ a(
              "button",
              {
                onClick: (f) => {
                  ...
                  const D = window.prompt(t("chat.renamePrompt"), e.chatThread.title);
                  D !== null && e.renameThread(e.chatThread.id, D);
                },
    ...
    /* @__PURE__ */ u("div", { ref: s, className: "workbench-chat-transcript", onScroll: ne, children: [
      e.chatMessages.length === 0 ? /* @__PURE__ */ a("div", { className: "workbench-chat-empty", children: /* @__PURE__ */ u("div", { children: [
        ...
        /* @__PURE__ */ a("br", {}),
        /* @__PURE__ */ a(Jr, { body: f.body }),
        f.gatewayLabel ? /* @__PURE__ */ u(Qe, { children: [
          /* @__PURE__ */ a("br", {}),
        ...
        f.role === "assistant" && f.status !== "streaming" && f.status !== "error" ? /* @__PURE__ */ u("div", { className: "workbench-chat-message-actions", children: [
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action", onClick: () => Me(f), title: t("chat.copyAnswer"), "aria-label": t("chat.copyAnswer"), children: /* @__PURE__ */ a(qn, { size: 14 }) }),
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action", onClick: () => e.saveMessageAsArtifact(f), title: t("chat.saveArtifact"), "aria-label": t("chat.saveArtifact"), children: /* @__PURE__ */ a(ra, { size: 14 }) }),
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action", onClick: () => e.rememberMessage(f), title: "Store in Atomek memory", "aria-label": t("chat.remember"), children: /* @__PURE__ */ a(Qs, { size: 14 }) }),
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action", onClick: () => e.previewEditFromMessage(f), disabled: e.workspaceFileCount === 0, title: t("chat.previewPatch"), "aria-label": t("chat.previewPatch"), children: /* @__PURE__ */ a(na, { size: 14 }) }),
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action regen", onClick: () => e.regenerateMessage(f), disabled: e.busy, title: t("chat.regenerate"), "aria-label": t("chat.regenerate"), children: /* @__PURE__ */ a(Ct, { size: 14 }) })
        ] }) : null,
        f.role === "assistant" && f.status === "error" ? /* @__PURE__ */ u("div", { className: "workbench-chat-message-actions", children: [
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action", onClick: () => Me(f), title: t("chat.copyError"), "aria-label": t("chat.copyError"), children: /* @__PURE__ */ a(qn, { size: 14 }) }),
          /* @__PURE__ */ a("button", { className: "workbench-chat-message-action regen", onClick: () => e.regenerateMessage(f), disabled: e.busy, title: t("chat.retry"), "aria-label": t("chat.retry"), children: /* @__PURE__ */ a(Ct, { size: 14 }) })
        ] }) : null
      ] }, f.id)),
      m ? /* @__PURE__ */ a("button", { className: "workbench-chat-jump", onClick: ze, children: t("chat.jumpLatest") }) : null
    ] }),
    /* @__PURE__ */ u("div", { className: "workbench-chat-composer", children: [
      /* @__PURE__ */ u("div", { className: "workbench-chat-tip", children: [
        ...
        /* @__PURE__ */ a("strong", { children: vo(e.contextScope) }),
        /* @__PURE__ */ a("em", { children: e.selectedChatTarget.kind === "atomek-ai" ? Ka(e.chatSettings, e.aiStatus.label, e.memoryHitCount) : e.selectedChatTarget.description })
      ] }),
      /* @__PURE__ */ u("div", { className: "workbench-chat-box", children: [
        /* @__PURE__ */ u("div", { className: "workbench-chat-attachments", children: [
          ...
          e.contextScope === "indexed-project" ? /* @__PURE__ */ u(Qe, { children: [
          ...
          e.contextAttachments.length === 0 ? /* @__PURE__ */ u("span", { className: "workbench-chat-chip muted", children: [
            /* @__PURE__ */ a(Xa, { size: 13 }),
            " ",
            t("chat.noFileContext")
          ] }) : e.contextAttachments.map((f) => {
            const D = typeof f.score == "number" ? f.score.toFixed(2) : null, Q = typeof f.vectorScore == "number" ? f.vectorScore.toFixed(2) : null, ke = typeof f.keywordScore == "number" ? f.keywordScore.toFixed(1) : null, ie = [
              f.path,
            ...
            return /* @__PURE__ */ u("span", { className: "workbench-chat-chip", title: ie, children: [
              /* @__PURE__ */ a("button", { className: "workbench-chat-chip-open", onClick: () => e.revealContextAttachment(f), disabled: !f.fileId, title: t("chat.revealContext"), children: /* @__PURE__ */ a(Xa, { size: 13 }) }),
              f.label,
              D ? /* @__PURE__ */ a("small", { children: D }) : null,
              f.snippet ? /* @__PURE__ */ u("small", { children: [
                f.snippet.slice(0, 60),
                f.snippet.length > 60 ? "…" : ""
              ] }) : null,
              f.dirty ? /* @__PURE__ */ a("small", { children: t("chat.dirty") }) : null,
              f.removable ? /* @__PURE__ */ a("button", { className: "workbench-chat-chip-remove", onClick: () => e.removeContextAttachment(f), title: t("chat.removeContext"), children: /* @__PURE__ */ a(at, { size: 11 }) }) : null
            ] }, f.id);
          }),
        ...
        /* @__PURE__ */ u("div", { className: "workbench-chat-toolbar atomek-input", children: [
          /* @__PURE__ */ u("details", { ref: b, className: "workbench-chat-attach", children: [
            /* @__PURE__ */ a("summary", { title: t("chat.addContext"), "aria-label": t("chat.addContext"), children: /* @__PURE__ */ a(Yn, { size: 16 }) }),
            /* @__PURE__ */ u("div", { className: "workbench-chat-attach-menu", role: "menu", children: [
              /* @__PURE__ */ a("button", { onClick: () => T("active-file"), disabled: !e.activeFile, title: t("chat.useActiveFile"), children: t("chat.activeFile") }),
              /* @__PURE__ */ a("button", { onClick: () => T("active-selection"), disabled: !e.activeFile, title: t("chat.useSelection"), children: t("chat.selection") }),
              /* @__PURE__ */ a("button", { onClick: () => T("open-editors"), title: t("chat.useOpenEditors"), children: t("chat.openEditors") }),
              /* @__PURE__ */ a("button", { onClick: () => T("indexed-project"), title: t("chat.useIndexedProject"), children: t("chat.indexedProject") }),
              /* @__PURE__ */ a("button", { onClick: () => T("none"), title: t("chat.noContext"), children: t("chat.noContext") })
            ] })
          ] }),
          V ? /* @__PURE__ */ u("div", { className: "workbench-chat-recording", children: [
            /* @__PURE__ */ a("button", { className: "workbench-chat-recording-cancel", onClick: G, title: t("chat.cancelRecording"), "aria-label": t("chat.cancelRecording"), children: /* @__PURE__ */ a(at, { size: 14 }) }),
            /* @__PURE__ */ a("span", { className: "workbench-chat-recording-wave", "aria-hidden": "true", children: Array.from({ length: 14 }).map((f, D) => /* @__PURE__ */ a("span", { style: { animationDelay: `${D * 0.05}s` } }, D)) }),
            /* @__PURE__ */ a("span", { className: "workbench-chat-recording-dot", "aria-hidden": "true" }),
            /* @__PURE__ */ a("span", { className: "workbench-chat-recording-time", children: I(Y) })
          ] }) : /* @__PURE__ */ a("span", { className: "workbench-chat-route-summary", children: e.selectedChatTarget.kind === "atomek-ai" ? Ka(e.chatSettings, e.aiStatus.label, e.memoryHitCount) : e.selectedChatTarget.description }),
          /* @__PURE__ */ u("div", { className: "workbench-chat-toolbar-right", children: [
            V ? null : /* @__PURE__ */ a(
              "button",
              {
                ...
                onClick: M,
                disabled: !we || e.busy,
                title: t(we ? "chat.voiceInput" : "chat.voiceUnsupported"),
                "aria-label": t("chat.voiceInput"),
                children: /* @__PURE__ */ a(ti, { size: 16 })
              }
            ),
            /* @__PURE__ */ u("details", { ref: y, className: "workbench-chat-target", children: [
            ...
            e.busy ? /* @__PURE__ */ a("button", { className: "workbench-chat-send stop", onClick: e.stopChat, title: t("chat.stop"), "aria-label": t("chat.stop"), children: /* @__PURE__ */ a(ar, { size: 14 }) }) : /* @__PURE__ */ a("button", { className: `workbench-chat-send ${i ? "ready" : ""}`, onClick: e.askAgent, title: t("chat.send"), disabled: !i, "aria-label": t("chat.sendMessage"), children: /* @__PURE__ */ a(Hs, { size: 18 }) })
          ] })
        ] })
      ] })
    ] })
...
function Ka(e, t, n) {
  e.model;
  const i = [e.gatewayPreference === "auto" ? t : Zr(e.gatewayPreference)];
...
function Fl({ host: e, appName: t, currentVersion: n }) {
  const r = e.apps, [i, s] = P(null), [o, l] = P(!1), [m, p] = P(null), b = w(async () => {
    if (!r?.checkUpdate) {
    ...
    l(!0), p(null);
    try {
      const V = await r.checkUpdate();
      s(V), V.error && p(V.error);
    } catch (V) {
  ...
  const y = w(async () => {
    ...
    l(!0), p(null);
    try {
      const V = await r.updateSelf();
      s(V), p(V.error ?? `${t} updated. Close and reopen the app to load the new bundle.`);
    } catch (V) {
      p(V instanceof Error ? V.message : String(V));
    } finally {
      l(!1);
    }
  }, [r, t]), N = i?.latestVersion ?? n, z = !!i?.updateAvailable;
  return /* @__PURE__ */ u("div", { className: "workbench-settings-section", children: [
    ...
    /* @__PURE__ */ u("div", { style: { display: "flex", gap: 8, flexWrap: "wrap" }, children: [
      /* @__PURE__ */ u("button", { className: "workbench-button-subtle", onClick: () => void b(), disabled: o, children: [
        /* @__PURE__ */ a(Ct, { size: 14 }),
        o ? "Checking…" : "Check for update"
      ] }),
      z ? /* @__PURE__ */ a("button", { className: "workbench-button-primary", onClick: () => void y(), disabled: o, children: o ? "Updating…" : `Update ${t}` }) : null
    ] }),
    /* @__PURE__ */ a("div", { className: "workbench-settings-note", children: m ?? (i ? z ? "Update available." : "You are running the latest available version." : "Checking latest version…") })
  ] });
}
function Rl(e) {
  const [t, n] = P([]), [r, i] = P("Loading gateway models…"), [s, o] = P([]), [l, m] = P("Checking embedding capability…");
  pe(() => {
    ...
    return (async () => {
      ...
      try {
        const V = await e.host.ai.listModels({
          gatewayPreference: e.chatSettings.gatewayPreference,
          signal: N.signal
        });
        if (N.signal.aborted) return;
        n(V.map((R) => ({ id: R.id, gatewayLabel: R.gatewayLabel }))), i(V.length > 0 ? `${V.length} models discovered from AIL.` : "No models discovered. You can still enter any AIL alias manually.");
      } catch (V) {
        if (N.signal.aborted) return;
        n([]), i(`Model discovery failed: ${V instanceof Error ? V.message : String(V)}`);
      }
    })(), () => N.abort();
  }, [e.chatSettings.gatewayPreference, e.host.ai]), pe(() => {
    const N = new AbortController();
    return (async () => {
      const V = Mc(e.host);
      if (V) {
      ...
      try {
        const R = await jc(e.host, {
          gatewayPreference: e.chatSettings.gatewayPreference,
          signal: N.signal
        });
        if (N.signal.aborted) return;
        o(R.map((Y) => ({ id: Y.id, gatewayLabel: Y.gatewayLabel ?? Y.source ?? "AIL" }))), m(R.length > 0 ? `${R.length} embedding models discovered from AIL metadata.` : "AIL embedding API is present, but no embedding-capable model metadata was returned.");
      } catch (R) {
        if (N.signal.aborted) return;
        o([]), m(`Embedding model discovery failed: ${R instanceof Error ? R.message : String(R)}`);
      }
    })(), () => N.abort();
  }, [e.chatSettings.gatewayPreference, e.host]);
  const p = (N) => {
    e.onChange({ ...e.chatSettings, gatewayPreference: N });
  }, b = (N) => {
    e.onChange({ ...e.chatSettings, model: N });
  }, y = (N) => {
    e.onChange({ ...e.chatSettings, embeddingModel: N });
  };
  return /* @__PURE__ */ a("div", { className: "workbench-settings-tab", children: /* @__PURE__ */ u("section", { className: "workbench-settings-page", "aria-label": "Atomek Settings", children: [
    /* @__PURE__ */ u("header", { className: "workbench-settings-header", children: [
      ...
      /* @__PURE__ */ a("button", { onClick: e.onClose, title: "Close", children: /* @__PURE__ */ a(at, { size: 15 }) })
    ] }),
    /* @__PURE__ */ u("div", { className: "workbench-settings-body", children: [
      /* @__PURE__ */ a(Fl, { host: e.host, appName: "Atomek", currentVersion: Za }),
      /* @__PURE__ */ u("div", { className: "workbench-settings-section", children: [
        ...
        /* @__PURE__ */ u("label", { className: "workbench-settings-label", children: [
          ...
          /* @__PURE__ */ a("datalist", { id: "atomek-chat-models", children: t.map((N) => /* @__PURE__ */ a("option", { value: N.id, children: N.gatewayLabel }, `${N.gatewayLabel}:${N.id}`)) })
        ] }),
        /* @__PURE__ */ u("div", { className: "workbench-settings-note", children: [
          "Current request: ",
          Zr(e.chatSettings.gatewayPreference),
      ...
      /* @__PURE__ */ u("div", { className: "workbench-settings-section", children: [
        ...
        /* @__PURE__ */ u("label", { className: "workbench-settings-label", children: [
          ...
          /* @__PURE__ */ a("datalist", { id: "atomek-embedding-models", children: s.map((N) => /* @__PURE__ */ a("option", { value: N.id, children: N.gatewayLabel }, `${N.gatewayLabel}:${N.id}`)) })
        ] }),
        ...
        /* @__PURE__ */ a("div", { className: "workbench-settings-note", children: l })
      ] })
    ] }),
    /* @__PURE__ */ u("footer", { className: "workbench-settings-footer", children: [
      /* @__PURE__ */ a("button", { onClick: () => e.onChange(un), children: "Reset" }),
      /* @__PURE__ */ a("button", { onClick: e.onClose, children: "Close tab" })
    ] })
  ] }) });
}
function Kr({ outputs: e, clearOutputs: t, deleteArtifact: n, runAiSynthesis: r, captureManualCheck: i, openOutputAsFile: s, previewEditFromOutput: o, canPreviewEdit: l = !1, compact: m = !1 }) {
  const p = _e();
  return /* @__PURE__ */ u("div", { className: `workbench-panel-list ${m ? "compact" : ""}`, children: [
    /* @__PURE__ */ u("div", { style: { display: "flex", gap: 8, marginBottom: 10 }, children: [
      ...
      /* @__PURE__ */ u("button", { className: "workbench-button-subtle", onClick: i, children: [
        /* @__PURE__ */ a(Ws, { size: 14 }),
        "Capture check"
      ] }),
      /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: t, children: "Clear" })
    ] }),
    e.length === 0 ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No outputs yet. Save an AI answer as an artifact or create an AI synthesis." }) : e.map((b) => /* @__PURE__ */ u("div", { className: "workbench-output-card", children: [
      /* @__PURE__ */ u("div", { className: "workbench-output-head", children: [
        /* @__PURE__ */ a("strong", { children: b.title }),
        /* @__PURE__ */ a("span", { children: b.source === "ai" ? `AI · ${b.kind}` : b.kind }),
        /* @__PURE__ */ a("button", { onClick: () => void jt(b.body), children: "Copy" }),
        /* @__PURE__ */ a("button", { onClick: () => s(b), children: "Open as file" }),
        o ? /* @__PURE__ */ a(
          "button",
          {
            className: Ba(b.body) ? "workbench-output-edit-cta" : void 0,
            onClick: () => o(b),
            disabled: !l,
            children: Ba(b.body) ? "Preview/apply edit" : "Preview edit"
          }
        ) : null,
        b.source === "ai" ? /* @__PURE__ */ a("button", { onClick: () => n(b.id), children: p("chat.delete") }) : null
      ] }),
      /* @__PURE__ */ a(Jr, { body: b.body })
    ] }, b.id))
  ] });
}
function Dl({ edit: e, onApply: t, onOpenAsFile: n, onClose: r }) {
  return /* @__PURE__ */ a("div", { className: "workbench-edit-review-overlay", role: "dialog", "aria-label": "Review AI edit", children: /* @__PURE__ */ u("section", { className: "workbench-edit-review", children: [
    /* @__PURE__ */ u("header", { className: "workbench-edit-review-head", children: [
      ...
      /* @__PURE__ */ a("button", { title: "Close", onClick: r, children: /* @__PURE__ */ a(at, { size: 16 }) })
    ] }),
...
function El({ patch: e, onApply: t, onOpenAsFiles: n, onClose: r }) {
  ...
  return /* @__PURE__ */ a("div", { className: "workbench-edit-review-overlay", role: "dialog", "aria-label": "Review AI workspace patch", children: /* @__PURE__ */ u("section", { className: "workbench-edit-review workspace", children: [
    ...
    /* @__PURE__ */ u("div", { className: "workbench-workspace-patch-list", children: [
      e.edits.map((s) => /* @__PURE__ */ u("article", { className: "workbench-workspace-patch-card", children: [
        ...
        /* @__PURE__ */ a("pre", { children: Ul(s.proposedContent) })
      ] }, s.fileId)),
...
function Yl(e, t) {
  ...
  if (e)
    n.push("", `Active file: ${e.path}`, `Language: ${e.language}`, `Dirty: ${e.dirty ? "yes" : "no"}`, "", "Active file content:", "```" + e.language, ql(e.content), "```");
  else if (t.length > 0) {
...
function Br({
  ...
  const m = _e(), [p, b] = P([]), [y, N] = P([]), [z, V] = P(null), [R, Y] = P(!1), [B, we] = P(null), [G, M] = P("Review the active Atomek context. Return concise findings. If you propose edits, output a unified diff or fenced replacement blocks so Atomek can preview before applying."), [I, he] = P(null), [se, T] = P([]), [x, Te] = P(() => Vi()), [ne, ze] = P([]), [Me, De] = P([]), [We, f] = P([]), [D, Q] = P([]), ke = Re([]), [ie, L] = P("task-execute"), [O, q] = P("mission"), S = se.find((d) => d.status === "running" || d.status === "canceling") ?? se[0] ?? null, $ = se.some((d) => d.status === "running" || d.status === "canceling"), ce = l === "dock", ge = x?.goal || G || "", be = ue(() => Mt(z, kt(ge, z, x?.teamPresetId)), [x?.teamPresetId, ge, z]), g = ue(() => bn(ge, z, be.id), [ge, be.id, z]), X = g.find((d) => d.id === ie) ?? g[1] ?? g[0] ?? null, Xe = ue(() => X ? be.assignments.find((d) => d.role === X.role) ?? be.assignments.find((d) => d.role === "implementer") ?? be.assignments[0] ?? null : null, [be.assignments, X]), E = ue(() => !Xe || !z ? null : z.resources.find((d) => d.id === Xe.resourceId) ?? null, [z, Xe]), Ue = ue(() => new Map(D.map((d) => [d.path, d])), [D]), et = w((d) => {
    if (!x) {
      t("Start or resume a mission first");
      return;
    }
    const A = Ue.get(d);
    if (!A) {
      t("Refresh mission pack before opening generated files");
      return;
    }
    i(x, [A], { primaryOnly: !1, activatePath: d });
  }, [x, Ue, i, t]), Ee = o.filter((d) => d.dirty).length, _ = s ? `${s.path} · ${s.language} · ${s.content.length.toLocaleString()} chars${s.dirty ? " · dirty" : ""}` : o.length > 0 ? `${o.length} open editor${o.length === 1 ? "" : "s"}${Ee ? ` · ${Ee} dirty` : ""}` : "No active file — jobs run with only your typed prompt.", ae = ue(() => [
    {
  ...
  const re = w(async (d = x) => {
    if (!d?.rootPath || !e.missions?.listRuns)
      return f([]), [];
    try {
      const A = await e.missions.listRuns(d.rootPath);
      return f(A), ke.current = A, A;
    } catch (A) {
      return t(`Mission run history failed: ${A instanceof Error ? A.message : String(A)}`), [];
    }
  }, [e.missions, x, t]), me = w(async (d, A) => {
    if (!d) return;
    const H = [...A].sort((F, ee) => Sa(ee).localeCompare(Sa(F))).slice(0, 100), C = H.map((F) => JSON.stringify(F)).join(`
`) + (H.length ? `
` : "");
    d.rootPath && e.missions?.write ? await e.missions.write({ rootPath: d.rootPath, files: [{ path: "RUNS.jsonl", content: C }] }) : d.handle && await Jn(d.handle, "RUNS.jsonl", C), f(H), ke.current = H;
  }, [e.missions]), Pe = w(async (d, A = x) => {
    if (!A) return;
    const H = [
      d,
      ...ke.current.filter((C) => C.id !== d.id)
    ];
    await me(A, H);
  }, [x, me]), He = w(async () => {
    if (!e.local?.listTools && !e.skills?.list && !e.resources?.list) {
      b([]), N([]), V(null), we("This Tytus host build does not expose local tools, resource graph, or skill registry yet.");
      return;
    }
    Y(!0), we(null);
    try {
      const [d, A, H, C] = await Promise.all([
        e.local?.listTools?.().catch((F) => (t(`Local tool discovery failed: ${F instanceof Error ? F.message : String(F)}`), [])) ?? Promise.resolve([]),
        e.skills?.list?.().catch((F) => (t(`Skill registry discovery failed: ${F instanceof Error ? F.message : String(F)}`), [])) ?? Promise.resolve([]),
        e.resources?.list?.().catch((F) => (t(`Resource graph discovery failed: ${F instanceof Error ? F.message : String(F)}`), null)) ?? Promise.resolve(null),
        e.missions?.list?.().catch((F) => (t(`Mission list failed: ${F instanceof Error ? F.message : String(F)}`), [])) ?? Promise.resolve([])
      ]);
      b(d), N(A), V(H), ze(C), x?.rootPath && re(x), t(`Agent team loaded · ${d.length} tools · ${A.length} skills · ${C.length} missions${H ? ` · ${H.resources.length} resources` : ""}`);
    } catch (d) {
      we(d instanceof Error ? d.message : String(d));
    } finally {
      Y(!1);
    }
  }, [e.local, e.missions, e.resources, e.skills, re, x, t]);
  pe(() => {
    He();
  }, [He]), pe(() => {
    const d = (A) => {
      const H = A.detail;
      H?.missionId && (Te(H), re(H)), He();
    };
  ...
  const it = w((d) => {
    ...
    Te(A), Q([]), qt(A), re(A), De([{
      ts: (/* @__PURE__ */ new Date()).toISOString(),
      kind: "mission.resume",
      message: `Mission resumed from Atomek agent team: ${A.rootPath ?? A.name}`,
      data: { runCount: d.runCount ?? 0, taskCount: d.taskCount ?? 0 }
    }]), M(d.goal || `Continue mission ${d.title}. Review MISSION.md, TASKS.md, RESOURCES.md, and runs/ before acting.`), t(`Resumed mission: ${d.rootPath}`);
  }, [re, t]), Z = w(async (d, A, H = [], C = {}) => {
    const F = [
      ...Me,
      ...H,
      { ts: (/* @__PURE__ */ new Date()).toISOString(), kind: "mission.pack.write", message: "Mission context pack written from Atomek" }
    ], ee = kt(A || d.goal, z, d.teamPresetId), W = hr(d, z, s, o, A, ee, [
      F.map((de) => JSON.stringify(de)).join(`
`) + `
`
    ]).map((de) => de.path === "RUNS.jsonl" ? { ...de, content: ke.current.map((qe) => JSON.stringify(qe)).join(`
`) + (ke.current.length ? `
` : "") } : de), Le = new Set(o.filter((de) => de.source === "mission" && de.dirty && de.mission?.missionId === d.missionId).map((de) => de.mission?.relPath).filter(Boolean)), xe = W.filter((de) => !Le.has(de.path));
    if (d.rootPath && e.missions?.write)
      await e.missions.write({ rootPath: d.rootPath, files: xe });
    else if (d.handle) {
      await Lt(d.handle, "runs"), await Lt(d.handle, "outputs"), await Lt(d.handle, "proposals"), await Lt(d.handle, "approvals");
      for (const de of xe) await cr(d.handle, de.path, de.content);
    } else
      throw new Error("Mission has neither tray rootPath nor browser folder handle");
    De(F), Q(W), i(d, W, C.openFiles ? { activate: C.activate } : { openTabs: !1, activate: !1, quiet: !0 }), qt(d);
  }, [s, e.missions, Me, o, i, z]), ve = w(async (d, A = {}) => {
    if (x)
      return await Z(x, d, [], { openFiles: !!A.openFiles, activate: A.activate }), x;
    const H = `Atomek mission ${(/* @__PURE__ */ new Date()).toLocaleString()}`, C = d.trim() || "Coordinate Tytus resources for the current Atomek task.";
    let F = null;
    if (e.missions?.create) {
      const W = await e.missions.create({ title: H, goal: C });
      F = {
        missionId: W.missionId,
        title: W.title,
        goal: W.goal,
        rootPath: W.rootPath,
        name: W.rootPath.split("/").pop() || W.missionId,
        source: "tray"
      };
    } else if (A.allowBrowserPicker) {
      const W = await xi();
      if (!W)
      ...
      F = {
        handle: W,
        name: W.name,
        missionId: `mission-${Date.now()}-${Wi(W.name)}`,
        title: H,
        goal: C,
        source: "browser"
      };
    ...
    if (!F) return null;
    const ee = { ts: (/* @__PURE__ */ new Date()).toISOString(), kind: "mission.folder.ready", message: `Mission folder ready: ${F.rootPath ?? F.name}` };
    return Te(F), qt(F), De([ee]), await Z(F, C, [ee], { openFiles: A.openFiles ?? !0, activate: A.activate ?? !0 }), t(`Mission pack ready in ${F.rootPath ?? F.name}`), F;
  }, [e.missions, x, t, Z]), Ae = w(async (d, A) => {
    if (!e.local?.openTerminal) {
      t("Terminal bridge unavailable in this host build");
      return;
    }
    try {
      const H = (A ?? G).trim() || `Open ${d.label} from Atomek with current context.`, C = d.kind === "ai-cli" ? await ve(H) : x;
      await e.local.openTerminal({
        toolId: d.id,
        command: d.command,
        cwd: C?.rootPath ?? Ua(s),
        prompt: C ? `Atomek mission pack ready at ${C.rootPath ?? C.name}. Read MISSION.md and RESOURCES.md. ${_}` : `Opened from Atomek. ${_}`
      }), t(d.kind === "ai-cli" ? `Started ${d.label} in a fresh Tytus Terminal with mission context.` : "Opened Tytus Terminal");
    } catch (H) {
      t(`Terminal launch failed: ${H instanceof Error ? H.message : String(H)}`);
    }
  }, [s, _, ve, e.local, G, x, t]), le = w(async () => {
    try {
      await ve(G.trim(), { allowBrowserPicker: !0, openFiles: !0, activate: !0 }) || t("Mission folder setup skipped.");
    } catch (d) {
      t(`Mission folder setup failed: ${d instanceof Error ? d.message : String(d)}`);
    }
  }, [ve, G, t]), Je = w(async (d, A, H, C = x, F) => {
    if (!C) return;
    const ee = (/* @__PURE__ */ new Date()).toISOString().replace(/[:.]/g, "-"), W = F ?? `runs/${ee}-${d.id}.md`, Le = W.split("/").pop() || `${ee}-${d.id}.md`;
    if (C.rootPath && e.missions?.write)
      await e.missions.write({ rootPath: C.rootPath, files: [{ path: W, content: A }] });
    else if (C.handle) {
      const xe = await Lt(C.handle, "runs");
      await Jn(xe, Le, A);
    }
    await Z(C, G, [{
      ts: (/* @__PURE__ */ new Date()).toISOString(),
      kind: "local-cli.run.complete",
      message: `${d.label} exited ${H}; transcript saved to ${W}`,
      data: { toolId: d.id, exitCode: H, transcript: W }
    }]);
  }, [e.missions, G, x, Z]), Ge = w(async (d, A) => {
    ...
    try {
      ...
      t(`Mission pack failed before local job start: ${W instanceof Error ? W.message : String(W)}`);
      return;
    }
    he(d.id);
    const F = `local-run-${Date.now()}-${d.id}`, ee = Tt();
    T((W) => [{
      id: F,
      toolId: d.id,
      label: d.label,
    ...
    try {
      const W = await e.local.runJob({
        toolId: d.id,
        prompt: C ? [
          "Tytus mission context pack is active.",
          `Mission: ${C.title}`,
          `Goal: ${C.goal}`,
          C.rootPath ? `Mission folder: ${C.rootPath}` : `Mission folder: ${C.name}`,
...
`)
      }), Le = W.transcriptPath ?? (C?.rootPath ? `runs/${(/* @__PURE__ */ new Date()).toISOString().replace(/[:.]/g, "-")}-${d.id}.md` : void 0), xe = [
        `[Atomek] Started ${d.label} local job ${W.id}`,
        X ? `[Atomek] Task: ${X.title} (${X.id})` : "[Atomek] Task: manual",
        C?.rootPath ? `[Atomek] Mission: ${C.rootPath}` : ""
      ].filter(Boolean), de = {
        id: F,
        jobId: W.id,
        toolId: d.id,
      ...
      Pe(de, C).catch((fe) => {
        t(`Mission run index failed: ${fe instanceof Error ? fe.message : String(fe)}`);
      }), T((fe) => fe.map((te) => te.id === F ? { ...te, jobId: W.id, transcriptPath: Le } : te));
      const qe = (fe) => {
        T((te) => te.map((U) => U.id === F ? fe(U) : U));
      };
      e.local.streamJob(W.id, {
        onLog: (fe) => {
          xe.push(fe), qe((te) => ({ ...te, lines: xe.slice(-500) }));
        },
        onDone: (fe) => {
          fe && (xe.push(fe), qe((te) => ({ ...te, lines: xe.slice(-500) })));
        },
        onFail: (fe) => {
          xe.push(`[FAIL] ${fe}`), qe((te) => ({
            ...te,
            status: "failed",
            finishedAt: Date.now(),
            lines: xe.slice(-500)
            ...
            t(`Mission run index failed: ${te instanceof Error ? te.message : String(te)}`);
          }), r(`${d.label} local job failed`, xe.join(`
`)), Je(d, xe.join(`
`), -1, C, Le).catch((te) => {
            t(`Mission transcript save failed: ${te instanceof Error ? te.message : String(te)}`);
          }), he(null);
        },
        onExit: (fe) => {
          const te = [
...
`);
          qe((U) => ({
            ...
            finishedAt: Tt(),
            exitCode: fe,
            summary: `${d.label} exited ${fe}`
          }, C).catch((U) => {
            t(`Mission run index failed: ${U instanceof Error ? U.message : String(U)}`);
          }), r(`${d.label} local job`, te), Je(d, te, fe, C, Le).catch((U) => {
            t(`Mission transcript save failed: ${U instanceof Error ? U.message : String(U)}`);
          }), he(null);
        },
        onError: () => t(`Local job stream issue for ${d.label}`)
      }), t(`Started ${d.label} mission run${X ? ` · ${X.title}` : ""}`);
    } catch (W) {
      he(null), T((Le) => Le.map((xe) => xe.id === F ? {
        ...xe,
        status: "failed",
        finishedAt: Date.now(),
        lines: [...xe.lines, `[Atomek] Failed to start: ${W instanceof Error ? W.message : String(W)}`]
      } : xe)), t(`Local job failed to start: ${W instanceof Error ? W.message : String(W)}`);
    }
  }, [s, ve, e.local, G, o, z, r, Je, X, t, Pe, Z]), ot = w(async (d, A) => {
    const H = Zn(d), C = Pi(d);
    if (!H) {
      t(`Cannot dispatch ${Fe(d)}: missing pod id`);
      return;
    }
    const F = (A ?? G).trim();
    if (!F) {
    ...
    let ee = null;
    const W = Fe(d), Le = `pod-run-${Date.now()}-${H}`, xe = Tt(), de = `runs/${(/* @__PURE__ */ new Date()).toISOString().replace(/[:.]/g, "-")}-${d.id.replace(/[^a-z0-9_.-]/gi, "-")}.md`;
    try {
      ee = await ve(F), ee && await Z(ee, F, [{
        ts: (/* @__PURE__ */ new Date()).toISOString(),
        kind: "pod-agent.run.start",
        message: `${W} mission task started`,
        data: { resourceId: d.id, podId: H, routeId: C ?? void 0, taskId: X?.id ?? "manual", taskTitle: X?.title ?? "Manual pod run" }
      }]);
    } catch (U) {
      t(`Mission pack failed before pod task: ${U instanceof Error ? U.message : String(U)}`);
      return;
    }
    const qe = {
      id: Le,
      ...
      transcriptPath: de,
      summary: `Started ${W} for ${X?.title ?? "manual pod run"}`
    };
    T((U) => [{
      id: Le,
      toolId: d.id,
      ...
      taskTitle: X?.title ?? "Manual pod run",
      transcriptPath: de,
      lines: [`[Atomek] Dispatching ${W} via Tytus host bridge…`, `[Atomek] Pod: ${H}`, `[Atomek] Task: ${X?.title ?? "manual pod run"}`]
    }, ...U].slice(0, 6)), await Pe(qe, ee).catch((U) => {
      t(`Mission run index failed: ${U instanceof Error ? U.message : String(U)}`);
    });
    const fe = [], te = (U) => {
      fe.push(U), T((Ce) => Ce.map((Ze) => Ze.id === Le ? { ...Ze, lines: [...Ze.lines, U].slice(-500) } : Ze));
    };
    try {
      te("[Atomek] Routing through pod-agent chat bridge.");
      const U = [
        ...
        "",
        ee ? `Mission folder: ${ee.rootPath ?? ee.name}` : "Mission folder: not available",
        ee ? `Mission: ${ee.title}` : "",
        ee ? `Goal: ${ee.goal}` : "",
...
`);
      let Ce = "", Ze = !1;
      for await (const Oe of e.daemon.chatAgent({
        podId: H,
        routeId: C,
        message: U,
        mode: "operator",
        ...
        if (Oe.type === "profile" && te(`[Atomek] ${Oe.profile === "local" ? "Local Cortex" : "Cloud Cortex"} route selected.`), Oe.type === "session" && te("[Atomek] Pod-agent session established."), Oe.type === "token" && (Ze || (te("[Atomek] Pod agent is responding…"), Ze = !0), Ce = yn(`${Ce}${Oe.text}`)), Oe.type === "error") {
          const dt = Gn(Oe.message);
          throw new Error(dt.message);
        }
        if (Oe.type === "done") break;
      }
      if (Ce = Ce.trim(), !Ce) throw new Error("Pod agent returned no text.");
      te(Ce);
      const Ye = [
        `# Pod job — ${W}`,
        "",
...
`);
      T((Oe) => Oe.map((dt) => dt.id === Le ? { ...dt, status: "complete", finishedAt: Date.now(), lines: [...dt.lines, "[Atomek] Pod task complete."].slice(-500) } : dt)), await Pe({ ...qe, status: "complete", finishedAt: Tt(), summary: `${W} completed`, transcriptPath: de }, ee), r(`${W} pod job`, Ye), await Je({ id: d.id, label: W, kind: "pod-agent", status: d.status }, Ye, 0, ee, de), t(`${W} completed mission task`);
    } catch (U) {
      const Ce = U instanceof Error ? U.message : String(U);
      te(`[FAIL] ${Ce}`), T((Ye) => Ye.map((Oe) => Oe.id === Le ? { ...Oe, status: "failed", finishedAt: Date.now(), lines: Oe.lines.slice(-500) } : Oe)), await Pe({ ...qe, status: "failed", finishedAt: Tt(), exitCode: -1, summary: Ce, transcriptPath: de }, ee).catch((Ye) => {
        t(`Mission run index failed: ${Ye instanceof Error ? Ye.message : String(Ye)}`);
      });
      const Ze = [`# Pod job failed — ${W}`, "", `- Pod: ${H}`, `- Error: ${Ce}`, "", "```text", fe.join(`
`), "```", ""].join(`
`);
      r(`${W} pod job failed`, Ze), await Je({ id: d.id, label: W, kind: "pod-agent", status: d.status }, Ze, -1, ee, de).catch((Ye) => {
        t(`Pod transcript save failed: ${Ye instanceof Error ? Ye.message : String(Ye)}`);
      }), t(`Pod task failed: ${Ce}`);
    }
  }, [s, ve, e.daemon, G, o, z, r, Je, X, t, Pe, Z]), Zt = w(async (d) => {
    if (!d.jobId || !e.local?.cancelJob) {
      t("Local job cancel bridge unavailable in this host build");
      return;
    }
    T((A) => A.map((H) => H.id === d.id ? { ...H, status: "canceling", lines: [...H.lines, "[Atomek] Cancel requested…"] } : H)), Pe({
      id: d.id,
      jobId: d.jobId,
      toolId: d.toolId,
      label: d.label,
      ...
      t(`Mission run index failed: ${A instanceof Error ? A.message : String(A)}`);
    });
    try {
      await e.local.cancelJob(d.jobId), t(`Cancel requested for ${d.label}`);
    } catch (A) {
      T((H) => H.map((C) => C.id === d.id ? { ...C, status: "running", lines: [...C.lines, `[Atomek] Cancel failed: ${A instanceof Error ? A.message : String(A)}`] } : C)), t(`Local job cancel failed: ${A instanceof Error ? A.message : String(A)}`);
    }
  }, [e.local, t, Pe]), pt = w(async (d) => {
    const A = [
      `Use Tytus resource "${Fe(d)}" (${d.kind}) for the next mission step.`,
...
`);
    M(A), x && await Z(x, A, [{
      ...
      message: `Selected resource ${Fe(d)}`,
      data: { resourceId: d.id, kind: d.kind, status: d.status }
    }]), t(`Selected ${Fe(d)} for mission`);
  }, [x, t, Z]), tt = w((d) => {
    const A = d.setupAction, H = A?.commandPreview ? `${A.label}: ${A.commandPreview}` : A?.deepLink ? `${A.label}: ${A.deepLink}` : A?.label ?? `${Fe(d)} needs setup`;
    t(H), jt(A?.commandPreview ?? A?.deepLink ?? H);
  }, [t]), wn = w(async () => {
    try {
      if ($) {
        t("A mission task is already running. Open Runs or wait for it to finish."), q("runs");
        return;
      }
      if (!X) {
        t("Select a mission task first");
        return;
      }
      const d = X.prompt;
      if (M(d), !Xe) {
        t(`No resource assignment for ${X.title}`);
        return;
      }
      if (!E) {
        t(`${Xe.label} is not ready: ${Xe.resourceLabel}`);
        return;
      }
      if (E.status === "needs-setup" || E.setupAction) {
        tt(E);
        return;
      }
      if (E.kind === "local-cli") {
        const H = (typeof E.metadata?.id == "string" ? E.metadata.id : "") || E.id.replace(/^local-cli\./, ""), C = p.find((F) => F.id === H || F.command === H || F.label.toLowerCase() === E.label.toLowerCase());
        if (!C) {
          t(`Local tool not found for ${E.label}`);
          return;
        }
        if (C.status !== "available") {
          t(`${C.label} is ${C.status}; open Setup for install/repair`);
          return;
        }
        if (C.kind === "ai-cli") {
          await Ge(C, d), q("runs");
      ...
      if (E.kind === "app-skill") {
        const A = typeof E.metadata?.id == "string" ? E.metadata.id : E.id.replace(/^app-skill\./, ""), H = y.find((C) => C.id === A || C.id === E.id.replace(/^app-skill\./, "") || C.title === E.label);
        if (!H) {
          t(`App skill not found for ${E.label}`);
          return;
        }
        await n(H), x && await Z(x, d, [{
          ts: (/* @__PURE__ */ new Date()).toISOString(),
          kind: "app-skill.selected",
          message: `Attached app skill ${H.title} for task ${X.title}`,
          data: { skillId: H.id, taskId: X.id }
        }]), t(`Attached ${H.title} to chat for ${X.title}`);
        return;
      }
      if (E.kind === "shared-folder" || E.kind === "workspace") {
        await pt(E), t(`${E.label} selected as mission context. Pick an executable local/pod task to run.`);
        return;
      }
      await pt(E);
    } catch (d) {
      t(`Run task failed: ${d instanceof Error ? d.message : String(d)}`);
    }
  }, [n, $, x, Ae, Ge, ot, Xe, E, X, t, tt, y, p, pt, Z]);
  return /* @__PURE__ */ u("aside", { className: ce ? "workbench-agent-dock" : "workbench-sidebar", children: [
    ce ? null : /* @__PURE__ */ a("div", { className: "workbench-sidebar-title", children: "AGENT TEAM" }),
    /* @__PURE__ */ u("div", { className: ce ? "workbench-agent-dock-scroll" : "workbench-sidebar-scroll", children: [
      /* @__PURE__ */ u("div", { className: "workbench-computer-hero", children: [
        /* @__PURE__ */ a(ta, { size: 18 }),
        /* @__PURE__ */ u("div", { children: [
          /* @__PURE__ */ a("strong", { children: ce ? "Mission Runs" : "OpenClaw + Hermes Team Board" }),
      ...
      /* @__PURE__ */ u("button", { className: "workbench-button-subtle workbench-computer-refresh", onClick: () => {
        ...
        /* @__PURE__ */ a(Ct, { size: 14 }),
        " ",
        R ? "Refreshing…" : "Refresh capabilities"
      ] }),
      ...
      /* @__PURE__ */ u("div", { className: "workbench-team-switcher", role: "tablist", "aria-label": "Atomek agent team views", children: [
        /* @__PURE__ */ a("button", { className: O === "mission" ? "active" : "", onClick: () => q("mission"), children: "Mission" }),
        /* @__PURE__ */ a("button", { className: O === "runs" ? "active" : "", onClick: () => q("runs"), children: "Runs" }),
        /* @__PURE__ */ a("button", { className: O === "setup" ? "active" : "", onClick: () => q("setup"), children: "Setup" })
      ] }),
      O === "mission" ? /* @__PURE__ */ u(Qe, { children: [
        ...
        /* @__PURE__ */ u("div", { className: "workbench-computer-context-card mission", children: [
          /* @__PURE__ */ a("strong", { children: x ? x.title : "No mission folder selected" }),
          /* @__PURE__ */ a("span", { children: x ? `${x.rootPath ?? x.name} · ${x.source} · ${Me.length} audit events · transcripts saved under runs/` : "Atomek creates this automatically before launching local agents. It is the shared folder agents read/write transcripts from." }),
          z ? /* @__PURE__ */ u("span", { children: [
            lr(z.resources),
            z.warnings.length ? ` · ${z.warnings.length} warnings` : ""
          ] }) : /* @__PURE__ */ a("span", { children: "Resource graph not loaded yet." })
        ] }),
        /* @__PURE__ */ a("div", { className: "workbench-section-title", children: m("mission.files") }),
        /* @__PURE__ */ u("div", { className: "workbench-mission-file-tree", children: [
          ur.map((d) => {
            const A = Ue.get(d);
            return /* @__PURE__ */ u(
              "button",
              {
                ...
                onClick: () => et(d),
                disabled: !x || !A,
                title: A ? m("mission.files.openFile", { path: d }) : m("mission.files.refreshToOpen"),
                children: [
                  /* @__PURE__ */ a(sa, { size: 13 }),
                  /* @__PURE__ */ a("span", { children: d }),
                  /* @__PURE__ */ a("em", { children: m(A ? "mission.files.generated" : "mission.files.needsRefresh") })
                ]
              },
              d
            );
          ...
          /* @__PURE__ */ a(
            "button",
            {
              ...
              onClick: () => x && i(x, D, { primaryOnly: !1, activatePath: "MISSION.md" }),
              disabled: !x || D.length === 0,
              children: m("mission.files.openGenerated")
            }
          ),
          D.length ? null : /* @__PURE__ */ a("p", { className: "workbench-muted", children: m("mission.files.refreshToOpen") })
        ] }),
        ...
        /* @__PURE__ */ u("div", { className: "workbench-team-assignment-list", children: [
          /* @__PURE__ */ u("div", { className: `workbench-team-assignment-summary ${be.readiness}`, children: [
            /* @__PURE__ */ a("strong", { children: be.label }),
            /* @__PURE__ */ u("span", { children: [
              be.readiness,
              " · ",
              be.bestFor
          ...
          be.assignments.map((d) => /* @__PURE__ */ u("div", { className: "workbench-team-assignment-row", children: [
            /* @__PURE__ */ u("div", { children: [
        ...
        /* @__PURE__ */ u("div", { className: "workbench-computer-actions", children: [
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle workbench-agent-primary-action", onClick: () => {
            le();
          }, children: x ? "Refresh mission pack" : "Start mission pack" }),
          /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => x && void Z(x, G, [], { openFiles: !0, activate: !0 }), disabled: !x, children: "Rewrite context files" })
        ] }),
        ne.length ? /* @__PURE__ */ u(Qe, { children: [
          /* @__PURE__ */ a("div", { className: "workbench-section-title", children: "RESUME MISSION" }),
          /* @__PURE__ */ a("div", { className: "workbench-mission-list", children: ne.slice(0, ce ? 3 : 5).map((d) => /* @__PURE__ */ u(
            "button",
            {
              className: `workbench-mission-row ${x?.missionId === d.missionId ? "active" : ""}`,
              onClick: () => it(d),
              title: d.rootPath,
              children: [
        ...
        z?.warnings.length ? /* @__PURE__ */ a("div", { className: "workbench-resource-warnings", children: z.warnings.slice(0, 3).map((d) => /* @__PURE__ */ u("span", { children: [
          d.code,
          ": ",
          d.message
        ...
        /* @__PURE__ */ u("div", { className: "workbench-computer-context-card", children: [
          /* @__PURE__ */ a("strong", { children: _ }),
          /* @__PURE__ */ a("span", { children: s ? "Local agents receive clipped active-file content and must return previewable edits." : "Open a file to give local agents useful context." })
        ] }),
        /* @__PURE__ */ a("div", { className: "workbench-section-title", children: "TASK FOR LOCAL AGENT" }),
        /* @__PURE__ */ a("div", { className: "workbench-computer-presets", children: ae.map((d) => /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => M(d.prompt), children: d.label }, d.label)) }),
        /* @__PURE__ */ a(
          "textarea",
          {
        ...
        /* @__PURE__ */ a("div", { className: "workbench-task-graph", children: g.map((d, A) => /* @__PURE__ */ u(
          "button",
          {
        ...
        X ? /* @__PURE__ */ u("div", { className: "workbench-task-detail", children: [
          /* @__PURE__ */ u("header", { children: [
            /* @__PURE__ */ u("div", { children: [
              /* @__PURE__ */ a("strong", { children: m("mission.taskDetail") }),
              /* @__PURE__ */ a("span", { children: X.title })
            ] }),
            /* @__PURE__ */ a("span", { className: `workbench-computer-pill ${E?.status ?? X.status}`, children: E?.status ?? X.status })
          ] }),
          /* @__PURE__ */ u("div", { className: "workbench-task-detail-grid", children: [
            /* @__PURE__ */ a("span", { children: m("mission.assignedResource") }),
            /* @__PURE__ */ a("strong", { children: E ? Fe(E) : X.assignedResourceLabel }),
            /* @__PURE__ */ a("span", { children: m("mission.role") }),
            /* @__PURE__ */ a("strong", { children: Xe?.label ?? X.role }),
            /* @__PURE__ */ a("span", { children: m("mission.route") }),
            /* @__PURE__ */ a("strong", { children: E ? `${E.kind} · ${E.sandbox} · ${E.trustTier}` : X.resourceHint })
          ] }),
          /* @__PURE__ */ u("div", { className: "workbench-task-output-list", children: [
            /* @__PURE__ */ a("span", { children: m("mission.expectedOutputs") }),
            /* @__PURE__ */ a("ul", { children: X.expectedOutputs.map((d) => /* @__PURE__ */ a("li", { children: d }, d)) })
          ] }),
          /* @__PURE__ */ u("div", { className: "workbench-task-detail-actions", children: [
            /* @__PURE__ */ a(
              "button",
              {
                ...
                disabled: !X || $,
                children: m($ ? "mission.taskRunning" : "mission.runTask")
              }
            ),
            /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => q("runs"), children: m("mission.openRuns") })
          ] })
        ] }) : null
      ] }) : null,
      O === "runs" ? /* @__PURE__ */ u(Qe, { children: [
        S ? /* @__PURE__ */ u("div", { className: "workbench-agent-run", children: [
          /* @__PURE__ */ u("header", { children: [
            /* @__PURE__ */ u("div", { children: [
              ...
              S.transcriptPath ? /* @__PURE__ */ a("span", { children: S.transcriptPath }) : null
            ] }),
            /* @__PURE__ */ u("div", { className: "workbench-agent-run-actions", children: [
              /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => r(`${S.label} local job`, S.lines.join(`
`)), disabled: S.lines.length === 0, children: "Save output" }),
              S.jobId && (S.status === "running" || S.status === "canceling") ? /* @__PURE__ */ u("button", { className: "workbench-button-subtle danger", onClick: () => {
                Zt(S);
              }, disabled: S.status === "canceling", children: [
                /* @__PURE__ */ a(ar, { size: 12 }),
                " ",
                S.status === "canceling" ? "Canceling…" : "Cancel"
              ] }) : null
            ] })
          ] }),
          /* @__PURE__ */ a("pre", { className: "workbench-computer-job-log", children: S.lines.join(`
`) || "[waiting for output]" })
        ] }) : null,
        We.length ? /* @__PURE__ */ u(Qe, { children: [
          /* @__PURE__ */ a("div", { className: "workbench-section-title", children: "RUN HISTORY" }),
          /* @__PURE__ */ a("div", { className: "workbench-run-history", children: We.slice(0, ce ? 4 : 8).map((d) => /* @__PURE__ */ u("div", { className: "workbench-run-history-row", children: [
            /* @__PURE__ */ u("div", { children: [
            ...
            /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => void jt(d.transcriptPath ?? d.id), title: "Copy transcript path or run id", children: "Copy path" })
          ] }, d.id)) })
        ] }) : null
      ] }) : null,
      O === "setup" ? /* @__PURE__ */ u(Qe, { children: [
        ...
        /* @__PURE__ */ u("div", { className: "workbench-computer-list compact", children: [
          !z && !R ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No resource graph reported yet. Older Tytus host builds need `/api/resources`." }) : null,
          z?.resources.slice(0, ce ? 8 : 5).map((d) => /* @__PURE__ */ u("div", { className: "workbench-resource-row", children: [
            /* @__PURE__ */ u("div", { children: [
              /* @__PURE__ */ a("strong", { children: Fe(d) }),
              /* @__PURE__ */ a("span", { children: ha(d) })
            ] }),
            /* @__PURE__ */ u("div", { className: "workbench-resource-row-actions", children: [
              ...
              d.status === "needs-setup" || d.setupAction ? /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => tt(d), children: "Setup" }) : null
            ] })
          ] }, d.id))
        ] }),
        ...
        /* @__PURE__ */ u("div", { className: "workbench-computer-list", children: [
          p.length === 0 && !R ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No local tools reported yet." }) : null,
          p.map((d) => /* @__PURE__ */ u("div", { className: "workbench-computer-card", children: [
            ...
            /* @__PURE__ */ u("div", { className: "workbench-computer-actions", children: [
              /* @__PURE__ */ a("button", { className: "workbench-button-subtle workbench-agent-primary-action", onClick: () => {
                Ae(d);
              }, disabled: d.status !== "available", title: "Launch this tool in a fresh Tytus Terminal with mission context and execute it immediately.", children: Jl(d) }),
              d.kind === "ai-cli" ? /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => {
                Ge(d);
              }, disabled: d.status !== "available" || I !== null, title: "Run this local agent as a background read-only review inside Atomek and stream output here. It cannot write files directly.", children: Zl(d, I) }) : null
            ] })
          ] }, d.id))
        ] }),
        /* @__PURE__ */ a("div", { className: "workbench-section-title", children: "AGENTIC APP SKILLS" }),
        /* @__PURE__ */ u("div", { className: "workbench-computer-list", children: [
          y.length === 0 && !R ? /* @__PURE__ */ a("p", { className: "workbench-muted", children: "No skills reported yet." }) : null,
          y.map((d) => /* @__PURE__ */ u("div", { className: "workbench-computer-card", children: [
            /* @__PURE__ */ u("div", { className: "workbench-computer-card-head", children: [
              /* @__PURE__ */ u("div", { children: [
                /* @__PURE__ */ a("strong", { children: d.title }),
                /* @__PURE__ */ u("span", { children: [
            ...
            d.triggers?.length ? /* @__PURE__ */ a("div", { className: "workbench-computer-triggers", children: d.triggers.slice(0, 4).map((A) => /* @__PURE__ */ a("span", { children: A }, A)) }) : null,
            /* @__PURE__ */ a("button", { className: "workbench-button-subtle", onClick: () => {
              n(d);
...
function Kl({ status: e, file: t, cursor: n, fileCount: r, dirtyCount: i }) {
  const s = _e(), o = e === "Ready" ? s("app.ready") : e;
  return /* @__PURE__ */ u("footer", { className: "workbench-statusbar", children: [
    ...
    /* @__PURE__ */ a("span", { children: rr(t.language) })
  ] });
}
function Fn(e, t) {
...
function ed(e) {
  ...
  return e.slice(0, 160).map((r) => {
    ...
    const o = r.mission ? {
      ...
      rootPath: r.mission.rootPath,
      relPath: r.mission.relPath,
...
function rd() {
  try {
    ...
    const t = JSON.parse(e);
    return {
      gatewayPreference: t.gatewayPreference === "remote" || t.gatewayPreference === "local" || t.gatewayPreference === "auto" ? t.gatewayPreference : un.gatewayPreference,
...
function sd({ host: e }) {
  return /* @__PURE__ */ a(al, { host: e, children: /* @__PURE__ */ a(gl, { host: e }) });
}
function ld(e) {
  return function() {
    return /* @__PURE__ */ a(sd, { host: e.host });
  };
}
export {
  ld as default
