...
import { jsx as r, jsxs as u, Fragment as Re } from "react/jsx-runtime";
import { forwardRef as ja, createElement as Hn, useState as z, useRef as it, useCallback as N, useEffect as re, lazy as ls, useMemo as ue, Suspense as cs } from "react";
/**
...
}, Ma = (...e) => e.filter((t, n, a) => !!t && t.trim() !== "" && a.indexOf(t) === n).join(" ").trim(), fs = (e) => {
  for (const t in e)
...
const ms = ja(
  ({
    ...
    "svg",
    {
      ...
      className: Ma("lucide", s),
      ...!i && !fs(c) && { "aria-hidden": "true" },
      ...c
    },
    [
      ...o.map(([p, v]) => Hn(p, v)),
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const vs = [["path", { d: "M20 6 9 17l-5-5", key: "1gmf2c" }]], ys = ie("check", vs);
/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const gs = [["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]], an = ie("chevron-down", gs);
/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Bs = /* @__PURE__ */ new Set([".git", "node_modules", "dist", "build", ".next", ".turbo", "coverage", ".cache"]);
function Gs() {
  const e = Zn();
  return !!(e?.showOpenFilePicker && e.showDirectoryPicker);
}
async function Qs() {
  const e = Zn()?.showOpenFilePicker;
  if (!e) return Ja(!1);
  const t = await e({ multiple: !0 }), n = await Promise.all(t.map((a) => Kn(a, a.name, "local-file")));
  return jt(n.filter(Boolean));
}
async function $s() {
  const e = Zn()?.showDirectoryPicker;
  if (!e)
    return { name: "Browser fallback folder", files: await Ja(!0) };
  const t = await e({ mode: "readwrite" }), n = [];
  return await Un(t, t.name, n, 0, 320), { name: t.name, handle: t, files: jt(n) };
}
async function _s(e) {
  const t = await Promise.all(e.map((n) => Kn(n, n.name, "local-file")));
  return jt(t.filter(Boolean));
}
async function pa(e) {
  const t = [];
  return await Un(e, e.name, t, 0, 320), { name: e.name, handle: e, files: jt(t) };
}
async function Pn(e, t = "readwrite") {
  try {
...
async function Un(e, t, n, a, s) {
  if (!(n.length >= s || a > 8))
    for await (const i of e.values()) {
      if (n.length >= s) break;
      if (i.kind === "directory") {
        if (Bs.has(i.name)) continue;
        await Un(i, `${t}/${i.name}`, n, a + 1, s);
        continue;
      }
      const o = i, c = await Kn(o, `${t}/${o.name}`, "local-folder");
      c && n.push(c);
    }
}
function Ja(e) {
  return new Promise((t) => {
    ...
    n.type = "file", n.multiple = !0, n.style.display = "none", e && n.setAttribute("webkitdirectory", ""), n.onchange = async () => {
      const a = Array.from(n.files ?? []), s = await Promise.all(a.map(async (i) => {
        const o = i.webkitRelativePath || i.name;
        return Ya(o, i.size) ? {
          id: Za(o),
          name: i.name,
          path: o,
...
const Be = {
  ...
  available: !0
}, ti = "atomek:selected-chat-target", cn = {
  openclaw: "OpenClaw",
  hermes: "Hermes"
}, Kt = /https?:\/\/(?:10(?:\.\d{1,3}){3}|192\.168(?:\.\d{1,3}){2}|172\.(?:1[6-9]|2\d|3[01])(?:\.\d{1,3}){2})(?::\d+)?\S*/gi, Ut = /\b(?:10(?:\.\d{1,3}){3}|192\.168(?:\.\d{1,3}){2}|172\.(?:1[6-9]|2\d|3[01])(?:\.\d{1,3}){2})\b/g, Bt = /\b(?:MiniMax(?:-M[\w.-]+)?|Moonshot|Kimi|DeepSeek|Qwen|Alibaba|Xiaomi|Nous|OpenRouter|Strato|Scalesys|ail-compound|switchAILocal|OpenAI-compatible|vLLM|llama\.cpp)\b/gi, Gt = /\b(?:route[_-]?id|pod[_-]?id|droplet[_-]?id|provider[_-]?id|publicUrl|gatewayUrl|privateUrl)\b\s*[:=]\s*[^\s,;]+/gi, Qt = /\b(?:pod-agent|ail-route|strato-eu|wannolot|scalesys)[._:-][a-z0-9._:-]{4,}\b/gi, $t = /https?:\/\/[^\s)]*(?:tytus\.traylinx\.com|strato|scalesys|wannolot|droplet|gateway|route|\.internal|\.local|digitalocean|do\.com|hetzner)[^\s)]*/gi, _t = /\b(?:fe80|fc00|fd[0-9a-f]{2}):[0-9a-f:]+(?:%[a-z0-9]+)?\b/gi;
function Bn(e) {
  return e.replace(Kt, "private gateway").replace($t, "private gateway").replace(_t, "private gateway").replace(Ut, "private gateway").replace(Gt, "agent runtime").replace(Qt, "your Tytus pod").replace(Bt, "agent runtime").replace(/\s{3,}/g, "  ");
}
function ba(e) {
  const t = e.toLowerCase();
  return /\b(503|502|504|warm|warming|boot|starting|not ready|temporarily unavailable)\b/.test(t) ? { message: "Agent is warming up. Try again in a moment.", retryable: !0 } : /\b(timeout|timed out|aborted)\b/.test(t) ? { message: "Connection timed out. The agent may still be working. Try again.", retryable: !0 } : /\b(offline|stopped|unreachable|not found|404)\b/.test(t) ? { message: "Agent is offline. Restart the pod or pick another agent.", retryable: !0 } : { message: Bn(e).trim() || "Agent chat failed. Try again or pick another agent.", retryable: !1 };
}
function Ua(e) {
  return `${ti}:${e}`;
}
function ni(e) {
  try {
    return localStorage.getItem(Ua(e))?.trim() || Be.id;
  } catch {
    return Be.id;
  }
}
function va(e, t) {
  try {
    localStorage.setItem(Ua(e), t || Be.id);
  } catch {
  }
}
function gt(e, ...t) {
...
function si(e) {
  return e.kind !== "pod-agent" ? null : Ba([
    e.label,
    e.id,
    gt(e.metadata, "displayName", "display_name", "name", "podName", "pod_name"),
    gt(e.metadata, "agentFamily", "agent_family", "agentType", "agent_type", "internalAgentType", "brand")
  ].join(" "));
}
function ii(e) {
...
function oi(e) {
  const t = e.trim();
  return t.length < 2 || t.length > 44 ? !1 : Kt.test(t) || $t.test(t) || _t.test(t) || Ut.test(t) || Gt.test(t) || Qt.test(t) || Bt.test(t) ? (Kt.lastIndex = 0, $t.lastIndex = 0, _t.lastIndex = 0, Ut.lastIndex = 0, Gt.lastIndex = 0, Qt.lastIndex = 0, Bt.lastIndex = 0, !1) : (Kt.lastIndex = 0, $t.lastIndex = 0, _t.lastIndex = 0, Ut.lastIndex = 0, Gt.lastIndex = 0, Qt.lastIndex = 0, Bt.lastIndex = 0, /^[\p{L}\p{N}][\p{L}\p{N} ._()'&+-]*$/u.test(t));
}
function li(e, t) {
  const n = gt(e.metadata, "displayName", "display_name", "customName", "custom_name", "podDisplayName", "pod_display_name", "name");
  if (n) {
    const a = Bn(n).replace(/\bNemoClaw\b/gi, "OpenClaw").replace(/\s+/g, " ").trim();
    if (oi(a)) return a;
  }
  return cn[t];
}
...
function di(e) {
  const t = e.filter((i) => i.kind === "pod-agent"), n = t.reduce((i, o) => (i[o.agentFamily] = (i[o.agentFamily] ?? 0) + 1, i), { openclaw: 0, hermes: 0 }), a = {}, s = { openclaw: 0, hermes: 0 };
  return e.map((i) => {
    if (i.kind !== "pod-agent") return i;
    const o = i.label, c = cn[i.agentFamily];
    s[i.agentFamily] += 1;
    const h = o.toLowerCase();
    a[h] = (a[h] ?? 0) + 1;
    const p = t.filter((k) => k.label.toLowerCase() === h).length > 1, v = o === c && n[i.agentFamily] > 1;
    if (!p && !v) return i;
    const y = v ? s[i.agentFamily] : a[h];
    return { ...i, label: `${o} ${y}` };
  });
}
function ui(e) {
  const t = e.daemon?.state, n = t?.included ?? [], a = t?.agents ?? [], s = new Map(a.map((o) => [o.id, o])), i = n.flatMap((o) => {
    const c = o.id ?? "", p = { ...(o.agentId ? s.get(o.agentId) : void 0)?.meta ?? {}, ...o.meta ?? {} }, v = Ba([c, o.kind, gt(p, "displayName", "display_name", "agentFamily", "agentType", "brand")].join(" "));
    return !c || !v ? [] : [{
      id: `pod-agent.${c}`,
      kind: "pod-agent",
      label: cn[v],
  ...
  return Ga({ generatedAt: (/* @__PURE__ */ new Date()).toISOString(), resources: i });
}
async function fi(e, t) {
  ...
  const a = Ga(n), s = a.length > 0 ? [] : ui(e), i = /* @__PURE__ */ new Map();
  for (const o of [Be, ...a, ...s]) i.set(o.id, o);
  return [...i.values()];
}
const Qa = "atomek", Ye = "atomek:default", hi = 3e3, Gn = "tytus.atomek.threadTitleOverrides", $a = "tytus.atomek.selectedThreadId", ya = {
  available: !1,
  source: "none",
  label: "Tytus AI unavailable",
  reason: "host.ai is not available in this Tytus build."
}, ft = (e) => e.role !== "user" && e.role !== "assistant" ? null : {
  id: e.id,
  role: e.role,
  body: e.body,
  status: e.status,
...
}, mi = (e, t = hi) => e.length <= t ? e : `${e.slice(0, t)}

[...clipped ${e.length - t} chars...]`, ga = (e, t) => {
  const n = e.split(`
`).map((a) => a.replace(/^#+\s*/, "").trim()).find(Boolean);
  return n ? n.length > 80 ? `${n.slice(0, 77)}...` : n : t;
}, pi = (e) => ["briefing", "action-list", "quiz", "plan", "storyboard", "report", "local-draft", "markdown", "memory"].includes(e) ? e : "report", wa = (e) => ({
  id: e.id,
  title: e.title,
  kind: pi(e.kind),
  body: e.body,
...
`)
  ...
  try {
    const n = Qn();
    n[e] = t, localStorage.setItem(Gn, JSON.stringify(n));
  } catch {
  }
}, yi = (e) => {
  try {
    const t = Qn();
    delete t[e], localStorage.setItem(Gn, JSON.stringify(t));
  } catch {
  }
}, ka = (e) => {
  const t = Qn();
  ...
  try {
    return localStorage.getItem($a)?.trim() || null;
  } catch {
    return null;
  }
}, at = (e) => {
...
}, rn = (e) => `${Ye}:agent-session:${e}`, sn = (e) => `${Ye}:agent-transcript:${e}`, $n = (e) => `${Ye}:${Qa}:agent-session:${e}`, on = (e) => `${Ye}:${Qa}:agent-transcript:${e}`, _a = 100, wi = (e, t) => {
  try {
    const n = localStorage.getItem($n(e))?.trim();
    if (n) return n;
    const a = localStorage.getItem(rn(e))?.trim();
    return a || t && t !== e && localStorage.getItem(rn(t))?.trim() || null;
  } catch {
    return null;
  }
}, ki = (e, t) => {
  ...
  try {
    const n = localStorage.getItem(on(e)), a = n ? JSON.parse(n) : [], s = /* @__PURE__ */ new Map();
    for (const i of [...a, ...t]) s.set(i.id, i);
    localStorage.setItem(on(e), JSON.stringify([...s.values()].slice(-_a)));
  } catch {
  }
}, Nn = (e) => {
  if (!e) return [];
  ...
  try {
    const n = Nn(localStorage.getItem(on(e)));
    if (n.length > 0) return n;
    const a = Nn(localStorage.getItem(sn(e)));
    return a.length > 0 || !t || t === e ? a : Nn(localStorage.getItem(sn(t)));
  } catch {
    return [];
  }
}, xi = (e, t) => {
  try {
    localStorage.removeItem(on(e)), localStorage.removeItem($n(e)), localStorage.removeItem(sn(e)), localStorage.removeItem(rn(e)), t && t !== e && (localStorage.removeItem(sn(t)), localStorage.removeItem(rn(t)));
  } catch {
  }
}, Ni = (e) => {
  const t = e.daemon;
...
function Xi({ host: e, requestContext: t, chatSettings: n, selectedTarget: a = Be, setStatus: s }) {
  const i = e.ai, [o, c] = z(null), [h, p] = z([]), [v, y] = z([]), [k, m] = z([]), [A, R] = z([]), [Z, F] = z(ya), [ge, we] = z(!1), j = it(!0), _ = it(null), q = N(async () => {
    if (!i) {
      F(ya);
      return;
    }
    ...
    if (i)
      try {
        const L = await i.listArtifacts({ threadId: x });
        if (!j.current) return;
        m(L.map(wa));
      } catch (L) {
        s(`AI artifacts unavailable: ${L instanceof Error ? L.message : String(L)}`);
      }
  }, [i, s]), be = N(async (x) => {
    if (i)
      try {
        const L = await i.listMessages(x);
        if (!j.current) return;
        const V = h.find((X) => X.id === x) ?? null;
        V && c(V), at(x), y(L.map(ft).filter(Boolean)), R([]), await M(x);
      } catch (L) {
        s(`Load chat failed: ${L instanceof Error ? L.message : String(L)}`);
      }
  }, [i, M, s, h]), Y = N(async () => {
    if (i)
      try {
        const x = ka(await i.listThreads({ workspaceKey: Ye, status: "active" })), L = gi(), V = x.find((ne) => ne.id === L) ?? x[0] ?? await i.createThread({ workspaceKey: Ye, title: "Atomek chat" });
        if (!j.current) return;
        p(x[0] ? x : [V]), c(V), at(V.id);
        const X = await i.listMessages(V.id);
        if (!j.current) return;
        y(X.map(ft).filter(Boolean)), await M(V.id);
      } catch (x) {
        s(`AI chat unavailable: ${x instanceof Error ? x.message : String(x)}`);
      }
  }, [i, M, s]);
  re(() => (j.current = !0, q(), Y(), () => {
    j.current = !1;
  }), [Y, q]);
  const ve = a.kind === "pod-agent" ? a.podId : null;
  re(() => {
    if (a.kind === "pod-agent") {
      y(Pi(a.id, a.podId)), R([]);
      return;
    ...
    return (async () => {
      try {
        const L = await i.listMessages(o.id);
        !x && j.current && y(L.map(ft).filter(Boolean));
      } catch {
      }
    })(), () => {
      x = !0;
  ...
  const fe = N(async () => {
    if (!i) return null;
    if (o) return o;
    const x = await i.createThread({ workspaceKey: Ye, title: "Atomek chat" });
    return j.current && (c(x), at(x.id), p((L) => [x, ...L.filter((V) => V.id !== x.id)])), x;
  }, [i, o]), He = N(async () => {
    if (a.kind === "pod-agent") {
      xi(a.id, a.podId), y([]), R([]), s(`Cleared ${a.label} chat`);
      return;
    }
    if (!i) return;
    const x = await i.createThread({ workspaceKey: Ye, title: "Atomek chat" });
    c(x), at(x.id), p((L) => [x, ...L.filter((V) => V.id !== x.id)]), y([]), m([]), R([]), s("New AI chat created");
  }, [i, a, s]), We = N(async (x, L) => {
    if (!i) return;
    const V = L.trim();
    if (V)
      try {
        const X = i.updateThread, ne = h.find((le) => le.id === x) ?? o, ae = typeof X == "function" ? await X({ threadId: x, title: V }) : { ...ne ?? await fe(), id: x, title: V, updatedAt: Date.now() };
        typeof X != "function" && vi(x, V), p((le) => le.map((xe) => xe.id === ae.id ? ae : xe)), c((le) => le?.id === ae.id ? ae : le), s(typeof X == "function" ? `Renamed chat: ${ae.title}` : `Renamed chat locally: ${ae.title}`);
      } catch (X) {
        s(`Rename chat failed: ${X instanceof Error ? X.message : String(X)}`);
      }
  }, [i, fe, s, o, h]), je = N(async (x) => {
    if (i)
      try {
        await i.deleteThread(x), yi(x);
        const L = h.filter((V) => V.id !== x);
        if (p(L), o?.id === x) {
          const V = L[0] ?? await i.createThread({ workspaceKey: Ye, title: "Atomek chat" });
          c(V), at(V.id), p((ne) => ne.some((ae) => ae.id === V.id) ? ne : [V, ...ne]);
          const X = await i.listMessages(V.id);
          y(X.map(ft).filter(Boolean)), await M(V.id);
        }
        s("Deleted AI chat");
      } catch (L) {
        s(`Delete chat failed: ${L instanceof Error ? L.message : String(L)}`);
      }
  }, [i, M, s, o?.id, h]), O = N(async (x) => {
    if (!i) return null;
    try {
      const L = await fe();
      if (!L) return null;
      at(L.id);
      const V = await i.createArtifact({
        threadId: L.id,
        messageId: x.messageId ?? null,
        title: x.title?.trim() || ga(x.body, "Atomek artifact"),
        kind: x.kind ?? "markdown",
        body: x.body
      }), X = wa(V);
      return m((ne) => [X, ...ne.filter((ae) => ae.id !== X.id)]), s(`Saved AI artifact: ${X.title}`), X;
    } catch (L) {
      return s(`Save artifact failed: ${L instanceof Error ? L.message : String(L)}`), null;
    }
  }, [i, fe, s]), oe = N(async (x) => {
    if (i)
      try {
        await i.deleteArtifact(x), m((L) => L.filter((V) => V.id !== x)), s("Deleted AI artifact");
      } catch (L) {
        s(`Delete artifact failed: ${L instanceof Error ? L.message : String(L)}`);
      }
  }, [i, s]), Pe = N(async (x) => {
    if (!i) return null;
    try {
      const L = await i.writeMemory({
        title: x.title?.trim() || ga(x.body, "Atomek memory"),
        body: x.body,
        metadata: {
          source: "atomek",
          messageId: x.messageId ?? null
      ...
      return R((V) => [L, ...V.filter((X) => X.id !== L.id)].slice(0, 5)), s(`Remembered: ${L.title}`), L;
    } catch (L) {
      return s(`Remember failed: ${L instanceof Error ? L.message : String(L)}`), null;
    }
  }, [i, s]), he = N(async (x) => {
    if (!i) return [];
    const L = await i.searchMemory({ query: x, limit: 5 });
    return j.current && R(L), L;
  }, [i]), g = N(async (x, L = {}) => {
    const V = x.trim();
    if (!V) return null;
    const X = a;
    if (X.kind === "atomek-ai" && !i) return null;
    we(!0);
    let ne = null;
    const ae = new AbortController();
    _.current = ae;
    try {
      const le = L.requestContext ?? t;
      if (X.kind === "pod-agent") {
        const K = Ni(e), G = Date.now(), me = {
          id: `agent-user-${G}`,
          role: "user",
          body: V,
          status: "complete",
          createdAt: G
        }, ee = `agent-assistant-${G}`, Ne = {
          id: ee,
          role: "assistant",
          body: "",
          status: "streaming",
        ...
        if (y((te) => [...te, me, Ne]), Ft(X.id, [me, Ne]), !X.available) {
          const te = ba(X.description), de = { ...Ne, body: te.message, status: "error", error: te.message };
          return y((d) => d.map((w) => w.id === ee ? de : w)), Ft(X.id, [de]), s(te.message), de;
        }
        if (!K) {
          const te = "Agent chat bridge unavailable in this Tytus host build. Update TytusOS host API/runtime to enable OpenClaw and Hermes chat.", de = { ...Ne, body: te, status: "error", error: te };
          return y((d) => d.map((w) => w.id === ee ? de : w)), Ft(X.id, [de]), s("Agent chat bridge unavailable"), de;
        }
        let Ie = "";
        const De = (te, de) => (y((d) => d.map((w) => w.id === ee ? te : w)), Ft(X.id, [me, te]), s(de), te);
        try {
          for await (const te of K.chatAgent({
            podId: X.podId,
            ...
            if (te.type === "profile") {
              const de = te.profile === "local" ? "Local Cortex" : "Cloud Cortex";
              y(
                (d) => d.map(
                  (w) => w.id === ee ? { ...w, gatewayLabel: de } : w
                )
              );
            }
            if (te.type === "session" && ki(X.id, te.sessionId), te.type === "token" && (Ie = Bn(`${Ie}${te.text}`), y((de) => de.map((d) => d.id === ee ? { ...d, body: Ie, status: "streaming" } : d))), te.type === "error") {
              const de = ba(te.message), d = { ...Ne, body: de.message, status: "error", error: de.message };
              return De(d, de.message);
            }
            if (te.type === "done")
              return ne = { ...Ne, body: Ie || "Agent finished without visible output.", status: "complete" }, De(ne, `${X.label} answered`);
          }
        } catch (te) {
          if (ae.signal.aborted || te instanceof DOMException && te.name === "AbortError")
            return ne = { ...Ne, body: Ie || "Stopped by user.", status: "complete" }, De(ne, `${X.label} response stopped`);
          throw te;
        }
        return ae.signal.aborted ? (ne = { ...Ne, body: Ie || "Stopped by user.", status: "complete" }, De(ne, `${X.label} response stopped`)) : ne || (ne = { ...Ne, body: Ie || "Agent finished without visible output.", status: "complete" }, De(ne, `${X.label} answered`));
      }
      const xe = await fe();
      if (!xe || !i) return null;
      at(xe.id);
      const Ve = await he(V).catch(() => []), ze = bi(Ve), Ee = ze ? [...le, ze] : [...le];
      let Ze = null;
      for await (const K of i.sendMessage({
        threadId: xe.id,
        body: V,
        ...
        if (K.type === "message_created") {
          const G = ft(K.message);
          if (!G) continue;
          G.role === "assistant" && (Ze = G.id), y((me) => [...me.filter((ee) => ee.id !== G.id), G]);
        }
        if (K.type === "token" && (Ze = K.messageId, y((G) => G.some((me) => me.id === K.messageId) ? G.map(
          (me) => me.id === K.messageId ? { ...me, body: K.body, status: "streaming", sourceLabel: "Atomek" } : me
        ) : [...G, {
          id: K.messageId,
          role: "assistant",
          body: K.body,
          ...
          sourceLabel: "Atomek",
          createdAt: Date.now()
        }])), K.type === "message_updated" || K.type === "done") {
          const G = ft(K.message);
          if (!G) continue;
          G.role === "assistant" && (ne = G), y((me) => me.map((ee) => ee.id === G.id ? G : ee)), G.gatewayLabel && s(`AI answered via ${G.gatewayLabel}`);
        }
        if (K.type === "run_failed") {
          const G = ae.signal.aborted;
          s(G ? "AI response stopped" : `AI failed: ${K.error}`), Ze && y((me) => me.map((ee) => ee.id !== Ze ? ee : G ? { ...ee, status: "complete", error: void 0, body: ee.body || "Stopped by user." } : { ...ee, status: "error", error: K.error, body: K.error }));
        }
      }
      const ye = ka(await i.listThreads({ workspaceKey: Ye, status: "active" }).catch(() => []));
      return j.current && ye.length > 0 && p(ye), q(), ne;
    } catch (le) {
      return le instanceof DOMException && le.name === "AbortError" ? (s("AI response stopped"), ne) : (s(`AI failed: ${le instanceof Error ? le.message : String(le)}`), null);
    } finally {
      _.current === ae && (_.current = null), we(!1);
    }
  }, [i, n.gatewayPreference, n.model, fe, e, he, q, t, a, s]), W = N(() => {
    _.current?.abort(), s("Stopping AI response…");
  }, [s]);
  return {
    aiStatus: Z,
    artifacts: k,
...
const Li = (e) => `tytus-workbench:///${encodeURI(e.path)}`, Ai = (e) => {
  let t = 2166136261;
  for (let n = 0; n < e.length; n += 1)
    t ^= e.charCodeAt(n), t = Math.imul(t, 16777619);
  return (t >>> 0).toString(16).padStart(8, "0");
}, Oi = ({ files: e, openEditorIds: t, activeFileId: n, versions: a, activeSelection: s }) => {
  const i = new Set(t), o = e.map((c) => {
    const h = c.id === n;
    return {
      id: c.id,
      uri: Li(c),
      ...
      language: c.language,
      version: a[c.id] ?? 1,
      contentHash: Ai(c.content),
      dirty: c.dirty,
      source: c.source,
      selection: h && s ? s : void 0,
      updatedAt: Date.now(),
      open: i.has(c.id),
      active: h
    };
  ...
  return {
    ...
    activeDocumentId: n,
    openDocumentIds: t.filter((c) => o.some((h) => h.id === c))
  };
}, Si = "active-file", Ci = (e) => e === "none" ? "No context" : e === "active-selection" ? "Active selection" : e === "active-file" ? "Active file" : e === "open-editors" ? "Open editors" : e === "selected-files" ? "Selected files" : "Indexed project", Hi = (e, t = "file") => `${t}:${e.id}`, ji = (e, t) => [
  "selection",
  e.id,
  t.startLineNumber,
  t.startColumn,
  ...
  let s = [];
  return t.scope === "active-selection" ? a?.selection ? s = [Mi(a, a.selection, !0)] : a && (s = [Rt(a, !0, "Active file")]) : t.scope === "active-file" ? a && (s = [Rt(a, !0, "Active file")]) : t.scope === "open-editors" ? s = e.openDocumentIds.map((i) => e.byId.get(i)).filter(Boolean).map((i) => Rt(i, !0, "Open editor")) : t.scope === "selected-files" && (s = t.selectedFileIds.map((i) => e.byId.get(i)).filter(Boolean).map((i) => Rt(i, !1, "Selected file"))), Vi(s).filter((i) => !n.has(i.id));
}, Vi = (e) => {
  const t = /* @__PURE__ */ new Set();
  return e.filter((n) => t.has(n.id) ? !1 : (t.add(n.id), !0));
}, Ii = 4e3, Di = 8e3, Fi = 4e3, Ri = (e, t) => e.length <= t ? e : `${e.slice(0, t)}

[...clipped ${e.length - t} chars...]`, Ei = (e, t, n) => {
  const a = Wi(e, n), s = [], i = new Map(t.map((o) => [o.id, o]));
  for (const o of a) {
    if (!o.fileId) continue;
    const c = i.get(o.fileId), h = e.byId.get(o.fileId);
    if (!c || !h || !o.includeBody) continue;
    const p = [
      `Path: ${c.path}`,
      `Language: ${c.language}`,
      `Version: ${h.version}`,
      `Hash: ${h.contentHash}`,
      `Dirty: ${h.dirty ? "yes" : "no"}`,
      o.range ? `Range: ${Pa(o.range)}` : null
    ].filter(Boolean).join(`
`), v = o.kind === "selection" && o.range ? qi(c.content, o.range) : c.content, y = o.kind === "selection" ? Ii : o.label.startsWith("Open editor") ? Fi : Di;
    s.push({
...
`)).join(`
`)
  }), { parts: s, attachments: a };
}, qi = (e, t) => {
  const n = e.split(`
`), a = Math.max(1, t.startLineNumber), s = Math.max(a, t.endLineNumber), i = n.slice(a - 1, s);
...
`));
}, Pa = (e) => `${e.startLineNumber}:${e.startColumn}-${e.endLineNumber}:${e.endColumn}`, xa = 75e4, Yi = 2800, Ji = 240, Zi = 80, Ki = /* @__PURE__ */ new Set([
  ".git",
  ".hg",
  ".svn",
  ".next",
  ...
  e.map((t) => `${t.id}\0${t.path}\0${t.language}\0${t.dirty ? "1" : "0"}\0${st(t.content)}`).sort().join("")
), Mn = (e, t = {}) => {
  const n = e.size ?? e.content.length;
  return n === 0 || e.content.length === 0 ? "empty" : n > (t.maxFileBytes ?? xa) || e.content.length > (t.maxFileBytes ?? xa) ? "huge" : !t.includeDirty && e.dirty ? null : eo(e.path) ? "vendor" : to(e) ? "binary" : null;
}, Na = (e, t = {}) => {
  const n = Date.now(), a = [], s = [], i = [];
  for (const o of e) {
    const c = o.size ?? o.content.length, h = Mn(o, t);
    if (h) {
      s.push({ fileId: o.id, name: o.name, path: o.path, language: o.language, reason: h, size: c });
      continue;
    }
    const p = st(o.content), v = Bi(o, p, n, t);
    i.push(...v), a.push({
      fileId: o.id,
      name: o.name,
      path: o.path,
  ...
  return Gi({
    ...
    skipped: s,
    chunks: i,
    byFileId: new Map(a.map((o) => [o.fileId, o])),
    byChunkId: new Map(i.map((o) => [o.id, o]))
  });
}, Bi = (e, t = st(e.content), n = Date.now(), a = {}) => {
  const s = Math.max(500, a.maxChunkChars ?? Yi), i = Math.min(Math.max(0, a.chunkOverlapChars ?? Ji), Math.floor(s / 2)), o = Math.max(1, a.maxChunksPerFile ?? Zi), c = $i(e.content), h = [];
  let p = 0, v = 0;
  for (; p < e.content.length && h.length < o; ) {
    const y = Qi(e.content, p, Math.min(e.content.length, p + s)), k = e.content.slice(p, y).trim();
    if (k.length > 0) {
      const m = _i(c, p, y);
      h.push({
        id: `${e.id}:${t}:${v}:${m.startLineNumber}-${m.endLineNumber}`,
        fileId: e.id,
        path: e.path,
        name: e.name,
        language: e.language,
  ...
  const a = Math.max(t + 1, n - 500), s = e.lastIndexOf(`
`, n);
  if (s >= a) return s + 1;
...
` && t.push(n + 1);
  ...
  const a = Ta(e, t), s = Ta(e, Math.max(t, n - 1));
  return {
    startLineNumber: a + 1,
    startColumn: t - e[a] + 1,
    endLineNumber: s + 1,
  ...
  for (; n <= a; ) {
    ...
    if (e[s] <= t && (s === e.length - 1 || e[s + 1] > t)) return s;
    e[s] > t ? a = s - 1 : n = s + 1;
  }
  return 0;
}, eo = (e) => e.split(/[\\/]+/).filter(Boolean).some((t) => Ki.has(t)), to = (e) => {
  const t = e.name.includes(".") ? e.name.split(".").pop()?.toLowerCase() : void 0;
  if (t && Ui.has(t) || e.content.includes("\0")) return !0;
...
class no {
  ...
  options;
  constructor(t = [], n = {}) {
    this.options = { ...n }, this.snapshot = Na(t, this.options);
  }
  getSnapshot() {
  ...
  refresh(t, n = this.options) {
    return this.options = { ...n }, this.snapshot = Na(t, this.options), this.snapshot;
  }
  update(t, n = this.options) {
    return this.refresh(t, n);
  }
  staleReport(t) {
    return ao(this.snapshot, t, this.options);
  }
  isStale(t) {
    return this.staleReport(t).stale;
  }
}
const ht = (e = [], t = {}) => new no(e, t), ao = (e, t, n = {}) => {
  const a = new Map(t.map((c) => [c.id, c])), s = e.byFileId, i = [];
  for (const c of e.files) {
    const h = a.get(c.fileId);
    if (!h) {
      i.push({ fileId: c.fileId, path: c.path, status: "deleted", indexedHash: c.hash });
      continue;
    }
    if (Mn(h, n)) {
      i.push({ fileId: c.fileId, path: h.path, status: "skipped-now", indexedHash: c.hash, currentHash: st(h.content) });
      continue;
    }
    const v = st(h.content);
    v !== c.hash ? i.push({ fileId: c.fileId, path: h.path, status: "changed", indexedHash: c.hash, currentHash: v }) : h.dirty !== c.dirty && i.push({ fileId: c.fileId, path: h.path, status: "dirty-state-changed", indexedHash: c.hash, currentHash: v });
  }
  for (const c of t)
    !s.has(c.id) && !Mn(c, n) && i.push({ fileId: c.id, path: c.path, status: "new", currentHash: st(c.content) });
  const o = e.signature !== er(t);
  return { stale: i.length > 0, signatureChanged: o, files: i };
}, ro = 8, so = 12e3, tr = (e, t, n = {}, a) => {
  const s = lo(t);
  if (s.length === 0) return [];
  const i = new Set(a?.files.map((v) => v.fileId) ?? []), o = e.chunks.filter((v) => n.includeDirty !== !1 || !v.dirty).map((v) => co(v, s)).filter((v) => v.score >= (n.minScore ?? 1)).sort((v, y) => y.score - v.score || v.chunk.path.localeCompare(y.chunk.path) || v.chunk.ordinal - y.chunk.ordinal), c = [], h = /* @__PURE__ */ new Set();
  let p = n.maxChars ?? so;
  for (const v of o) {
    if (c.length >= (n.limit ?? ro) || p <= 0) break;
    const y = `${v.chunk.fileId}:${v.chunk.ordinal}`;
    if (h.has(y)) continue;
    h.add(y);
    const k = v.chunk.text.length > p ? `${v.chunk.text.slice(0, Math.max(0, p - 28))}
[...context clipped...]` : v.chunk.text;
    c.push(io(v, k, i.has(v.chunk.fileId))), p -= k.length;
  }
  return c;
}, io = (e, t = e.chunk.text, n = !1) => {
  const { chunk: a, score: s, matchedTerms: i } = e;
  return {
    id: `index-hit:${a.id}`,
    kind: "index-hit",
...
`), lo = (e) => Array.from(new Set(
  e.toLowerCase().split(/[^a-z0-9_.$/-]+/i).map((t) => t.trim()).filter((t) => t.length >= 2)
)), co = (e, t) => {
  const n = e.text.toLowerCase(), a = e.path.toLowerCase(), s = e.name.toLowerCase(), i = e.language.toLowerCase();
  let o = 0;
  const c = [];
  for (const h of t) {
    const p = Tn(n, h), v = Tn(a, h), y = Tn(s, h), k = i === h ? 1 : 0;
    p + v + y + k !== 0 && (c.push(h), o += Math.min(p, 12), o += v * 4, o += y * 6, o += k * 3, (n.includes(`function ${h}`) || n.includes(`const ${h}`) || n.includes(`class ${h}`) || n.includes(`type ${h}`)) && (o += 3));
  }
  ...
  const n = e.toLowerCase(), a = t.map((h) => n.indexOf(h)).filter((h) => h >= 0).sort((h, p) => h - p)[0] ?? 0, s = Math.max(0, a - 120), i = Math.min(e.length, a + 260), o = s > 0 ? "…" : "", c = i < e.length ? "…" : "";
  return `${o}${e.slice(s, i).replace(/\s+/g, " ").trim()}${c}`;
}, fo = (e, t = {}) => {
  const { autoRefresh: n = !1, ...a } = t, s = it(e), i = it(null);
  i.current || (i.current = ht(e, a));
  const [o, c] = z(() => i.current?.getSnapshot() ?? ht(e, a).getSnapshot());
  s.current = e;
  const h = N((k = s.current) => {
    const m = (i.current ?? ht([], a)).refresh(k, a);
    return c(m), m;
  }, [a.maxFileBytes, a.maxChunkChars, a.chunkOverlapChars, a.maxChunksPerFile, a.includeDirty]), p = N((k = s.current) => {
    const m = (i.current ?? ht([], a)).update(k, a);
    return c(m), m;
  }, [h]);
  re(() => {
    n && h(e);
  }, [n, e, h]);
  const v = (i.current ?? ht([], a)).staleReport(e), y = N((k, m = {}) => {
    const A = i.current ?? ht([], a);
    return tr(A.getSnapshot(), k, m, A.staleReport(s.current));
  }, []);
  return { snapshot: o, staleReport: v, isStale: v.stale, refresh: h, update: p, retrieve: y };
}, ho = "tytus.atomek.semanticVector:v1", nr = "__gateway_default__", ar = (e) => e?.trim() || nr, mo = (e) => {
  const t = ar(e);
  return t === nr ? "gateway default" : t;
}, rr = (e, t, n) => [
  ho,
  ...
  if (!sr()) return null;
  try {
    const a = rr(e, t, n), s = window.localStorage.getItem(a);
    if (!s) return null;
    const i = JSON.parse(s);
    return i.chunkId !== n.id || i.contentHash !== n.hash || i.modelAlias !== t || !Array.isArray(i.vector) || i.vector.some((o) => typeof o != "number" || !Number.isFinite(o)) ? null : {
      key: a,
      appId: e,
      chunkId: n.id,
      contentHash: n.hash,
  ...
  if (!sr()) return null;
  try {
    const t = rr(e.appId, e.modelAlias, { id: e.chunkId, hash: e.contentHash }), n = { ...e, key: t };
    return window.localStorage.setItem(t, JSON.stringify(n)), n;
  } catch {
    return null;
  }
}, At = 8, vo = 12e3, yo = 180, go = async (e, t, n, a, s = {}, i, o) => {
  const c = tr(t, n, { ...s, limit: Math.max(s.limit ?? At, 16) }, i), h = e.ai;
  if (typeof h?.embedText != "function")
    return { hits: c.slice(0, s.limit ?? At), mode: "keyword", reason: "Semantic index unavailable — using keyword retrieval.", embeddedChunks: 0 };
  try {
    const p = ar(a.embeddingModel), v = await h.embedText({
      input: n,
    ...
    const k = new Map(c.map((j) => [j.chunkId, j])), m = zo(n), A = /* @__PURE__ */ new Map();
    t.chunks.filter((j) => s.includeDirty !== !1 || !j.dirty).slice(0, yo).forEach((j) => A.set(j.id, j)), c.forEach((j) => {
      const _ = t.byChunkId.get(j.chunkId);
      _ && A.set(_.id, _);
    });
    const R = Array.from(A.values()), Z = [];
    let F = 0;
    for (const j of R) {
      o?.aborted;
      const _ = po(e.appId, p, j) ?? await ko(h, e.appId, p, j, a, o);
      if (!_) continue;
      _.updatedAt > Date.now() - 1e3 && (F += 1);
      const q = No(y, _.vector);
      if (!Number.isFinite(q)) continue;
      const be = k.get(j.id)?.score ?? Xo(j, m), Y = To(be) * 0.42 + Math.max(0, q) * 0.58;
      Z.push({ chunk: j, keywordScore: be, vectorScore: q, score: Y, matchedTerms: m.filter((ve) => j.text.toLowerCase().includes(ve)) });
    }
    if (Z.length === 0) return { hits: c.slice(0, s.limit ?? At), mode: "vector-fallback", reason: "Semantic retrieval produced no vectors — using keyword retrieval.", embeddedChunks: F };
    const ge = new Set(i?.files.map((j) => j.fileId) ?? []), we = Z.sort((j, _) => _.score - j.score || _.keywordScore - j.keywordScore || j.chunk.path.localeCompare(_.chunk.path) || j.chunk.ordinal - _.chunk.ordinal).slice(0, Math.max(s.limit ?? At, 1)).map((j) => Po(j, ge.has(j.chunk.fileId)));
    return {
      hits: xo(we, s.maxChars ?? vo),
      mode: "hybrid",
      reason: `Hybrid retrieval used ${mo(a.embeddingModel)} embeddings + keyword ranking.`,
      embeddedChunks: F
    };
  } catch (p) {
    return {
      hits: c.slice(0, s.limit ?? At),
  ...
  text: oo(t)
})), ko = async (e, t, n, a, s, i) => {
  if (typeof e.embedText != "function") return null;
  const o = await e.embedText({
    input: a.text,
    gatewayPreference: s.gatewayPreference,
    model: s.embeddingModel.trim() || void 0,
    signal: i
  }), c = ir(o.embedding);
  return c ? bo({
    appId: t,
  ...
  return {
    ...
    text: e.chunk.text,
    snippet: Lo(e.chunk.text, e.matchedTerms),
    score: e.score,
  ...
  for (const s of e) {
    if (n <= 0) break;
    const i = s.text.length > n ? `${s.text.slice(0, Math.max(0, n - 28))}
[...context clipped...]` : s.text;
    a.push({ ...s, text: i, charCount: i.length }), n -= i.length;
  }
  return a;
}, ir = (e) => {
  ...
  let a = 0, s = 0, i = 0;
  for (let o = 0; o < n; o += 1)
    a += e[o] * t[o], s += e[o] * e[o], i += t[o] * t[o];
  return s === 0 || i === 0 ? 0 : a / (Math.sqrt(s) * Math.sqrt(i));
}, To = (e) => Math.min(1, Math.max(0, e / 24)), zo = (e) => Array.from(new Set(
  e.toLowerCase().split(/[^a-z0-9_.$/-]+/i).map((t) => t.trim()).filter((t) => t.length >= 2)
)), Xo = (e, t) => {
  const n = `${e.path}
${e.name}
${e.language}
${e.text}`.toLowerCase();
  return t.reduce((a, s) => a + (n.includes(s) ? 1 : 0), 0);
}, Lo = (e, t) => {
  const n = e.toLowerCase(), a = t.map((o) => n.indexOf(o)).filter((o) => o >= 0).sort((o, c) => o - c)[0] ?? 0, s = Math.max(0, a - 120), i = Math.min(e.length, a + 260);
  return `${s > 0 ? "…" : ""}${e.slice(s, i).replace(/\s+/g, " ").trim()}${i < e.length ? "…" : ""}`;
}, Ao = /```([^\n`]*)\n([\s\S]*?)```/g, Oo = /^@@\s+-(\d+)(?:,\d+)?\s+\+(\d+)(?:,\d+)?\s+@@/;
function _n(e) {
  return Array.from(e.matchAll(Ao)).map((t) => or(t[1] ?? "", Mo(t[2] ?? ""))).filter((t) => t.content.trim().length > 0);
}
function or(e, t) {
  const n = e.trim().split(/[\s,]+/).filter(Boolean), a = {}, s = [];
  for (const i of n) {
    const o = i.match(/^([a-z0-9_-]+)=(.+)$/i);
    o ? a[o[1].toLowerCase()] = Vo(o[2]) : s.push(i.toLowerCase());
  }
  return { lang: e.trim().toLowerCase(), flags: s, attrs: a, content: t };
}
function Me(e, t) {
  return (typeof e == "string" ? or(e, "").flags : e.flags).includes(t.toLowerCase());
}
function lr(e) {
  return [..._n(e).filter((a) => Me(a, "diff") || Me(a, "patch")).map((a) => a.content), e].filter((a, s, i) => So(a) && i.findIndex((o) => o === a) === s);
}
function So(e) {
...
`), a = [];
  if (n.forEach((o, c) => {
    (o.startsWith("diff --git ") || o.startsWith("--- ")) && a.push(c);
  }), a.length === 0) return [{ raw: t, ...zn(t) }];
  const s = Array.from(new Set(a)).sort((o, c) => o - c), i = [];
  for (let o = 0; o < s.length; o += 1) {
    const c = s[o], p = s.find((y) => y > c && n[y].startsWith("diff --git ")) ?? n.length, v = n.slice(c, p).join(`
`);
    /^@@\s+-\d+/m.test(v) && i.push({ raw: v, ...zn(v) });
  }
  return i.length > 0 ? i : [{ raw: t, ...zn(t) }];
}
function zn(e) {
  const t = e.match(/^diff --git\s+(?:"?a\/(.+?)"?|(\S+))\s+(?:"?b\/(.+?)"?|(\S+))/m), n = e.match(/^---\s+(?:"?a\/(.+?)"?|(\S+))/m), a = e.match(/^\+\+\+\s+(?:"?b\/(.+?)"?|(\S+))/m), s = Ge(t?.[1] || t?.[2] || n?.[1] || n?.[2] || "") || null, i = Ge(t?.[3] || t?.[4] || a?.[1] || a?.[2] || "") || null, o = i && i !== "/dev/null" ? i : s;
  return { path: o && o !== "/dev/null" ? o : null, oldPath: s, newPath: i };
}
function Ge(e) {
  return e.trim().replace(/^['"]|['"]$/g, "").replace(/\\/g, "/").replace(/^[ab]\//, "").replace(/^\.\//, "");
}
function Wn(e) {
  return _n(e).filter((t) => Ho(t)).map((t) => ({
    content: Wo(t.content),
...
function Ho(e) {
  return Me(e, "atomek-replace") || Me(e, "atomek-full") || Me(e, "full-replacement") || Me(e, "full") || Me(e, "replace");
}
function jo(e) {
...
`).slice(0, 5);
  for (const a of n) {
    const s = a.match(/^\s*(?:\/\/|#|<!--)?\s*(?:atomek-)?(?:path|file)\s*:\s*([^\s>]+)\s*(?:-->)?\s*$/i);
    if (s) return Ge(s[1]);
  }
  return null;
}
...
`), s = [];
  ...
  for (let c = 0; c < a.length; c += 1) {
    const h = a[c].match(Oo);
    if (!h) continue;
    o = !0;
    const p = Number(h[1]), v = Math.max(0, p - 1);
    if (v < i) return null;
    for (s.push(...n.slice(i, v)), i = v, c += 1; c < a.length; c += 1) {
      const y = a[c];
      if (y.startsWith("@@ ")) {
        c -= 1;
        break;
      ...
      const k = y[0], m = y.slice(1);
      if (k === " ") {
        if (n[i] !== m) return null;
        s.push(m), i += 1;
        continue;
      }
      if (k === "-") {
  ...
  return o ? (s.push(...n.slice(i)), s.join(`
`)) : null;
}
function Mo(e) {
  return e.replace(/^\n+/, "").replace(/\n+$/, "");
...
function Io(e) {
  const { body: t, files: n, sourceTitle: a, activeFile: s = null, versions: i = {} } = e, o = /* @__PURE__ */ new Map(), c = [];
  for (const v of lr(t))
    for (const y of Co(v)) {
      if (!y.path) {
        if (s) {
          const A = Vn(s.content, y.raw);
          A && A !== s.content && o.set(s.id, Et({
            file: s,
            proposedContent: A,
            sourceTitle: a,
      ...
      const k = za(n, y.path);
      if (!k) {
        c.push(`${y.path}: no opened file`);
        continue;
      }
      const m = Vn(k.file.content, y.raw);
      if (!m || m === k.file.content) {
        c.push(`${y.path}: patch did not match or produced no change`);
        continue;
      }
      o.set(k.file.id, Et({
        file: k.file,
  ...
  for (const v of Wn(t)) {
    const y = v.path ? za(n, v.path) : s ? { file: s, normalizedPatchPath: Ge(s.path), confidence: "exact" } : null;
    if (!y) {
      c.push(`${v.path ?? "replacement block"}: no opened file`);
      continue;
    }
    if (v.content === y.file.content) {
      c.push(`${y.file.path}: replacement produced no change`);
      continue;
    }
    o.set(y.file.id, Et({
      file: y.file,
      proposedContent: v.content,
      sourceTitle: a,
      extractionLabel: v.label,
      versions: i,
      targetPath: v.path ?? y.file.path,
      match: y
    }));
  }
  const h = Wn(t).some((v) => v.path);
  if (o.size === 0 && s && !h) {
    const v = Do(t, s);
    v && v.content !== s.content && o.set(s.id, Et({
      file: s,
      proposedContent: v.content,
      sourceTitle: a,
      extractionLabel: v.label,
  ...
  return {
    ...
    stats: Ro(p.map((v) => v.stats)),
    kind: p.length === 0 ? "empty" : p.length === 1 ? "single-file" : "multi-file"
  };
}
function Do(e, t) {
  for (const h of lr(e)) {
    const p = Vn(t.content, h);
    if (p) return { content: p, label: "unified diff patch" };
  }
  const n = _n(e);
  if (n.length === 0) return null;
  const a = qo(t), s = Wn(e)[0];
  if (s) return { content: s.content, label: s.label };
  const i = n.find((h) => a.some((p) => Me(h, p)) && !Me(h, "diff") && !Me(h, "patch"));
  if (i) return { content: i.content, label: `matched ${i.lang || t.language} block` };
  const c = n.filter((h) => !Me(h, "diff") && !Me(h, "patch")).sort((h, p) => p.content.length - h.content.length)[0];
  return c ? { content: c.content, label: `largest fenced block (${c.lang || "plain"})` } : null;
}
function za(e, t) {
  const n = Ge(t), a = n.split("/").at(-1) ?? n, s = e.find((c) => Ge(c.path) === n);
  if (s) return { file: s, normalizedPatchPath: n, confidence: "exact" };
  const i = e.find((c) => Ge(c.path).endsWith(`/${n}`));
  if (i) return { file: i, normalizedPatchPath: n, confidence: "suffix" };
  const o = e.find((c) => c.name === a || Ge(c.path).endsWith(`/${a}`));
  return o ? { file: o, normalizedPatchPath: n, confidence: "basename" } : null;
}
function Fo(e, t) {
  const n = e.split(`
`), a = t.split(`
`), s = Math.max(n.length, a.length);
  let i = 0, o = 0, c = 0;
  for (let h = 0; h < s; h += 1)
    n[h] !== a[h] && (n[h] === void 0 ? i += 1 : a[h] === void 0 ? o += 1 : c += 1);
  return { added: i, removed: o, changed: c };
}
function Ro(e) {
  return e.reduce((t, n) => ({
...
function Et(e) {
  ...
  return {
    ...
    stats: Fo(e.file.content, e.proposedContent),
    base: {
...
const dn = (e) => typeof e == "object" && e !== null, Yo = (e) => dn(e.ai) ? e.ai : null, Jo = (e) => {
  if (!dn(e)) return null;
  const t = e.id;
...
}, qe = (e) => typeof e == "string" ? /\bembeddings?\b|text-embedding/i.test(e) : Array.isArray(e) ? e.some(qe) : dn(e) ? Object.values(e).some(qe) : !1, Ko = async (e, t) => {
  const n = Yo(e);
  if (typeof n?.listModels != "function") return [];
  const a = await n.listModels(t);
  return Array.isArray(a) ? a.map(Zo).filter((s) => !!s) : [];
}, Uo = (e) => (e.embedding ?? e.embeddings ?? e.supportsEmbedding ?? e.supportsEmbeddings) === !0 ? !0 : qe(e.capability) || qe(e.capabilities) || qe(e.modality) || qe(e.modalities) || qe(e.task) || qe(e.tasks) || qe(e.type) || qe(e.kind), dr = (e) => typeof e == "object" && e !== null, Bo = (e) => dr(e.ai) ? e.ai : null, ur = (e) => typeof Bo(e)?.embedText == "function", Go = async (e, t) => ur(e) ? (await Ko(e, t)).filter(Uo) : [], Qo = (e) => dr(e.ai) ? ur(e) ? null : "host.ai.embedText is not exposed by this Tytus build." : "host.ai is not available in this Tytus build.", $o = ["typecheck", "test", "lint", "build", "release:check", "verify", "verify:cortex"], _o = [
...
function al(e) {
  const t = e.results.length > 0 ? e.results.map((a, s) => [
    `Check ${s + 1}: ${a.command}`,
    `Status: ${a.status}`,
    "Output:",
    ul(a.output || "(no output pasted)", "text")
  ].join(`
`)).join(`
...
function sl(e) {
  ...
  for (const a of t) {
    const s = il(a.content);
    if (!s?.scripts) continue;
    const i = hr(a.path), o = ol(e, i, s);
    if (!o) continue;
    const c = Object.keys(s.scripts).filter((p) => typeof s.scripts?.[p] == "string"), h = ll(c);
    for (const p of h) {
      const v = `${o} run ${p}`;
      n.push({
        id: mr(`${i}:${v}`),
...
function ol(e, t, n) {
  ...
  for (const [a, s] of _o)
    if (e.some((i) => dl(i.path) === a && hr(i.path) === t)) return s;
  return null;
}
function ll(e) {
  const t = $o.filter((a) => e.includes(a)), n = e.filter((a) => !t.includes(a)).filter((a) => /(^|:)(check|typecheck|test|lint|verify|build)(:|$)/i.test(a)).sort((a, s) => a.localeCompare(s));
  return [...t, ...n];
}
function cl(e) {
  const t = /* @__PURE__ */ new Set();
...
function bl({ className: e }) {
  return /* @__PURE__ */ r("img", { src: pl, alt: "ATOMEK", className: e, draggable: !1 });
}
const vl = `# Tytus Resource Fabric
...
], xl = "tytus-atomek-handles", wt = "handles", Nl = 1, br = () => new Promise((e, t) => {
  const n = indexedDB.open(xl, Nl);
  n.onupgradeneeded = () => {
    const a = n.result;
    a.objectStoreNames.contains(wt) || a.createObjectStore(wt);
  }, n.onsuccess = () => e(n.result), n.onerror = () => t(n.error ?? new Error("Failed to open Atomek handle store"));
});
async function Xa(e, t) {
  const n = await br();
  await new Promise((a, s) => {
    const i = n.transaction(wt, "readwrite");
    i.objectStore(wt).put(t, e), i.oncomplete = () => a(), i.onerror = () => s(i.error ?? new Error("Failed to persist file handle"));
  }), n.close();
}
async function Xn(e) {
  const t = await br(), n = await new Promise((a, s) => {
    const o = t.transaction(wt, "readonly").objectStore(wt).get(e);
    o.onsuccess = () => a(o.result ?? null), o.onerror = () => s(o.error ?? new Error("Failed to read file handle"));
  });
  return t.close(), n;
}
const Tl = ls(() => import("./WorkbenchMonacoEditor-CJhaNTZX.js").then((e) => e.W).then((e) => ({ default: e.WorkbenchMonacoEditor }))), zl = {
  id: "welcome",
  name: "Agent Team",
  path: "Agent Team",
  language: "text",
  ...
  dirty: !1,
  source: "sample"
}, vr = "tytus.workspace.recent", yr = "tytus.workspace.layout", gr = "tytus.atomek.session.v2", wr = "tytus.atomek.chatAiSettings", Ln = "atomek:default", kr = "tytus.atomek.currentMission", In = "tytus.atomek.currentMissionChanged", La = "0.4.28", en = {
...
function An(e) {
  const t = Math.max(e || 1400, 760), n = Math.max(0, t - Xl), a = n < 1180, s = a ? 200 : 240, i = a ? 300 : 340, o = a ? 420 : 560, c = Math.max(s, Math.min(a ? 340 : 420, Math.floor(n * 0.28))), h = Math.min(300, c), p = Math.floor(n * (a ? 0.34 : 0.36)), v = n - h - o, y = Math.max(i, Math.min(a ? 500 : 640, p, v));
  return { primaryMin: s, primaryMax: c, secondaryMin: i, secondaryMax: y };
}
function Ll(e) {
  const t = [], n = /```([^\n`]*)\n?([\s\S]*?)```/g;
  let a = 0, s = 0, i;
  for (; (i = n.exec(e)) !== null; ) {
    if (i.index > a) {
      const c = e.slice(a, i.index);
      c.trim() && t.push({ type: "markdown", body: c, key: `md-${s}` });
    }
    t.push({
      type: "code",
      ...
      body: i[2] ?? "",
      key: `code-${s}`
    }), a = i.index + i[0].length, s += 1;
  }
  const o = e.slice(a);
  return (o.trim() || t.length === 0) && t.push({ type: "markdown", body: o, key: `md-${s}` }), t;
}
async function kt(e) {
  if (!e) return !1;
  try {
...
async function Dn(e, t, n) {
  const a = e.getFileHandle;
  if (!a) throw new Error("Selected mission folder is read-only in this browser context");
  const s = await a.call(e, t, { create: !0 });
  if (!s.createWritable) throw new Error(`Cannot write ${t}; File System Access write handle unavailable`);
  const i = await s.createWritable();
...
async function Ol(e, t, n) {
  ...
  let s = e;
  for (const i of a.slice(0, -1))
    s = await bt(s, i);
  await Dn(s, a[a.length - 1], n);
}
function Pr(e) {
  const t = e.reduce((n, a) => (n[a.kind] = (n[a.kind] ?? 0) + 1, n), {});
  return Object.entries(t).map(([n, a]) => `${a} ${n}`).join(" · ") || "no resources";
}
function vt(e, t) {
...
function Sl(e) {
  const t = e?.resources ?? [], n = (c) => c.status === "ready" || c.status === "available", a = t.filter((c) => c.kind === "pod-agent" && Pt(c) === "openclaw"), s = t.filter((c) => c.kind === "pod-agent" && Pt(c) === "hermes"), i = t.filter((c) => c.kind === "local-cli" && n(c)), o = t.filter((c) => c.kind === "shared-folder" && n(c));
  return [
    { label: "OpenClaw", value: a.length, detail: "fast pod agents for critique, planning, channel/app workflows", status: a.some(n) ? "ready" : "not allocated" },
    { label: "Hermes", value: s.length, detail: "heavier pod agent family when allocated", status: s.some(n) ? "ready" : "available when installed" },
    { label: "Local agents", value: i.length, detail: "Claude, OpenCode, Codex, pi, Kimi through Tytus tray", status: i.length ? "ready" : "missing" },
...
function Cl(e) {
  const t = e?.resources ?? [], n = (a) => t.some((s) => s.kind === a && (s.status === "ready" || s.status === "available"));
  return [
...
function rt(e, t) {
  return e.find((n) => xr(n) && t(n)) ?? null;
}
function Ue(e, t, n) {
  return rt(e, (a) => {
    if (a.kind !== t) return !1;
    const s = Hl(a);
    return n.some((i) => {
      ...
      if (o.length <= 4) {
        const c = o.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        return new RegExp(`(^|[^a-z0-9])${c}([^a-z0-9]|$)`).test(s);
      }
      return s.includes(o);
    });
  });
...
function Ot(e, t, n, a, s) {
  return {
    ...
    label: t,
    purpose: n,
    resourceId: a?.id ?? `missing:${e}`,
    resourceLabel: a ? Oe(a) : s,
    status: a?.status ?? "needs-setup",
    trustTier: a?.trustTier ?? "not-available",
    sandbox: a?.sandbox ?? "none"
  };
}
function xt(e, t = "repo-repair") {
  const n = Ct.find((Y) => Y.id === t) ?? Ct[0], a = e?.resources ?? [], s = rt(a, (Y) => Y.kind === "pod-agent" && Pt(Y) === "openclaw"), i = rt(a, (Y) => Y.kind === "pod-agent" && Pt(Y) === "hermes"), o = rt(a, (Y) => Y.kind === "ail-route"), c = rt(a, (Y) => Y.kind === "shared-folder"), h = Ue(a, "local-cli", ["claude"]), p = Ue(a, "local-cli", ["opencode", "open code"]), v = Ue(a, "local-cli", ["codex"]), y = Ue(a, "local-cli", ["pi"]), k = Ue(a, "local-cli", ["kimi"]), m = rt(a, (Y) => Y.kind === "local-cli"), A = Ue(a, "app-skill", ["juli3ta", "music", "song"]), R = Ue(a, "app-skill", ["blender", "3d"]), Z = Ue(a, "app-skill", ["remotion", "video", "render"]), F = rt(a, (Y) => Y.kind === "app-skill"), ge = t === "pod-local" ? s ?? i ?? o ?? h ?? m : t === "creative-production" ? i ?? o ?? h ?? m : t === "research-watch" ? s ?? o ?? i ?? h ?? m : h ?? p ?? o ?? m, we = t === "creative-production" ? A ?? R ?? Z ?? F ?? p ?? h ?? m : p ?? h ?? v ?? m, j = t === "pod-local" ? v ?? y ?? k ?? s ?? h ?? m : t === "research-watch" ? y ?? k ?? v ?? s ?? m : v ?? y ?? s ?? k ?? m, _ = t === "creative-production" ? A ?? R ?? Z ?? F : t === "research-watch" ? Ue(a, "app-skill", ["browser", "channel", "telegram"]) ?? F : F, q = [
    Ot("planner", "Planner", "Break goal into tasks, risks, and required context.", ge, "No planner agent ready"),
    Ot("implementer", "Implementer", "Execute local/app work and return transcript or patch proposal.", we, "No local/app implementer ready"),
    Ot("reviewer", "Reviewer", "Independent critique before approval or handoff.", j, "No reviewer agent ready"),
    Ot("team-desk", "Team Desk", "Shared mission folder for transcripts, outputs, proposals, and handoff.", c, "Mission folder only until shared folder is bound")
  ];
  (t === "creative-production" || _) && q.push(Ot("app-tool", "App Tool", "Drive installed local app skill through mission context.", _, "No configured app skill"));
  const M = q.filter((Y) => Y.status === "ready" || Y.status === "available" || Y.status === "degraded").length, be = M >= q.length - 1 ? "ready" : M >= 2 ? "partial" : "needs-setup";
  return { ...n, readiness: be, assignments: q };
}
function ot(e, t, n) {
  if (n && Ct.some((s) => s.id === n)) return n;
  const a = e.toLowerCase();
  return /(music|song|audio|video|render|blender|remotion|juli3ta|creative)/.test(a) ? "creative-production" : /(research|watch|monitor|news|summar|scan)/.test(a) ? "research-watch" : (t?.resources ?? []).some((s) => s.kind === "pod-agent" && xr(s)) ? "pod-local" : "repo-repair";
}
function jl(e) {
  return Ct.map((t) => xt(e, t.id));
}
function Jt(e) {
...
function St(e) {
  ...
  try {
    localStorage.setItem(kr, JSON.stringify(t)), window.dispatchEvent(new CustomEvent(In, { detail: t }));
  } catch {
  }
}
function Wl() {
...
function Ht(e, t, n) {
  const a = e.trim() || "Coordinate a Tytus mission.", s = xt(t, ot(a, t, n)), i = (y) => s.assignments.find((k) => k.role === y), o = i("planner"), c = i("implementer"), h = i("reviewer"), p = i("team-desk"), v = i("app-tool");
  return [
    {
      id: "task-scope",
      title: "Scope mission and context",
      prompt: `Planner role: turn this goal into an executable mission plan, list required files/assets, and define approval gates. Goal: ${a}`,
      resourceHint: o ? Jt(o) : "Planner agent",
      role: "planner",
    ...
    },
    {
      ...
      prompt: `Implementer role: use the mission folder, selected files, and shared/team desk context to execute the smallest safe step. Return transcript, artifact, or patch proposal only. Goal: ${a}`,
      resourceHint: c ? Jt(c) : "Local/app implementer",
      role: "implementer",
    ...
    v ? {
      ...
      prompt: `App-tool role: use the relevant app skill only through configured Tytus/app instructions. Save source assets and outputs into the mission/team desk. Goal: ${a}`,
      resourceHint: Jt(v),
      role: "app-tool",
      assignedResourceLabel: v.resourceLabel,
      status: v.status === "ready" || v.status === "available" ? "waiting" : "needs-approval",
      expectedOutputs: ["app output", "asset path", "usage notes"]
    } : null,
    {
      id: "task-handoff",
      title: "Review and hand off",
      prompt: `Reviewer role: independently review the outputs, list approval decisions, and prepare a handoff that another agent can continue from. Goal: ${a}`,
      resourceHint: h ? `${Jt(h)} · ${p?.resourceLabel ?? "mission folder"}` : "Reviewer + mission folder",
      role: "reviewer",
      assignedResourceLabel: h?.resourceLabel ?? "Reviewer agent",
      status: "waiting",
...
function tn(e, t, n, a, s, i) {
  const o = xt(t, ot(s || e.goal, t, i ?? e.teamPresetId));
  return [
    `# ${e.title}`,
    "",
    `- Mission ID: \`${e.missionId}\``,
    ...
    `- Open editors: ${a.length}`,
    "",
    "## Current task",
    "",
    s || "(no task prompt set)",
    "",
    "## Resource graph",
    "",
    t ? `- ${Pr(t.resources)}` : "- not loaded",
...
function zr(e, t, n, a) {
  const s = ot(n || e.goal, t, a ?? e.teamPresetId), i = xt(t, s), o = Ht(n || e.goal, t, s);
  return JSON.stringify({
    ...
    storage: {
      ...
      teamDesk: i.assignments.find((c) => c.role === "team-desk")?.resourceLabel ?? "mission folder",
      paths: {
        runs: "runs/",
        outputs: "outputs/",
        proposals: "proposals/",
    ...
    tasks: o.map((c, h) => ({
      ...
      status: h === 0 ? "ready" : "waiting",
      selectedResourceHint: c.resourceHint,
      dependsOn: h === 0 ? [] : [o[h - 1].id],
...
function Il({ host: e }) {
  const t = it(null), [n, a] = z(0), s = ue(() => Tc(), []), i = ue(() => wc(), []), o = ue(() => gc(yc(), i.recent), [i.recent]), [c, h] = z(i.activity ?? "computer"), [p, v] = z(s.primaryVisible), [y, k] = z(s.primaryWidth), [m, A] = z(i.secondaryTab ?? "chat"), [R, Z] = z(s.secondaryVisible), [F, ge] = z(s.secondaryWidth), [we, j] = z(!!i.bottomPanelVisible), [_, q] = z(i.bottomPanelTab ?? "problems"), [M, be] = z(s.markdownPreviewVisible), [Y, ve] = z(!!i.welcomeClosed), [fe, He] = z(i.folder ? { name: i.folder.name, files: [] } : null), [We, je] = z(i.folder?.handleKey ?? null), [O, oe] = z(() => kc(i.files)), [Pe, he] = z(() => (i.openEditorIds ?? []).filter((l) => (i.files ?? []).some((f) => f.id === l))), [g, W] = z(() => i.activeFileId && (i.files ?? []).some((l) => l.id === i.activeFileId) ? i.activeFileId : null), [x, L] = z(i.query ?? ""), [V, X] = z({ lineNumber: 1, column: 1 }), [ne, ae] = z(null), [le, xe] = z({}), [Ve, ze] = z(Si), [Ee, Ze] = z([]), [ye, K] = z([]), [G, me] = z(null), [ee, Ne] = z(i.chatInput ?? ""), [Ie, De] = z(!1), [te, de] = z(""), [d, w] = z([]), [T, H] = z(null), [S, E] = z(null), [$, U] = z(!1), [ke, Ke] = z(() => zc()), [B, I] = z([Be]), [se, Le] = z(() => ni(Ln)), [Te, Ae] = z(null), [Fe, lt] = z(null), [ct, Nt] = z(""), [Qe, un] = z(""), [Mt, Wt] = z(""), [Vt, na] = z("failed"), [jr, aa] = z(null), [Mr, C] = z("Ready"), [Tt, Wr] = z(() => o), Se = Pe.map((l) => O.find((f) => f.id === l)).filter(Boolean), D = g ? O.find((l) => l.id === g) ?? null : null, ra = ue(() => Oi({ files: O, openEditorIds: Pe, activeFileId: g, versions: le, activeSelection: ne }), [g, ne, le, O, Pe]), sa = ue(() => ({
    scope: Ve,
    removedAttachmentIds: Ee,
    selectedFileIds: []
  }), [Ve, Ee]), zt = ue(() => Ei(ra, O, sa), [sa, ra, O]), $e = fo(O, { autoRefresh: !0, includeDirty: !0 }), ia = ue(() => ye.map((l) => ({
    id: l.id,
    kind: "index-hit",
    label: l.label,
    path: l.path,
    ...
    snippet: l.snippet
  })), [ye]), Vr = ue(() => [...zt.attachments, ...ia], [zt.attachments, ia]), oa = ue(() => B.find((l) => l.id === se) ?? Be, [B, se]), Q = Xi({ host: e, requestContext: zt.parts, chatSettings: ke, selectedTarget: oa, setStatus: C }), tt = ue(
    () => [...Q.artifacts, ...d].sort((l, f) => f.createdAt - l.createdAt),
    [Q.artifacts, d]
  ), It = $ && !D, fn = !D && !It && !Y, Xe = ue(() => O.filter((l) => l.dirty), [O]), Ir = ue(() => {
    const l = x.trim().toLowerCase();
    return l ? O.filter((f) => f.path.toLowerCase().includes(l)) : O;
  }, [O, x]);
  re(() => {
    xe((l) => {
      const f = {};
      for (const b of O) f[b.id] = l[b.id] ?? 1;
      return f;
    });
  }, [O]), re(() => {
    Ze([]), K([]);
    ...
    const f = async () => {
      const P = await fi(e);
      l && (I(P), Le((J) => {
        const ce = P.some((nt) => nt.id === J) ? J : Be.id;
        return ce !== J && va(Ln, ce), ce;
      }));
    };
    f();
    const b = e.daemon.onStateChange(() => {
      f();
    });
    return () => {
      l = !1, b?.();
  ...
  const Dr = N((l) => {
    const f = B.find((b) => b.id === l) ?? Be;
    Le(f.id), va(Ln, f.id), C(`Chat target: ${f.label}`);
  }, [B, C]), Fr = N((l) => {
    if (l.kind === "index-hit") {
      K((f) => f.filter((b) => b.id !== l.id)), C(`Removed project context: ${l.label}`);
      return;
    }
    Ze((f) => f.includes(l.id) ? f : [...f, l.id]), C(`Removed chat context: ${l.label}`);
  }, []), Dt = N(() => {
    U(!0), W(null), ve(!0), C("Atomek settings opened");
  }, []), la = N(() => {
    U(!1), W((l) => l ?? Pe.at(-1) ?? null), Pe.length === 0 && ve(!1), C("Atomek settings closed");
  }, [Pe]), dt = N((l) => {
    xe((f) => ({ ...f, [l]: (f[l] ?? 1) + 1 }));
  }, []), Rr = N((l) => {
    l.preventDefault(), l.currentTarget.setPointerCapture?.(l.pointerId);
    const f = An(n), b = l.clientX, P = F, J = (nt) => {
      const kn = P + (b - nt.clientX);
      ge(Yt(kn, f.secondaryMin, f.secondaryMax));
    }, ce = () => {
      window.removeEventListener("pointermove", J), window.removeEventListener("pointerup", ce);
    };
    window.addEventListener("pointermove", J), window.addEventListener("pointerup", ce);
  }, [F, n]), Er = N((l) => {
    l.preventDefault(), l.currentTarget.setPointerCapture?.(l.pointerId);
    const f = An(n), b = l.clientX, P = y, J = (nt) => {
      const kn = P + (nt.clientX - b);
      k(Yt(kn, f.primaryMin, f.primaryMax));
    }, ce = () => {
      window.removeEventListener("pointermove", J), window.removeEventListener("pointerup", ce);
    };
    window.addEventListener("pointermove", J), window.addEventListener("pointerup", ce);
    ...
    Wr((f) => {
      const b = [l, ...f.filter((P) => P.path !== l.path)].slice(0, 10);
      return localStorage.setItem(vr, JSON.stringify(b)), b;
    });
  }, []), pe = N((l, f) => {
    he((b) => b.includes(l.id) ? b : [...b, l.id]), W(l.id), ve(!1), aa(f ?? null), X({ lineNumber: f ?? 1, column: 1 });
  }, []), qr = N((l) => {
    const f = {
      id: `atomek-doc:${l.id}`,
      name: l.fileName,
    ...
    oe((b) => Zt(b, [f])), pe(f), A("chat"), Z(!0), be(!0), C(`Opened Atomek guide: ${l.title}`);
  }, [pe]), Yr = N((l) => {
    if (!l.fileId) return;
    const f = O.find((b) => b.id === l.fileId);
    f && (pe(f, l.range?.startLineNumber ?? 1), C(`Revealed context: ${l.label}`));
  }, [O, pe]), Xt = N(async () => {
    if (On(Xe, "open new files"))
      try {
        const l = await Qs();
        if (l.length === 0) return;
        oe((f) => Zt(f, l)), await Promise.all(l.map(async (f) => {
          const b = f.handle ? `file:${f.path}` : void 0;
          f.handle && b && await Xa(b, f.handle), _e({ name: f.name, path: f.path, kind: "file", handleKey: b, at: Date.now() });
        })), pe(l[0]), C(`Opened ${l.length} local file${l.length === 1 ? "" : "s"}`);
      } catch (l) {
        l.name !== "AbortError" && C(`Open file failed: ${l.message}`);
      }
  }, [Xe, pe, _e]), hn = N(async () => {
    if (On(Xe, "open another folder"))
      try {
        const l = await $s(), f = l.handle ? `folder:${l.name}:${Date.now()}` : null;
        l.handle && f && await Xa(f, l.handle), je(f), He(l), oe(l.files), he([]), W(null), ve(!1), _e({ name: l.name, path: l.name, kind: "folder", handleKey: f ?? void 0, at: Date.now() }), C(`${l.handle ? "Opened local folder" : "Opened browser fallback folder"} ${l.name} (${l.files.length} text files indexed)`);
      } catch (l) {
        l.name !== "AbortError" && C(`Open folder failed: ${l.message}`);
      }
  }, [Xe, _e]), Jr = N((l) => {
    if (!g) return;
    let f = !1;
    oe((b) => b.map((P) => P.id !== g || P.content === l ? P : (f = !0, { ...P, content: l, dirty: !0 }))), f && dt(g);
  }, [g, dt]), mn = N(async () => {
    if (D)
      try {
        const l = await xn(D);
        oe((f) => f.map((b) => b.id === l.id ? l : b)), C(`Saved ${l.name}`);
      } catch (l) {
        C(`Save failed: ${l.message}`);
      }
  }, [D]), Zr = N(async (l) => {
    const f = O.find((P) => P.id === l);
    if (!f) return null;
    const b = await xn(f);
    return oe((P) => P.map((J) => J.id === b.id ? b : J)), b;
  }, [O]), ca = N(async () => {
    const l = O.filter((f) => f.dirty);
    if (l.length === 0) {
      C("No dirty files to save");
      return;
    }
    try {
      const f = await Promise.all(l.map((P) => xn(P))), b = new Map(f.map((P) => [P.id, P]));
      oe((P) => P.map((J) => b.get(J.id) ?? J)), Ae(null), C(`Saved ${f.length} dirty file${f.length === 1 ? "" : "s"}`);
    } catch (f) {
      C(`Save all failed: ${f.message}`);
    }
  }, [O]), pn = N((l) => {
    const f = O.find((b) => b.id === l);
    if (f?.dirty && !window.confirm(`${f.name} has unsaved changes. Close without saving?`)) {
      C(`Close canceled — ${f.name} has unsaved changes`);
      return;
    }
    he((b) => {
      const P = b.filter((J) => J !== l);
      return g === l && (W(P.at(-1) ?? null), ae(null)), P;
    });
  }, [g, O]), Kr = N(() => {
    On(Xe, "close all editors") && (he([]), W(null), aa(null), ve(!1), C("Closed all editors"));
  }, [Xe]), bn = N(() => {
    const l = O.filter((b) => b.name.startsWith("Untitled")).length + 1, f = {
...
`,
    ...
    return K(P), P.length === 0 ? (C($e.snapshot.chunks.length === 0 ? "Project index is empty — open a folder with readable files first" : "Project index found no matching context for this prompt"), f) : (b.mode !== "hybrid" && b.reason ? C(b.reason) : C(`${P.length} project context hit${P.length === 1 ? "" : "s"} · ${b.reason ?? "hybrid retrieval"}`), [
      ...f,
      ...wo(P)
    ]);
  }, [zt.parts, Ve, ke, e, $e]), vn = N(() => {
    if (!D && Se.length === 0) {
      C("Open a file before asking Atomek to synthesize an AI artifact");
      return;
    }
    const f = [
      `Create a polished Markdown artifact from ${D?.path ?? `${Se.length} open editors`}.`,
    ...
    Z(!0), A("chat"), C("Asking Atomek to synthesize an AI artifact…"), (async () => {
      const b = await et(f), P = await Q.askAgent(f, { requestContext: b });
      !P || P.status === "error" || Q.createArtifact({
        messageId: P.id,
        title: `AI synthesis — ${D?.name ?? "open workspace"}`,
        kind: "markdown",
        body: P.body
      }).then(() => {
        Z(!0), A("outputs"), j(!0), q("output");
      });
    })();
  }, [D, Q, et, Se.length]), yn = N(async (l) => {
    if (l.kind === "folder") {
      const b = O.filter((P) => P.path === l.path || P.path.startsWith(`${l.path}/`));
      if (fe?.name === l.name || b.length > 0) {
        b.length > 0 && (He((P) => P?.name === l.name ? P : { name: l.name, files: b }), oe((P) => Zt(P, b))), h("explorer"), v(!0), W(null), ve(!1), _e({ ...l, at: Date.now() }), C(`Opened recent folder ${l.name}`);
        return;
      }
    }
    const f = O.find((b) => b.path === l.path || b.name === l.name);
    if (f) {
      pe(f), C(`Opened recent ${f.name}`);
      return;
    }
    if (!l.handleKey) {
      C("Recent item has no stored browser permission. Use Open File or Open Folder once, then Atomek can restore it.");
      return;
    }
    try {
      if (l.kind === "folder") {
        const J = await Xn(l.handleKey);
        if (!J || !await Pn(J, "readwrite")) {
          C("Browser permission expired for this folder. Click Open Folder and pick it once to refresh the recent handle.");
          return;
        }
        const ce = await pa(J);
        je(l.handleKey), He(ce), oe(ce.files), he([]), W(null), ve(!1), _e({ ...l, at: Date.now() }), C(`Reopened ${ce.name} (${ce.files.length} text files indexed)`);
        return;
      }
      const b = await Xn(l.handleKey);
      if (!b || !await Pn(b, "readwrite")) {
        C("Browser permission expired for this file. Click Open File and pick it once to refresh the recent handle.");
        return;
      }
      const P = await _s([b]);
      if (!P[0]) {
        C(`Recent file is not readable text: ${l.name}`);
        return;
      }
      oe((J) => Zt(J, P)), pe(P[0]), _e({ ...l, at: Date.now() }), C(`Reopened ${P[0].name}`);
    } catch (b) {
      C(`Open recent failed: ${b instanceof Error ? b.message : String(b)}`);
    }
  }, [O, fe?.name, pe, _e]), Ce = N((l) => {
    Z(!0), A("chat"), Ne(""), (async () => {
      const f = await et(l);
      await Q.askAgent(l, { requestContext: f });
    })();
  }, [Q, et]), da = N(async (l) => {
    if (!e.skills?.get) {
      C("Tytus skill registry is not available in this host build");
      return;
    }
    try {
      const f = await e.skills.get(l.id), b = f.body.length > 4500 ? `${f.body.slice(0, 4500)}

[Skill pack clipped by Atomek. Ask for the full pack if needed.]` : f.body, P = [
        `Use Tytus skill "${f.title}" (${f.id}).`,
        `Driver: ${f.driver}. Source: ${f.source}. Status: ${f.status}.`,
...
`);
      Ne((J) => [J.trim(), P].filter(Boolean).join(`

`)), Z(!0), A("chat"), C(`Attached skill ${f.title} to chat input`);
    } catch (f) {
      C(`Failed to attach skill: ${f instanceof Error ? f.message : String(f)}`);
    }
  }, [e.skills]), Ur = N((l) => {
    const f = Q.messages.findIndex((P) => P.id === l.id), b = Q.messages.slice(0, f < 0 ? void 0 : f).reverse().find((P) => P.role === "user");
    if (!b?.body.trim()) {
      C("No previous user prompt to regenerate from");
      return;
    }
    (async () => {
      const P = await et(b.body);
      await Q.askAgent(b.body, { requestContext: P });
    })();
  }, [Q, et]), Br = N((l) => {
    Q.createArtifact({
      messageId: l.id,
...
`).find(Boolean)?.replace(/^#+\s*/, "").slice(0, 80) || "Atomek memory",
    ...
    if (!D) {
      C("No active file to save as AI artifact");
      return;
    }
    Q.createArtifact({
      title: D.path,
      kind: D.language === "markdown" ? "markdown" : "report",
      body: D.content
    }).then(() => {
      Z(!0), A("outputs"), j(!0), q("output");
    });
  }, [D, Q]), gn = N((l) => {
    const f = Cn(O, Sn(l.title || l.kind)), b = {
    ...
    oe((P) => [...P, b]), pe(b), C(`Opened ${l.title} as editable file`);
  }, [O, pe]), wn = N(() => {
    const l = window.prompt("Check command/name (manual capture only; Atomek will not execute it)");
    if (l === null) return;
    const f = l.trim();
    if (!f) {
      C("Manual check capture canceled — command/name was empty");
      return;
    }
...
`), J = {
      id: `manual-check-${Date.now()}`,
      title: `Manual check — ${f.slice(0, 80)}`,
      kind: "report",
      body: P,
      createdAt: Date.now(),
      source: "local"
    };
    w((ce) => [J, ...ce]), j(!0), q("output"), C(`Captured manual check: ${f}`);
  }, []), ut = N((l, f) => {
    const b = Io({
      body: f,
      files: O,
      ...
      edits: b.edits.map(bc),
      skipped: b.skipped
    };
    return b.edits.length > 1 ? (E(P), H(null), C(`Previewing AI workspace patch for ${b.edits.length} files`), !0) : b.edits.length === 1 ? (H(P.edits[0]), E(null), C(`Previewing AI patch for ${P.edits[0].fileName}`), !0) : (C(b.skipped.length > 0 ? `No applicable edit found. ${b.skipped.slice(0, 2).join(" · ")}` : "No fenced replacement block or applicable unified diff found. Ask Atomek for an edit again."), !1);
  }, [D, le, O]), ua = N((l, f) => {
    const b = {
    ...
    w((P) => [b, ...P]), Z(!0), A("outputs"), j(!0), q("output"), C(`Saved local job output: ${l}`), (f.includes("```diff") || f.includes("--- a/")) && ut(l, f);
  }, [ut]), $r = N(() => {
    const l = ee.trim();
    if (!l) return;
    Ne("");
    const f = ac(l);
    (async () => {
      const b = await et(l), P = await Q.askAgent(l, { requestContext: b });
      if (!f || !P || P.status === "error") return;
      ut(P.body.split(`
`).find(Boolean)?.replace(/^#+\s*/, "").slice(0, 80) || "Atomek edit", P.body) || C("Edit request answered without a patch. Use Generate patch / Edit to request an applicable diff.");
    })();
  }, [Q, et, ee, ut]), _r = N(() => {
    G && (me(null), Ce(rc(G)));
  }, [Ce, G]), Lt = N((l) => {
    const f = el(O, l);
    lt(f);
    const b = f.commands[0]?.command ?? "";
    Wt(b), Nt(""), un(""), na("failed"), j(!0), q("terminal"), C(f.commands.length > 0 ? `Manual check ready: copy ${f.commands[0].command}` : "Manual check ready: enter a check command to copy");
  }, [O]), es = N((l) => {
    l.trim() && (kt(l), Wt(l), C(`Manual check command copied: ${l}`));
  }, []), ts = N(() => {
    lt((l) => {
      if (!l) return l;
      const f = tl(l, ct), b = f.commands.at(-1)?.command ?? "";
      return b && Wt(b), f;
    }), Nt("");
  }, [ct]), ns = N(() => {
    if (!Fe || !Mt.trim()) {
      C("Select or enter a manual check command before capturing output");
      return;
    }
    const l = Mt.trim();
    lt((f) => f && nl(f, l, Vt, Qe)), un(""), C(`Captured manual check result: ${l} (${Vt})`);
  }, [Qe, Mt, Fe, Vt]), as = N(() => {
    Fe && Ce(al(Fe));
  }, [Ce, Fe]), rs = N(() => {
    if (!T) return;
    const l = O.find((f) => f.id === T.fileId);
    if (!l) {
      C(`Cannot apply edit — ${T.fileName} is no longer open`), H(null);
      return;
    }
    l.content !== T.originalContent && !window.confirm(`${T.fileName} changed after the preview was created. Apply the AI edit anyway?`) || (oe((f) => f.map((b) => b.id === T.fileId ? { ...b, content: T.proposedContent, dirty: !0 } : b)), dt(T.fileId), Ae(`AI edit applied to ${l.name}. Save All to persist it to disk.`), H(null), Lt(`AI edit applied to ${l.name}`), C(`Applied AI edit to ${l.name} — unsaved; manual check ready`));
  }, [dt, O, T, Lt]), ss = N(() => {
    if (!T) return;
    const l = Cn(O, `${Sn(T.fileName)}-ai-edit`), f = {
      id: `pending-edit-${T.fileId}-${Date.now()}`,
      name: l,
      path: l,
      language: D?.language ?? "markdown",
      content: T.proposedContent,
      dirty: !0,
      source: "generated"
    };
    oe((b) => [...b, f]), pe(f), H(null), C(`Opened proposed edit as ${l}`);
  }, [D?.language, O, pe, T]), is = N(() => {
    if (!S) return;
    const l = new Map(S.edits.map((b) => [b.fileId, b]));
    O.some((b) => {
      const P = l.get(b.id);
      return P && b.content !== P.originalContent;
    }) && !window.confirm("One or more files changed after the workspace patch preview was created. Apply anyway?") || (oe((b) => b.map((P) => {
      const J = l.get(P.id);
      return J ? { ...P, content: J.proposedContent, dirty: !0 } : P;
    })), l.forEach((b, P) => dt(P)), Ae(`AI workspace patch applied to ${l.size} file${l.size === 1 ? "" : "s"}. Save All to persist changes.`), E(null), Lt(`AI workspace patch applied to ${l.size} file${l.size === 1 ? "" : "s"}`), C(`Applied AI workspace patch to ${l.size} file${l.size === 1 ? "" : "s"} — unsaved; manual check ready`));
  }, [dt, O, S, Lt]), os = N(() => {
    if (!S) return;
    const l = [...O], f = S.edits.map((b) => {
      const P = Cn(l, `${Sn(b.fileName)}-ai-edit`), J = O.find((nt) => nt.id === b.fileId), ce = {
        id: `workspace-patch-${b.fileId}-${Date.now()}-${P}`,
        name: P,
        path: P,
    ...
    oe((b) => [...b, ...f]), f[0] && pe(f[0]), E(null), C(`Opened ${f.length} proposed edit file${f.length === 1 ? "" : "s"}`);
  }, [O, pe, S]), fa = N((l) => {
    if (l === "explain") {
      Ce("Explain the active file. Focus on purpose, structure, risks, and next useful edits.");
      return;
    }
    if (l === "improve") {
      Ce("Review the active file and propose the smallest concrete improvements. Include exact snippets if useful.");
      return;
    }
    if (l === "plan") {
      Ce("Create an implementation plan from the open editor context. Be specific, ordered, and call out blockers.");
      return;
    }
    if (l === "edit") {
      Ce("Edit the active file or open workspace files. Prefer one git-style unified diff in a fenced diff block, with paths matching opened files. If editing one file, a complete fenced replacement is also OK. Do not use provider-specific tools or model assumptions.");
      return;
    }
    Ce("Draft a concrete Markdown artifact from the open editor context. Make it ready to save as an output.");
  }, [Ce]);
  return re(() => {
    const l = (f) => {
      (f.metaKey || f.ctrlKey) && (f.key.toLowerCase() === "o" && (f.preventDefault(), Xt()), f.key.toLowerCase() === "s" && (f.preventDefault(), mn()), f.key.toLowerCase() === "w" && (f.preventDefault(), g && pn(g)), f.key.toLowerCase() === "b" && (f.preventDefault(), v((P) => !P)), f.shiftKey && f.key.toLowerCase() === "f" && (f.preventDefault(), h("search"), v(!0)), (f.key.toLowerCase() === "k" || f.key.toLowerCase() === "p") && (f.preventDefault(), De(!0)));
    };
    return window.addEventListener("keydown", l), () => window.removeEventListener("keydown", l);
  }, [g, pn, Xt, mn]), re(() => {
    const l = (f) => {
      Xe.length !== 0 && (f.preventDefault(), f.returnValue = "");
    };
    ...
    const l = t.current;
    if (!l) return;
    const f = () => a(Math.round(l.getBoundingClientRect().width));
    f();
    ...
    if (!n) return;
    const l = An(n);
    k((f) => Yt(f, l.primaryMin, l.primaryMax)), ge((f) => Yt(f, l.secondaryMin, l.secondaryMax));
  }, [n]), re(() => {
    const l = { primaryVisible: p, primaryWidth: y, secondaryVisible: R, secondaryWidth: F, markdownPreviewVisible: M };
    localStorage.setItem(yr, JSON.stringify(l));
  }, [M, p, y, R, F]), re(() => {
    if (!i.folder?.handleKey) return;
    let l = !1;
    return (async () => {
      try {
        const f = await Xn(i.folder?.handleKey ?? "");
        if (!f || !await Pn(f, "readwrite") || l) return;
        const b = await pa(f);
        if (l) return;
        je(i.folder?.handleKey ?? null), He(b), oe((P) => Nc(P, b.files)), he((P) => P.filter((J) => b.files.some((ce) => ce.id === J) || O.some((ce) => ce.id === J))), C(`Restored ${b.name} (${b.files.length} text files indexed)`);
      } catch (f) {
        l || C(`Workspace restore failed: ${f instanceof Error ? f.message : String(f)}`);
      }
    })(), () => {
      l = !0;
    };
    ...
    xc({
      activity: c,
      folder: fe ? { name: fe.name, handleKey: We } : null,
      files: Pc(O),
      openEditorIds: Pe,
      activeFileId: g,
      query: x,
      ...
      welcomeClosed: Y,
      secondaryTab: m,
      bottomPanelVisible: we,
      bottomPanelTab: _,
      recent: Tt
    });
  }, [c, g, _, we, ee, We, O, fe, Pe, x, Tt, m, Y]), re(() => {
    localStorage.setItem(wr, JSON.stringify(ke));
  }, [ke]), /* @__PURE__ */ u(
    "div",
    {
      ref: t,
      className: `workbench-workbench ${p ? "" : "no-primary"} ${R ? "" : "no-secondary"} ${we ? "has-bottom-panel" : ""}`,
      "data-app": "workbench-vscode-base",
      style: { "--workbench-primary-width": `${y}px`, "--workbench-secondary-width": `${F}px` },
      children: [
        /* @__PURE__ */ r(
          Dl,
          {
        ...
        p && /* @__PURE__ */ u("div", { className: "workbench-primary-region", children: [
          /* @__PURE__ */ r(
            Fl,
            {
              ...
              openFile: Xt,
              openFolder: hn,
              openWorkbenchFile: pe,
              newFile: bn,
              recent: Tt,
              reopenRecent: yn,
              setStatus: C,
              hasFsAccess: Gs(),
              attachSkillToChat: da,
              saveLocalJobOutput: ua,
              activeFile: D
            }
          ),
          /* @__PURE__ */ r("div", { className: "workbench-primary-resizer", onPointerDown: Er, title: "Resize Explorer" })
        ] }),
        /* @__PURE__ */ u("main", { className: "workbench-editor-area", children: [
          /* @__PURE__ */ r("button", { className: "workbench-command-center", onClick: () => De(!0), children: "Workspace" }),
          /* @__PURE__ */ u("section", { className: "workbench-editor-stack", children: [
            /* @__PURE__ */ r(
              Yl,
              {
                ...
                closeSettings: la,
                secondaryVisible: R,
                toggleSecondary: () => Z((l) => !l),
                canPreview: D?.language === "markdown",
                previewVisible: M,
                togglePreview: () => be((l) => !l)
              }
            ),
            /* @__PURE__ */ r(ql, { file: D, folder: fe, showWelcome: fn }),
            Te && Xe.length > 0 ? /* @__PURE__ */ u("div", { className: "workbench-ai-dirty-banner", children: [
              /* @__PURE__ */ r("span", { children: Te }),
              /* @__PURE__ */ r("button", { onClick: () => {
                ca();
              }, children: "Save all" }),
              /* @__PURE__ */ r("button", { onClick: () => Ae(null), title: "Dismiss", children: /* @__PURE__ */ r(Je, { size: 13 }) })
            ] }) : null,
            /* @__PURE__ */ r("div", { className: "workbench-editor-content", children: D ? /* @__PURE__ */ u("div", { className: D.language === "markdown" && M ? "workbench-editor-split" : "workbench-editor-single", children: [
              /* @__PURE__ */ r("div", { className: "workbench-editor-pane", children: /* @__PURE__ */ r(cs, { fallback: /* @__PURE__ */ r("div", { className: "workbench-empty-pane", children: "Loading editor…" }), children: /* @__PURE__ */ r(
                Tl,
                {
                  file: D,
                  revealLine: jr,
              ...
              D.language === "markdown" && M && /* @__PURE__ */ r(Ql, { content: D.content })
            ] }) : It ? /* @__PURE__ */ r(
              ic,
              {
                host: e,
            ...
            ) : fn ? /* @__PURE__ */ r(Kl, { host: e, openFile: Xt, openFolder: hn, newFile: bn, recent: Tt, reopenRecent: yn, setStatus: C, openControlTower: () => {
              h("computer"), v(!0);
            }, openChat: () => {
              A("chat"), Z(!0);
            }, openEmbeddedDoc: qr }) : /* @__PURE__ */ u("div", { className: "workbench-no-editor", children: [
              /* @__PURE__ */ r(ln, { size: 34 }),
              /* @__PURE__ */ r("p", { children: "No editor open" }),
              /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: () => ve(!1), children: "Show Agent Team" })
            ] }) }),
            we && /* @__PURE__ */ r(
              _l,
              {
                ...
                runAiSynthesis: vn,
                captureManualCheck: wn,
                openOutputAsFile: gn,
                manualCheckSession: Fe,
                manualCheckCommandInput: ct,
                setManualCheckCommandInput: Nt,
                manualCheckOutputInput: Qe,
                setManualCheckOutputInput: un,
                manualCheckSelectedCommand: Mt,
                setManualCheckSelectedCommand: Wt,
                manualCheckStatus: Vt,
                setManualCheckStatus: na,
                copyManualCheckCommand: es,
                addManualCheckCommand: ts,
                recordManualCheckResult: ns,
                askAgentFromManualChecks: as,
                onClose: () => j(!1)
              }
            )
          ] })
        ...
        R && /* @__PURE__ */ r(
          ec,
          {
            ...
            chatInput: ee,
            setChatInput: Ne,
            chatMessages: Q.messages,
            chatThread: Q.thread,
            chatThreads: Q.threads,
            askAgent: $r,
            stopChat: Q.stopChat,
            regenerateMessage: Ur,
            newChat: () => {
              Q.newChat();
            },
            selectThread: (l) => {
            ...
            saveMessageAsArtifact: Br,
            rememberMessage: Gr,
            previewEditFromMessage: (l) => ut(l.body.split(`
`).find(Boolean)?.replace(/^#+\s*/, "").slice(0, 80) || "Atomek answer", l.body),
            runQuickPrompt: fa,
            pendingPatchPrompt: G,
            generatePatchPrompt: _r,
            workspaceFileCount: O.length,
            aiStatus: Q.aiStatus,
            chatSettings: ke,
            chatTargets: B,
            selectedChatTarget: oa,
            selectChatTarget: Dr,
            openSettings: Dt,
            busy: Q.busy,
            memoryHitCount: Q.memoryHits.length,
            outputs: tt,
            runAiSynthesis: vn,
            captureManualCheck: wn,
            openOutputAsFile: gn,
            previewEditFromOutput: (l) => ut(l.title, l.body),
            canPreviewEdit: O.length > 0,
            clearOutputs: () => w([]),
            deleteArtifact: (l) => {
              Q.deleteArtifact(l);
            },
            ...
            contextScope: Ve,
            setContextScope: ze,
            contextAttachments: Vr,
            removeContextAttachment: Fr,
            revealContextAttachment: Yr,
            projectIndexSummary: `${$e.snapshot.files.length} files · ${$e.snapshot.chunks.length} chunks`,
            projectIndexStale: $e.isStale,
            refreshProjectIndex: () => {
              const l = $e.refresh(O);
              C(`Project index refreshed: ${l.files.length} files · ${l.chunks.length} chunks`);
            },
            onResizeStart: Rr,
            onClose: () => Z(!1)
          }
        ...
        Ie && /* @__PURE__ */ r(
          Gl,
          {
            ...
            activeFile: D,
            commands: [
              { label: "File: New File", detail: "Create an untitled Markdown file", run: bn },
              ...
              ...Tt.map((l) => ({ label: `File: Open Recent — ${l.name}`, detail: l.path, run: () => {
                yn(l);
              } })),
              { label: "File: Save All", detail: `${Xe.length} dirty file${Xe.length === 1 ? "" : "s"}`, run: () => {
                ca();
              }, disabled: Xe.length === 0 },
              { label: "File: Close All Editors", detail: `${Se.length} open editor${Se.length === 1 ? "" : "s"}`, run: Kr, disabled: Se.length === 0 },
              ...
              { label: "Help: Show Agent Team", detail: "Open the Atomek Resource Fabric landing page", run: () => {
                W(null), ve(!1), h("computer"), v(!0);
              } },
              { label: "View: Toggle Primary Side Bar", detail: p ? "Hide Explorer side bar" : "Show Explorer side bar", run: () => v((l) => !l) },
              { label: "View: Toggle Chat Panel", detail: R ? "Hide right AI side bar" : "Show right AI side bar", run: () => Z((l) => !l) },
              { label: "View: Toggle Bottom Panel", detail: we ? "Hide Problems/Output/Terminal panel" : "Show Problems/Output/Terminal panel", run: () => j((l) => !l) },
              { label: "Atomek: Open Settings", detail: "Open settings as an editor tab", run: Dt },
              { label: "Checks: Open Manual Check Panel", detail: "Capture copy/paste check commands without host execution", run: () => Lt("Manual check requested from command palette") },
              { label: "View: Toggle Markdown Preview", detail: D?.language === "markdown" ? "Show or hide Markdown preview split" : "Available for Markdown files", run: () => be((l) => !l), disabled: D?.language !== "markdown" },
              { label: "Atomek: Create AI Synthesis", detail: D || Se.length > 0 ? "Ask AIL to produce a saved Markdown artifact" : "Open a file first", run: vn, disabled: !D && Se.length === 0 },
              { label: "AI: Explain Active File", detail: D ? `Ask Cortex to explain ${D.path}` : "Open a file first", run: () => Ce("Explain the active file. Focus on purpose, structure, risks, and next useful edits."), disabled: !D },
              { label: "AI: Improve Active File", detail: D ? `Ask Cortex for concrete edits to ${D.path}` : "Open a file first", run: () => Ce("Review the active file and propose the smallest concrete improvements. Include exact snippets if useful."), disabled: !D },
              { label: "AI: Draft Editable Replacement", detail: D ? `Ask Cortex for a full-file replacement for ${D.path}` : "Open a file first", run: () => fa("edit"), disabled: !D },
              { label: "AI: Plan Workspace Work", detail: Se.length > 0 ? "Use open editors as bounded context" : "Open files first", run: () => Ce("Create an implementation plan from the open editor context. Be specific and sequence the work."), disabled: Se.length === 0 },
              { label: "AI: Save Active File as Artifact", detail: D ? "Persist active file in host.ai artifacts" : "Open a file first", run: Qr, disabled: !D },
              { label: "AI: Capture Manual Check Output", detail: "Paste check output as an auditable local artifact; no shell execution", run: wn },
              { label: "AI: Open Latest Artifact as File", detail: tt[0] ? `Create editable file from ${tt[0].title}` : "No outputs yet", run: () => tt[0] && gn(tt[0]), disabled: tt.length === 0 }
            ],
            openWorkbenchFile: pe,
            onClose: () => De(!1)
          }
        ...
        /* @__PURE__ */ r(pc, { status: Mr, file: D ?? zl, cursor: V, fileCount: O.length, dirtyCount: Xe.length })
      ]
    }
  );
}
function Dl({ active: e, setActive: t, togglePrimary: n, openSettings: a, settingsActive: s }) {
  return /* @__PURE__ */ u("aside", { className: "workbench-activity-bar", "aria-label": "Activity Bar", children: [
    /* @__PURE__ */ r("button", { className: "workbench-activity-brand", title: "Toggle side bar", "aria-label": "Toggle side bar", onClick: n, children: /* @__PURE__ */ r(pr, { size: 30, variant: "cream" }) }),
    /* @__PURE__ */ r(pt, { icon: /* @__PURE__ */ r(Va, { size: 25 }), label: "Explorer", active: e === "explorer", onClick: () => t("explorer") }),
    /* @__PURE__ */ r(pt, { icon: /* @__PURE__ */ r(Fs, { size: 25 }), label: "Search", active: e === "search", onClick: () => t("search") }),
    /* @__PURE__ */ r(pt, { icon: /* @__PURE__ */ r(Da, { size: 25 }), label: "Source Control", active: e === "source-control", onClick: () => t("source-control") }),
    /* @__PURE__ */ r(pt, { icon: /* @__PURE__ */ r(Wa, { size: 25 }), label: "Run and Debug", active: e === "run", onClick: () => t("run") }),
    /* @__PURE__ */ r(pt, { icon: /* @__PURE__ */ r(Rn, { size: 25 }), label: "Agent Team", active: e === "computer", onClick: () => t("computer") }),
    /* @__PURE__ */ r("div", { className: "workbench-activity-spacer" }),
    /* @__PURE__ */ r(pt, { icon: /* @__PURE__ */ r(Ys, { size: 23 }), label: "Settings", active: s, onClick: a })
  ] });
}
function pt({ icon: e, label: t, active: n, onClick: a }) {
  return /* @__PURE__ */ r("button", { className: `workbench-activity-button ${n ? "active" : ""}`, title: t, "aria-label": t, onClick: a, children: e });
}
function Fl(e) {
  return e.activity === "search" ? /* @__PURE__ */ r(Ul, { files: e.files, query: e.query, setQuery: e.setQuery, openWorkbenchFile: e.openWorkbenchFile, activeFileId: e.activeFileId }) : e.activity === "source-control" ? /* @__PURE__ */ r(Ha, { title: "SOURCE CONTROL", body: "No source control provider registered. Git belongs here, not as a fake demo." }) : e.activity === "run" ? /* @__PURE__ */ r(Ha, { title: "RUN AND DEBUG", body: "Run configurations, terminals, and recipe execution will plug into this surface later." }) : e.activity === "computer" ? /* @__PURE__ */ r(Cr, { host: e.host, setStatus: e.setStatus, attachSkillToChat: e.attachSkillToChat, saveLocalJobOutput: e.saveLocalJobOutput, activeFile: e.activeFile, openEditors: e.openEditors }) : /* @__PURE__ */ r(Rl, { ...e });
}
function Rl(e) {
  const t = !e.folder, n = ue(() => El(e.files, e.folder?.name), [e.files, e.folder?.name]), [a, s] = z(() => /* @__PURE__ */ new Set());
  re(() => {
    const o = Xr(n);
    s((c) => {
      const h = new Set(c);
      return o.forEach((p) => h.add(p)), h;
    });
  }, [n]);
  const i = N((o) => {
    s((c) => {
  ...
  return /* @__PURE__ */ u("aside", { className: "workbench-sidebar", children: [
    ...
    /* @__PURE__ */ u("div", { className: "workbench-sidebar-scroll", children: [
      t ? /* @__PURE__ */ u(Re, { children: [
        ...
        /* @__PURE__ */ r("button", { className: "workbench-button-blue", onClick: () => e.recent[0] ? void e.reopenRecent(e.recent[0]) : e.setStatus("No recent local workspace yet."), children: "Open Recent" }),
        ...
        /* @__PURE__ */ u("div", { className: "workbench-sidebar-actions", children: [
          /* @__PURE__ */ u("button", { className: "workbench-button-subtle", onClick: e.openFile, children: [
            /* @__PURE__ */ r(Yn, { size: 14 }),
            "Open File"
          ] }),
          /* @__PURE__ */ u("button", { className: "workbench-button-subtle", onClick: e.openFolder, children: [
            /* @__PURE__ */ r(Jn, { size: 14 }),
            "Open Folder"
          ] })
        ] }),
        /* @__PURE__ */ r("input", { className: "workbench-input", value: e.query, onChange: (o) => e.setQuery(o.target.value), placeholder: "Search files" }),
        /* @__PURE__ */ u("div", { className: "workbench-section-title", children: [
          /* @__PURE__ */ r(an, { size: 12 }),
          " Open Editors"
        ] }),
        e.openEditors.length === 0 ? /* @__PURE__ */ r("p", { className: "workbench-muted", children: "No open editors" }) : e.openEditors.map((o) => /* @__PURE__ */ r(ta, { file: o, active: o.id === e.activeFileId, onOpen: () => e.openWorkbenchFile(o), label: o.name, detail: o.path }, o.id)),
        /* @__PURE__ */ u("div", { className: "workbench-section-title", children: [
          /* @__PURE__ */ r(an, { size: 12 }),
          " ",
          e.folder?.name ?? "Workspace"
        ] }),
        n.length === 0 ? /* @__PURE__ */ r("p", { className: "workbench-muted", children: "No readable text files found." }) : Lr(n, e.activeFileId, e.openWorkbenchFile, a, i)
      ] }),
      /* @__PURE__ */ r("div", { className: "workbench-section-title", children: "Recent" }),
      e.recent.length === 0 ? /* @__PURE__ */ r("p", { className: "workbench-muted", children: "No recent folders yet." }) : e.recent.map((o) => /* @__PURE__ */ u("button", { className: "workbench-tree-row", onClick: () => {
        e.reopenRecent(o);
      }, title: o.path, children: [
        o.kind === "file" ? /* @__PURE__ */ r(qn, { size: 14 }) : /* @__PURE__ */ r(Ia, { size: 14 }),
        /* @__PURE__ */ r("span", { className: "workbench-row-name", children: o.name })
      ] }, `${o.path}-${o.at}`))
    ] })
  ] });
}
function ta({ file: e, active: t, onOpen: n, basePath: a, depth: s = 0, label: i, detail: o }) {
  const c = a && e.path.startsWith(`${a}/`) ? e.path.slice(a.length + 1) : e.path, h = s || Math.max(0, c.split("/").length - 1);
  return /* @__PURE__ */ u("button", { className: `workbench-file-row ${t ? "active" : ""}`, style: { "--workbench-depth": h }, onClick: n, title: e.path, children: [
    /* @__PURE__ */ r(qn, { size: 14 }),
    /* @__PURE__ */ u("span", { className: "workbench-row-text", children: [
      /* @__PURE__ */ r("span", { className: "workbench-row-name", children: i ?? c }),
      o ? /* @__PURE__ */ r("span", { className: "workbench-row-detail", children: o }) : null
    ] }),
    e.dirty && /* @__PURE__ */ r("span", { className: "workbench-row-meta", children: "●" })
  ] });
}
function El(e, t) {
  const n = [], a = /* @__PURE__ */ new Map(), s = (o, c, h = n) => {
    const p = a.get(o);
    if (p) return p;
    const v = { name: c, path: o, children: [] };
    return a.set(o, v), h.push(v), v;
  };
  e.forEach((o) => {
    const c = t && o.path.startsWith(`${t}/`) ? o.path.slice(t.length + 1) : o.path, h = c.split("/").filter(Boolean);
    let p = n, v = "";
    h.slice(0, -1).forEach((y) => {
      v = v ? `${v}/${y}` : y, p = s(v, y, p).children;
    }), p.push({ name: h.at(-1) ?? o.name, path: c, file: o, children: [] });
  });
  const i = (o) => o.sort((c, h) => +!!c.file - +!!h.file || c.name.localeCompare(h.name)).map((c) => ({ ...c, children: i(c.children) }));
  return i(n);
}
function Xr(e) {
  return e.flatMap((t) => t.file ? [] : [t.path, ...Xr(t.children)]);
}
function Lr(e, t, n, a, s, i = 0) {
  return e.map((o) => {
    if (o.file)
      return /* @__PURE__ */ r(ta, { file: o.file, active: o.file.id === t, onOpen: () => n(o.file), depth: i, label: o.name }, o.file.id);
    const c = a.has(o.path);
    return /* @__PURE__ */ u("div", { children: [
      /* @__PURE__ */ u("button", { className: "workbench-folder-row", style: { "--workbench-depth": i }, onClick: () => s(o.path), title: c ? `Collapse ${o.name}` : `Expand ${o.name}`, children: [
        c ? /* @__PURE__ */ r(an, { size: 12 }) : /* @__PURE__ */ r(an, { className: "workbench-chevron-collapsed", size: 12 }),
        c ? /* @__PURE__ */ r(Jn, { size: 14 }) : /* @__PURE__ */ r(Ia, { size: 14 }),
        /* @__PURE__ */ r("span", { className: "workbench-row-name", children: o.name }),
        /* @__PURE__ */ r("span", { className: "workbench-row-meta", children: o.children.length })
      ] }),
      c ? Lr(o.children, t, n, a, s, i + 1) : null
    ] }, o.path);
  });
}
function ql({ file: e, folder: t, showWelcome: n }) {
  const a = n ? ["Agent Team"] : e?.path.split("/").filter(Boolean) ?? [], s = t && a[0] === t.name ? a.slice(1) : a;
  return /* @__PURE__ */ r("div", { className: "workbench-breadcrumb", children: s.length === 0 ? /* @__PURE__ */ r("span", { children: "Workspace" }) : s.map((i, o) => /* @__PURE__ */ u("span", { className: "workbench-breadcrumb-part", children: [
    o > 0 && /* @__PURE__ */ r("span", { className: "workbench-breadcrumb-sep", children: "›" }),
    i
  ] }, `${i}-${o}`)) });
}
function Yl(e) {
  return /* @__PURE__ */ u("div", { className: "workbench-tabs", children: [
    e.showWelcome && /* @__PURE__ */ u("button", { className: "workbench-tab active", children: [
      /* @__PURE__ */ r(ln, { size: 15 }),
      /* @__PURE__ */ r("span", { className: "workbench-tab-name", children: "Agent Team" }),
      /* @__PURE__ */ r("span", { className: "workbench-tab-close", role: "button", tabIndex: 0, onClick: (t) => {
        t.stopPropagation(), e.closeWelcome();
      }, children: /* @__PURE__ */ r(Je, { size: 13 }) })
    ] }),
    e.settingsOpen && /* @__PURE__ */ u("button", { className: `workbench-tab ${e.settingsActive ? "active" : ""}`, onClick: e.openSettings, title: "Atomek Settings", children: [
      /* @__PURE__ */ r(Fa, { size: 15 }),
      /* @__PURE__ */ r("span", { className: "workbench-tab-name", children: "Atomek Settings" }),
      /* @__PURE__ */ r("span", { className: "workbench-tab-close", role: "button", tabIndex: 0, onClick: (t) => {
        t.stopPropagation(), e.closeSettings();
      }, children: /* @__PURE__ */ r(Je, { size: 13 }) })
    ] }),
    e.openEditors.map((t) => /* @__PURE__ */ u("button", { className: `workbench-tab ${t.id === e.activeFileId ? "active" : ""}`, onClick: () => e.setActiveFileId(t.id), title: t.path, children: [
      /* @__PURE__ */ r(qn, { size: 15 }),
    ...
    e.canPreview && /* @__PURE__ */ r("button", { className: `workbench-editor-action ${e.previewVisible ? "active" : ""}`, title: "Toggle Markdown Preview", onClick: e.togglePreview, children: /* @__PURE__ */ r(En, { size: 16 }) }),
    /* @__PURE__ */ r("button", { className: `workbench-editor-action ${e.secondaryVisible ? "active" : ""}`, title: "Toggle Chat", onClick: e.toggleSecondary, children: /* @__PURE__ */ r(js, { size: 16 }) })
  ] });
}
function Jl(e) {
  const t = e?.resources ?? [], n = (s) => t.filter((i) => i.kind === s).length, a = t.filter((s) => s.status === "ready" || s.status === "available").length;
  return [
    ...
    { label: "Ready resources", value: a, detail: "usable now" }
  ];
}
function Zl(e) {
  const t = {
  ...
  return [...e?.resources ?? []].sort((n, a) => (t[n.kind] ?? 9) - (t[a.kind] ?? 9) || Oe(n).localeCompare(Oe(a))).slice(0, 8);
}
function Kl({
  host: e,
  openFile: t,
  ...
  const [v, y] = z("Coordinate a Tytus mission across pods, local agents, shared folders, and app skills."), [k, m] = z(null), [A, R] = z([]), [Z, F] = z(!1), [ge, we] = z(null), [j, _] = z(null), [q, M] = z("pod-local"), be = N(async () => {
    F(!0), _(null);
    try {
      ...
      m(g ?? null), R(W), g && o(`Agent team loaded · ${g.resources.length} resources · ${g.warnings.length} warnings`);
    } catch (g) {
      const W = g instanceof Error ? g.message : String(g);
      _(W), o(`Agent team resource load failed: ${W}`);
    } finally {
      F(!1);
    }
  }, [e.missions, e.resources, o]), Y = N((g, W) => {
    try {
      e.windows.openOrFocus(g), o(`Opened ${W}`);
    } catch (x) {
      o(`Open ${W} failed: ${x instanceof Error ? x.message : String(x)}`);
    }
  }, [e.windows, o]);
  re(() => {
    be();
  ...
  const ve = N(async () => {
    ...
    const g = v.trim() || "Coordinate a Tytus mission.", W = ot(g, k, q);
    F(!0);
    try {
      const x = await e.missions.create({
        ...
        data: { resourceCount: k?.resources.length ?? 0 }
      };
      await e.missions.write({
        rootPath: x.rootPath,
        files: [
          { path: "MISSION.md", content: tn(L, k, null, [], g, W) },
          { path: "MISSION.json", content: zr(L, k, g, W) },
          { path: "RESOURCES.md", content: nn(k) },
          { path: "TASKS.md", content: Nr(Ht(g, k, W)) },
          { path: "HANDOFF.md", content: Tr(L) },
...
` },
          { path: "AUDIT.jsonl", content: `${JSON.stringify(V)}
` },
...
`) }
      ...
      }), we(x), St(L), o(`Mission created: ${x.rootPath}`), c();
    } catch (x) {
      o(`Mission create failed: ${x instanceof Error ? x.message : String(x)}`);
    } finally {
      F(!1);
    }
  }, [v, k, e.missions, c, o, q]), fe = Jl(k), He = Sl(k), We = Cl(k), je = Zl(k), O = k?.warnings ?? [], oe = jl(k), Pe = xt(k, ot(v, k, q)), he = Ht(v, k, Pe.id);
  return /* @__PURE__ */ u("div", { className: "workbench-welcome workbench-control-home", children: [
    /* @__PURE__ */ u("section", { className: "workbench-control-hero-main", children: [
      /* @__PURE__ */ u("div", { className: "workbench-brand-lockup", "aria-label": "Atomek", children: [
        /* @__PURE__ */ r(pr, { size: 74, variant: "acid" }),
        /* @__PURE__ */ u("div", { children: [
          /* @__PURE__ */ r(bl, { className: "workbench-brand-wordmark" }),
          /* @__PURE__ */ r("div", { className: "workbench-control-kicker", children: "Resource Fabric / Agent Team" })
        ] })
      ] }),
      /* @__PURE__ */ r("h1", { children: "Split the mission. Ship the build." }),
      /* @__PURE__ */ r("p", { children: "Atomek is the Tytus control surface for OpenClaw, Hermes, local AI agents, shared folders, pods, local apps, files, outputs, and approval-gated handoffs around one durable mission folder." }),
      /* @__PURE__ */ u("div", { className: "workbench-control-goal-row", children: [
        /* @__PURE__ */ r("textarea", { value: v, onChange: (g) => y(g.target.value), rows: 3, "aria-label": "Mission goal" }),
        /* @__PURE__ */ u("div", { className: "workbench-control-hero-actions", children: [
          /* @__PURE__ */ r("button", { className: "workbench-button-primary", onClick: () => {
            ve();
          }, disabled: Z, children: "Start mission" }),
          /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: c, children: "Open team board" }),
          /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: h, children: "Open chat" })
        ] })
      ] }),
      /* @__PURE__ */ r("div", { className: "workbench-team-preset-strip", "aria-label": "Team presets", children: oe.map((g) => /* @__PURE__ */ u(
        "button",
        {
          className: `workbench-team-preset-card ${g.id === Pe.id ? "active" : ""} ${g.readiness}`,
          onClick: () => M(g.id),
          children: [
            /* @__PURE__ */ u("div", { children: [
              /* @__PURE__ */ r("strong", { children: g.label }),
              /* @__PURE__ */ r("span", { children: g.readiness })
            ] }),
            /* @__PURE__ */ r("p", { children: g.summary }),
            /* @__PURE__ */ r("small", { children: g.assignments.map((W) => W.resourceLabel).slice(0, 3).join(" · ") })
          ]
        },
        g.id
      )) }),
      ge ? /* @__PURE__ */ u("div", { className: "workbench-control-success", children: [
        "Mission ready: ",
        /* @__PURE__ */ r("code", { children: ge.rootPath })
      ] }) : null,
      j ? /* @__PURE__ */ r("div", { className: "workbench-inline-error", children: j }) : null
    ] }),
    /* @__PURE__ */ u("section", { className: "workbench-control-grid", children: [
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        /* @__PURE__ */ u("header", { children: [
          /* @__PURE__ */ r("strong", { children: "System inventory" }),
          /* @__PURE__ */ u("button", { className: "workbench-button-subtle", onClick: () => {
            be();
          }, disabled: Z, children: [
            /* @__PURE__ */ r(yt, { size: 13 }),
            " ",
            Z ? "Refreshing…" : "Refresh"
          ] })
        ] }),
        /* @__PURE__ */ r("div", { className: "workbench-control-metrics", children: fe.map((g) => /* @__PURE__ */ u("div", { className: "workbench-control-metric", children: [
          /* @__PURE__ */ r("strong", { children: g.value }),
          /* @__PURE__ */ r("span", { children: g.label }),
          /* @__PURE__ */ r("em", { children: g.detail })
        ] }, g.label)) })
      ] }),
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        /* @__PURE__ */ u("header", { children: [
          /* @__PURE__ */ r("strong", { children: "Agent team" }),
          /* @__PURE__ */ r("span", { children: "OpenClaw + Hermes are first-class" })
        ] }),
        /* @__PURE__ */ r("div", { className: "workbench-agent-brand-grid", children: He.map((g) => /* @__PURE__ */ u("div", { className: `workbench-agent-brand-card ${g.status.replace(/\s+/g, "-")}`, children: [
          /* @__PURE__ */ u("div", { children: [
            /* @__PURE__ */ r("strong", { children: g.label }),
            /* @__PURE__ */ r("span", { children: g.status })
          ] }),
          /* @__PURE__ */ r("b", { children: g.value }),
          /* @__PURE__ */ r("p", { children: g.detail })
        ] }, g.label)) })
      ] }),
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        /* @__PURE__ */ u("header", { children: [
          /* @__PURE__ */ r("strong", { children: "Docs & Skills" }),
          /* @__PURE__ */ r("span", { children: "open a guide as a markdown tab, then ask chat about it" })
        ] }),
        /* @__PURE__ */ r("div", { className: "workbench-doc-grid", children: Pl.map((g) => /* @__PURE__ */ u("button", { className: "workbench-doc-card", onClick: () => p(g), title: g.summary, children: [
          /* @__PURE__ */ r("strong", { children: g.title }),
          /* @__PURE__ */ r("p", { children: g.summary }),
          /* @__PURE__ */ r("small", { children: g.tags.join(" · ") })
        ] }, g.id)) })
      ] }),
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        /* @__PURE__ */ u("header", { children: [
          /* @__PURE__ */ r("strong", { children: "Tytus Resource Fabric" }),
          /* @__PURE__ */ r("span", { children: "local computer ↔ shared folders ↔ pods ↔ apps" })
        ] }),
        /* @__PURE__ */ r("div", { className: "workbench-fabric-flow", children: We.map((g, W) => /* @__PURE__ */ u("div", { className: `workbench-fabric-node ${g.status.replace(/\s+/g, "-")}`, children: [
          /* @__PURE__ */ r("span", { children: W + 1 }),
          /* @__PURE__ */ r("strong", { children: g.label }),
          /* @__PURE__ */ r("em", { children: g.status }),
          /* @__PURE__ */ r("p", { children: g.detail })
        ] }, g.label)) }),
        /* @__PURE__ */ u("div", { className: "workbench-fabric-actions", children: [
          /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: () => Y(qt.sharedFiles, "Shared Files"), children: "Open shared files" }),
          /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: () => Y(qt.podInspector, "Pod Inspector"), children: "Open pods" }),
          /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: () => Y(qt.channels, "Channels"), children: "Open channels" }),
          /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: () => Y(qt.settings, "Agent Settings"), children: "Open agent settings" })
        ] })
      ] }),
      /* @__PURE__ */ u("article", { className: "workbench-control-card", children: [
        /* @__PURE__ */ r("header", { children: /* @__PURE__ */ r("strong", { children: "First missions" }) }),
        /* @__PURE__ */ r("button", { className: "workbench-control-preset", onClick: () => y("Review this repo with local OpenCode/Claude, then ask Codex or pi for an independent review. Save all transcripts and proposed patches in the mission folder."), children: "Review + patch repo" }),
        /* @__PURE__ */ r("button", { className: "workbench-control-preset", onClick: () => y("Ask OpenClaw for independent critique, use Hermes when allocated for deep planning/copy, then run local Claude/OpenCode/Codex for implementation. Keep shared context in the mission folder and approval-gate all edits."), children: "OpenClaw/Hermes + local agent" }),
        /* @__PURE__ */ r("button", { className: "workbench-control-preset", onClick: () => y("Coordinate creative output: script, audio, visuals, render assets, and final handoff through app skills and shared folders."), children: "Creative production" })
      ] }),
      /* @__PURE__ */ u("article", { className: "workbench-control-card", children: [
        /* @__PURE__ */ u("header", { children: [
          /* @__PURE__ */ r("strong", { children: "Resume" }),
          /* @__PURE__ */ r("span", { children: A.length ? `${A.length} missions` : "none yet" })
        ] }),
        A.length === 0 ? /* @__PURE__ */ r("p", { className: "workbench-muted", children: "Create a mission once; it stays in Tytus Home/Missions and can be resumed here." }) : null,
        A.slice(0, 4).map((g) => /* @__PURE__ */ u("button", { className: "workbench-control-preset", onClick: () => {
          St(g), c();
      ...
      /* @__PURE__ */ u("article", { className: "workbench-control-card", children: [
        /* @__PURE__ */ r("header", { children: /* @__PURE__ */ r("strong", { children: "Workspace" }) }),
        /* @__PURE__ */ u("button", { className: "workbench-start-link", onClick: n, children: [
          /* @__PURE__ */ r(Jn, { size: 18 }),
          "Open workspace folder"
        ] }),
        /* @__PURE__ */ u("button", { className: "workbench-start-link", onClick: t, children: [
          /* @__PURE__ */ r(Va, { size: 18 }),
          "Open file"
        ] }),
        /* @__PURE__ */ u("button", { className: "workbench-start-link", onClick: a, children: [
          /* @__PURE__ */ r(Yn, { size: 18 }),
          "New mission note"
        ] }),
        s.length ? /* @__PURE__ */ u("div", { className: "workbench-control-recent", children: [
          /* @__PURE__ */ r("span", { children: "Recent" }),
          s.slice(0, 3).map((g) => /* @__PURE__ */ r("button", { onClick: () => {
            i(g);
      ...
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        /* @__PURE__ */ u("header", { children: [
          /* @__PURE__ */ r("strong", { children: "Resource graph" }),
          /* @__PURE__ */ r("span", { children: k ? `${k.resources.length} discovered` : "not loaded" })
        ] }),
        /* @__PURE__ */ u("div", { className: "workbench-control-resource-list", children: [
          je.length === 0 ? /* @__PURE__ */ r("p", { className: "workbench-muted", children: "No resource graph yet. Start Tytus tray beta30 or newer, then refresh." }) : null,
          je.map((g) => /* @__PURE__ */ u("div", { className: "workbench-control-resource", children: [
            /* @__PURE__ */ u("div", { children: [
              /* @__PURE__ */ r("strong", { children: Oe(g) }),
              /* @__PURE__ */ r("span", { children: ea(g) })
            ] }),
            /* @__PURE__ */ r("span", { className: `workbench-computer-pill ${g.status}`, children: g.status })
          ] }, g.id))
        ] }),
        O.length ? /* @__PURE__ */ r("div", { className: "workbench-resource-warnings", children: O.slice(0, 2).map((g) => /* @__PURE__ */ u("span", { children: [
          g.code,
          ": ",
          g.message
      ...
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        /* @__PURE__ */ r("header", { children: /* @__PURE__ */ r("strong", { children: "Recommended task graph" }) }),
        /* @__PURE__ */ r("div", { className: "workbench-task-graph home", children: he.map((g, W) => /* @__PURE__ */ u("button", { className: `workbench-task-card ${g.status}`, onClick: () => y(g.prompt), children: [
          /* @__PURE__ */ r("span", { children: W + 1 }),
          /* @__PURE__ */ r("strong", { children: g.title }),
          /* @__PURE__ */ r("em", { children: g.resourceHint }),
          /* @__PURE__ */ r("small", { children: g.assignedResourceLabel })
        ] }, g.id)) })
      ] }),
      /* @__PURE__ */ u("article", { className: "workbench-control-card wide", children: [
        /* @__PURE__ */ r("header", { children: /* @__PURE__ */ r("strong", { children: "Control loop" }) }),
        /* @__PURE__ */ u("ol", { className: "workbench-control-loop", children: [
          /* @__PURE__ */ u("li", { children: [
            /* @__PURE__ */ r("b", { children: "Mission" }),
            /* @__PURE__ */ r("span", { children: "Goal + shared context folder." })
          ] }),
          /* @__PURE__ */ u("li", { children: [
            /* @__PURE__ */ r("b", { children: "Resources" }),
            /* @__PURE__ */ r("span", { children: "Pods, local agents, folders, app skills." })
          ] }),
          /* @__PURE__ */ u("li", { children: [
            /* @__PURE__ */ r("b", { children: "Tasks" }),
            /* @__PURE__ */ r("span", { children: "Plan, implement, review, render, validate." })
          ] }),
          /* @__PURE__ */ u("li", { children: [
            /* @__PURE__ */ r("b", { children: "Runs" }),
            /* @__PURE__ */ u("span", { children: [
              "Streams + transcripts saved under ",
              /* @__PURE__ */ r("code", { children: "runs/" }),
              "."
            ] })
          ] }),
          /* @__PURE__ */ u("li", { children: [
            /* @__PURE__ */ r("b", { children: "Approvals" }),
            /* @__PURE__ */ r("span", { children: "Diffs/artifacts applied only after preview." })
          ] })
        ] })
      ] })
    ] })
...
function Ul({ files: e, query: t, setQuery: n, openWorkbenchFile: a, activeFileId: s }) {
  const i = ue(() => Bl(e, t), [e, t]), o = ue(() => {
    const c = /* @__PURE__ */ new Map();
    return i.forEach((h) => c.set(h.file.id, [...c.get(h.file.id) ?? [], h])), Array.from(c.values()).slice(0, 50);
  }, [i]);
  return /* @__PURE__ */ u("aside", { className: "workbench-sidebar", children: [
    /* @__PURE__ */ r("div", { className: "workbench-sidebar-title", children: "SEARCH" }),
    /* @__PURE__ */ u("div", { className: "workbench-sidebar-scroll", children: [
      /* @__PURE__ */ r("input", { className: "workbench-input", value: t, onChange: (c) => n(c.target.value), placeholder: "Search files and text", autoFocus: !0 }),
      /* @__PURE__ */ u("div", { className: "workbench-section-title", children: [
        /* @__PURE__ */ r(ln, { size: 12 }),
        " Results"
      ] }),
      t.trim() ? o.length === 0 ? /* @__PURE__ */ r("p", { className: "workbench-muted", children: "No matches." }) : o.map((c) => {
        const h = c[0].file;
        return /* @__PURE__ */ u("div", { className: "workbench-search-group", children: [
          /* @__PURE__ */ r(ta, { file: h, active: h.id === s, onOpen: () => a(h) }),
          c.slice(0, 5).map((p) => /* @__PURE__ */ u("button", { className: "workbench-search-hit", onClick: () => a(h, p.lineNumber), title: p.line, children: [
            /* @__PURE__ */ r("span", { className: "workbench-search-line", children: p.lineNumber }),
            /* @__PURE__ */ r("span", { children: p.line })
          ] }, `${h.id}-${p.lineNumber}-${p.line}`)),
          c.length > 5 && /* @__PURE__ */ u("div", { className: "workbench-search-more", children: [
            "+",
            c.length - 5,
            " more matches"
          ] })
...
function Bl(e, t) {
  ...
  const a = [];
  return e.forEach((s) => {
    s.path.toLowerCase().includes(n) && a.push({ file: s, lineNumber: 1, line: s.path }), s.content.split(`
`).some((i, o) => i.toLowerCase().includes(n) ? (a.push({ file: s, lineNumber: o + 1, line: i.trim() || "(blank line)" }), a.length >= 200) : !1);
  }), a.slice(0, 200);
}
function Gl(e) {
  const t = e.query.trim().toLowerCase(), n = e.files.slice(0, 80).map((s) => ({
    label: s.path,
    detail: `Open ${qa(s.language)} file`,
    run: () => e.openWorkbenchFile(s)
  })), a = [...e.commands, ...n].filter((s) => !t || s.label.toLowerCase().includes(t) || s.detail.toLowerCase().includes(t)).slice(0, 12);
  return re(() => {
    const s = (i) => {
      i.key === "Escape" && e.onClose();
    };
    return window.addEventListener("keydown", s), () => window.removeEventListener("keydown", s);
  }, [e.onClose]), /* @__PURE__ */ r("div", { className: "workbench-command-overlay", role: "dialog", "aria-label": "Command Palette", children: /* @__PURE__ */ u("div", { className: "workbench-command-palette", children: [
    /* @__PURE__ */ r(
      "input",
      {
        ...
        autoFocus: !0,
        value: e.query,
        onChange: (s) => e.setQuery(s.target.value),
        placeholder: "Type a command or file name...",
        onKeyDown: (s) => {
          s.key === "Enter" && a[0] && !a[0].disabled && (a[0].run(), e.onClose());
        }
      }
    ),
    /* @__PURE__ */ r("div", { className: "workbench-command-list", children: a.map((s) => /* @__PURE__ */ u(
      "button",
      {
        disabled: s.disabled,
        ...
        children: [
          ...
          /* @__PURE__ */ r("small", { children: s.detail })
        ]
      },
      `${s.label}-${s.detail}`
    )) })
...
function $l(e) {
  const t = e.session ? rl(e.session) : "pending";
  return /* @__PURE__ */ u("div", { className: "workbench-manual-check-panel", children: [
    ...
    e.session ? /* @__PURE__ */ u(Re, { children: [
      ...
      /* @__PURE__ */ u("div", { className: "workbench-manual-check-grid", children: [
        /* @__PURE__ */ u("section", { children: [
          ...
          /* @__PURE__ */ r("div", { className: "workbench-check-command-list", children: e.session.commands.map((n) => /* @__PURE__ */ u(
            "button",
            {
      ...
      e.session.results.length > 0 ? /* @__PURE__ */ u("div", { className: "workbench-check-results", children: [
        ...
        e.session.results.map((n, a) => /* @__PURE__ */ u("article", { children: [
...
function _l(e) {
  return /* @__PURE__ */ u("section", { className: "workbench-bottom-panel", "aria-label": "Panel", children: [
    /* @__PURE__ */ u("div", { className: "workbench-bottom-tabs", children: [
      ...
      /* @__PURE__ */ r("span", {}),
      /* @__PURE__ */ r("button", { title: "Close Panel", onClick: e.onClose, children: /* @__PURE__ */ r(Je, { size: 14 }) })
    ] }),
    /* @__PURE__ */ u("div", { className: "workbench-bottom-body", children: [
      ...
      e.tab === "output" && /* @__PURE__ */ r(Sr, { outputs: e.outputs, clearOutputs: e.clearOutputs, deleteArtifact: e.deleteArtifact, runAiSynthesis: e.runAiSynthesis, captureManualCheck: e.captureManualCheck, openOutputAsFile: e.openOutputAsFile, compact: !0 })
    ] })
  ] });
}
function ec(e) {
  return /* @__PURE__ */ u("aside", { className: "workbench-secondary", children: [
    ...
    /* @__PURE__ */ u("div", { className: "workbench-secondary-tabs", children: [
      /* @__PURE__ */ u("div", { className: "workbench-secondary-tab-group", children: [
        ...
        /* @__PURE__ */ r("button", { className: `workbench-secondary-tab ${e.tab === "agents" ? "active" : ""}`, onClick: () => e.setTab("agents"), children: "AGENTS" }),
      ...
      /* @__PURE__ */ u("div", { className: "workbench-secondary-actions", children: [
        /* @__PURE__ */ r("button", { title: "New Chat", onClick: e.newChat, children: /* @__PURE__ */ r(Vs, { size: 15 }) }),
        /* @__PURE__ */ r("button", { title: "Chat Settings", onClick: e.openSettings, children: /* @__PURE__ */ r(Ps, { size: 16 }) }),
        /* @__PURE__ */ r("button", { title: "Close Chat", onClick: e.onClose, children: /* @__PURE__ */ r(Je, { size: 15 }) })
      ] })
    ] }),
    e.tab === "chat" ? /* @__PURE__ */ r(tc, { ...e }) : e.tab === "agents" ? /* @__PURE__ */ r(
      Cr,
      {
        host: e.host,
    ...
    ) : /* @__PURE__ */ r(Sr, { outputs: e.outputs, clearOutputs: e.clearOutputs, deleteArtifact: e.deleteArtifact, runAiSynthesis: e.runAiSynthesis, captureManualCheck: e.captureManualCheck, openOutputAsFile: e.openOutputAsFile, previewEditFromOutput: e.previewEditFromOutput, canPreviewEdit: e.canPreviewEdit })
  ] });
}
function Ar({ body: e }) {
  const t = ue(() => Ll(e), [e]), [n, a] = z(null), s = N((i, o) => {
    (async () => await kt(o) && (a(i), window.setTimeout(() => a((h) => h === i ? null : h), 1200)))();
  }, []);
    ...
    if (i.type === "code") {
      ...
      return /* @__PURE__ */ u("div", { className: "workbench-rich-code", children: [
        /* @__PURE__ */ u("div", { className: "workbench-rich-code-head", children: [
          ...
          /* @__PURE__ */ u("button", { onClick: () => s(i.key, i.body), title: "Copy code block", children: [
            o ? /* @__PURE__ */ r(ys, { size: 12 }) : /* @__PURE__ */ r(jn, { size: 12 }),
            o ? "Copied" : "Copy"
          ] })
        ] }),
        /* @__PURE__ */ r("pre", { children: /* @__PURE__ */ r("code", { children: i.body }) })
      ] }, i.key);
    }
    return /* @__PURE__ */ r(
      "div",
      {
        ...
        dangerouslySetInnerHTML: { __html: Ka(i.body) }
      },
      i.key
    );
  }) });
...
function tc(e) {
  const t = e.selectedChatTarget.available, n = e.selectedChatTarget.kind === "atomek-ai", a = e.chatInput.trim().length > 0 && !e.busy && t, s = it(null), [i, o] = z(!0), [c, h] = z(!1), p = ue(() => e.chatMessages.map((m) => `${m.id}:${m.status ?? ""}:${m.body.length}`).join("|"), [e.chatMessages]);
  re(() => {
    const m = s.current;
    m && (i ? (m.scrollTop = m.scrollHeight, h(!1)) : h(!0));
  }, [i, p]);
  const v = N(() => {
    const m = s.current;
    if (!m) return;
    const R = m.scrollHeight - m.scrollTop - m.clientHeight < 48;
    o(R), R && h(!1);
  }, []), y = N(() => {
    const m = s.current;
    m && (m.scrollTop = m.scrollHeight, o(!0), h(!1));
  }, []), k = N((m) => {
    kt(m.body);
  }, []);
  return /* @__PURE__ */ u("div", { className: "workbench-chat-wrap", children: [
    /* @__PURE__ */ u("div", { className: "workbench-chat-threadbar", children: [
      n ? /* @__PURE__ */ u(
        "select",
        {
          ...
          onChange: (m) => e.selectThread(m.target.value),
          ...
          children: [
            ...
            e.chatThreads.map((m) => /* @__PURE__ */ u("option", { value: m.id, children: [
              m.title,
              " · ",
              nc(m.lastMessageAt ?? m.updatedAt)
            ] }, m.id))
          ]
        }
      ) : /* @__PURE__ */ u("span", { className: "workbench-chat-route-summary", children: [
        e.selectedChatTarget.label,
        " session"
      ] }),
      /* @__PURE__ */ r(
        "select",
        {
          value: e.selectedChatTarget.id,
          onChange: (m) => e.selectChatTarget(m.target.value),
          disabled: e.busy,
          title: "Select chat target",
          children: e.chatTargets.map((m) => /* @__PURE__ */ u("option", { value: m.id, disabled: !m.available, children: [
            m.label,
            m.kind === "pod-agent" && m.status !== "running" ? ` · ${m.status}` : ""
          ] }, m.id))
        }
      ),
      n ? /* @__PURE__ */ u(Re, { children: [
        /* @__PURE__ */ r(
          "button",
          {
            onClick: () => {
              if (!e.chatThread) return;
              const m = window.prompt("Rename chat", e.chatThread.title);
              m !== null && e.renameThread(e.chatThread.id, m);
            },
    ...
    /* @__PURE__ */ u("div", { ref: s, className: "workbench-chat-transcript", onScroll: v, children: [
      e.chatMessages.length === 0 ? /* @__PURE__ */ r("div", { className: "workbench-chat-empty", children: /* @__PURE__ */ u("div", { children: [
        /* @__PURE__ */ r(Cs, { size: 48 }),
        /* @__PURE__ */ u("h3", { children: [
          "Build with ",
          e.selectedChatTarget.label
        ] }),
        /* @__PURE__ */ r("p", { children: e.selectedChatTarget.kind === "atomek-ai" ? "Ask about open files, request a plan, or draft an artifact." : "Chat with the selected pod agent from this same Atomek panel." }),
      ...
      ] }) }) : e.chatMessages.map((m) => /* @__PURE__ */ u("div", { className: `workbench-chat-message ${m.role}`, children: [
        /* @__PURE__ */ r("strong", { children: m.role === "user" ? "You" : m.sourceLabel ?? "Atomek" }),
        m.status === "streaming" ? /* @__PURE__ */ r("em", { children: " streaming" }) : null,
        m.status === "error" ? /* @__PURE__ */ r("em", { children: " error" }) : null,
        /* @__PURE__ */ r("br", {}),
        /* @__PURE__ */ r(Ar, { body: m.body }),
        m.gatewayLabel ? /* @__PURE__ */ u(Re, { children: [
          /* @__PURE__ */ r("br", {}),
          /* @__PURE__ */ r("small", { children: m.gatewayLabel })
        ] }) : null,
        m.role === "assistant" && m.status !== "streaming" && m.status !== "error" ? /* @__PURE__ */ u("div", { className: "workbench-chat-message-actions", children: [
          /* @__PURE__ */ u("button", { className: "workbench-chat-message-action", onClick: () => k(m), title: "Copy this answer", children: [
            /* @__PURE__ */ r(jn, { size: 12 }),
            " Copy"
          ] }),
          /* @__PURE__ */ u("button", { className: "workbench-chat-message-action", onClick: () => e.saveMessageAsArtifact(m), title: "Save this answer as an output artifact", children: [
            /* @__PURE__ */ r(Yn, { size: 12 }),
            " Save"
          ] }),
          /* @__PURE__ */ u("button", { className: "workbench-chat-message-action", onClick: () => e.rememberMessage(m), title: "Store this answer in Atomek memory", children: [
            /* @__PURE__ */ r(Da, { size: 12 }),
            " Remember"
          ] }),
          /* @__PURE__ */ u("button", { className: "workbench-chat-message-action", onClick: () => e.previewEditFromMessage(m), disabled: e.workspaceFileCount === 0, title: "Preview an editable patch from this answer", children: [
            /* @__PURE__ */ r(En, { size: 12 }),
            " Preview"
          ] }),
          /* @__PURE__ */ u("button", { className: "workbench-chat-message-action regen", onClick: () => e.regenerateMessage(m), disabled: e.busy, title: "Regenerate this answer", children: [
            /* @__PURE__ */ r(yt, { size: 12 }),
            " Regenerate"
          ] })
        ] }) : null,
        m.role === "assistant" && m.status === "error" ? /* @__PURE__ */ u("div", { className: "workbench-chat-message-actions", children: [
          /* @__PURE__ */ u("button", { className: "workbench-chat-message-action", onClick: () => k(m), title: "Copy this error", children: [
            /* @__PURE__ */ r(jn, { size: 12 }),
            " Copy"
          ] }),
          /* @__PURE__ */ u("button", { className: "workbench-chat-message-action regen", onClick: () => e.regenerateMessage(m), disabled: e.busy, children: [
            /* @__PURE__ */ r(yt, { size: 12 }),
            " Retry"
          ] })
        ] }) : null
      ] }, m.id)),
      c ? /* @__PURE__ */ r("button", { className: "workbench-chat-jump", onClick: y, children: "Jump to latest" }) : null
    ] }),
    /* @__PURE__ */ u("div", { className: "workbench-chat-composer", children: [
      /* @__PURE__ */ u("div", { className: "workbench-chat-tip", children: [
        /* @__PURE__ */ r("span", { children: "Target" }),
        /* @__PURE__ */ r("strong", { children: e.selectedChatTarget.label }),
        /* @__PURE__ */ r("em", { children: e.selectedChatTarget.kind === "atomek-ai" ? Oa(e.chatSettings, e.aiStatus.label, e.memoryHitCount) : e.selectedChatTarget.description }),
        /* @__PURE__ */ r("span", { children: "Context" }),
        /* @__PURE__ */ r("strong", { children: Ci(e.contextScope) })
      ] }),
      /* @__PURE__ */ u("div", { className: "workbench-chat-box", children: [
        /* @__PURE__ */ u("div", { className: "workbench-chat-attachments", children: [
          /* @__PURE__ */ u(
            "select",
            {
              ...
              onChange: (m) => e.setContextScope(m.target.value),
              disabled: e.busy,
          ...
          e.contextScope === "indexed-project" ? /* @__PURE__ */ u(Re, { children: [
          ...
          e.contextAttachments.length === 0 ? /* @__PURE__ */ u("span", { className: "workbench-chat-chip muted", children: [
            /* @__PURE__ */ r(ma, { size: 13 }),
            " No file context"
          ] }) : e.contextAttachments.map((m) => {
            const A = typeof m.score == "number" ? m.score.toFixed(2) : null, R = typeof m.vectorScore == "number" ? m.vectorScore.toFixed(2) : null, Z = typeof m.keywordScore == "number" ? m.keywordScore.toFixed(1) : null, F = [
              m.path,
              m.range ? `${m.range.startLineNumber}:${m.range.startColumn}-${m.range.endLineNumber}:${m.range.endColumn}` : null,
              A ? `score ${A}` : null,
              R ? `vector ${R}` : null,
              Z ? `keyword ${Z}` : null,
              m.snippet,
            ...
            return /* @__PURE__ */ u("span", { className: "workbench-chat-chip", title: F, children: [
              /* @__PURE__ */ r("button", { className: "workbench-chat-chip-open", onClick: () => e.revealContextAttachment(m), disabled: !m.fileId, title: "Reveal context", children: /* @__PURE__ */ r(ma, { size: 13 }) }),
              m.label,
              A ? /* @__PURE__ */ r("small", { children: A }) : null,
              m.snippet ? /* @__PURE__ */ u("small", { children: [
                m.snippet.slice(0, 60),
                m.snippet.length > 60 ? "…" : ""
              ] }) : null,
              m.dirty ? /* @__PURE__ */ r("small", { children: "dirty" }) : null,
              m.removable ? /* @__PURE__ */ r("button", { className: "workbench-chat-chip-remove", onClick: () => e.removeContextAttachment(m), title: "Remove context", children: /* @__PURE__ */ r(Je, { size: 11 }) }) : null
            ] }, m.id);
          }),
        ...
        /* @__PURE__ */ r(
          "textarea",
          {
            ...
            value: e.chatInput,
            onChange: (m) => e.setChatInput(m.target.value),
            onKeyDown: (m) => {
              m.key === "Enter" && !m.shiftKey && (m.preventDefault(), e.busy || e.askAgent());
            },
            placeholder: e.selectedChatTarget.kind === "atomek-ai" ? "Ask Atomek about the open file or describe what to build..." : `Ask ${e.selectedChatTarget.label}…`,
            rows: 3
          }
        ),
        /* @__PURE__ */ u("div", { className: "workbench-chat-toolbar compact", children: [
          /* @__PURE__ */ r("span", { className: "workbench-chat-route-summary", children: e.selectedChatTarget.kind === "atomek-ai" ? Oa(e.chatSettings, e.aiStatus.label, e.memoryHitCount) : e.selectedChatTarget.description }),
          /* @__PURE__ */ r("span", {}),
          e.busy ? /* @__PURE__ */ r("button", { className: "workbench-chat-send stop", onClick: e.stopChat, title: "Stop", children: /* @__PURE__ */ r(Ra, { size: 14 }) }) : /* @__PURE__ */ r("button", { className: `workbench-chat-send ${a ? "ready" : ""}`, onClick: e.askAgent, title: "Send", disabled: !a, "aria-label": "Send message", children: /* @__PURE__ */ r(Es, { size: 16 }) })
        ] })
      ] })
    ] })
  ] });
...
function Oa(e, t, n) {
  e.model;
  const s = [e.gatewayPreference === "auto" ? t : Or(e.gatewayPreference)];
  return n > 0 && s.push(`${n} memories`), s.join(" · ");
}
function nc(e) {
...
function sc({ host: e, appName: t, currentVersion: n }) {
  const a = e.apps, [s, i] = z(null), [o, c] = z(!1), [h, p] = z(null), v = N(async () => {
    if (!a?.checkUpdate) {
    ...
    c(!0), p(null);
    try {
      const A = await a.checkUpdate();
      i(A), A.error && p(A.error);
    } catch (A) {
      p(A instanceof Error ? A.message : String(A));
    } finally {
      c(!1);
    }
  }, [a]);
  ...
  const y = N(async () => {
    ...
    c(!0), p(null);
    try {
      const A = await a.updateSelf();
      i(A), p(A.error ?? `${t} updated. Close and reopen the app to load the new bundle.`);
    } catch (A) {
      p(A instanceof Error ? A.message : String(A));
    } finally {
      c(!1);
    }
  }, [a, t]), k = s?.latestVersion ?? n, m = !!s?.updateAvailable;
  return /* @__PURE__ */ u("div", { className: "workbench-settings-section", children: [
    /* @__PURE__ */ r("h3", { children: "App version" }),
    ...
    /* @__PURE__ */ u("div", { style: { display: "flex", gap: 8, flexWrap: "wrap" }, children: [
      /* @__PURE__ */ u("button", { className: "workbench-button-subtle", onClick: () => void v(), disabled: o, children: [
        /* @__PURE__ */ r(yt, { size: 14 }),
        o ? "Checking…" : "Check for update"
      ] }),
      m ? /* @__PURE__ */ r("button", { className: "workbench-button-primary", onClick: () => void y(), disabled: o, children: o ? "Updating…" : `Update ${t}` }) : null
    ] }),
    /* @__PURE__ */ r("div", { className: "workbench-settings-note", children: h ?? (s ? m ? "Update available." : "You are running the latest available version." : "Checking latest version…") })
  ] });
}
function ic(e) {
  const [t, n] = z([]), [a, s] = z("Loading gateway models…"), [i, o] = z([]), [c, h] = z("Checking embedding capability…");
  re(() => {
    const k = new AbortController();
    return (async () => {
      if (!e.host.ai?.listModels) {
        n([]), s("This Tytus build does not expose model discovery yet.");
        return;
      }
      s("Loading gateway models…");
      try {
        const A = await e.host.ai.listModels({
          gatewayPreference: e.chatSettings.gatewayPreference,
          signal: k.signal
        });
        if (k.signal.aborted) return;
        n(A.map((R) => ({ id: R.id, gatewayLabel: R.gatewayLabel }))), s(A.length > 0 ? `${A.length} models discovered from AIL.` : "No models discovered. You can still enter any AIL alias manually.");
      } catch (A) {
        if (k.signal.aborted) return;
        n([]), s(`Model discovery failed: ${A instanceof Error ? A.message : String(A)}`);
      }
    })(), () => k.abort();
  }, [e.chatSettings.gatewayPreference, e.host.ai]), re(() => {
    const k = new AbortController();
    return (async () => {
      const A = Qo(e.host);
      if (A) {
      ...
      h("Loading embedding-capable models from AIL…");
      try {
        const R = await Go(e.host, {
          gatewayPreference: e.chatSettings.gatewayPreference,
          signal: k.signal
        });
        if (k.signal.aborted) return;
        o(R.map((Z) => ({ id: Z.id, gatewayLabel: Z.gatewayLabel ?? Z.source ?? "AIL" }))), h(R.length > 0 ? `${R.length} embedding models discovered from AIL metadata.` : "AIL embedding API is present, but no embedding-capable model metadata was returned.");
      } catch (R) {
        if (k.signal.aborted) return;
        o([]), h(`Embedding model discovery failed: ${R instanceof Error ? R.message : String(R)}`);
      }
    })(), () => k.abort();
  }, [e.chatSettings.gatewayPreference, e.host]);
  const p = (k) => {
    e.onChange({ ...e.chatSettings, gatewayPreference: k });
  }, v = (k) => {
    e.onChange({ ...e.chatSettings, model: k });
  }, y = (k) => {
    e.onChange({ ...e.chatSettings, embeddingModel: k });
  };
  return /* @__PURE__ */ r("div", { className: "workbench-settings-tab", children: /* @__PURE__ */ u("section", { className: "workbench-settings-page", "aria-label": "Atomek Settings", children: [
    /* @__PURE__ */ u("header", { className: "workbench-settings-header", children: [
      ...
      /* @__PURE__ */ r("button", { onClick: e.onClose, title: "Close", children: /* @__PURE__ */ r(Je, { size: 15 }) })
    ] }),
    /* @__PURE__ */ u("div", { className: "workbench-settings-body", children: [
      /* @__PURE__ */ r(sc, { host: e.host, appName: "Atomek", currentVersion: La }),
      /* @__PURE__ */ u("div", { className: "workbench-settings-section", children: [
        ...
        /* @__PURE__ */ u("label", { className: "workbench-settings-label", children: [
          ...
          /* @__PURE__ */ r("datalist", { id: "atomek-chat-models", children: t.map((k) => /* @__PURE__ */ r("option", { value: k.id, children: k.gatewayLabel }, `${k.gatewayLabel}:${k.id}`)) })
        ] }),
        /* @__PURE__ */ u("div", { className: "workbench-settings-note", children: [
          "Current request: ",
          Or(e.chatSettings.gatewayPreference),
      ...
      /* @__PURE__ */ u("div", { className: "workbench-settings-section", children: [
        ...
        /* @__PURE__ */ u("label", { className: "workbench-settings-label", children: [
          ...
          /* @__PURE__ */ r("datalist", { id: "atomek-embedding-models", children: i.map((k) => /* @__PURE__ */ r("option", { value: k.id, children: k.gatewayLabel }, `${k.gatewayLabel}:${k.id}`)) })
        ] }),
        ...
        /* @__PURE__ */ r("div", { className: "workbench-settings-note", children: c })
      ] })
    ] }),
    /* @__PURE__ */ u("footer", { className: "workbench-settings-footer", children: [
      /* @__PURE__ */ r("button", { onClick: () => e.onChange(en), children: "Reset" }),
      /* @__PURE__ */ r("button", { onClick: e.onClose, children: "Close tab" })
    ] })
  ] }) });
}
function Sr({ outputs: e, clearOutputs: t, deleteArtifact: n, runAiSynthesis: a, captureManualCheck: s, openOutputAsFile: i, previewEditFromOutput: o, canPreviewEdit: c = !1, compact: h = !1 }) {
  return /* @__PURE__ */ u("div", { className: `workbench-panel-list ${h ? "compact" : ""}`, children: [
    /* @__PURE__ */ u("div", { style: { display: "flex", gap: 8, marginBottom: 10 }, children: [
      /* @__PURE__ */ u("button", { className: "workbench-button-subtle", onClick: a, children: [
        /* @__PURE__ */ r(Rn, { size: 14 }),
        "AI synthesis"
      ] }),
      /* @__PURE__ */ u("button", { className: "workbench-button-subtle", onClick: s, children: [
        /* @__PURE__ */ r(Wa, { size: 14 }),
        "Capture check"
      ] }),
      /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: t, children: "Clear" })
    ] }),
    e.length === 0 ? /* @__PURE__ */ r("p", { className: "workbench-muted", children: "No outputs yet. Save an AI answer as an artifact or create an AI synthesis." }) : e.map((p) => /* @__PURE__ */ u("div", { className: "workbench-output-card", children: [
      /* @__PURE__ */ u("div", { className: "workbench-output-head", children: [
        /* @__PURE__ */ r("strong", { children: p.title }),
        /* @__PURE__ */ r("span", { children: p.source === "ai" ? `AI · ${p.kind}` : p.kind }),
        /* @__PURE__ */ r("button", { onClick: () => void kt(p.body), children: "Copy" }),
        /* @__PURE__ */ r("button", { onClick: () => i(p), children: "Open as file" }),
        o ? /* @__PURE__ */ r(
          "button",
          {
            className: Sa(p.body) ? "workbench-output-edit-cta" : void 0,
            onClick: () => o(p),
            disabled: !c,
            children: Sa(p.body) ? "Preview/apply edit" : "Preview edit"
          }
        ) : null,
        p.source === "ai" ? /* @__PURE__ */ r("button", { onClick: () => n(p.id), children: "Delete" }) : null
      ] }),
      /* @__PURE__ */ r(Ar, { body: p.body })
    ] }, p.id))
  ] });
}
function oc({ edit: e, onApply: t, onOpenAsFile: n, onClose: a }) {
  return /* @__PURE__ */ r("div", { className: "workbench-edit-review-overlay", role: "dialog", "aria-label": "Review AI edit", children: /* @__PURE__ */ u("section", { className: "workbench-edit-review", children: [
    /* @__PURE__ */ u("header", { className: "workbench-edit-review-head", children: [
      ...
      /* @__PURE__ */ r("button", { title: "Close", onClick: a, children: /* @__PURE__ */ r(Je, { size: 16 }) })
    ] }),
...
function lc({ patch: e, onApply: t, onOpenAsFiles: n, onClose: a }) {
  const s = e.edits.reduce((i, o) => ({
    added: i.added + o.stats.added,
    removed: i.removed + o.stats.removed,
    changed: i.changed + o.stats.changed
  }), { added: 0, removed: 0, changed: 0 });
  return /* @__PURE__ */ r("div", { className: "workbench-edit-review-overlay", role: "dialog", "aria-label": "Review AI workspace patch", children: /* @__PURE__ */ u("section", { className: "workbench-edit-review workspace", children: [
    /* @__PURE__ */ u("header", { className: "workbench-edit-review-head", children: [
      /* @__PURE__ */ u("div", { children: [
    ...
    /* @__PURE__ */ u("div", { className: "workbench-workspace-patch-list", children: [
      e.edits.map((i) => /* @__PURE__ */ u("article", { className: "workbench-workspace-patch-card", children: [
        /* @__PURE__ */ u("header", { children: [
          /* @__PURE__ */ r("strong", { children: i.fileName }),
          /* @__PURE__ */ u("span", { children: [
            i.extractionLabel,
            " · +",
            i.stats.added,
        ...
        /* @__PURE__ */ r("pre", { children: vc(i.proposedContent) })
      ] }, i.fileId)),
...
function dc(e, t) {
  ...
  if (e)
    n.push("", `Active file: ${e.path}`, `Language: ${e.language}`, `Dirty: ${e.dirty ? "yes" : "no"}`, "", "Active file content:", "```" + e.language, cc(e.content), "```");
  else if (t.length > 0) {
...
function hc(e) {
  const n = e.data?.find((a) => typeof a.id == "string" && a.id.trim());
  return typeof n?.id == "string" ? n.id : null;
}
function mc(e) {
  const n = e.choices?.[0], a = n?.message?.content ?? n?.text ?? n?.delta?.content;
  return typeof a == "string" ? a : Array.isArray(a) ? a.map((s) => typeof s == "string" ? s : s && typeof s == "object" && "text" in s && typeof s.text == "string" ? s.text : "").join("") : JSON.stringify(e, null, 2);
}
function Cr({
  host: e,
  setStatus: t,
  attachSkillToChat: n,
  saveLocalJobOutput: a,
  activeFile: s,
  openEditors: i,
  variant: o = "sidebar"
}) {
  const [c, h] = z([]), [p, v] = z([]), [y, k] = z(null), [m, A] = z(!1), [R, Z] = z(null), [F, ge] = z("Review the active Atomek context. Return concise findings. If you propose edits, output a unified diff or fenced replacement blocks so Atomek can preview before applying."), [we, j] = z(null), [_, q] = z([]), [M, be] = z(() => Wl()), [Y, ve] = z([]), [fe, He] = z([]), [We, je] = z([]), O = it([]), [oe, Pe] = z("task-execute"), [he, g] = z("mission"), W = _.find((d) => d.status === "running" || d.status === "canceling") ?? _[0] ?? null, x = o === "dock", L = ue(() => xt(y, ot(F || M?.goal || "", y, M?.teamPresetId)), [F, M?.goal, M?.teamPresetId, y]), V = ue(() => Ht(F || M?.goal || "", y, L.id), [F, M?.goal, L.id, y]), X = V.find((d) => d.id === oe) ?? V[1] ?? V[0] ?? null, ne = i.filter((d) => d.dirty).length, ae = s ? `${s.path} · ${s.language} · ${s.content.length.toLocaleString()} chars${s.dirty ? " · dirty" : ""}` : i.length > 0 ? `${i.length} open editor${i.length === 1 ? "" : "s"}${ne ? ` · ${ne} dirty` : ""}` : "No active file — jobs run with only your typed prompt.", le = ue(() => [
    {
  ...
  const xe = N(async (d = M) => {
    if (!d?.rootPath || !e.missions?.listRuns)
      return je([]), [];
    try {
      const w = await e.missions.listRuns(d.rootPath);
      return je(w), O.current = w, w;
    } catch (w) {
      return t(`Mission run history failed: ${w instanceof Error ? w.message : String(w)}`), [];
    }
  }, [e.missions, M, t]), Ve = N(async (d, w) => {
    if (!d) return;
    const T = [...w].sort((S, E) => Aa(E).localeCompare(Aa(S))).slice(0, 100), H = T.map((S) => JSON.stringify(S)).join(`
`) + (T.length ? `
` : "");
    d.rootPath && e.missions?.write ? await e.missions.write({ rootPath: d.rootPath, files: [{ path: "RUNS.jsonl", content: H }] }) : d.handle && await Dn(d.handle, "RUNS.jsonl", H), je(T), O.current = T;
  }, [e.missions]), ze = N(async (d, w = M) => {
    if (!w) return;
    const T = [
      d,
      ...O.current.filter((H) => H.id !== d.id)
    ];
    await Ve(w, T);
  }, [M, Ve]), Ee = N(async () => {
    if (!e.local?.listTools && !e.skills?.list && !e.resources?.list) {
      h([]), v([]), k(null), Z("This Tytus host build does not expose local tools, resource graph, or skill registry yet.");
      return;
    }
    A(!0), Z(null);
    try {
      const [d, w, T, H] = await Promise.all([
        e.local?.listTools?.().catch((S) => (t(`Local tool discovery failed: ${S instanceof Error ? S.message : String(S)}`), [])) ?? Promise.resolve([]),
        e.skills?.list?.().catch((S) => (t(`Skill registry discovery failed: ${S instanceof Error ? S.message : String(S)}`), [])) ?? Promise.resolve([]),
        e.resources?.list?.().catch((S) => (t(`Resource graph discovery failed: ${S instanceof Error ? S.message : String(S)}`), null)) ?? Promise.resolve(null),
        e.missions?.list?.().catch((S) => (t(`Mission list failed: ${S instanceof Error ? S.message : String(S)}`), [])) ?? Promise.resolve([])
      ]);
      h(d), v(w), k(T), ve(H), M?.rootPath && xe(M), t(`Agent team loaded · ${d.length} tools · ${w.length} skills · ${H.length} missions${T ? ` · ${T.resources.length} resources` : ""}`);
    } catch (d) {
      Z(d instanceof Error ? d.message : String(d));
    } finally {
      A(!1);
    }
  }, [e.local, e.missions, e.resources, e.skills, xe, M, t]);
  re(() => {
    Ee();
  }, [Ee]), re(() => {
    const d = (w) => {
      const T = w.detail;
      T?.missionId && (be(T), xe(T)), Ee();
    };
    return window.addEventListener(In, d), () => window.removeEventListener(In, d);
  }, [Ee, xe]);
  const Ze = N((d) => {
    const w = Vl(d);
    be(w), St(w), xe(w), He([{
    ...
    }]), ge(d.goal || `Continue mission ${d.title}. Review MISSION.md, TASKS.md, RESOURCES.md, and runs/ before acting.`), t(`Resumed mission: ${d.rootPath}`);
  }, [xe, t]), ye = N(async (d, w, T = []) => {
    const H = [
      ...fe,
      ...T,
      { ts: (/* @__PURE__ */ new Date()).toISOString(), kind: "mission.pack.write", message: "Mission context pack written from Atomek" }
    ], S = ot(w || d.goal, y, d.teamPresetId), E = Ht(w || d.goal, y, S), $ = [
      { path: "MISSION.md", content: tn(d, y, s, i, w, S) },
      { path: "MISSION.json", content: zr(d, y, w, S) },
      { path: "RESOURCES.md", content: nn(y) },
      { path: "TASKS.md", content: Nr(E) },
      { path: "HANDOFF.md", content: Tr(d) },
      { path: "INBOX.md", content: `# Mission inbox
...
Approved handoffs, final artifacts, and user-ready summaries go here.
` },
      { path: "AUDIT.jsonl", content: H.map((U) => JSON.stringify(U)).join(`
`) + `
` },
      { path: "RUNS.jsonl", content: O.current.map((U) => JSON.stringify(U)).join(`
`) + (O.current.length ? `
` : "") },
      { path: "runs/README.md", content: `# Mission runs
...
` }
    ...
    if (d.rootPath && e.missions?.write)
      await e.missions.write({ rootPath: d.rootPath, files: $ });
    else if (d.handle) {
      await bt(d.handle, "runs"), await bt(d.handle, "outputs"), await bt(d.handle, "proposals"), await bt(d.handle, "approvals");
      for (const U of $) await Ol(d.handle, U.path, U.content);
    } else
      throw new Error("Mission has neither tray rootPath nor browser folder handle");
    He(H), St(d);
  }, [s, e.missions, fe, i, y]), K = N(async (d, w = {}) => {
    if (M)
      return await ye(M, d), M;
    const T = `Atomek mission ${(/* @__PURE__ */ new Date()).toLocaleString()}`, H = d.trim() || "Coordinate Tytus resources for the current Atomek task.";
    let S = null;
    if (e.missions?.create) {
      const $ = await e.missions.create({ title: T, goal: H });
      S = {
        missionId: $.missionId,
        title: $.title,
        goal: $.goal,
        rootPath: $.rootPath,
        name: $.rootPath.split("/").pop() || $.missionId,
        source: "tray"
      };
      ...
      S = {
        handle: $,
        name: $.name,
        missionId: `mission-${Date.now()}-${Ml($.name)}`,
        title: T,
        goal: H,
        source: "browser"
      };
    ...
    if (!S) return null;
    const E = { ts: (/* @__PURE__ */ new Date()).toISOString(), kind: "mission.folder.ready", message: `Mission folder ready: ${S.rootPath ?? S.name}` };
    return be(S), St(S), He([E]), await ye(S, H, [E]), t(`Mission pack ready in ${S.rootPath ?? S.name}`), S;
  }, [e.missions, M, t, ye]), G = N(async (d) => {
    if (!e.local?.openTerminal) {
      t("Terminal bridge unavailable in this host build");
      return;
    }
    try {
      const w = F.trim() || `Open ${d.label} from Atomek with current context.`, T = d.kind === "ai-cli" ? await K(w) : M;
      await e.local.openTerminal({
        toolId: d.id,
        command: d.command,
        cwd: T?.rootPath ?? Ca(s),
        prompt: T ? `Atomek mission pack ready at ${T.rootPath ?? T.name}. Read MISSION.md and RESOURCES.md. ${ae}` : `Opened from Atomek. ${ae}`
  ...
  }, [s, ae, K, e.local, F, M, t]), me = N(async () => {
    try {
      await K(F.trim(), { allowBrowserPicker: !0 }) || t("Mission folder setup skipped.");
    } catch (d) {
      t(`Mission folder setup failed: ${d instanceof Error ? d.message : String(d)}`);
    }
  }, [K, F, t]), ee = N(async (d, w, T, H = M, S) => {
    if (!H) return;
    const E = (/* @__PURE__ */ new Date()).toISOString().replace(/[:.]/g, "-"), $ = S ?? `runs/${E}-${d.id}.md`, U = $.split("/").pop() || `${E}-${d.id}.md`;
    if (H.rootPath && e.missions?.write)
      await e.missions.write({ rootPath: H.rootPath, files: [{ path: $, content: w }] });
    else if (H.handle) {
      const ke = await bt(H.handle, "runs");
      await Dn(ke, U, w);
    }
    await ye(H, F, [{
      ts: (/* @__PURE__ */ new Date()).toISOString(),
      kind: "local-cli.run.complete",
      message: `${d.label} exited ${T}; transcript saved to ${$}`,
      data: { toolId: d.id, exitCode: T, transcript: $ }
    }]);
  }, [e.missions, F, M, ye]), Ne = N(async (d) => {
    ...
    try {
      ...
      t(`Mission pack failed before local job start: ${E instanceof Error ? E.message : String(E)}`);
      return;
    }
    j(d.id);
    const H = `local-run-${Date.now()}-${d.id}`, S = mt();
    q((E) => [{
      id: H,
      toolId: d.id,
      label: d.label,
    ...
    try {
      const E = await e.local.runJob({
        toolId: d.id,
        prompt: T ? [
          "Tytus mission context pack is active.",
          `Mission: ${T.title}`,
          `Goal: ${T.goal}`,
          T.rootPath ? `Mission folder: ${T.rootPath}` : `Mission folder: ${T.name}`,
...
`)
      }), $ = E.transcriptPath ?? (T?.rootPath ? `runs/${(/* @__PURE__ */ new Date()).toISOString().replace(/[:.]/g, "-")}-${d.id}.md` : void 0), U = [
        `[Atomek] Started ${d.label} local job ${E.id}`,
        X ? `[Atomek] Task: ${X.title} (${X.id})` : "[Atomek] Task: manual",
        T?.rootPath ? `[Atomek] Mission: ${T.rootPath}` : ""
      ].filter(Boolean), ke = {
        id: H,
        jobId: E.id,
        toolId: d.id,
      ...
      ze(ke, T).catch((B) => {
        t(`Mission run index failed: ${B instanceof Error ? B.message : String(B)}`);
      }), q((B) => B.map((I) => I.id === H ? { ...I, jobId: E.id, transcriptPath: $ } : I));
      const Ke = (B) => {
        q((I) => I.map((se) => se.id === H ? B(se) : se));
      };
      e.local.streamJob(E.id, {
        onLog: (B) => {
          U.push(B), Ke((I) => ({ ...I, lines: U.slice(-500) }));
        },
        onDone: (B) => {
          B && (U.push(B), Ke((I) => ({ ...I, lines: U.slice(-500) })));
        },
        onFail: (B) => {
          U.push(`[FAIL] ${B}`), Ke((I) => ({
            ...I,
            ...
            t(`Mission run index failed: ${I instanceof Error ? I.message : String(I)}`);
          }), a(`${d.label} local job failed`, U.join(`
`)), ee(d, U.join(`
`), -1, T, $).catch((I) => {
            t(`Mission transcript save failed: ${I instanceof Error ? I.message : String(I)}`);
          }), j(null);
        },
        onExit: (B) => {
          const I = [
...
`);
          Ke((se) => ({
            ...
            finishedAt: mt(),
            exitCode: B,
            summary: `${d.label} exited ${B}`
          }, T).catch((se) => {
            t(`Mission run index failed: ${se instanceof Error ? se.message : String(se)}`);
          }), a(`${d.label} local job`, I), ee(d, I, B, T, $).catch((se) => {
            t(`Mission transcript save failed: ${se instanceof Error ? se.message : String(se)}`);
          }), j(null);
        },
        onError: () => t(`Local job stream issue for ${d.label}`)
      }), t(`Started ${d.label} mission run${X ? ` · ${X.title}` : ""}`);
    } catch (E) {
      j(null), q(($) => $.map((U) => U.id === H ? {
        ...U,
        status: "failed",
        finishedAt: Date.now(),
        lines: [...U.lines, `[Atomek] Failed to start: ${E instanceof Error ? E.message : String(E)}`]
      } : U)), t(`Local job failed to start: ${E instanceof Error ? E.message : String(E)}`);
    }
  }, [s, K, e.local, F, i, y, a, ee, X, t, ze, ye]), Ie = N(async (d) => {
    const w = Fn(d);
    if (!w) {
      t(`Cannot dispatch ${Oe(d)}: missing pod id`);
      return;
    }
    const T = F.trim();
    if (!T) {
    ...
    let H = null;
    const S = Oe(d), E = `pod-run-${Date.now()}-${w}`, $ = mt(), U = `runs/${(/* @__PURE__ */ new Date()).toISOString().replace(/[:.]/g, "-")}-${d.id.replace(/[^a-z0-9_.-]/gi, "-")}.md`;
    try {
      H = await K(T), H && await ye(H, T, [{
        ts: (/* @__PURE__ */ new Date()).toISOString(),
        kind: "pod-agent.run.start",
        message: `${S} mission task started`,
        data: { resourceId: d.id, podId: w, taskId: X?.id ?? "manual", taskTitle: X?.title ?? "Manual pod run" }
      }]);
    } catch (I) {
      t(`Mission pack failed before pod task: ${I instanceof Error ? I.message : String(I)}`);
      return;
    }
    const ke = {
      id: E,
      ...
      transcriptPath: U,
      summary: `Started ${S} for ${X?.title ?? "manual pod run"}`
    };
    q((I) => [{
      id: E,
      toolId: d.id,
      ...
      taskTitle: X?.title ?? "Manual pod run",
      transcriptPath: U,
      lines: [`[Atomek] Dispatching ${S} via Tytus host bridge…`, `[Atomek] Pod: ${w}`, `[Atomek] Task: ${X?.title ?? "manual pod run"}`]
    }, ...I].slice(0, 6)), await ze(ke, H).catch((I) => {
      t(`Mission run index failed: ${I instanceof Error ? I.message : String(I)}`);
    });
    const Ke = [], B = (I) => {
      Ke.push(I), q((se) => se.map((Le) => Le.id === E ? { ...Le, lines: [...Le.lines, I].slice(-500) } : Le));
    };
    try {
      const I = await e.daemon.callPodEndpoint(w, "/v1/models", { method: "GET" });
      if (!I.ok)
        throw new Error(`/v1/models ${I.status}: ${await I.text()}`);
      const se = await I.json(), Le = hc(se);
      if (!Le)
        throw new Error("pod /v1/models returned no model id");
      B(`[Atomek] Selected pod model from live metadata: ${Le}`);
      const Te = await e.daemon.callPodEndpoint(w, "/v1/chat/completions", {
        method: "POST",
...
`)
      ...
      if (!Te.ok)
        throw new Error(`/v1/chat/completions ${Te.status}: ${Ae}`);
      let Fe = Ae;
      try {
        Fe = JSON.parse(Ae);
      } catch {
      }
      const lt = typeof Fe == "string" ? Fe : mc(Fe);
      B(lt);
      const ct = [
        `# Pod job — ${S}`,
        "",
...
`);
      q((Nt) => Nt.map((Qe) => Qe.id === E ? { ...Qe, status: "complete", finishedAt: Date.now(), lines: [...Qe.lines, "[Atomek] Pod task complete."].slice(-500) } : Qe)), await ze({ ...ke, status: "complete", finishedAt: mt(), summary: `${S} completed`, transcriptPath: U }, H), a(`${S} pod job`, ct), await ee({ id: d.id, label: S, kind: "pod-agent", status: d.status }, ct, 0, H, U), t(`${S} completed mission task`);
    } catch (I) {
      const se = I instanceof Error ? I.message : String(I);
      B(`[FAIL] ${se}`), q((Te) => Te.map((Ae) => Ae.id === E ? { ...Ae, status: "failed", finishedAt: Date.now(), lines: Ae.lines.slice(-500) } : Ae)), await ze({ ...ke, status: "failed", finishedAt: mt(), exitCode: -1, summary: se, transcriptPath: U }, H).catch((Te) => {
        t(`Mission run index failed: ${Te instanceof Error ? Te.message : String(Te)}`);
      });
      const Le = [`# Pod job failed — ${S}`, "", `- Pod: ${w}`, `- Error: ${se}`, "", "```text", Ke.join(`
`), "```", ""].join(`
`);
      a(`${S} pod job failed`, Le), await ee({ id: d.id, label: S, kind: "pod-agent", status: d.status }, Le, -1, H, U).catch((Te) => {
        t(`Pod transcript save failed: ${Te instanceof Error ? Te.message : String(Te)}`);
      }), t(`Pod task failed: ${se}`);
    }
  }, [s, K, e.daemon, F, i, y, a, ee, X, t, ze, ye]), De = N(async (d) => {
    if (!d.jobId || !e.local?.cancelJob) {
      t("Local job cancel bridge unavailable in this host build");
      return;
    }
    q((w) => w.map((T) => T.id === d.id ? { ...T, status: "canceling", lines: [...T.lines, "[Atomek] Cancel requested…"] } : T)), ze({
      id: d.id,
      jobId: d.jobId,
      toolId: d.toolId,
      label: d.label,
    ...
    try {
      ...
      q((T) => T.map((H) => H.id === d.id ? { ...H, status: "running", lines: [...H.lines, `[Atomek] Cancel failed: ${w instanceof Error ? w.message : String(w)}`] } : H)), t(`Local job cancel failed: ${w instanceof Error ? w.message : String(w)}`);
    }
  }, [e.local, t, ze]), te = N(async (d) => {
    const w = [
      `Use Tytus resource "${Oe(d)}" (${d.kind}) for the next mission step.`,
...
`);
    ge(w), M && await ye(M, w, [{
      ...
      message: `Selected resource ${Oe(d)}`,
      data: { resourceId: d.id, kind: d.kind, status: d.status }
    }]), t(`Selected ${Oe(d)} for mission`);
  }, [M, t, ye]), de = N((d) => {
    const w = d.setupAction, T = w?.commandPreview ? `${w.label}: ${w.commandPreview}` : w?.deepLink ? `${w.label}: ${w.deepLink}` : w?.label ?? `${Oe(d)} needs setup`;
    t(T), kt(w?.commandPreview ?? w?.deepLink ?? T);
  }, [t]);
  return /* @__PURE__ */ u("aside", { className: x ? "workbench-agent-dock" : "workbench-sidebar", children: [
    x ? null : /* @__PURE__ */ r("div", { className: "workbench-sidebar-title", children: "AGENT TEAM" }),
    /* @__PURE__ */ u("div", { className: x ? "workbench-agent-dock-scroll" : "workbench-sidebar-scroll", children: [
      /* @__PURE__ */ u("div", { className: "workbench-computer-hero", children: [
        /* @__PURE__ */ r(Rn, { size: 18 }),
        /* @__PURE__ */ u("div", { children: [
          /* @__PURE__ */ r("strong", { children: x ? "Mission Runs" : "OpenClaw + Hermes Team Board" }),
          /* @__PURE__ */ r("p", { className: "workbench-muted", children: "Coordinate OpenClaw pods, Hermes pods, local agents, shared folders, app skills, and AIL routes. Open tools in Terminal when you want hands-on control; run background reviews when you want streamed, approval-gated output." })
        ] })
      ] }),
      ...
      R && /* @__PURE__ */ r("div", { className: "workbench-inline-error", children: R }),
      /* @__PURE__ */ u("div", { className: "workbench-team-switcher", role: "tablist", "aria-label": "Atomek agent team views", children: [
        /* @__PURE__ */ r("button", { className: he === "mission" ? "active" : "", onClick: () => g("mission"), children: "Mission" }),
        /* @__PURE__ */ r("button", { className: he === "runs" ? "active" : "", onClick: () => g("runs"), children: "Runs" }),
        /* @__PURE__ */ r("button", { className: he === "setup" ? "active" : "", onClick: () => g("setup"), children: "Setup" })
      ] }),
      he === "mission" ? /* @__PURE__ */ u(Re, { children: [
        /* @__PURE__ */ r("div", { className: "workbench-section-title", children: "MISSION PACK — SHARED CONTEXT" }),
        /* @__PURE__ */ u("div", { className: "workbench-computer-context-card mission", children: [
          /* @__PURE__ */ r("strong", { children: M ? M.title : "No mission folder selected" }),
          /* @__PURE__ */ r("span", { children: M ? `${M.rootPath ?? M.name} · ${M.source} · ${fe.length} audit events · transcripts saved under runs/` : "Atomek creates this automatically before launching local agents. It is the shared folder agents read/write transcripts from." }),
          y ? /* @__PURE__ */ u("span", { children: [
            Pr(y.resources),
            y.warnings.length ? ` · ${y.warnings.length} warnings` : ""
          ] }) : /* @__PURE__ */ r("span", { children: "Resource graph not loaded yet." })
        ] }),
        /* @__PURE__ */ r("div", { className: "workbench-section-title", children: "SELECTED TEAM" }),
        /* @__PURE__ */ u("div", { className: "workbench-team-assignment-list", children: [
          ...
          L.assignments.map((d) => /* @__PURE__ */ u("div", { className: "workbench-team-assignment-row", children: [
            /* @__PURE__ */ u("div", { children: [
              ...
              /* @__PURE__ */ r("span", { children: d.resourceLabel })
            ] }),
            /* @__PURE__ */ r("em", { children: d.status })
          ] }, `${d.role}-${d.resourceId}`))
        ] }),
        /* @__PURE__ */ u("div", { className: "workbench-computer-actions", children: [
          /* @__PURE__ */ r("button", { className: "workbench-button-subtle workbench-agent-primary-action", onClick: () => {
            me();
          }, children: M ? "Refresh mission pack" : "Start mission pack" }),
          /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: () => M && void ye(M, F), disabled: !M, children: "Rewrite context files" })
        ] }),
        Y.length ? /* @__PURE__ */ u(Re, { children: [
          /* @__PURE__ */ r("div", { className: "workbench-section-title", children: "RESUME MISSION" }),
          /* @__PURE__ */ r("div", { className: "workbench-mission-list", children: Y.slice(0, x ? 3 : 5).map((d) => /* @__PURE__ */ u(
            "button",
            {
              className: `workbench-mission-row ${M?.missionId === d.missionId ? "active" : ""}`,
              onClick: () => Ze(d),
              title: d.rootPath,
              children: [
        ...
        y?.warnings.length ? /* @__PURE__ */ r("div", { className: "workbench-resource-warnings", children: y.warnings.slice(0, 3).map((d) => /* @__PURE__ */ u("span", { children: [
          d.code,
          ": ",
          d.message
        ] }, `${d.code}-${d.resourceId ?? d.message}`)) }) : null,
        /* @__PURE__ */ r("div", { className: "workbench-section-title", children: "ACTIVE CONTEXT" }),
        /* @__PURE__ */ u("div", { className: "workbench-computer-context-card", children: [
          /* @__PURE__ */ r("strong", { children: ae }),
          /* @__PURE__ */ r("span", { children: s ? "Local agents receive clipped active-file content and must return previewable edits." : "Open a file to give local agents useful context." })
        ] }),
        /* @__PURE__ */ r("div", { className: "workbench-section-title", children: "TASK FOR LOCAL AGENT" }),
        /* @__PURE__ */ r("div", { className: "workbench-computer-presets", children: le.map((d) => /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: () => ge(d.prompt), children: d.label }, d.label)) }),
        /* @__PURE__ */ r(
          "textarea",
          {
        ...
        /* @__PURE__ */ r("div", { className: "workbench-section-title", children: "TASK GRAPH" }),
        /* @__PURE__ */ r("div", { className: "workbench-task-graph", children: V.map((d, w) => /* @__PURE__ */ u(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ r("span", { children: w + 1 }),
              /* @__PURE__ */ r("strong", { children: d.title }),
              /* @__PURE__ */ r("em", { children: d.resourceHint }),
              /* @__PURE__ */ r("small", { children: d.assignedResourceLabel })
            ]
          },
          d.id
        )) })
      ] }) : null,
      he === "runs" ? /* @__PURE__ */ u(Re, { children: [
        W ? /* @__PURE__ */ u("div", { className: "workbench-agent-run", children: [
          /* @__PURE__ */ u("header", { children: [
            /* @__PURE__ */ u("div", { children: [
              /* @__PURE__ */ r("strong", { children: W.label }),
              /* @__PURE__ */ u("span", { children: [
                W.status,
                typeof W.exitCode == "number" ? ` · exit ${W.exitCode}` : "",
                W.taskTitle ? ` · ${W.taskTitle}` : ""
              ] }),
              W.transcriptPath ? /* @__PURE__ */ r("span", { children: W.transcriptPath }) : null
            ] }),
            /* @__PURE__ */ u("div", { className: "workbench-agent-run-actions", children: [
              /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: () => a(`${W.label} local job`, W.lines.join(`
`)), disabled: W.lines.length === 0, children: "Save output" }),
              W.jobId && (W.status === "running" || W.status === "canceling") ? /* @__PURE__ */ u("button", { className: "workbench-button-subtle danger", onClick: () => {
                De(W);
              }, disabled: W.status === "canceling", children: [
                /* @__PURE__ */ r(Ra, { size: 12 }),
                " ",
                W.status === "canceling" ? "Canceling…" : "Cancel"
              ] }) : null
            ] })
          ] }),
          /* @__PURE__ */ r("pre", { className: "workbench-computer-job-log", children: W.lines.join(`
`) || "[waiting for output]" })
        ] }) : null,
        We.length ? /* @__PURE__ */ u(Re, { children: [
          /* @__PURE__ */ r("div", { className: "workbench-section-title", children: "RUN HISTORY" }),
          /* @__PURE__ */ r("div", { className: "workbench-run-history", children: We.slice(0, x ? 4 : 8).map((d) => /* @__PURE__ */ u("div", { className: "workbench-run-history-row", children: [
            /* @__PURE__ */ u("div", { children: [
              /* @__PURE__ */ r("strong", { children: d.taskTitle || d.label }),
              /* @__PURE__ */ u("span", { children: [
                d.label,
                " · ",
                d.status,
              ...
              d.transcriptPath ? /* @__PURE__ */ r("small", { children: d.transcriptPath }) : null
            ] }),
            /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: () => void kt(d.transcriptPath ?? d.id), title: "Copy transcript path or run id", children: "Copy path" })
          ] }, d.id)) })
        ] }) : null
      ] }) : null,
      he === "setup" ? /* @__PURE__ */ u(Re, { children: [
        /* @__PURE__ */ r("div", { className: "workbench-section-title", children: "RESOURCE GRAPH" }),
        /* @__PURE__ */ u("div", { className: "workbench-computer-list compact", children: [
          !y && !m ? /* @__PURE__ */ r("p", { className: "workbench-muted", children: "No resource graph reported yet. Older Tytus host builds need `/api/resources`." }) : null,
          y?.resources.slice(0, x ? 8 : 5).map((d) => /* @__PURE__ */ u("div", { className: "workbench-resource-row", children: [
            /* @__PURE__ */ u("div", { children: [
              /* @__PURE__ */ r("strong", { children: Oe(d) }),
              /* @__PURE__ */ r("span", { children: ea(d) })
            ] }),
            /* @__PURE__ */ u("div", { className: "workbench-resource-row-actions", children: [
              /* @__PURE__ */ r("span", { className: `workbench-computer-pill ${d.status}`, children: d.status }),
              /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: () => {
                te(d);
              }, children: "Use" }),
              d.kind === "pod-agent" && Fn(d) ? /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: () => {
                Ie(d);
              }, children: "Ask pod" }) : null,
              d.status === "needs-setup" || d.setupAction ? /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: () => de(d), children: "Setup" }) : null
            ] })
          ] }, d.id))
        ] }),
        /* @__PURE__ */ u("div", { className: "workbench-computer-explainer", children: [
          /* @__PURE__ */ r("strong", { children: "How launch works" }),
          /* @__PURE__ */ u("span", { children: [
            /* @__PURE__ */ r("b", { children: "Open in Terminal" }),
            ": opens a fresh Tytus Terminal, changes into the mission folder, and starts the selected CLI immediately."
          ] }),
          /* @__PURE__ */ u("span", { children: [
            /* @__PURE__ */ r("b", { children: "Background review" }),
        ...
        /* @__PURE__ */ r("div", { className: "workbench-section-title", children: "LOCAL AGENTS & TERMINAL" }),
        /* @__PURE__ */ u("div", { className: "workbench-computer-list", children: [
          c.length === 0 && !m ? /* @__PURE__ */ r("p", { className: "workbench-muted", children: "No local tools reported yet." }) : null,
          c.map((d) => /* @__PURE__ */ u("div", { className: "workbench-computer-card", children: [
            ...
            d.description ? /* @__PURE__ */ r("p", { className: "workbench-muted", children: d.description }) : null,
            /* @__PURE__ */ u("div", { className: "workbench-computer-actions", children: [
              /* @__PURE__ */ r("button", { className: "workbench-button-subtle workbench-agent-primary-action", onClick: () => {
                G(d);
              }, disabled: d.status !== "available", title: "Launch this tool in a fresh Tytus Terminal with mission context and execute it immediately.", children: uc(d) }),
              d.kind === "ai-cli" ? /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: () => {
                Ne(d);
              }, disabled: d.status !== "available" || we !== null, title: "Run this local agent as a background read-only review inside Atomek and stream output here. It cannot write files directly.", children: fc(d, we) }) : null
            ] })
          ] }, d.id))
        ] }),
        /* @__PURE__ */ r("div", { className: "workbench-section-title", children: "AGENTIC APP SKILLS" }),
        /* @__PURE__ */ u("div", { className: "workbench-computer-list", children: [
          p.length === 0 && !m ? /* @__PURE__ */ r("p", { className: "workbench-muted", children: "No skills reported yet." }) : null,
          p.map((d) => /* @__PURE__ */ u("div", { className: "workbench-computer-card", children: [
            ...
            /* @__PURE__ */ r("p", { className: "workbench-muted", children: d.description }),
            d.triggers?.length ? /* @__PURE__ */ r("div", { className: "workbench-computer-triggers", children: d.triggers.slice(0, 4).map((w) => /* @__PURE__ */ r("span", { children: w }, w)) }) : null,
            /* @__PURE__ */ r("button", { className: "workbench-button-subtle", onClick: () => {
              n(d);
...
function pc({ status: e, file: t, cursor: n, fileCount: a, dirtyCount: s }) {
  return /* @__PURE__ */ u("footer", { className: "workbench-statusbar", children: [
    ...
    /* @__PURE__ */ r("span", { children: qa(t.language) })
  ] });
}
function On(e, t) {
...
function gc(...e) {
  ...
  for (const n of e.flatMap(Hr)) {
    const a = `${n.kind ?? "file"}:${n.handleKey ?? n.path}`, s = t.get(a);
    (!s || n.at >= s.at) && t.set(a, n);
  }
  return [...t.values()].sort((n, a) => a.at - n.at).slice(0, 10);
}
function wc() {
  try {
...
function Pc(e) {
  let t = 0;
  const n = 2e6;
  return e.slice(0, 160).map((a) => {
    const i = t + a.content.length <= n ? a.content : "";
    return t += i.length, {
      id: a.id,
      name: a.name,
      path: a.path,
...
function Nc(e, t) {
  ...
  return t.map((a) => {
    const s = n.get(a.id);
    return s && s.dirty ? { ...a, content: s.content, dirty: !0 } : a;
  });
}
function Tc() {
  const e = {
...
function Xc({ host: e }) {
  return /* @__PURE__ */ r(Il, { host: e });
}
function Oc(e) {
  return function() {
    return /* @__PURE__ */ r(Xc, { host: e.host });
  };
}
export {
  Oc as default
