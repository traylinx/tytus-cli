import { c as P, l as _, e as B } from "./WorkbenchMonacoEditor-DeMocMpz.js";
import { f as Q, g as G, C as J, H as Y, b as y, d as X, F as Z, S as $, e as K } from "./lspLanguageFeatures-BSh83StM.js";
import { a as Ae, D as Oe, h as Ie, R as Le, c as Ne, i as Ee, j as Ue, t as De, k as Be } from "./lspLanguageFeatures-BSh83StM.js";
const x = 120 * 1e3;
class C {
  constructor(i) {
  ...
  _getClient() {
    return this._lastUsedTime = Date.now(), this._client || (this._worker = P({
      ...
      createWorker: () => new Worker(new URL(
        /* @vite-ignore */
        "" + new URL("assets/json.worker-DQOG4ivs.js", import.meta.url).href,
        import.meta.url
      ), { type: "module" }),
...
export {
  ...
  G as DocumentRangeFormattingEditProvider,
...
//# sourceMappingURL=jsonMode-CQUaiEmr.js.map
