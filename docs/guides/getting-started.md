...
|---|---|---|
| macOS Apple Silicon | `Tytus-0.7.12-aarch64-apple-darwin-unsigned-PUBLIC-BETA-UNSIGNED.pkg` | Open the pkg. If macOS blocks it, Control-click the file and choose **Open**. |
| macOS Intel | `Tytus-0.7.12-x86_64-apple-darwin-unsigned-PUBLIC-BETA-UNSIGNED.pkg` | Open the pkg. If macOS blocks it, Control-click the file and choose **Open**. |
| Ubuntu/Debian x86_64 | `Tytus-0.7.12-x86_64-unknown-linux-gnu-unsigned-PUBLIC-BETA-UNSIGNED.deb` | Open with your software installer or run `sudo apt install ./Tytus-0.7.12-x86_64-unknown-linux-gnu-unsigned-PUBLIC-BETA-UNSIGNED.deb`. |
