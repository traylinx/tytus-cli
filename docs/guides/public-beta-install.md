...
> For `v0.6.14-beta.12`. This is a technical preview, not production GA.
...
```powershell
$env:TYTUS_RELEASE_TAG="v0.6.14-beta.12"; irm https://get.traylinx.com/install.ps1 | iex
```
...
```bash
curl -fsSL https://get.traylinx.com/install.sh | TYTUS_RELEASE_TAG=v0.6.14-beta.12 sh
```
