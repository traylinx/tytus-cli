...
curl -fsSL https://get.traylinx.com/install.sh | TYTUS_RELEASE_TAG=v0.6.14-beta.2 sh
...
$env:TYTUS_RELEASE_TAG="v0.6.14-beta.2"; irm https://get.traylinx.com/install.ps1 | iex
