...
# macOS / Linux — explicit tag/pre-release
curl -fsSL https://get.traylinx.com/install.sh | TYTUS_RELEASE_TAG=v0.6.14 sh

# Windows — stable/latest production release
powershell -c "irm https://get.traylinx.com/install.ps1 | iex"

# Windows — explicit tag/pre-release
$env:TYTUS_RELEASE_TAG="v0.6.14"; irm https://get.traylinx.com/install.ps1 | iex
