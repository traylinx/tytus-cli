...
Current public beta: **v0.6.14-beta.28** (2026-05-10).
...
curl -fsSL https://get.traylinx.com/install.sh | TYTUS_RELEASE_TAG=v0.6.14-beta.28 sh
```

```powershell
# Windows public beta preview
$env:TYTUS_RELEASE_TAG="v0.6.14-beta.28"; irm https://get.traylinx.com/install.ps1 | iex
```
