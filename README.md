...
Current release: **v0.6.11** (2026-05-03).
...
Manual release artifacts are published at GitHub Releases for macOS arm64/x64, Linux x64, and Windows x64. Windows binaries compile and package in v0.6.11, but full Windows daemon/tray/tunnel runtime parity is still preview.
